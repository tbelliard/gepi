...
class ImportModele {
  ...
  function search($nom) {
    ...
    $this->req = "SELECT nom,prenom,login,statut FROM utilisateurs
                ...
                AND auth_mode='sso'";
    $this->res = mysqli_query($GLOBALS["___mysqli_ston"], $this->req) or die(((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));
  ...
  public function cree_table_import() {
    ...
    $this->res = mysqli_query($GLOBALS["___mysqli_ston"], $this->req);
  ...
  public function get_infos_classes() {
    ...
    $this->res = mysqli_query($GLOBALS["___mysqli_ston"], $this->sql) or die(((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));
    return $this->res;
  }
