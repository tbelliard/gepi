...
function titre_lettre_type($id)
 {
	...
	$execution_lettre = mysqli_query($GLOBALS["___mysqli_ston"], $requete_lettre) or die('Erreur SQL !'.$requete_lettre.'<br />'.((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));
...
if(!empty($lettre_type_nouv) and $action_choix_lettre === 'editer' and $valide_form === 'yes')
 {
	// on vérifie s'il y a des lettres de ce type qui on était envoyé si oui on ne peut pas supprimer ce type de lettre
        $test_existance = mysql_result(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT count(*) FROM ".$prefix_base."lettres_types WHERE titre_lettre_type = '".$lettre_type_nouv."'"),0);
        if ($test_existance === '0')
	{
 	      if(empty($reponse_lettre_type)) { $reponse_lettre_type = 'non'; }
              ...
              $execution_requete = mysqli_query($GLOBALS["___mysqli_ston"], $requete);
	      $lettre_type = ((is_null($___mysqli_res = mysqli_insert_id($GLOBALS["___mysqli_ston"]))) ? false : $___mysqli_res);
...
if($action_cadre === 'supprimer_cadre' and $valide_form === 'yes')
 {
	...
	{
		// on vérifie s'il y a des lettres de ce type qui on était envoyé si oui on ne peut pas supprimer ce type de lettre
                $test_existance = mysql_result(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT count(*) FROM ".$prefix_base."lettres_tcs WHERE cadre_lettre_tc = '".$id."'"),0);
                if ($test_existance === '0')
		{
...
if($action_choix_lettre === 'supprimer' and $valide_form === 'yes')
 {
	...
	{
		// on vérifie s'il y a des lettres de ce type qui on était envoyé si oui on ne peut pas supprimer ce type de lettre
                $test_existance = mysql_result(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT count(*) FROM ".$prefix_base."lettres_suivis WHERE type_lettre_suivi = '".$lettre_type."'"),0);
                if ($test_existance === '0')
		{
...
if($action_choix_lettre === 'renommer' and $lettre_type_nouv != '' and $valide_form === 'yes')
 {
	...
	{
		// on vérifie s'il y a des lettres de ce type qui on était envoyé si oui on ne peut pas supprimer ce type de lettre
                $test_existance = mysql_result(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT count(*) FROM ".$prefix_base."lettres_types WHERE titre_lettre_type = '".$lettre_type_nouv."' AND id_lettre_type != '".$lettre_type."'"),0);
                if ($test_existance === '0')
		{
			if(empty($reponse_lettre_type)) { $reponse_lettre_type = 'non'; }
...
if($action_laf === 'reinit_envoi' and $valide_form === 'yes')
 {
	if(!empty($id))
	{
		// on vérifie s'il n'y a pas eu de réponse pour cette envoi si oui on ne peut pas réinitialiser
                $test_existance = mysql_result(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT count(*) FROM ".$prefix_base."lettres_suivis WHERE id_lettre_suivi = '".$id."' AND (reponse_date_lettre_suivi = '' OR reponse_date_lettre_suivi != '0000-00-00') AND statu_lettre_suivi = 'recus'"),0);
                if ($test_existance === '0')
		{
...
<div style="text-align: center;">
	...
	foreach ($_POST['id_lettre_suivi'] as $i => $value) 
		...
		$resultat_efface_courriers = mysqli_query($GLOBALS["___mysqli_ston"], $rq_efface_courriers) or die('Erreur SQL !'.$rq_efface_courriers.'<br />'.((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));
	...
	if ( $form_pdf_lettre === 'affiche' and $_POST['Submit3']==='Assembler les courriers' and $_POST['id_lettre_suivi'][0]!='')
	{
		...
		$resultat_rq_liste = mysqli_query($GLOBALS["___mysqli_ston"], $rq_liste) or die('Erreur SQL !'.$rq_liste.'<br />'.((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));
			...
			if ($precedent[1]==$courrier[1])
				{
					...
					mysqli_query($GLOBALS["___mysqli_ston"], $rq_ajout_courrier) or die('Erreur SQL !'.$rq_liste.'<br />'.((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));
					...
					mysqli_query($GLOBALS["___mysqli_ston"], $rq_suppr_prece) or die('Erreur SQL !'.$rq_suppr_prece.'<br />'.((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));
					$precedent=$courrier;
				}
			else 
				{			
	...
	foreach ($_POST['id_lettre_suivi'] as $i => $value) 
		...
		$resultat_repasse_courriers_attente = mysqli_query($GLOBALS["___mysqli_ston"], $rq_repasse_courriers_attente) or die('Erreur SQL !'.$rq_repasse_courriers_attente.'<br />'.((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));
	...
	foreach ($_POST['id_lettre_suivi'] as $i => $value) 
		...
		$resultat_rq_reponse_recue = mysqli_query($GLOBALS["___mysqli_ston"], $rq_reponse_recue) or die('Erreur SQL !'.$rq_reponse_recue.'<br />'.((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));
...
<?php /*   <form method="post" action="lettre_pdf.php?type_impr=<?php echo $type_impr; ?>&amp;choix=<?php echo $choix; ?>&amp;lettre_action=originaux" name="form2"> */ ?>
   <form method="post" action="impression_absences.php?type_impr=<?php echo $type_impr; ?>&amp;lettre_action=originaux" name="form2">
	...
	<table style="margin: auto; text-align: left; width: 750px; border: 2px solid #000000; background-color: #FFFFFF;" cellpadding="0" cellspacing="1">	  <tbody>
		...
		$resultat_liste_courrier = mysqli_query($GLOBALS["___mysqli_ston"], $requete_liste_courrier) or die('Erreur SQL !'.$requete_liste_courrier.'<br />'.((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));
            ...
            Classe
                <select name="classe">
                    ...
                    <?php
                          ...
                          $req_classe = mysqli_query($GLOBALS["___mysqli_ston"], $sql_classe) or die('Erreur SQL ! '.$sql_classe.' '.((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));
                ...
                <select name="eleve">
                    ...
                    <?php
                         ...
                         if( $classe != "tous" ) { $sql_eleve = 'SELECT DISTINCT '.$prefix_base.'eleves.login, nom, prenom, '.$prefix_base.'j_eleves_classes.login, id_classe FROM '.$prefix_base.'eleves, '.$prefix_base.'j_eleves_classes WHERE '.$prefix_base.'j_eleves_classes.login='.$prefix_base.'eleves.login AND id_classe="'.$classe.'" ORDER BY nom, prenom ASC'; }
                          ...
                          $req_eleve = mysqli_query($GLOBALS["___mysqli_ston"], $sql_eleve) or die('Erreur SQL ! '.$sql_eleve.' '.((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));
                ...
                ?>
                  <tr class="<?php echo $couleur_cellule; ?>">
                    ...
                    <td>
                        ...
                        <?php
                             $req_cpe = mysqli_query($GLOBALS["___mysqli_ston"], $sql_cpe) or die('Erreur SQL ! '.$sql_cpe.' '.((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));
      ...
      <fieldset style="width: 450px; margin: auto;" class="couleur_ligne_3">
		...
		<select name="etiquette_format" style="width: 200px;">
                    <?php
                          ...
                          $req_etiquette = mysqli_query($GLOBALS["___mysqli_ston"], $sql_etiquette) or die('Erreur SQL ! '.$sql_etiquette.' '.((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));
