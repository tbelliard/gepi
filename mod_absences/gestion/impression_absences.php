...
function titre_lettre_type($id)
 { 
	...
	$donner_lettre = mysql_fetch_array($execution_lettre);
...
<input type="submit" name="Submit" value="Listée la sélection" style="cursor: pointer;" /></td>
</tr>
</table>
      ...
      <fieldset style="width: 450px; margin: auto;" class="couleur_ligne_3">
		...
		<select name="etiquette_format" style="width: 200px;">
                    <?php
                          ...
                          $req_etiquette = mysql_query($sql_etiquette) or die('Erreur SQL ! '.$sql_etiquette.' '.mysql_error());
                          while($donner_etiquette = mysql_fetch_array($req_etiquette))
                          {
