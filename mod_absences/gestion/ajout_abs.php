          ...
          if($verification != '1')
           {
              ...
              $j = $j + 1;
                   ...
                   if ( $action_sql === "modifier" ) { $requete="UPDATE ".$prefix_base."absences_eleves SET
                                                                 ...
                                                                 motif_absence_eleve = '$motif_absence_eleve',
