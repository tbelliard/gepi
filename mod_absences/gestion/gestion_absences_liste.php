...
function age($date_de_naissance_fr)
         ...
         function pp($classe_choix)
          {
            global $prefix_base;
               $call_prof_classe = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM ".$prefix_base."classes, ".$prefix_base."j_eleves_professeurs, ".$prefix_base."j_eleves_classes WHERE ".$prefix_base."j_eleves_professeurs.login = ".$prefix_base."j_eleves_classes.login AND ".$prefix_base."j_eleves_classes.id_classe = ".$prefix_base."classes.id AND ".$prefix_base."classes.classe = '".$classe_choix."'");
        ...
        if ($action_sql == "modifier") { $id_suivi_eleve_cpe = $_POST['id_suivi_eleve_cpe']; }
            ...
            if($data_info_suivi != "")
            {
                ...
                if($action_sql == "ajouter")
                {
			     ...
			     if(!empty($id_suivi_eleve_cpe)) { $id_saisi = $id_suivi_eleve_cpe; } else { $id_saisi = ((is_null($___mysqli_res = mysqli_insert_id($GLOBALS["___mysqli_ston"]))) ? false : $___mysqli_res); }
                             $verification = 1;
			     ...
			     if($support_suivi_eleve_cpe === '4' and !empty($lettre_type))
			      {
	                             ...
	                             mysqli_query($GLOBALS["___mysqli_ston"], $requete_courrier) or die('Erreur SQL !'.$requete_courrier.'<br />'.((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));
				     $courrier_suivi_eleve_cpe = ((is_null($___mysqli_res = mysqli_insert_id($GLOBALS["___mysqli_ston"]))) ? false : $___mysqli_res);
			      }
            } else {
...
if ($action == "modifier")
 {
      ...
      $resultat_modif_fiche = mysqli_query($GLOBALS["___mysqli_ston"], $requete_modif_fiche) or die('Erreur SQL !'.$requete_modif_fiche.'<br />'.((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));
...
<?php
	...
	if ($choix=="top10" and $fiche_eleve == "" and $select_fiche_eleve == "") {
		...
		$execution_top10 = mysqli_query($GLOBALS["___mysqli_ston"], $requete_top10)
			or die('Erreur SQL !'.$requete_top10.'<br />'.((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));
    ...
    <br />
      <table class="td_tableau_gestion" style="margin: auto; margin-top:15px; width: 600px; border: 0 0 0 0;">
        ...
        <?php
         ...
         $execution_top10 = mysqli_query($GLOBALS["___mysqli_ston"], $requete_top10) or die('Erreur SQL !'.$requete_top10.'<br />'.((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));
         while ( $data_top10 = mysqli_fetch_array($execution_top10))
         {
...
if ($choix=="sm" and $fiche_eleve == "" and $select_fiche_eleve == "") {
  ...
  $retour_total=mysqli_query($GLOBALS["___mysqli_ston"], $compte);
...
}else
{
	 ...
	 $execution_sans_motif = mysqli_query($GLOBALS["___mysqli_ston"], $requete_sans_motif) or die('Erreur SQL !'.$requete_sans_motif.'<br />'.((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));
...
$premiereEntree = ($pageActuelle-1)*$messageParPage;
		...
		$execution_sans_motif = mysqli_query($GLOBALS["___mysqli_ston"], $requete_sans_motif)
			or die('Erreur SQL !'.$requete_sans_motif.'<br />'.((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));
			}
...
$premiereEntree = ($pageActuelle-1)*$messageParPage;
    if ($test_nbre_eleves_cpe === 0){
		...
		$execution_avec_motif = mysqli_query($GLOBALS["___mysqli_ston"], $requete_avec_motif)
		 	or die('Erreur SQL !'.$requete_avec_motif.'<br />'.((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));
