...
$cpt_eleves = mysql_result(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT count(*) FROM ".$prefix_base."absences_eleves WHERE eleve_absence_eleve='".$_GET['id_eleve']."' and type_absence_eleve = '".$_GET['type']."'"),0);
if ($cpt_eleves!=0) {
?>
...
<?php
    ...
    $execution_dispense = mysqli_query($GLOBALS["___mysqli_ston"], $requete_dispense);
