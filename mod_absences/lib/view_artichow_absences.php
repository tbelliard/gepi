...
while($i<12)
  {
         ...
         if($eleve_1 == "tous" and $classe_1 == "tous") { $requete_compt = old_mysql_result(mysqli_query($GLOBALS["mysqli"], "SELECT count(*) FROM ".$prefix_base."absences_eleves WHERE type_absence_eleve = '".$type_1."' AND d_date_absence_eleve >= '".$date_debut."' AND a_date_absence_eleve <= '".$date_fin."'"),0); }
//echo "SELECT count(*) FROM ".$prefix_base."absences_eleves WHERE type_absence_eleve = '".$type_1."' AND d_date_absence_eleve >= '".$date_debut."' AND a_date_absence_eleve <= '".$date_fin."'";
         if($eleve_1 == "tous" and $classe_1 != "tous") { $requete_compt = old_mysql_result(mysqli_query($GLOBALS["mysqli"], "SELECT count(DISTINCT (id_absence_eleve)) FROM ".$prefix_base."eleves, ".$prefix_base."j_eleves_classes, ".$prefix_base."classes, ".$prefix_base."absences_eleves WHERE ".$prefix_base."eleves.login=".$prefix_base."j_eleves_classes.login AND ".$prefix_base."j_eleves_classes.id_classe=".$prefix_base."classes.id AND ".$prefix_base."absences_eleves.type_absence_eleve = '".$type_1."' AND ".$prefix_base."absences_eleves.d_date_absence_eleve >= '".$date_debut."' AND ".$prefix_base."absences_eleves.a_date_absence_eleve <= '".$date_fin."' AND ".$prefix_base."absences_eleves.eleve_absence_eleve = ".$prefix_base."eleves.login AND ".$prefix_base."classes.id = '".$classe_1."' LIMIT 0,1"),0); }
//         if($eleve_1 == "tous" and $classe_1 != "tous") { $requete_compt = old_mysql_result(mysql_query("SELECT count(".$prefix_base."eleves.login, ".$prefix_base."eleves.nom, ".$prefix_base."eleves.prenom, ".$prefix_base."j_eleves_classes.login, ".$prefix_base."j_eleves_classes.id_classe, ".$prefix_base."j_eleves_classes.periode, ".$prefix_base."classes.classe, ".$prefix_base."classes.id, ".$prefix_base."classes.nom_complet, ".$prefix_base."absences_eleves.type_absence_eleve, ".$prefix_base."absences_eleves.d_date_absence_eleve, ".$prefix_base."absences_eleves.a_date_absence_eleve, ".$prefix_base."absences_eleves.eleve_absence_eleve) FROM ".$prefix_base."eleves, ".$prefix_base."j_eleves_classes, ".$prefix_base."classes, ".$prefix_base."absences_eleves WHERE ".$prefix_base."eleves.login=".$prefix_base."j_eleves_classes.login AND ".$prefix_base."j_eleves_classes.id_classe=".$prefix_base."classes.id AND ".$prefix_base."absences_eleves.type_absence_eleve = '".$type_1."' AND ".$prefix_base."absences_eleves.d_date_absence_eleve >= '".$date_debut."' AND ".$prefix_base."absences_eleves.a_date_absence_eleve <= '".$date_fin."' AND ".$prefix_base."absences_eleves.eleve_absence_eleve = ".$prefix_base."eleves.login AND ".$prefix_base."classes.id = '".$classe_1."' LIMIT 0,1"),0); }

         if($eleve_1 != "tous" and $classe_1 != "tous") { $requete_compt = old_mysql_result(mysqli_query($GLOBALS["mysqli"], "SELECT count(*) FROM ".$prefix_base."absences_eleves WHERE type_absence_eleve = '".$type_1."' AND d_date_absence_eleve >= '".$date_debut."' AND a_date_absence_eleve <= '".$date_fin."' AND eleve_absence_eleve = '".$eleve_1."'"),0); }
