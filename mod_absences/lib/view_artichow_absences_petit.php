...
if($type_1=="A") { $tire_graph = "Absences sur les 12 précédent mois"; }
if($type_1=="D") { $tire_graph = "Dispense sur les 12 précédent mois"; }
if($type_1=="I") { $tire_graph = "Passage à l'infirmerie sur les 12 précédent mois"; }
if($type_1=="R") { $tire_graph = "Retard sur les 12 précédent mois"; }
