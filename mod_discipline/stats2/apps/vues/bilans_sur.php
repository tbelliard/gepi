                ...
                <table class="boireaus">
                    <tr ><td rowspan="5"  colspan="5" class='nouveau'>
                            <p><font class='titre'>Bilan des incidents concernant : </font>
                                        ...
                                        <?php if($filtres_categories||$filtres_mesures||$filtres_roles||$filtres_sanctions) { ?><p>avec les filtres selectionnés</p><?php }?></td>
                    ...
                    <tr><td  <?php if ($titre=='L\'Etablissement' ) {?> colspan="2" <?php }?> class='nouveau'><font class='titre'>Nombre total de mesures prises pour ces incidents :</font> <?php echo $totaux[$titre]['mesures']; ?></td><?php if ($titre!=='L\'Etablissement' ) {?> <td  class='nouveau' > <font class='titre'>% sur la période/Etab: </font> <?php if($totaux['L\'Etablissement']['mesures']) echo round((100*($totaux[$titre]['mesures']/$totaux['L\'Etablissement']['mesures'])),2); else echo'0';?></td><?php } ?></tr>
                    ...
                    <tr><th><a href='index.php?ctrl=bilans&action=tri&choix=date'><font class='titre'>Date</font></a></th><th><a href='index.php?ctrl=bilans&action=tri&choix=declarant'><font class='titre'>Déclarant</font></a></th><th><a href='index.php?ctrl=bilans&action=tri&choix=heure'><font class='titre'>Heure</font></a></th><th><a href='index.php?ctrl=bilans&action=tri&choix=nature'><font class='titre'>Nature</font></a></th>
                        <th><a href='index.php?ctrl=bilans&action=tri&choix=categorie'><font class='titre'>Catégorie</font></a></th><th width="25%"><font class='titre'>Description</font></th><th width="45%"><font class='titre'>Suivi</font></th></tr>
                                    <?php $alt_b=1;
            ...
            <div class="panel" id="tab<?php echo $i+1;?>">                
               <table class="boireaus"> <tr><td class="nouveau" colspan="11"><strong>Bilan individuel</strong></td></tr></table>
                <table  class="boireaus rowstyle-alt colstyle-alt" >
                    <tr><th rowspan="2" <?php if (!isset($totaux_indiv[$titre])) {?>class="sortable-text" <?php }?>>Nom</th><th rowspan="2">Prénom</th><th rowspan="2" <?php if (!isset($totaux_indiv[$titre])) {?>class="sortable-numeric" <?php }?>>Nombre d'incidents</th>
