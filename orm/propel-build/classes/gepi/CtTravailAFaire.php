...
require 'gepi/om/BaseCtTravailAFaire.php';


/**
 * Skeleton subclass for representing a row from the 'ct_devoirs_entry' table.
 *
 * Travail ра faire (devoir) cahier de texte
 *
 ...
 * @package    gepi
 */
class CtTravailAFaire extends BaseCtTravailAFaire {
	...
	{
		if ($criteria != null || $this->lastCtDevoirDocumentCriteria != null || $this->collCtDevoirDocuments === null) {
			$this->collCtDevoirDocuments = parent::getCtDevoirDocuments($criteria, $con);
		}
	...
	/**
	 * Initializes internal state of CtTravailAFaire object.
