 ...
 * @package    gepi.map
 */
class CtTravailAFaireMapBuilder implements MapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'gepi.map.CtTravailAFaireMapBuilder';
	...
	{
		$this->dbMap = Propel::getDatabaseMap(CtTravailAFairePeer::DATABASE_NAME);

		$tMap = $this->dbMap->addTable(CtTravailAFairePeer::TABLE_NAME);
		$tMap->setPhpName('CtTravailAFaire');
		$tMap->setClassname('CtTravailAFaire');
