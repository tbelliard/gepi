...
/**
 * This class defines the structure of the 'j_eleves_classes' table.
 *
 *
 *
...
class JEleveClasseTableMap extends TableMap
{
	 ...
	 */
	const CLASS_NAME = 'gepi.map.JEleveClasseTableMap';
	...
	public function initialize()
	{
		...
		$this->addForeignPrimaryKey('ID_CLASSE', 'IdClasse', 'INTEGER' , 'classes', 'ID', true, 11, 0);
		$this->addPrimaryKey('PERIODE', 'Periode', 'INTEGER', true, 11, 0);
		$this->addColumn('RANG', 'Rang', 'SMALLINT', true, 6, 0);
		// validators
	} // initialize()
