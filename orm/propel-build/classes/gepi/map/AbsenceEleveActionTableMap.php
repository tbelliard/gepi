...
/**
 * This class defines the structure of the 'a_actions' table.
 *
 *
 *
 ...
 */
class AbsenceEleveActionTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'gepi.map.AbsenceEleveActionTableMap';
	...
	{
	  // attributes
		$this->setName('a_actions');
		$this->setPhpName('AbsenceEleveAction');
		$this->setClassname('AbsenceEleveAction');
