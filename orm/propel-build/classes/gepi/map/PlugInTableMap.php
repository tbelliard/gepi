...
class PlugInTableMap extends TableMap {
	...
	{
    $this->addRelation('PlugInAutorisation', 'PlugInAutorisation', RelationMap::ONE_TO_MANY, array('id' => 'plugin_id', ), null, null);
    $this->addRelation('PlugInMiseEnOeuvreMenu', 'PlugInMiseEnOeuvreMenu', RelationMap::ONE_TO_MANY, array('id' => 'plugin_id', ), null, null);
	} // buildRelations()
