...
abstract class BaseAbsenceEleveTraitement extends BaseObject implements Persistent
{
    ...
    /**
     * @var        PropelObjectCollection|AbsenceEleveNotification[] Collection to store aggregation of AbsenceEleveNotification objects.
     */
    protected $collAbsenceEleveNotifications;
    protected $collAbsenceEleveNotificationsPartial;
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->absenceEleveSaisiesScheduledForDeletion !== null) {
                if (!$this->absenceEleveSaisiesScheduledForDeletion->isEmpty()) {
                    ...
                    foreach ($this->absenceEleveSaisiesScheduledForDeletion->getPrimaryKeys(false) as $remotePk) {
    ...
    {
        if (isset($alreadyDumpedObjects['AbsenceEleveTraitement'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['AbsenceEleveTraitement'][$this->getPrimaryKey()] = true;
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aAbsenceEleveMotif) {
                $result['AbsenceEleveMotif'] = $this->aAbsenceEleveMotif->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
            if (null !== $this->aAbsenceEleveJustification) {
                $result['AbsenceEleveJustification'] = $this->aAbsenceEleveJustification->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setATypeId($this->getATypeId());
        $copyObj->setAMotifId($this->getAMotifId());
        $copyObj->setAJustificationId($this->getAJustificationId());
    ...
    public function setJTraitementSaisieEleves(PropelCollection $jTraitementSaisieEleves, PropelPDO $con = null)
    {
        ...
        foreach ($this->jTraitementSaisieElevesScheduledForDeletion as $jTraitementSaisieEleveRemoved) {
            $jTraitementSaisieEleveRemoved->setAbsenceEleveTraitement(null);
        }
    ...
    public function removeJTraitementSaisieEleve($jTraitementSaisieEleve)
    {
        if ($this->getJTraitementSaisieEleves()->contains($jTraitementSaisieEleve)) {
            ...
            $jTraitementSaisieEleve->setAbsenceEleveTraitement(null);
        }
    }
    ...
    public function clearAbsenceEleveNotifications()
    {
        ...
        $this->collAbsenceEleveNotificationsPartial = null;
    }

    /**
     * reset is the collAbsenceEleveNotifications collection loaded partially
     *
     * @return void
     */
    public function resetPartialAbsenceEleveNotifications($v = true)
    {
        $this->collAbsenceEleveNotificationsPartial = $v;
    }
     ...
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     * @return PropelObjectCollection|AbsenceEleveNotification[] List of AbsenceEleveNotification objects
     * @throws PropelException
     */
    public function getAbsenceEleveNotifications($criteria = null, PropelPDO $con = null)
    {
        $partial = $this->collAbsenceEleveNotificationsPartial && !$this->isNew();
        if (null === $this->collAbsenceEleveNotifications || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collAbsenceEleveNotifications) {
                ...
                $collAbsenceEleveNotifications = AbsenceEleveNotificationQuery::create(null, $criteria)
                    ...
                    ->find($con);
                if (null !== $criteria) {
                    if (false !== $this->collAbsenceEleveNotificationsPartial && count($collAbsenceEleveNotifications)) {
                      $this->initAbsenceEleveNotifications(false);

                      foreach($collAbsenceEleveNotifications as $obj) {
                        if (false == $this->collAbsenceEleveNotifications->contains($obj)) {
                          $this->collAbsenceEleveNotifications->append($obj);
                        }
                      }

                      $this->collAbsenceEleveNotificationsPartial = true;
                    }

                    return $collAbsenceEleveNotifications;
                }

                if($partial && $this->collAbsenceEleveNotifications) {
                    foreach($this->collAbsenceEleveNotifications as $obj) {
                        if($obj->isNew()) {
                            $collAbsenceEleveNotifications[] = $obj;
                        }
                    }
                }

                $this->collAbsenceEleveNotifications = $collAbsenceEleveNotifications;
                $this->collAbsenceEleveNotificationsPartial = false;
            }
        }
    ...
    public function setAbsenceEleveNotifications(PropelCollection $absenceEleveNotifications, PropelPDO $con = null)
    {
        ...
        foreach ($this->absenceEleveNotificationsScheduledForDeletion as $absenceEleveNotificationRemoved) {
            $absenceEleveNotificationRemoved->setAbsenceEleveTraitement(null);
        }
    ...
    public function countAbsenceEleveNotifications(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        ...
        if (null === $this->collAbsenceEleveNotifications || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collAbsenceEleveNotifications) {
                ...
                if($partial && !$criteria) {
                    return count($this->getAbsenceEleveNotifications());
                }
    ...
    public function addAbsenceEleveNotification(AbsenceEleveNotification $l)
    {
        ...
        if (!in_array($l, $this->collAbsenceEleveNotifications->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
    ...
    /**
     * @param	AbsenceEleveNotification $absenceEleveNotification The absenceEleveNotification object to remove.
     */
    public function removeAbsenceEleveNotification($absenceEleveNotification)
    {
        if ($this->getAbsenceEleveNotifications()->contains($absenceEleveNotification)) {
            $this->collAbsenceEleveNotifications->remove($this->collAbsenceEleveNotifications->search($absenceEleveNotification));
            if (null === $this->absenceEleveNotificationsScheduledForDeletion) {
                $this->absenceEleveNotificationsScheduledForDeletion = clone $this->collAbsenceEleveNotifications;
                $this->absenceEleveNotificationsScheduledForDeletion->clear();
            }
            $this->absenceEleveNotificationsScheduledForDeletion[]= $absenceEleveNotification;
            $absenceEleveNotification->setAbsenceEleveTraitement(null);
        }
    }
    ...
    {
        $this->clearAbsenceEleveSaisies();
        $currentAbsenceEleveSaisies = $this->getAbsenceEleveSaisies();

        $this->absenceEleveSaisiesScheduledForDeletion = $currentAbsenceEleveSaisies->diff($absenceEleveSaisies);

        foreach ($absenceEleveSaisies as $absenceEleveSaisie) {
            if (!$currentAbsenceEleveSaisies->contains($absenceEleveSaisie)) {
    ...
    /**
     * Remove a AbsenceEleveSaisie object to this object
     * through the j_traitements_saisies cross reference table.
     *
     * @param AbsenceEleveSaisie $absenceEleveSaisie The JTraitementSaisieEleve object to relate
     * @return void
     */
    public function removeAbsenceEleveSaisie(AbsenceEleveSaisie $absenceEleveSaisie)
    {
    ...
    {
        return (string) $this->exportTo(AbsenceEleveTraitementPeer::DEFAULT_STRING_FORMAT);
    }
