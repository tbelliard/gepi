...
abstract class BaseJTraitementSaisieEleve extends BaseObject  implements Persistent
{
	 ...
	 * @var        JTraitementSaisieElevePeer
	 */
	...
	public function setASaisieId($v)
	{
		...
		if ($this->a_saisie_id !== $v) {
			$this->a_saisie_id = $v;
			$this->modifiedColumns[] = JTraitementSaisieElevePeer::A_SAISIE_ID;
		}
	...
	public function setATraitementId($v)
	{
		...
		if ($this->a_traitement_id !== $v) {
			...
			$this->modifiedColumns[] = JTraitementSaisieElevePeer::A_TRAITEMENT_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = JTraitementSaisieElevePeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating JTraitementSaisieEleve object", $e);
		}
	}
	...
	public function ensureConsistency()
	{
		...
		if ($this->aAbsenceEleveSaisie !== null && $this->a_saisie_id !== $this->aAbsenceEleveSaisie->getId()) {
			$this->aAbsenceEleveSaisie = null;
		}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = JTraitementSaisieElevePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = JTraitementSaisieEleveQuery::create()
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(JTraitementSaisieElevePeer::A_SAISIE_ID)) {
			$modifiedColumns[':p' . $index++]  = 'A_SAISIE_ID';
		}
		if ($this->isColumnModified(JTraitementSaisieElevePeer::A_TRAITEMENT_ID)) {
			$modifiedColumns[':p' . $index++]  = 'A_TRAITEMENT_ID';
		}

		$sql = sprintf(
			'INSERT INTO j_traitements_saisies (%s) VALUES (%s)',
		...
		try {
			...
			foreach ($modifiedColumns as $identifier => $columnName) {
				switch ($columnName) {
					case 'A_SAISIE_ID':
						$stmt->bindValue($identifier, $this->a_saisie_id, PDO::PARAM_INT);
						break;
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = JTraitementSaisieElevePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = JTraitementSaisieElevePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['JTraitementSaisieEleve'][serialize($this->getPrimaryKey())])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['JTraitementSaisieEleve'][serialize($this->getPrimaryKey())] = true;
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(JTraitementSaisieElevePeer::A_SAISIE_ID)) $criteria->add(JTraitementSaisieElevePeer::A_SAISIE_ID, $this->a_saisie_id);
		if ($this->isColumnModified(JTraitementSaisieElevePeer::A_TRAITEMENT_ID)) $criteria->add(JTraitementSaisieElevePeer::A_TRAITEMENT_ID, $this->a_traitement_id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of JTraitementSaisieEleve (or compatible) type.
	...
	{
		$copyObj->setASaisieId($this->getASaisieId());
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     JTraitementSaisieEleve Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     JTraitementSaisieElevePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new JTraitementSaisieElevePeer();
		}
		return self::$peer;
	}
	...
	public function getAbsenceEleveTraitement(PropelPDO $con = null)
	{
		if ($this->aAbsenceEleveTraitement === null && ($this->a_traitement_id !== null)) {
			...
			/* The following can be used additionally to
				...
				undesirable since it could result in an only partially populated collection
				in the referenced object.
				$this->aAbsenceEleveTraitement->addJTraitementSaisieEleves($this);
			 */
		}
	...
	{
		return (string) $this->exportTo(JTraitementSaisieElevePeer::DEFAULT_STRING_FORMAT);
	}
