...
abstract class BaseAbsenceEleveNotification extends BaseObject implements Persistent
{
    ...
    /**
     * @var        PropelObjectCollection|JNotificationResponsableEleve[] Collection to store aggregation of JNotificationResponsableEleve objects.
     */
    protected $collJNotificationResponsableEleves;
    protected $collJNotificationResponsableElevesPartial;
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->responsableElevesScheduledForDeletion !== null) {
                if (!$this->responsableElevesScheduledForDeletion->isEmpty()) {
                    ...
                    foreach ($this->responsableElevesScheduledForDeletion->getPrimaryKeys(false) as $remotePk) {
    ...
    public function clearJNotificationResponsableEleves()
    {
        ...
        $this->collJNotificationResponsableElevesPartial = null;
    }

    /**
     * reset is the collJNotificationResponsableEleves collection loaded partially
     *
     * @return void
     */
    public function resetPartialJNotificationResponsableEleves($v = true)
    {
        $this->collJNotificationResponsableElevesPartial = $v;
    }
     ...
     * @param PropelPDO $con optional connection object
     * @return PropelObjectCollection|JNotificationResponsableEleve[] List of JNotificationResponsableEleve objects
     * @throws PropelException
     */
    public function getJNotificationResponsableEleves($criteria = null, PropelPDO $con = null)
    {
        $partial = $this->collJNotificationResponsableElevesPartial && !$this->isNew();
        if (null === $this->collJNotificationResponsableEleves || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collJNotificationResponsableEleves) {
                ...
                $collJNotificationResponsableEleves = JNotificationResponsableEleveQuery::create(null, $criteria)
                    ...
                    ->find($con);
                if (null !== $criteria) {
                    if (false !== $this->collJNotificationResponsableElevesPartial && count($collJNotificationResponsableEleves)) {
                      $this->initJNotificationResponsableEleves(false);

                      foreach($collJNotificationResponsableEleves as $obj) {
                        if (false == $this->collJNotificationResponsableEleves->contains($obj)) {
                          $this->collJNotificationResponsableEleves->append($obj);
                        }
                      }

                      $this->collJNotificationResponsableElevesPartial = true;
                    }

                    return $collJNotificationResponsableEleves;
                }

                if($partial && $this->collJNotificationResponsableEleves) {
                    foreach($this->collJNotificationResponsableEleves as $obj) {
                        if($obj->isNew()) {
                            $collJNotificationResponsableEleves[] = $obj;
                        }
                    }
                }

                $this->collJNotificationResponsableEleves = $collJNotificationResponsableEleves;
                $this->collJNotificationResponsableElevesPartial = false;
            }
        }
    ...
    public function setJNotificationResponsableEleves(PropelCollection $jNotificationResponsableEleves, PropelPDO $con = null)
    {
        ...
        foreach ($this->jNotificationResponsableElevesScheduledForDeletion as $jNotificationResponsableEleveRemoved) {
            $jNotificationResponsableEleveRemoved->setAbsenceEleveNotification(null);
        }
    ...
    public function countJNotificationResponsableEleves(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        ...
        if (null === $this->collJNotificationResponsableEleves || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collJNotificationResponsableEleves) {
                ...
                if($partial && !$criteria) {
                    return count($this->getJNotificationResponsableEleves());
                }
    ...
    public function addJNotificationResponsableEleve(JNotificationResponsableEleve $l)
    {
        ...
        if (!in_array($l, $this->collJNotificationResponsableEleves->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
    ...
    /**
     * @param	JNotificationResponsableEleve $jNotificationResponsableEleve The jNotificationResponsableEleve object to remove.
     */
    public function removeJNotificationResponsableEleve($jNotificationResponsableEleve)
    {
        if ($this->getJNotificationResponsableEleves()->contains($jNotificationResponsableEleve)) {
            $this->collJNotificationResponsableEleves->remove($this->collJNotificationResponsableEleves->search($jNotificationResponsableEleve));
            if (null === $this->jNotificationResponsableElevesScheduledForDeletion) {
                $this->jNotificationResponsableElevesScheduledForDeletion = clone $this->collJNotificationResponsableEleves;
                $this->jNotificationResponsableElevesScheduledForDeletion->clear();
            }
            $this->jNotificationResponsableElevesScheduledForDeletion[]= $jNotificationResponsableEleve;
            $jNotificationResponsableEleve->setAbsenceEleveNotification(null);
        }
    }
    ...
    {
        $this->clearResponsableEleves();
        $currentResponsableEleves = $this->getResponsableEleves();

        $this->responsableElevesScheduledForDeletion = $currentResponsableEleves->diff($responsableEleves);

        foreach ($responsableEleves as $responsableEleve) {
            if (!$currentResponsableEleves->contains($responsableEleve)) {
    ...
    /**
     * Remove a ResponsableEleve object to this object
     * through the j_notifications_resp_pers cross reference table.
     *
     * @param ResponsableEleve $responsableEleve The JNotificationResponsableEleve object to relate
     * @return void
     */
    public function removeResponsableEleve(ResponsableEleve $responsableEleve)
    {
