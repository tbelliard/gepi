...
abstract class BaseAbsenceAbsencePeer {
	...
	const ELEVE_ID = 'a_absences.ELEVE_ID';
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(AbsenceAbsencePeer::ELEVE_ID);
	...
	public static function doCountJoinEleve(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(AbsenceAbsencePeer::ELEVE_ID,), array(ElevePeer::ID_ELEVE,), $join_behavior);
		$stmt = BasePeer::doCount($criteria, $con);
	...
	/**
	 * Selects a collection of AbsenceAbsence objects pre-filled with their Eleve objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of AbsenceAbsence objects.
	...
	public static function doSelectJoinEleve(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$c->addJoin(array(AbsenceAbsencePeer::ELEVE_ID,), array(ElevePeer::ID_ELEVE,), $join_behavior);
		$stmt = BasePeer::doSelect($c, $con);
		$results = array();
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (AbsenceAbsence) to $obj2 (Eleve)
				$obj2->addAbsenceAbsence($obj1);
	...
	public static function doSelectJoinAll(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (AbsenceAbsence) to the collection in $obj3 (Eleve)
				$obj3->addAbsenceAbsence($obj1);
			} // if joined row not null
	...
	/**
	 * Selects a collection of AbsenceAbsence objects pre-filled with all related objects except UtilisateurProfessionnel.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAllExceptUtilisateurProfessionnel(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = AbsenceAbsencePeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (AbsenceAbsence) to the collection in $obj2 (Eleve)
				$obj2->addAbsenceAbsence($obj1);
	...
	/**
	 * Selects a collection of AbsenceAbsence objects pre-filled with all related objects except Eleve.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
