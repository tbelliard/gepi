...
abstract class BaseJNotificationResponsableEleveQuery extends ModelCriteria
{
     ...
     * @param     JNotificationResponsableEleveQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     * @param array $key Primary key to use for the query
                         A Primary key composition: [$a_notification_id, $pers_id]
     * @param     PropelPDO $con an optional connection object
     *
     * @return   JNotificationResponsableEleve|JNotificationResponsableEleve[]|mixed the result, formatted by the current formatter
     */
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|JNotificationResponsableEleve[]|mixed the list of results, formatted by the current formatter
     */
     ...
     *
     * @param   AbsenceEleveNotification|PropelObjectCollection $absenceEleveNotification The related object(s) to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   JNotificationResponsableEleveQuery The current query, for fluid interface
