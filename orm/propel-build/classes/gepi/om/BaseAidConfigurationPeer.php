...
abstract class BaseAidConfigurationPeer
{
     ...
     * e.g. AidConfigurationPeer::$fieldNames[AidConfigurationPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (AidConfigurationPeer::NOM, AidConfigurationPeer::NOM_COMPLET, AidConfigurationPeer::NOTE_MAX, AidConfigurationPeer::ORDER_DISPLAY1, AidConfigurationPeer::ORDER_DISPLAY2, AidConfigurationPeer::TYPE_NOTE, AidConfigurationPeer::DISPLAY_BEGIN, AidConfigurationPeer::DISPLAY_END, AidConfigurationPeer::MESSAGE, AidConfigurationPeer::DISPLAY_NOM, AidConfigurationPeer::INDICE_AID, AidConfigurationPeer::DISPLAY_BULLETIN, AidConfigurationPeer::BULL_SIMPLIFIE, AidConfigurationPeer::OUTILS_COMPLEMENTAIRES, AidConfigurationPeer::FEUILLE_PRESENCE, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. AidConfigurationPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (AidConfigurationPeer::NOM => 0, AidConfigurationPeer::NOM_COMPLET => 1, AidConfigurationPeer::NOTE_MAX => 2, AidConfigurationPeer::ORDER_DISPLAY1 => 3, AidConfigurationPeer::ORDER_DISPLAY2 => 4, AidConfigurationPeer::TYPE_NOTE => 5, AidConfigurationPeer::DISPLAY_BEGIN => 6, AidConfigurationPeer::DISPLAY_END => 7, AidConfigurationPeer::MESSAGE => 8, AidConfigurationPeer::DISPLAY_NOM => 9, AidConfigurationPeer::INDICE_AID => 10, AidConfigurationPeer::DISPLAY_BULLETIN => 11, AidConfigurationPeer::BULL_SIMPLIFIE => 12, AidConfigurationPeer::OUTILS_COMPLEMENTAIRES => 13, AidConfigurationPeer::FEUILLE_PRESENCE => 14, ),
    ...
    {
        $toNames = AidConfigurationPeer::getFieldNames($toType);
        $key = isset(AidConfigurationPeer::$fieldKeys[$fromType][$name]) ? AidConfigurationPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(AidConfigurationPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, AidConfigurationPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return AidConfigurationPeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(AidConfigurationPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(AidConfigurationPeer::DATABASE_NAME);
     ...
     *
     * @param      AidConfiguration $obj A AidConfiguration object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            AidConfigurationPeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(AidConfigurationPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(AidConfigurationPeer::$instances[$key])) {
                return AidConfigurationPeer::$instances[$key];
            }
        }
    ...
    {
        AidConfigurationPeer::$instances = array();
    }
    ...
    {
        // Invalidate objects in AidDetailsPeer instance pool,
    ...
    {
        return Propel::getDatabaseMap(AidConfigurationPeer::DATABASE_NAME)->getTable(AidConfigurationPeer::TABLE_NAME);
    }
    ...
    {
        return AidConfigurationPeer::OM_CLASS;
    }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(AidConfigurationPeer::DATABASE_NAME);
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $affectedRows += BasePeer::doDeleteAll(AidConfigurationPeer::TABLE_NAME, $con, AidConfigurationPeer::DATABASE_NAME);
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        try {
            ...
            $c = clone $criteria;
            $affectedRows += AidConfigurationPeer::doOnDeleteCascade($c, $con);
