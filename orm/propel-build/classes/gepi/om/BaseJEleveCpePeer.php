...
abstract class BaseJEleveCpePeer
{
     ...
     * e.g. JEleveCpePeer::$fieldNames[JEleveCpePeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('ELogin', 'CpeLogin', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('eLogin', 'cpeLogin', ),
        BasePeer::TYPE_COLNAME => array (JEleveCpePeer::E_LOGIN, JEleveCpePeer::CPE_LOGIN, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. JEleveCpePeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('ELogin' => 0, 'CpeLogin' => 1, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('eLogin' => 0, 'cpeLogin' => 1, ),
        BasePeer::TYPE_COLNAME => array (JEleveCpePeer::E_LOGIN => 0, JEleveCpePeer::CPE_LOGIN => 1, ),
    ...
    {
        $toNames = JEleveCpePeer::getFieldNames($toType);
        $key = isset(JEleveCpePeer::$fieldKeys[$fromType][$name]) ? JEleveCpePeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(JEleveCpePeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, JEleveCpePeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return JEleveCpePeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(JEleveCpePeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(JEleveCpePeer::DATABASE_NAME);
     ...
     *
     * @param      JEleveCpe $obj A JEleveCpe object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            JEleveCpePeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(JEleveCpePeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(JEleveCpePeer::$instances[$key])) {
                return JEleveCpePeer::$instances[$key];
            }
        }
    ...
    {
        return Propel::getDatabaseMap(JEleveCpePeer::DATABASE_NAME)->getTable(JEleveCpePeer::TABLE_NAME);
    }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(JEleveCpePeer::DATABASE_NAME);
