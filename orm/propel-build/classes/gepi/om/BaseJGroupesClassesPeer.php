...
abstract class BaseJGroupesClassesPeer
{
     ...
     * e.g. JGroupesClassesPeer::$fieldNames[JGroupesClassesPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (JGroupesClassesPeer::ID_GROUPE, JGroupesClassesPeer::ID_CLASSE, JGroupesClassesPeer::PRIORITE, JGroupesClassesPeer::COEF, JGroupesClassesPeer::CATEGORIE_ID, JGroupesClassesPeer::SAISIE_ECTS, JGroupesClassesPeer::VALEUR_ECTS, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. JGroupesClassesPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (JGroupesClassesPeer::ID_GROUPE => 0, JGroupesClassesPeer::ID_CLASSE => 1, JGroupesClassesPeer::PRIORITE => 2, JGroupesClassesPeer::COEF => 3, JGroupesClassesPeer::CATEGORIE_ID => 4, JGroupesClassesPeer::SAISIE_ECTS => 5, JGroupesClassesPeer::VALEUR_ECTS => 6, ),
    ...
    {
        $toNames = JGroupesClassesPeer::getFieldNames($toType);
        $key = isset(JGroupesClassesPeer::$fieldKeys[$fromType][$name]) ? JGroupesClassesPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(JGroupesClassesPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, JGroupesClassesPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return JGroupesClassesPeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(JGroupesClassesPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(JGroupesClassesPeer::DATABASE_NAME);
     ...
     *
     * @param      JGroupesClasses $obj A JGroupesClasses object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            JGroupesClassesPeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(JGroupesClassesPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(JGroupesClassesPeer::$instances[$key])) {
                return JGroupesClassesPeer::$instances[$key];
            }
        }
    ...
    {
        JGroupesClassesPeer::$instances = array();
    }
    ...
    {
        return Propel::getDatabaseMap(JGroupesClassesPeer::DATABASE_NAME)->getTable(JGroupesClassesPeer::TABLE_NAME);
    }
    ...
    {
        return JGroupesClassesPeer::OM_CLASS;
    }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(JGroupesClassesPeer::DATABASE_NAME);
