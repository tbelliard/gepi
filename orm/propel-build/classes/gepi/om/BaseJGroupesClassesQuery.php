...
abstract class BaseJGroupesClassesQuery extends ModelCriteria
{
     ...
     * @param     JGroupesClassesQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     * @param array $key Primary key to use for the query
                         A Primary key composition: [$id_groupe, $id_classe]
     * @param     PropelPDO $con an optional connection object
     *
     * @return   JGroupesClasses|JGroupesClasses[]|mixed the result, formatted by the current formatter
     */
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|JGroupesClasses[]|mixed the list of results, formatted by the current formatter
     */
