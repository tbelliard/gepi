...
abstract class BaseAbsenceEleveLieuQuery extends ModelCriteria
{
     ...
     * @param     AbsenceEleveLieuQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     *
     * @return   AbsenceEleveLieu|AbsenceEleveLieu[]|mixed the result, formatted by the current formatter
     */
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|AbsenceEleveLieu[]|mixed the list of results, formatted by the current formatter
     */
     ...
     *
     * @param   AbsenceEleveType|PropelObjectCollection $absenceEleveType  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   AbsenceEleveLieuQuery The current query, for fluid interface
    ...
    public function filterByAbsenceEleveType($absenceEleveType, $comparison = null)
    {
        ...
        } elseif ($absenceEleveType instanceof PropelObjectCollection) {
            return $this
