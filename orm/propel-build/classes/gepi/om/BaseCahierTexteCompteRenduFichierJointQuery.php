...
abstract class BaseCahierTexteCompteRenduFichierJointQuery extends ModelCriteria
{
     ...
     * @param     CahierTexteCompteRenduFichierJointQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     *
     * @return   CahierTexteCompteRenduFichierJoint|CahierTexteCompteRenduFichierJoint[]|mixed the result, formatted by the current formatter
     */
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|CahierTexteCompteRenduFichierJoint[]|mixed the list of results, formatted by the current formatter
     */
     ...
     *
     * @param   CahierTexteCompteRendu|PropelObjectCollection $cahierTexteCompteRendu The related object(s) to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   CahierTexteCompteRenduFichierJointQuery The current query, for fluid interface
