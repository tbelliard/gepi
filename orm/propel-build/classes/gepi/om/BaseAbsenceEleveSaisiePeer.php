...
abstract class BaseAbsenceEleveSaisiePeer {
	...
	protected static function doOnDeleteSetNull(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$updateValues = new Criteria(AbsenceEleveSaisiePeer::DATABASE_NAME);
			$selectCriteria->add(JTraitementSaisieElevePeer::A_SAISIE_ID, $obj->getId());
			$updateValues->add(JTraitementSaisieElevePeer::A_SAISIE_ID, null);
