...
abstract class BaseAbsenceEleveSaisiePeer
{
    ...
    const ID_LIEU = 'a_saisies.ID_LIEU';

    /** the column name for the DELETED_BY field */
    const DELETED_BY = 'a_saisies.DELETED_BY';
    ...
    const VERSION_CREATED_AT = 'a_saisies.VERSION_CREATED_AT';

    /** the column name for the VERSION_CREATED_BY field */
    const VERSION_CREATED_BY = 'a_saisies.VERSION_CREATED_BY';
     ...
     * e.g. AbsenceEleveSaisiePeer::$fieldNames[AbsenceEleveSaisiePeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (AbsenceEleveSaisiePeer::ID, AbsenceEleveSaisiePeer::UTILISATEUR_ID, AbsenceEleveSaisiePeer::ELEVE_ID, AbsenceEleveSaisiePeer::COMMENTAIRE, AbsenceEleveSaisiePeer::DEBUT_ABS, AbsenceEleveSaisiePeer::FIN_ABS, AbsenceEleveSaisiePeer::ID_EDT_CRENEAU, AbsenceEleveSaisiePeer::ID_EDT_EMPLACEMENT_COURS, AbsenceEleveSaisiePeer::ID_GROUPE, AbsenceEleveSaisiePeer::ID_CLASSE, AbsenceEleveSaisiePeer::ID_AID, AbsenceEleveSaisiePeer::ID_S_INCIDENTS, AbsenceEleveSaisiePeer::ID_LIEU, AbsenceEleveSaisiePeer::DELETED_BY, AbsenceEleveSaisiePeer::CREATED_AT, AbsenceEleveSaisiePeer::UPDATED_AT, AbsenceEleveSaisiePeer::DELETED_AT, AbsenceEleveSaisiePeer::VERSION, AbsenceEleveSaisiePeer::VERSION_CREATED_AT, AbsenceEleveSaisiePeer::VERSION_CREATED_BY, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. AbsenceEleveSaisiePeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (AbsenceEleveSaisiePeer::ID => 0, AbsenceEleveSaisiePeer::UTILISATEUR_ID => 1, AbsenceEleveSaisiePeer::ELEVE_ID => 2, AbsenceEleveSaisiePeer::COMMENTAIRE => 3, AbsenceEleveSaisiePeer::DEBUT_ABS => 4, AbsenceEleveSaisiePeer::FIN_ABS => 5, AbsenceEleveSaisiePeer::ID_EDT_CRENEAU => 6, AbsenceEleveSaisiePeer::ID_EDT_EMPLACEMENT_COURS => 7, AbsenceEleveSaisiePeer::ID_GROUPE => 8, AbsenceEleveSaisiePeer::ID_CLASSE => 9, AbsenceEleveSaisiePeer::ID_AID => 10, AbsenceEleveSaisiePeer::ID_S_INCIDENTS => 11, AbsenceEleveSaisiePeer::ID_LIEU => 12, AbsenceEleveSaisiePeer::DELETED_BY => 13, AbsenceEleveSaisiePeer::CREATED_AT => 14, AbsenceEleveSaisiePeer::UPDATED_AT => 15, AbsenceEleveSaisiePeer::DELETED_AT => 16, AbsenceEleveSaisiePeer::VERSION => 17, AbsenceEleveSaisiePeer::VERSION_CREATED_AT => 18, AbsenceEleveSaisiePeer::VERSION_CREATED_BY => 19, ),
    ...
    {
        $toNames = AbsenceEleveSaisiePeer::getFieldNames($toType);
        $key = isset(AbsenceEleveSaisiePeer::$fieldKeys[$fromType][$name]) ? AbsenceEleveSaisiePeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(AbsenceEleveSaisiePeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, AbsenceEleveSaisiePeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return AbsenceEleveSaisiePeer::$fieldNames[$type];
    }
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(AbsenceEleveSaisiePeer::DELETED_BY);
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(AbsenceEleveSaisiePeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(AbsenceEleveSaisiePeer::DATABASE_NAME);
        // soft_delete behavior
        if (AbsenceEleveSaisieQuery::isSoftDeleteEnabled()) {
            $criteria->add(AbsenceEleveSaisiePeer::DELETED_AT, null, Criteria::ISNULL);
        } else {
     ...
     *
     * @param      AbsenceEleveSaisie $obj A AbsenceEleveSaisie object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            AbsenceEleveSaisiePeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(AbsenceEleveSaisiePeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(AbsenceEleveSaisiePeer::$instances[$key])) {
                return AbsenceEleveSaisiePeer::$instances[$key];
            }
        }
    ...
    {
        AbsenceEleveSaisiePeer::$instances = array();
    }
    ...
    /**
     * Selects a collection of AbsenceEleveSaisie objects pre-filled with their AbsenceEleveLieu objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of AbsenceEleveSaisie objects.
    ...
    public static function doSelectJoinAbsenceEleveLieu(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (AbsenceEleveSaisie) to $obj2 (AbsenceEleveLieu)
                $obj2->addAbsenceEleveSaisie($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            $key9 = AbsenceEleveLieuPeer::getPrimaryKeyHashFromRow($row, $startcol9);
            if ($key9 !== null) {
                $obj9 = AbsenceEleveLieuPeer::getInstanceFromPool($key9);
                if (!$obj9) {
                    ...
                    AbsenceEleveLieuPeer::addInstanceToPool($obj9, $key9);
                } // if obj9 loaded

                // Add the $obj1 (AbsenceEleveSaisie) to the collection in $obj9 (AbsenceEleveLieu)
                $obj9->addAbsenceEleveSaisie($obj1);
            } // if joined row not null
    ...
    public static function doSelectJoinAllExceptUtilisateurProfessionnel(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = AbsenceEleveSaisiePeer::getInstanceFromPool($key1))) {
                ...
                $key8 = AbsenceEleveLieuPeer::getPrimaryKeyHashFromRow($row, $startcol8);
                if ($key8 !== null) {
                    $obj8 = AbsenceEleveLieuPeer::getInstanceFromPool($key8);
                    if (!$obj8) {
                    ...
                    $obj8 = new $cls();
                    $obj8->hydrate($row, $startcol8);
                    AbsenceEleveLieuPeer::addInstanceToPool($obj8, $key8);
                } // if $obj8 already loaded

                // Add the $obj1 (AbsenceEleveSaisie) to the collection in $obj8 (AbsenceEleveLieu)
                $obj8->addAbsenceEleveSaisie($obj1);
    ...
    {
        return Propel::getDatabaseMap(AbsenceEleveSaisiePeer::DATABASE_NAME)->getTable(AbsenceEleveSaisiePeer::TABLE_NAME);
    }
    ...
    {
        return AbsenceEleveSaisiePeer::OM_CLASS;
    }

    /**
     * Performs an INSERT on the database, given a AbsenceEleveSaisie or Criteria object.
     *
    ...
    /**
     * Performs an UPDATE on the database, given a AbsenceEleveSaisie or Criteria object.
     *
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(AbsenceEleveSaisiePeer::DATABASE_NAME);
    ...
    /**
     * Deletes all rows from the a_saisies table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
    ...
    /**
     * Performs a DELETE on the database, given a AbsenceEleveSaisie or Criteria object OR a primary key value.
     *
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            // delete related AbsenceEleveSaisieVersion objects
            $criteria = new Criteria(AbsenceEleveSaisieVersionPeer::DATABASE_NAME);

            $criteria->add(AbsenceEleveSaisieVersionPeer::ID, $obj->getId());
            $affectedRows += AbsenceEleveSaisieVersionPeer::doDelete($criteria, $con);
        }
