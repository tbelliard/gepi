 ...
 * @package    gepi.om
 */
abstract class BaseAbsenceAction extends BaseObject  implements Persistent {
	...
	/**
	 * Initializes internal state of BaseAbsenceAction object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     AbsenceAction The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = AbsenceActionPeer::ID;
		}
	...
	public function setNom($v)
	{
		...
		if ($this->nom !== $v) {
			$this->nom = $v;
			$this->modifiedColumns[] = AbsenceActionPeer::NOM;
		}
	...
	public function setOrdre($v)
	{
		...
		if ($this->ordre !== $v) {
			$this->ordre = $v;
			$this->modifiedColumns[] = AbsenceActionPeer::ORDRE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = AbsenceActionPeer::NUM_COLUMNS - AbsenceActionPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating AbsenceAction object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = AbsenceActionPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			AbsenceActionPeer::doDelete($this, $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			$con->commit();
			AbsenceActionPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = AbsenceActionPeer::doInsert($this, $con);
					...
					$affectedRows += AbsenceActionPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = AbsenceActionPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = AbsenceActionPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = AbsenceActionPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getNom(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AbsenceActionPeer::ID)) $criteria->add(AbsenceActionPeer::ID, $this->id);
		if ($this->isColumnModified(AbsenceActionPeer::NOM)) $criteria->add(AbsenceActionPeer::NOM, $this->nom);
		if ($this->isColumnModified(AbsenceActionPeer::ORDRE)) $criteria->add(AbsenceActionPeer::ORDRE, $this->ordre);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(AbsenceActionPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of AbsenceAction (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     AbsenceAction Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     AbsenceActionPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new AbsenceActionPeer();
		}
		return self::$peer;
	}
	 ...
	 * Otherwise if this AbsenceAction has previously been saved, it will retrieve
	 * related AbsenceTraitements from storage. If this AbsenceAction is new, it will return
		...
		if ($this->collAbsenceTraitements === null) {
			if ($this->isNew()) {
			   $this->collAbsenceTraitements = array();
				...
				$criteria->add(AbsenceTraitementPeer::A_ACTION_ID, $this->id);
	 ...
	 * Otherwise if this AbsenceAction is new, it will return
	 * an empty collection; or if this AbsenceAction has previously
	 * been saved, it will retrieve related AbsenceTraitements from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in AbsenceAction.
	 */
