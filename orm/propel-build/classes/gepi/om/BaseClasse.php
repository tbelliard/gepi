...
abstract class BaseClasse extends BaseObject implements Persistent
{
    ...
    /**
     * @var        PropelObjectCollection|PeriodeNote[] Collection to store aggregation of PeriodeNote objects.
     */
    protected $collPeriodeNotes;
    protected $collPeriodeNotesPartial;
    ...
    /**
     * @var        PropelObjectCollection|JCategoriesMatieresClasses[] Collection to store aggregation of JCategoriesMatieresClasses objects.
     */
    protected $collJCategoriesMatieresClassess;
    protected $collJCategoriesMatieresClassessPartial;
    ...
    /**
     * @var        PropelObjectCollection|CategorieMatiere[] Collection to store aggregation of CategorieMatiere objects.
     */
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->categorieMatieresScheduledForDeletion !== null) {
                if (!$this->categorieMatieresScheduledForDeletion->isEmpty()) {
                    $pks = array();
                    $pk = $this->getPrimaryKey();
                    foreach ($this->categorieMatieresScheduledForDeletion->getPrimaryKeys(false) as $remotePk) {
                        $pks[] = array($remotePk, $pk);
                    }
    ...
    public function clearPeriodeNotes()
    {
        ...
        $this->collPeriodeNotesPartial = null;
    }

    /**
     * reset is the collPeriodeNotes collection loaded partially
     *
     * @return void
     */
    public function resetPartialPeriodeNotes($v = true)
    {
        $this->collPeriodeNotesPartial = $v;
    }
     ...
     * @return PropelObjectCollection|PeriodeNote[] List of PeriodeNote objects
     * @throws PropelException
     */
    public function getPeriodeNotes($criteria = null, PropelPDO $con = null)
    {
        $partial = $this->collPeriodeNotesPartial && !$this->isNew();
        if (null === $this->collPeriodeNotes || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collPeriodeNotes) {
                ...
                $collPeriodeNotes = PeriodeNoteQuery::create(null, $criteria)
                    ...
                    ->find($con);
                if (null !== $criteria) {
                    if (false !== $this->collPeriodeNotesPartial && count($collPeriodeNotes)) {
                      $this->initPeriodeNotes(false);

                      foreach($collPeriodeNotes as $obj) {
                        if (false == $this->collPeriodeNotes->contains($obj)) {
                          $this->collPeriodeNotes->append($obj);
                        }
                      }

                      $this->collPeriodeNotesPartial = true;
                    }

                    return $collPeriodeNotes;
                }

                if($partial && $this->collPeriodeNotes) {
                    foreach($this->collPeriodeNotes as $obj) {
                        if($obj->isNew()) {
                            $collPeriodeNotes[] = $obj;
                        }
                    }
                }

                $this->collPeriodeNotes = $collPeriodeNotes;
                $this->collPeriodeNotesPartial = false;
            }
        }
    ...
    public function setPeriodeNotes(PropelCollection $periodeNotes, PropelPDO $con = null)
    {
        ...
        foreach ($this->periodeNotesScheduledForDeletion as $periodeNoteRemoved) {
            $periodeNoteRemoved->setClasse(null);
        }
    ...
    public function countPeriodeNotes(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        ...
        if (null === $this->collPeriodeNotes || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collPeriodeNotes) {
                ...
                if($partial && !$criteria) {
                    return count($this->getPeriodeNotes());
                }
    ...
    public function addPeriodeNote(PeriodeNote $l)
    {
        ...
        if (!in_array($l, $this->collPeriodeNotes->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
    ...
    /**
     * @param	PeriodeNote $periodeNote The periodeNote object to remove.
     */
    public function removePeriodeNote($periodeNote)
    {
        if ($this->getPeriodeNotes()->contains($periodeNote)) {
            $this->collPeriodeNotes->remove($this->collPeriodeNotes->search($periodeNote));
            if (null === $this->periodeNotesScheduledForDeletion) {
                $this->periodeNotesScheduledForDeletion = clone $this->collPeriodeNotes;
                $this->periodeNotesScheduledForDeletion->clear();
            }
            $this->periodeNotesScheduledForDeletion[]= $periodeNote;
            $periodeNote->setClasse(null);
        }
    }
    ...
    public function setJScolClassess(PropelCollection $jScolClassess, PropelPDO $con = null)
    {
        ...
        foreach ($this->jScolClassessScheduledForDeletion as $jScolClassesRemoved) {
            $jScolClassesRemoved->setClasse(null);
        }
    ...
    public function setJGroupesClassess(PropelCollection $jGroupesClassess, PropelPDO $con = null)
    {
        ...
        foreach ($this->jGroupesClassessScheduledForDeletion as $jGroupesClassesRemoved) {
            $jGroupesClassesRemoved->setClasse(null);
        }
    ...
    public function removeJGroupesClasses($jGroupesClasses)
    {
        if ($this->getJGroupesClassess()->contains($jGroupesClasses)) {
            ...
            $jGroupesClasses->setClasse(null);
        }
    }
    ...
    public function setJEleveClasses(PropelCollection $jEleveClasses, PropelPDO $con = null)
    {
        ...
        foreach ($this->jEleveClassesScheduledForDeletion as $jEleveClasseRemoved) {
            $jEleveClasseRemoved->setClasse(null);
        }
    ...
    public function setAbsenceEleveSaisies(PropelCollection $absenceEleveSaisies, PropelPDO $con = null)
    {
        ...
        foreach ($this->absenceEleveSaisiesScheduledForDeletion as $absenceEleveSaisieRemoved) {
            $absenceEleveSaisieRemoved->setClasse(null);
        }
    ...
    public function removeAbsenceEleveSaisie($absenceEleveSaisie)
    {
        if ($this->getAbsenceEleveSaisies()->contains($absenceEleveSaisie)) {
            ...
            $absenceEleveSaisie->setClasse(null);
        }
    }
    ...
    public function clearJCategoriesMatieresClassess()
    {
        ...
        $this->collJCategoriesMatieresClassessPartial = null;
    }

    /**
     * reset is the collJCategoriesMatieresClassess collection loaded partially
     *
     * @return void
     */
    public function resetPartialJCategoriesMatieresClassess($v = true)
    {
        $this->collJCategoriesMatieresClassessPartial = $v;
    }
     ...
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     * @return PropelObjectCollection|JCategoriesMatieresClasses[] List of JCategoriesMatieresClasses objects
     * @throws PropelException
     */
    public function getJCategoriesMatieresClassess($criteria = null, PropelPDO $con = null)
    {
        $partial = $this->collJCategoriesMatieresClassessPartial && !$this->isNew();
        if (null === $this->collJCategoriesMatieresClassess || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collJCategoriesMatieresClassess) {
                ...
                $collJCategoriesMatieresClassess = JCategoriesMatieresClassesQuery::create(null, $criteria)
                    ...
                    ->find($con);
                if (null !== $criteria) {
                    if (false !== $this->collJCategoriesMatieresClassessPartial && count($collJCategoriesMatieresClassess)) {
                      $this->initJCategoriesMatieresClassess(false);

                      foreach($collJCategoriesMatieresClassess as $obj) {
                        if (false == $this->collJCategoriesMatieresClassess->contains($obj)) {
                          $this->collJCategoriesMatieresClassess->append($obj);
                        }
                      }

                      $this->collJCategoriesMatieresClassessPartial = true;
                    }

                    return $collJCategoriesMatieresClassess;
                }

                if($partial && $this->collJCategoriesMatieresClassess) {
                    foreach($this->collJCategoriesMatieresClassess as $obj) {
                        if($obj->isNew()) {
                            $collJCategoriesMatieresClassess[] = $obj;
                        }
                    }
                }

                $this->collJCategoriesMatieresClassess = $collJCategoriesMatieresClassess;
                $this->collJCategoriesMatieresClassessPartial = false;
            }
        }
    ...
    public function setJCategoriesMatieresClassess(PropelCollection $jCategoriesMatieresClassess, PropelPDO $con = null)
    {
        ...
        foreach ($this->jCategoriesMatieresClassessScheduledForDeletion as $jCategoriesMatieresClassesRemoved) {
            $jCategoriesMatieresClassesRemoved->setClasse(null);
        }
    ...
    public function countJCategoriesMatieresClassess(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        ...
        if (null === $this->collJCategoriesMatieresClassess || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collJCategoriesMatieresClassess) {
                ...
                if($partial && !$criteria) {
                    return count($this->getJCategoriesMatieresClassess());
                }
    ...
    public function addJCategoriesMatieresClasses(JCategoriesMatieresClasses $l)
    {
        ...
        if (!in_array($l, $this->collJCategoriesMatieresClassess->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
    ...
    /**
     * @param	JCategoriesMatieresClasses $jCategoriesMatieresClasses The jCategoriesMatieresClasses object to remove.
     */
    public function removeJCategoriesMatieresClasses($jCategoriesMatieresClasses)
    {
        if ($this->getJCategoriesMatieresClassess()->contains($jCategoriesMatieresClasses)) {
            $this->collJCategoriesMatieresClassess->remove($this->collJCategoriesMatieresClassess->search($jCategoriesMatieresClasses));
            if (null === $this->jCategoriesMatieresClassessScheduledForDeletion) {
                $this->jCategoriesMatieresClassessScheduledForDeletion = clone $this->collJCategoriesMatieresClassess;
                $this->jCategoriesMatieresClassessScheduledForDeletion->clear();
            }
            $this->jCategoriesMatieresClassessScheduledForDeletion[]= $jCategoriesMatieresClasses;
            $jCategoriesMatieresClasses->setClasse(null);
        }
    }
    ...
    public function clearCategorieMatieres()
    {
        ...
        $this->collCategorieMatieresPartial = null;
    }
     ...
     * @param PropelPDO $con Optional connection object
     *
     * @return PropelObjectCollection|CategorieMatiere[] List of CategorieMatiere objects
     */
    ...
    {
        $this->clearCategorieMatieres();
        $currentCategorieMatieres = $this->getCategorieMatieres();

        $this->categorieMatieresScheduledForDeletion = $currentCategorieMatieres->diff($categorieMatieres);

        foreach ($categorieMatieres as $categorieMatiere) {
            if (!$currentCategorieMatieres->contains($categorieMatiere)) {
    ...
    /**
     * Remove a CategorieMatiere object to this object
     * through the j_matieres_categories_classes cross reference table.
     *
     * @param CategorieMatiere $categorieMatiere The JCategoriesMatieresClasses object to relate
     * @return void
     */
    public function removeCategorieMatiere(CategorieMatiere $categorieMatiere)
    {
        if ($this->getCategorieMatieres()->contains($categorieMatiere)) {
            $this->collCategorieMatieres->remove($this->collCategorieMatieres->search($categorieMatiere));
            if (null === $this->categorieMatieresScheduledForDeletion) {
                $this->categorieMatieresScheduledForDeletion = clone $this->collCategorieMatieres;
                $this->categorieMatieresScheduledForDeletion->clear();
            }
            $this->categorieMatieresScheduledForDeletion[]= $categorieMatiere;
        }
    }
