...
abstract class BaseAbsenceEleveMotifQuery extends ModelCriteria
{
     ...
     * @param     AbsenceEleveMotifQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     *
     * @return   AbsenceEleveMotif|AbsenceEleveMotif[]|mixed the result, formatted by the current formatter
     */
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|AbsenceEleveMotif[]|mixed the list of results, formatted by the current formatter
     */
