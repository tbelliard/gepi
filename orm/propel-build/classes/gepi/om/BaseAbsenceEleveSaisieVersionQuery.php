...
abstract class BaseAbsenceEleveSaisieVersionQuery extends ModelCriteria
{
     ...
     * @param     AbsenceEleveSaisieVersionQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     *
     * @return   AbsenceEleveSaisieVersion|AbsenceEleveSaisieVersion[]|mixed the result, formatted by the current formatter
     */
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|AbsenceEleveSaisieVersion[]|mixed the list of results, formatted by the current formatter
     */
