...
abstract class BaseEdtEmplacementCoursQuery extends ModelCriteria
{
     ...
     * @param     EdtEmplacementCoursQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     *
     * @return   EdtEmplacementCours|EdtEmplacementCours[]|mixed the result, formatted by the current formatter
     */
     ...
     */
     public function findOneByIdCours($key, $con = null)
     {
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|EdtEmplacementCours[]|mixed the list of results, formatted by the current formatter
     */
     ...
     *
     * @param   EdtSalle|PropelObjectCollection $edtSalle The related object(s) to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   EdtEmplacementCoursQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByEdtSalle($edtSalle, $comparison = null)
    {
        ...
        } elseif ($edtSalle instanceof PropelObjectCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }
     ...
     *
     * @param   EdtCalendrierPeriode|PropelObjectCollection $edtCalendrierPeriode The related object(s) to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   EdtEmplacementCoursQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByEdtCalendrierPeriode($edtCalendrierPeriode, $comparison = null)
    {
        ...
        } elseif ($edtCalendrierPeriode instanceof PropelObjectCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }
