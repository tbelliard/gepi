...
abstract class BaseAbsenceEleveLieu extends BaseObject implements Persistent
{
    ...
    /**
     * @var        PropelObjectCollection|AbsenceEleveType[] Collection to store aggregation of AbsenceEleveType objects.
     */
    protected $collAbsenceEleveTypes;
    protected $collAbsenceEleveTypesPartial;
     ...
     */
    protected $absenceEleveTypesScheduledForDeletion = null;
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = AbsenceEleveLieuQuery::create()
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->absenceEleveTypesScheduledForDeletion !== null) {
                if (!$this->absenceEleveTypesScheduledForDeletion->isEmpty()) {
                    foreach ($this->absenceEleveTypesScheduledForDeletion as $absenceEleveType) {
                        // need to save related object because we set the relation to null
                        $absenceEleveType->save($con);
                    }
                    $this->absenceEleveTypesScheduledForDeletion = null;
                }
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(AbsenceEleveLieuPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(AbsenceEleveLieuPeer::NOM)) {
            $modifiedColumns[':p' . $index++]  = 'NOM';
        }
        if ($this->isColumnModified(AbsenceEleveLieuPeer::COMMENTAIRE)) {
            $modifiedColumns[':p' . $index++]  = 'COMMENTAIRE';
        }
        if ($this->isColumnModified(AbsenceEleveLieuPeer::SORTABLE_RANK)) {
            $modifiedColumns[':p' . $index++]  = 'SORTABLE_RANK';
        }

        $sql = sprintf(
            'INSERT INTO a_lieux (%s) VALUES (%s)',
    ...
    public function clearAbsenceEleveTypes()
    {
        ...
        $this->collAbsenceEleveTypesPartial = null;
    }

    /**
     * reset is the collAbsenceEleveTypes collection loaded partially
     *
     * @return void
     */
    public function resetPartialAbsenceEleveTypes($v = true)
    {
        $this->collAbsenceEleveTypesPartial = $v;
    }
     ...
     * @return PropelObjectCollection|AbsenceEleveType[] List of AbsenceEleveType objects
     * @throws PropelException
     */
    public function getAbsenceEleveTypes($criteria = null, PropelPDO $con = null)
    {
        $partial = $this->collAbsenceEleveTypesPartial && !$this->isNew();
        if (null === $this->collAbsenceEleveTypes || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collAbsenceEleveTypes) {
                ...
                $collAbsenceEleveTypes = AbsenceEleveTypeQuery::create(null, $criteria)
                    ...
                    ->find($con);
                if (null !== $criteria) {
                    if (false !== $this->collAbsenceEleveTypesPartial && count($collAbsenceEleveTypes)) {
                      $this->initAbsenceEleveTypes(false);

                      foreach($collAbsenceEleveTypes as $obj) {
                        if (false == $this->collAbsenceEleveTypes->contains($obj)) {
                          $this->collAbsenceEleveTypes->append($obj);
                        }
                      }

                      $this->collAbsenceEleveTypesPartial = true;
                    }

                    return $collAbsenceEleveTypes;
                }

                if($partial && $this->collAbsenceEleveTypes) {
                    foreach($this->collAbsenceEleveTypes as $obj) {
                        if($obj->isNew()) {
                            $collAbsenceEleveTypes[] = $obj;
                        }
                    }
                }

                $this->collAbsenceEleveTypes = $collAbsenceEleveTypes;
                $this->collAbsenceEleveTypesPartial = false;
            }
        }
    ...
    /**
     * Sets a collection of AbsenceEleveType objects related by a one-to-many relationship
     * to the current object.
     * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
     * and new objects from the given Propel collection.
     *
     * @param PropelCollection $absenceEleveTypes A Propel collection.
     * @param PropelPDO $con Optional connection object
     */
    public function setAbsenceEleveTypes(PropelCollection $absenceEleveTypes, PropelPDO $con = null)
    {
        $this->absenceEleveTypesScheduledForDeletion = $this->getAbsenceEleveTypes(new Criteria(), $con)->diff($absenceEleveTypes);

        foreach ($this->absenceEleveTypesScheduledForDeletion as $absenceEleveTypeRemoved) {
            $absenceEleveTypeRemoved->setAbsenceEleveLieu(null);
        }

        $this->collAbsenceEleveTypes = null;
        foreach ($absenceEleveTypes as $absenceEleveType) {
            $this->addAbsenceEleveType($absenceEleveType);
        }

        $this->collAbsenceEleveTypes = $absenceEleveTypes;
        $this->collAbsenceEleveTypesPartial = false;
    }
    ...
    public function countAbsenceEleveTypes(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        ...
        if (null === $this->collAbsenceEleveTypes || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collAbsenceEleveTypes) {
                ...
                if($partial && !$criteria) {
                    return count($this->getAbsenceEleveTypes());
                }
    ...
    public function addAbsenceEleveType(AbsenceEleveType $l)
    {
        ...
        if (!in_array($l, $this->collAbsenceEleveTypes->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
            $this->doAddAbsenceEleveType($l);
        }
    ...
    /**
     * @param	AbsenceEleveType $absenceEleveType The absenceEleveType object to add.
     */
    protected function doAddAbsenceEleveType($absenceEleveType)
    {
        $this->collAbsenceEleveTypes[]= $absenceEleveType;
        $absenceEleveType->setAbsenceEleveLieu($this);
    }

    /**
     * @param	AbsenceEleveType $absenceEleveType The absenceEleveType object to remove.
     */
    public function removeAbsenceEleveType($absenceEleveType)
    {
        if ($this->getAbsenceEleveTypes()->contains($absenceEleveType)) {
            $this->collAbsenceEleveTypes->remove($this->collAbsenceEleveTypes->search($absenceEleveType));
            if (null === $this->absenceEleveTypesScheduledForDeletion) {
                $this->absenceEleveTypesScheduledForDeletion = clone $this->collAbsenceEleveTypes;
                $this->absenceEleveTypesScheduledForDeletion->clear();
            }
            $this->absenceEleveTypesScheduledForDeletion[]= $absenceEleveType;
            $absenceEleveType->setAbsenceEleveLieu(null);
        }
    }
    ...
    public function setAbsenceEleveSaisies(PropelCollection $absenceEleveSaisies, PropelPDO $con = null)
    {
        ...
        foreach ($this->absenceEleveSaisiesScheduledForDeletion as $absenceEleveSaisieRemoved) {
            $absenceEleveSaisieRemoved->setAbsenceEleveLieu(null);
        }
    ...
    protected function doAddAbsenceEleveSaisie($absenceEleveSaisie)
    {
        ...
        $absenceEleveSaisie->setAbsenceEleveLieu($this);
    }
    ...
    public function removeAbsenceEleveSaisie($absenceEleveSaisie)
    {
        if ($this->getAbsenceEleveSaisies()->contains($absenceEleveSaisie)) {
            ...
            $absenceEleveSaisie->setAbsenceEleveLieu(null);
        }
    }
