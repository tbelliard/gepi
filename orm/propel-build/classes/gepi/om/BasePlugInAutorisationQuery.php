...
abstract class BasePlugInAutorisationQuery extends ModelCriteria
{
     ...
     * @param     PlugInAutorisationQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     *
     * @return   PlugInAutorisation|PlugInAutorisation[]|mixed the result, formatted by the current formatter
     */
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|PlugInAutorisation[]|mixed the list of results, formatted by the current formatter
     */
