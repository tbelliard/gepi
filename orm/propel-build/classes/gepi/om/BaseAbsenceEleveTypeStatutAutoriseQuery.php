...
abstract class BaseAbsenceEleveTypeStatutAutoriseQuery extends ModelCriteria
{
     ...
     * @param     AbsenceEleveTypeStatutAutoriseQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     *
     * @return   AbsenceEleveTypeStatutAutorise|AbsenceEleveTypeStatutAutorise[]|mixed the result, formatted by the current formatter
     */
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|AbsenceEleveTypeStatutAutorise[]|mixed the list of results, formatted by the current formatter
     */
