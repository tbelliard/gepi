...
abstract class BaseAbsenceSaisiePeer {
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += AbsenceSaisiePeer::doOnDeleteCascade(new Criteria(AbsenceSaisiePeer::DATABASE_NAME), $con);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->beginTransaction();
			$affectedRows += AbsenceSaisiePeer::doOnDeleteCascade($criteria, $con);
			...
			// invalidate objects in JTraitementSaisieAbsencePeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related JTraitementSaisieAbsence objects
			$c = new Criteria(JTraitementSaisieAbsencePeer::DATABASE_NAME);
			
			$c->add(JTraitementSaisieAbsencePeer::A_SAISIE_ID, $obj->getId());
			$affectedRows += JTraitementSaisieAbsencePeer::doDelete($c, $con);
		}
		return $affectedRows;
	}
