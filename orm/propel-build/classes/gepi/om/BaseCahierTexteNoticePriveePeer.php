...
abstract class BaseCahierTexteNoticePriveePeer
{
    ...
    const ID_CT = 'ct_private_entry.ID_CT';

    /** the column name for the HEURE_ENTRY field */
    const HEURE_ENTRY = 'ct_private_entry.HEURE_ENTRY';

    /** the column name for the DATE_CT field */
    const DATE_CT = 'ct_private_entry.DATE_CT';

    /** the column name for the CONTENU field */
    const CONTENU = 'ct_private_entry.CONTENU';

    /** the column name for the ID_GROUPE field */
    const ID_GROUPE = 'ct_private_entry.ID_GROUPE';

    /** the column name for the ID_LOGIN field */
    const ID_LOGIN = 'ct_private_entry.ID_LOGIN';

    /** the column name for the ID_SEQUENCE field */
    const ID_SEQUENCE = 'ct_private_entry.ID_SEQUENCE';

    /** The default string format for model objects of the related table **/
    const DEFAULT_STRING_FORMAT = 'YAML';

    /**
     * An identiy map to hold any loaded instances of CahierTexteNoticePrivee objects.
     * This must be public so that other peer classes can access this when hydrating from JOIN
     * queries.
     * @var        array CahierTexteNoticePrivee[]
     */
     ...
     * e.g. CahierTexteNoticePriveePeer::$fieldNames[CahierTexteNoticePriveePeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (CahierTexteNoticePriveePeer::ID_CT, CahierTexteNoticePriveePeer::HEURE_ENTRY, CahierTexteNoticePriveePeer::DATE_CT, CahierTexteNoticePriveePeer::CONTENU, CahierTexteNoticePriveePeer::ID_GROUPE, CahierTexteNoticePriveePeer::ID_LOGIN, CahierTexteNoticePriveePeer::ID_SEQUENCE, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. CahierTexteNoticePriveePeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (CahierTexteNoticePriveePeer::ID_CT => 0, CahierTexteNoticePriveePeer::HEURE_ENTRY => 1, CahierTexteNoticePriveePeer::DATE_CT => 2, CahierTexteNoticePriveePeer::CONTENU => 3, CahierTexteNoticePriveePeer::ID_GROUPE => 4, CahierTexteNoticePriveePeer::ID_LOGIN => 5, CahierTexteNoticePriveePeer::ID_SEQUENCE => 6, ),
    ...
    {
        $toNames = CahierTexteNoticePriveePeer::getFieldNames($toType);
        $key = isset(CahierTexteNoticePriveePeer::$fieldKeys[$fromType][$name]) ? CahierTexteNoticePriveePeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(CahierTexteNoticePriveePeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, CahierTexteNoticePriveePeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return CahierTexteNoticePriveePeer::$fieldNames[$type];
    }
     ...
     * @param      string $column The column name for current table. (i.e. CahierTexteNoticePriveePeer::COLUMN_NAME).
     * @return string
     */
    public static function alias($alias, $column)
    {
        return str_replace(CahierTexteNoticePriveePeer::TABLE_NAME.'.', $alias.'.', $column);
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setPrimaryTableName(CahierTexteNoticePriveePeer::TABLE_NAME);
        ...
        $criteria->setDbName(CahierTexteNoticePriveePeer::DATABASE_NAME); // Set the correct dbName
     ...
     * @param      PropelPDO $con
     * @return                 CahierTexteNoticePrivee
     * @throws PropelException Any exceptions caught during processing will be
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectOne(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $critcopy->setLimit(1);
        $objects = CahierTexteNoticePriveePeer::doSelect($critcopy, $con);
        if ($objects) {
            return $objects[0];
        }
    ...
    {
        return CahierTexteNoticePriveePeer::populateObjects(CahierTexteNoticePriveePeer::doSelectStmt($criteria, $con));
    }
    /**
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(CahierTexteNoticePriveePeer::DATABASE_NAME);
     ...
     *
     * @param      CahierTexteNoticePrivee $obj A CahierTexteNoticePrivee object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            CahierTexteNoticePriveePeer::$instances[$key] = $obj;
        }
    }
     ...
     *
     * @param      mixed $value A CahierTexteNoticePrivee object or a primary key value.
     *
     * @return void
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof CahierTexteNoticePrivee) {
                $key = (string) $value->getIdCt();
            } elseif (is_scalar($value)) {
                // assume we've been passed a primary key
                $key = (string) $value;
            } else {
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or CahierTexteNoticePrivee object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
                throw $e;
            }

            unset(CahierTexteNoticePriveePeer::$instances[$key]);
        }
     ...
     * @return   CahierTexteNoticePrivee Found object or null if 1) no instance exists for specified key or 2) instance pooling has been disabled.
     * @see        getPrimaryKeyHash()
     */
    public static function getInstanceFromPool($key)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(CahierTexteNoticePriveePeer::$instances[$key])) {
                return CahierTexteNoticePriveePeer::$instances[$key];
            }
        }
    ...
    {
        CahierTexteNoticePriveePeer::$instances = array();
    }
    ...
    public static function populateObject($row, $startcol = 0)
    {
        ...
        if (null !== ($obj = CahierTexteNoticePriveePeer::getInstanceFromPool($key))) {
            ...
            $col = $startcol + CahierTexteNoticePriveePeer::NUM_HYDRATE_COLUMNS;
        } else {
    ...
    public static function doSelectJoinGroupe(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        CahierTexteNoticePriveePeer::addSelectColumns($criteria);
        $startcol = CahierTexteNoticePriveePeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CahierTexteNoticePrivee) to $obj2 (Groupe)
                $obj2->addCahierTexteNoticePrivee($obj1);
    ...
    public static function doSelectJoinUtilisateurProfessionnel(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CahierTexteNoticePrivee) to $obj2 (UtilisateurProfessionnel)
                $obj2->addCahierTexteNoticePrivee($obj1);
    ...
    public static function doSelectJoinCahierTexteSequence(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CahierTexteNoticePrivee) to $obj2 (CahierTexteSequence)
                $obj2->addCahierTexteNoticePrivee($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        CahierTexteNoticePriveePeer::addSelectColumns($criteria);
        $startcol2 = CahierTexteNoticePriveePeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CahierTexteNoticePrivee) to the collection in $obj2 (Groupe)
                $obj2->addCahierTexteNoticePrivee($obj1);
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (CahierTexteNoticePrivee) to the collection in $obj3 (UtilisateurProfessionnel)
                $obj3->addCahierTexteNoticePrivee($obj1);
            } // if joined row not null
            ...
            if ($key4 !== null) {
                ...
                // Add the $obj1 (CahierTexteNoticePrivee) to the collection in $obj4 (CahierTexteSequence)
                $obj4->addCahierTexteNoticePrivee($obj1);
            } // if joined row not null
    ...
    public static function doSelectJoinAllExceptGroupe(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = CahierTexteNoticePriveePeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (CahierTexteNoticePrivee) to the collection in $obj2 (UtilisateurProfessionnel)
                $obj2->addCahierTexteNoticePrivee($obj1);
                ...
                // Add the $obj1 (CahierTexteNoticePrivee) to the collection in $obj3 (CahierTexteSequence)
                $obj3->addCahierTexteNoticePrivee($obj1);
    ...
    {
        return Propel::getDatabaseMap(CahierTexteNoticePriveePeer::DATABASE_NAME)->getTable(CahierTexteNoticePriveePeer::TABLE_NAME);
    }
    ...
    {
        return CahierTexteNoticePriveePeer::OM_CLASS;
    }
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria = $values->buildCriteria(); // build Criteria from CahierTexteNoticePrivee object
        }

        if ($criteria->containsKey(CahierTexteNoticePriveePeer::ID_CT) && $criteria->keyContainsValue(CahierTexteNoticePriveePeer::ID_CT) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(CahierTexteNoticePriveePeer::DATABASE_NAME);
    ...
    /**
     * Validates all modified columns of given CahierTexteNoticePrivee object.
     * If parameter $columns is either a single column name or an array of column names
     * than only those columns are validated.
     *
     * NOTICE: This does not apply to primary or foreign keys for now.
     *
     * @param      CahierTexteNoticePrivee $obj The object to validate.
    ...
    public static function doValidate($obj, $cols = null)
    {
        ...
        if ($cols) {
            $dbMap = Propel::getDatabaseMap(CahierTexteNoticePriveePeer::DATABASE_NAME);
            $tableMap = $dbMap->getTable(CahierTexteNoticePriveePeer::TABLE_NAME);
        ...
        return BasePeer::doValidate(CahierTexteNoticePriveePeer::DATABASE_NAME, CahierTexteNoticePriveePeer::TABLE_NAME, $columns);
    }
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        if (null !== ($obj = CahierTexteNoticePriveePeer::getInstanceFromPool((string) $pk))) {
            return $obj;
        }
        ...
        $criteria = new Criteria(CahierTexteNoticePriveePeer::DATABASE_NAME);
        $criteria->add(CahierTexteNoticePriveePeer::ID_CT, $pk);

        $v = CahierTexteNoticePriveePeer::doSelect($criteria, $con);
