...
abstract class BaseEdtSalleQuery extends ModelCriteria
{
     ...
     * @param     EdtSalleQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     *
     * @return   EdtSalle|EdtSalle[]|mixed the result, formatted by the current formatter
     */
    public function findPk($key, $con = null)
    {
        ...
        if ((null !== ($obj = EdtSallePeer::getInstanceFromPool((string) $key))) && !$this->formatter) {
     ...
     *
     * @return   EdtSalle A model object, or null if the key is not found
     * @throws   PropelException
     */
     public function findOneByIdSalle($key, $con = null)
     {
    ...
    {
        $sql = 'SELECT ID_SALLE, NUMERO_SALLE, NOM_SALLE FROM salle_cours WHERE ID_SALLE = :p0';
        try {
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|EdtSalle[]|mixed the list of results, formatted by the current formatter
     */
