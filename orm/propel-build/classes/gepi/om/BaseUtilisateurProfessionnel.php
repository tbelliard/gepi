...
abstract class BaseUtilisateurProfessionnel extends BaseObject implements Persistent
{
    ...
    /**
     * @var        PropelObjectCollection|JScolClasses[] Collection to store aggregation of JScolClasses objects.
     */
    protected $collJScolClassess;
    protected $collJScolClassessPartial;
    ...
    protected $collModifiedAbsenceEleveTraitementsPartial;
    ...
    /**
     * @var        PropelObjectCollection|JProfesseursMatieres[] Collection to store aggregation of JProfesseursMatieres objects.
     */
    protected $collJProfesseursMatieress;
    protected $collJProfesseursMatieressPartial;

    /**
     * @var        PropelObjectCollection|PreferenceUtilisateurProfessionnel[] Collection to store aggregation of PreferenceUtilisateurProfessionnel objects.
     */
    protected $collPreferenceUtilisateurProfessionnels;
    protected $collPreferenceUtilisateurProfessionnelsPartial;
    ...
    /**
     * @var        PropelObjectCollection|Groupe[] Collection to store aggregation of Groupe objects.
     */
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->groupesScheduledForDeletion !== null) {
                if (!$this->groupesScheduledForDeletion->isEmpty()) {
                    ...
                    foreach ($this->groupesScheduledForDeletion->getPrimaryKeys(false) as $remotePk) {
            ...
            if ($this->modifiedAbsenceEleveTraitementsScheduledForDeletion !== null) {
                if (!$this->modifiedAbsenceEleveTraitementsScheduledForDeletion->isEmpty()) {
                    foreach ($this->modifiedAbsenceEleveTraitementsScheduledForDeletion as $modifiedAbsenceEleveTraitement) {
                        // need to save related object because we set the relation to null
                        $modifiedAbsenceEleveTraitement->save($con);
                    }
    ...
    public function setJGroupesProfesseurss(PropelCollection $jGroupesProfesseurss, PropelPDO $con = null)
    {
        ...
        foreach ($this->jGroupesProfesseurssScheduledForDeletion as $jGroupesProfesseursRemoved) {
            $jGroupesProfesseursRemoved->setUtilisateurProfessionnel(null);
        }
    ...
    public function removeJGroupesProfesseurs($jGroupesProfesseurs)
    {
        if ($this->getJGroupesProfesseurss()->contains($jGroupesProfesseurs)) {
            ...
            $jGroupesProfesseurs->setUtilisateurProfessionnel(null);
        }
    }
    ...
    public function clearJScolClassess()
    {
        ...
        $this->collJScolClassessPartial = null;
    }

    /**
     * reset is the collJScolClassess collection loaded partially
     *
     * @return void
     */
    public function resetPartialJScolClassess($v = true)
    {
        $this->collJScolClassessPartial = $v;
    }
     ...
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     * @return PropelObjectCollection|JScolClasses[] List of JScolClasses objects
     * @throws PropelException
     */
    public function getJScolClassess($criteria = null, PropelPDO $con = null)
    {
        $partial = $this->collJScolClassessPartial && !$this->isNew();
        if (null === $this->collJScolClassess || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collJScolClassess) {
                ...
                $collJScolClassess = JScolClassesQuery::create(null, $criteria)
                    ...
                    ->find($con);
                if (null !== $criteria) {
                    if (false !== $this->collJScolClassessPartial && count($collJScolClassess)) {
                      $this->initJScolClassess(false);

                      foreach($collJScolClassess as $obj) {
                        if (false == $this->collJScolClassess->contains($obj)) {
                          $this->collJScolClassess->append($obj);
                        }
                      }

                      $this->collJScolClassessPartial = true;
                    }

                    return $collJScolClassess;
                }

                if($partial && $this->collJScolClassess) {
                    foreach($this->collJScolClassess as $obj) {
                        if($obj->isNew()) {
                            $collJScolClassess[] = $obj;
                        }
                    }
                }

                $this->collJScolClassess = $collJScolClassess;
                $this->collJScolClassessPartial = false;
            }
        }
    ...
    public function setJScolClassess(PropelCollection $jScolClassess, PropelPDO $con = null)
    {
        ...
        foreach ($this->jScolClassessScheduledForDeletion as $jScolClassesRemoved) {
            $jScolClassesRemoved->setUtilisateurProfessionnel(null);
        }
    ...
    public function countJScolClassess(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        ...
        if (null === $this->collJScolClassess || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collJScolClassess) {
                ...
                if($partial && !$criteria) {
                    return count($this->getJScolClassess());
                }
    ...
    public function addJScolClasses(JScolClasses $l)
    {
        ...
        if (!in_array($l, $this->collJScolClassess->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
    ...
    /**
     * @param	JScolClasses $jScolClasses The jScolClasses object to remove.
     */
    public function removeJScolClasses($jScolClasses)
    {
        if ($this->getJScolClassess()->contains($jScolClasses)) {
            $this->collJScolClassess->remove($this->collJScolClassess->search($jScolClasses));
            if (null === $this->jScolClassessScheduledForDeletion) {
                $this->jScolClassessScheduledForDeletion = clone $this->collJScolClassess;
                $this->jScolClassessScheduledForDeletion->clear();
            }
            $this->jScolClassessScheduledForDeletion[]= $jScolClasses;
            $jScolClasses->setUtilisateurProfessionnel(null);
        }
    }
    ...
    public function setCahierTexteCompteRendus(PropelCollection $cahierTexteCompteRendus, PropelPDO $con = null)
    {
        ...
        foreach ($this->cahierTexteCompteRendusScheduledForDeletion as $cahierTexteCompteRenduRemoved) {
            $cahierTexteCompteRenduRemoved->setUtilisateurProfessionnel(null);
        }
    ...
    public function removeCahierTexteCompteRendu($cahierTexteCompteRendu)
    {
        if ($this->getCahierTexteCompteRendus()->contains($cahierTexteCompteRendu)) {
            ...
            $cahierTexteCompteRendu->setUtilisateurProfessionnel(null);
        }
    }
    ...
    public function setCahierTexteTravailAFaires(PropelCollection $cahierTexteTravailAFaires, PropelPDO $con = null)
    {
        ...
        foreach ($this->cahierTexteTravailAFairesScheduledForDeletion as $cahierTexteTravailAFaireRemoved) {
            $cahierTexteTravailAFaireRemoved->setUtilisateurProfessionnel(null);
        }
    ...
    public function removeCahierTexteTravailAFaire($cahierTexteTravailAFaire)
    {
        if ($this->getCahierTexteTravailAFaires()->contains($cahierTexteTravailAFaire)) {
            ...
            $cahierTexteTravailAFaire->setUtilisateurProfessionnel(null);
        }
    }
    ...
    public function setCahierTexteNoticePrivees(PropelCollection $cahierTexteNoticePrivees, PropelPDO $con = null)
    {
        ...
        foreach ($this->cahierTexteNoticePriveesScheduledForDeletion as $cahierTexteNoticePriveeRemoved) {
            $cahierTexteNoticePriveeRemoved->setUtilisateurProfessionnel(null);
        }
    ...
    public function removeCahierTexteNoticePrivee($cahierTexteNoticePrivee)
    {
        if ($this->getCahierTexteNoticePrivees()->contains($cahierTexteNoticePrivee)) {
            ...
            $cahierTexteNoticePrivee->setUtilisateurProfessionnel(null);
        }
    }
    ...
    public function setJEleveCpes(PropelCollection $jEleveCpes, PropelPDO $con = null)
    {
        ...
        foreach ($this->jEleveCpesScheduledForDeletion as $jEleveCpeRemoved) {
            $jEleveCpeRemoved->setUtilisateurProfessionnel(null);
        }
    ...
    public function removeJEleveCpe($jEleveCpe)
    {
        if ($this->getJEleveCpes()->contains($jEleveCpe)) {
            ...
            $jEleveCpe->setUtilisateurProfessionnel(null);
        }
    }
    ...
    public function setJEleveProfesseurPrincipals(PropelCollection $jEleveProfesseurPrincipals, PropelPDO $con = null)
    {
        ...
        foreach ($this->jEleveProfesseurPrincipalsScheduledForDeletion as $jEleveProfesseurPrincipalRemoved) {
            $jEleveProfesseurPrincipalRemoved->setUtilisateurProfessionnel(null);
        }
    ...
    public function removeJEleveProfesseurPrincipal($jEleveProfesseurPrincipal)
    {
        if ($this->getJEleveProfesseurPrincipals()->contains($jEleveProfesseurPrincipal)) {
            ...
            $jEleveProfesseurPrincipal->setUtilisateurProfessionnel(null);
        }
    }
    ...
    public function setJAidUtilisateursProfessionnelss(PropelCollection $jAidUtilisateursProfessionnelss, PropelPDO $con = null)
    {
        ...
        foreach ($this->jAidUtilisateursProfessionnelssScheduledForDeletion as $jAidUtilisateursProfessionnelsRemoved) {
            $jAidUtilisateursProfessionnelsRemoved->setUtilisateurProfessionnel(null);
        }
    ...
    public function removeJAidUtilisateursProfessionnels($jAidUtilisateursProfessionnels)
    {
        if ($this->getJAidUtilisateursProfessionnelss()->contains($jAidUtilisateursProfessionnels)) {
            ...
            $jAidUtilisateursProfessionnels->setUtilisateurProfessionnel(null);
        }
    }
    ...
    public function setAbsenceEleveSaisies(PropelCollection $absenceEleveSaisies, PropelPDO $con = null)
    {
        ...
        foreach ($this->absenceEleveSaisiesScheduledForDeletion as $absenceEleveSaisieRemoved) {
            $absenceEleveSaisieRemoved->setUtilisateurProfessionnel(null);
        }
    ...
    public function removeAbsenceEleveSaisie($absenceEleveSaisie)
    {
        if ($this->getAbsenceEleveSaisies()->contains($absenceEleveSaisie)) {
            ...
            $absenceEleveSaisie->setUtilisateurProfessionnel(null);
        }
    }
    ...
    public function setAbsenceEleveTraitements(PropelCollection $absenceEleveTraitements, PropelPDO $con = null)
    {
        ...
        foreach ($this->absenceEleveTraitementsScheduledForDeletion as $absenceEleveTraitementRemoved) {
            $absenceEleveTraitementRemoved->setUtilisateurProfessionnel(null);
        }
    ...
    public function removeAbsenceEleveTraitement($absenceEleveTraitement)
    {
        if ($this->getAbsenceEleveTraitements()->contains($absenceEleveTraitement)) {
            ...
            $absenceEleveTraitement->setUtilisateurProfessionnel(null);
        }
    }
    ...
    public function clearModifiedAbsenceEleveTraitements()
    {
        ...
        $this->collModifiedAbsenceEleveTraitementsPartial = null;
    }

    /**
     * reset is the collModifiedAbsenceEleveTraitements collection loaded partially
     *
     * @return void
     */
    public function resetPartialModifiedAbsenceEleveTraitements($v = true)
    {
        $this->collModifiedAbsenceEleveTraitementsPartial = $v;
    }
    ...
    {
        $partial = $this->collModifiedAbsenceEleveTraitementsPartial && !$this->isNew();
        if (null === $this->collModifiedAbsenceEleveTraitements || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collModifiedAbsenceEleveTraitements) {
                ...
                $collModifiedAbsenceEleveTraitements = AbsenceEleveTraitementQuery::create(null, $criteria)
                    ...
                    ->find($con);
                if (null !== $criteria) {
                    if (false !== $this->collModifiedAbsenceEleveTraitementsPartial && count($collModifiedAbsenceEleveTraitements)) {
                      $this->initModifiedAbsenceEleveTraitements(false);

                      foreach($collModifiedAbsenceEleveTraitements as $obj) {
                        if (false == $this->collModifiedAbsenceEleveTraitements->contains($obj)) {
                          $this->collModifiedAbsenceEleveTraitements->append($obj);
                        }
                      }

                      $this->collModifiedAbsenceEleveTraitementsPartial = true;
                    }

                    return $collModifiedAbsenceEleveTraitements;
                }

                if($partial && $this->collModifiedAbsenceEleveTraitements) {
                    foreach($this->collModifiedAbsenceEleveTraitements as $obj) {
                        if($obj->isNew()) {
                            $collModifiedAbsenceEleveTraitements[] = $obj;
                        }
                    }
                }

                $this->collModifiedAbsenceEleveTraitements = $collModifiedAbsenceEleveTraitements;
                $this->collModifiedAbsenceEleveTraitementsPartial = false;
            }
        }
    ...
    public function setModifiedAbsenceEleveTraitements(PropelCollection $modifiedAbsenceEleveTraitements, PropelPDO $con = null)
    {
        ...
        foreach ($this->modifiedAbsenceEleveTraitementsScheduledForDeletion as $modifiedAbsenceEleveTraitementRemoved) {
            $modifiedAbsenceEleveTraitementRemoved->setModifieParUtilisateur(null);
        }
    ...
    public function countModifiedAbsenceEleveTraitements(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        ...
        if (null === $this->collModifiedAbsenceEleveTraitements || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collModifiedAbsenceEleveTraitements) {
                ...
                if($partial && !$criteria) {
                    return count($this->getModifiedAbsenceEleveTraitements());
                }
                $query = AbsenceEleveTraitementQuery::create(null, $criteria);
                if ($distinct) {
                    $query->distinct();
    ...
    public function addModifiedAbsenceEleveTraitement(AbsenceEleveTraitement $l)
    {
        ...
        if (!in_array($l, $this->collModifiedAbsenceEleveTraitements->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
    ...
    /**
     * @param	ModifiedAbsenceEleveTraitement $modifiedAbsenceEleveTraitement The modifiedAbsenceEleveTraitement object to remove.
     */
    public function removeModifiedAbsenceEleveTraitement($modifiedAbsenceEleveTraitement)
    {
        if ($this->getModifiedAbsenceEleveTraitements()->contains($modifiedAbsenceEleveTraitement)) {
            $this->collModifiedAbsenceEleveTraitements->remove($this->collModifiedAbsenceEleveTraitements->search($modifiedAbsenceEleveTraitement));
            if (null === $this->modifiedAbsenceEleveTraitementsScheduledForDeletion) {
                $this->modifiedAbsenceEleveTraitementsScheduledForDeletion = clone $this->collModifiedAbsenceEleveTraitements;
                $this->modifiedAbsenceEleveTraitementsScheduledForDeletion->clear();
            }
            $this->modifiedAbsenceEleveTraitementsScheduledForDeletion[]= $modifiedAbsenceEleveTraitement;
            $modifiedAbsenceEleveTraitement->setModifieParUtilisateur(null);
        }
    }
    ...
    public function setAbsenceEleveNotifications(PropelCollection $absenceEleveNotifications, PropelPDO $con = null)
    {
        ...
        foreach ($this->absenceEleveNotificationsScheduledForDeletion as $absenceEleveNotificationRemoved) {
            $absenceEleveNotificationRemoved->setUtilisateurProfessionnel(null);
        }
    ...
    public function removeAbsenceEleveNotification($absenceEleveNotification)
    {
        if ($this->getAbsenceEleveNotifications()->contains($absenceEleveNotification)) {
            ...
            $absenceEleveNotification->setUtilisateurProfessionnel(null);
        }
    }
    ...
    public function clearJProfesseursMatieress()
    {
        ...
        $this->collJProfesseursMatieressPartial = null;
    }

    /**
     * reset is the collJProfesseursMatieress collection loaded partially
     *
     * @return void
     */
    public function resetPartialJProfesseursMatieress($v = true)
    {
        $this->collJProfesseursMatieressPartial = $v;
    }
     ...
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     * @return PropelObjectCollection|JProfesseursMatieres[] List of JProfesseursMatieres objects
     * @throws PropelException
     */
    public function getJProfesseursMatieress($criteria = null, PropelPDO $con = null)
    {
        $partial = $this->collJProfesseursMatieressPartial && !$this->isNew();
        if (null === $this->collJProfesseursMatieress || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collJProfesseursMatieress) {
                ...
                $collJProfesseursMatieress = JProfesseursMatieresQuery::create(null, $criteria)
                    ...
                    ->find($con);
                if (null !== $criteria) {
                    if (false !== $this->collJProfesseursMatieressPartial && count($collJProfesseursMatieress)) {
                      $this->initJProfesseursMatieress(false);

                      foreach($collJProfesseursMatieress as $obj) {
                        if (false == $this->collJProfesseursMatieress->contains($obj)) {
                          $this->collJProfesseursMatieress->append($obj);
                        }
                      }

                      $this->collJProfesseursMatieressPartial = true;
                    }

                    return $collJProfesseursMatieress;
                }

                if($partial && $this->collJProfesseursMatieress) {
                    foreach($this->collJProfesseursMatieress as $obj) {
                        if($obj->isNew()) {
                            $collJProfesseursMatieress[] = $obj;
                        }
                    }
                }

                $this->collJProfesseursMatieress = $collJProfesseursMatieress;
                $this->collJProfesseursMatieressPartial = false;
            }
        }
    ...
    public function setJProfesseursMatieress(PropelCollection $jProfesseursMatieress, PropelPDO $con = null)
    {
        ...
        foreach ($this->jProfesseursMatieressScheduledForDeletion as $jProfesseursMatieresRemoved) {
            $jProfesseursMatieresRemoved->setProfesseur(null);
        }
    ...
    public function countJProfesseursMatieress(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        ...
        if (null === $this->collJProfesseursMatieress || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collJProfesseursMatieress) {
                ...
                if($partial && !$criteria) {
                    return count($this->getJProfesseursMatieress());
                }
    ...
    public function addJProfesseursMatieres(JProfesseursMatieres $l)
    {
        ...
        if (!in_array($l, $this->collJProfesseursMatieress->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
    ...
    /**
     * @param	JProfesseursMatieres $jProfesseursMatieres The jProfesseursMatieres object to remove.
     */
    public function removeJProfesseursMatieres($jProfesseursMatieres)
    {
        if ($this->getJProfesseursMatieress()->contains($jProfesseursMatieres)) {
            $this->collJProfesseursMatieress->remove($this->collJProfesseursMatieress->search($jProfesseursMatieres));
            if (null === $this->jProfesseursMatieressScheduledForDeletion) {
                $this->jProfesseursMatieressScheduledForDeletion = clone $this->collJProfesseursMatieress;
                $this->jProfesseursMatieressScheduledForDeletion->clear();
            }
            $this->jProfesseursMatieressScheduledForDeletion[]= $jProfesseursMatieres;
            $jProfesseursMatieres->setProfesseur(null);
        }
    }
    ...
    public function clearPreferenceUtilisateurProfessionnels()
    {
        ...
        $this->collPreferenceUtilisateurProfessionnelsPartial = null;
    }

    /**
     * reset is the collPreferenceUtilisateurProfessionnels collection loaded partially
     *
     * @return void
     */
    public function resetPartialPreferenceUtilisateurProfessionnels($v = true)
    {
        $this->collPreferenceUtilisateurProfessionnelsPartial = $v;
    }
     ...
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     * @return PropelObjectCollection|PreferenceUtilisateurProfessionnel[] List of PreferenceUtilisateurProfessionnel objects
     * @throws PropelException
     */
    public function getPreferenceUtilisateurProfessionnels($criteria = null, PropelPDO $con = null)
    {
        $partial = $this->collPreferenceUtilisateurProfessionnelsPartial && !$this->isNew();
        if (null === $this->collPreferenceUtilisateurProfessionnels || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collPreferenceUtilisateurProfessionnels) {
                ...
                $collPreferenceUtilisateurProfessionnels = PreferenceUtilisateurProfessionnelQuery::create(null, $criteria)
                    ...
                    ->find($con);
                if (null !== $criteria) {
                    if (false !== $this->collPreferenceUtilisateurProfessionnelsPartial && count($collPreferenceUtilisateurProfessionnels)) {
                      $this->initPreferenceUtilisateurProfessionnels(false);

                      foreach($collPreferenceUtilisateurProfessionnels as $obj) {
                        if (false == $this->collPreferenceUtilisateurProfessionnels->contains($obj)) {
                          $this->collPreferenceUtilisateurProfessionnels->append($obj);
                        }
                      }

                      $this->collPreferenceUtilisateurProfessionnelsPartial = true;
                    }

                    return $collPreferenceUtilisateurProfessionnels;
                }

                if($partial && $this->collPreferenceUtilisateurProfessionnels) {
                    foreach($this->collPreferenceUtilisateurProfessionnels as $obj) {
                        if($obj->isNew()) {
                            $collPreferenceUtilisateurProfessionnels[] = $obj;
                        }
                    }
                }

                $this->collPreferenceUtilisateurProfessionnels = $collPreferenceUtilisateurProfessionnels;
                $this->collPreferenceUtilisateurProfessionnelsPartial = false;
            }
        }
    ...
    public function setPreferenceUtilisateurProfessionnels(PropelCollection $preferenceUtilisateurProfessionnels, PropelPDO $con = null)
    {
        ...
        foreach ($this->preferenceUtilisateurProfessionnelsScheduledForDeletion as $preferenceUtilisateurProfessionnelRemoved) {
            $preferenceUtilisateurProfessionnelRemoved->setUtilisateurProfessionnel(null);
        }
    ...
    public function countPreferenceUtilisateurProfessionnels(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        ...
        if (null === $this->collPreferenceUtilisateurProfessionnels || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collPreferenceUtilisateurProfessionnels) {
                ...
                if($partial && !$criteria) {
                    return count($this->getPreferenceUtilisateurProfessionnels());
                }
    ...
    public function addPreferenceUtilisateurProfessionnel(PreferenceUtilisateurProfessionnel $l)
    {
        ...
        if (!in_array($l, $this->collPreferenceUtilisateurProfessionnels->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
    ...
    /**
     * @param	PreferenceUtilisateurProfessionnel $preferenceUtilisateurProfessionnel The preferenceUtilisateurProfessionnel object to remove.
     */
    public function removePreferenceUtilisateurProfessionnel($preferenceUtilisateurProfessionnel)
    {
        if ($this->getPreferenceUtilisateurProfessionnels()->contains($preferenceUtilisateurProfessionnel)) {
            $this->collPreferenceUtilisateurProfessionnels->remove($this->collPreferenceUtilisateurProfessionnels->search($preferenceUtilisateurProfessionnel));
            if (null === $this->preferenceUtilisateurProfessionnelsScheduledForDeletion) {
                $this->preferenceUtilisateurProfessionnelsScheduledForDeletion = clone $this->collPreferenceUtilisateurProfessionnels;
                $this->preferenceUtilisateurProfessionnelsScheduledForDeletion->clear();
            }
            $this->preferenceUtilisateurProfessionnelsScheduledForDeletion[]= $preferenceUtilisateurProfessionnel;
            $preferenceUtilisateurProfessionnel->setUtilisateurProfessionnel(null);
        }
    }
    ...
    public function setEdtEmplacementCourss(PropelCollection $edtEmplacementCourss, PropelPDO $con = null)
    {
        ...
        foreach ($this->edtEmplacementCourssScheduledForDeletion as $edtEmplacementCoursRemoved) {
            $edtEmplacementCoursRemoved->setUtilisateurProfessionnel(null);
        }
    ...
    public function removeEdtEmplacementCours($edtEmplacementCours)
    {
        if ($this->getEdtEmplacementCourss()->contains($edtEmplacementCours)) {
            ...
            $edtEmplacementCours->setUtilisateurProfessionnel(null);
        }
    }
     ...
     * @param PropelPDO $con Optional connection object
     *
     * @return PropelObjectCollection|Groupe[] List of Groupe objects
     */
    ...
    {
        $this->clearGroupes();
        $currentGroupes = $this->getGroupes();

        $this->groupesScheduledForDeletion = $currentGroupes->diff($groupes);

        foreach ($groupes as $groupe) {
            if (!$currentGroupes->contains($groupe)) {
    ...
    /**
     * Remove a Groupe object to this object
     * through the j_groupes_professeurs cross reference table.
     *
     * @param Groupe $groupe The JGroupesProfesseurs object to relate
     * @return void
    ...
    {
        if ($this->getGroupes()->contains($groupe)) {
            $this->collGroupes->remove($this->collGroupes->search($groupe));
            if (null === $this->groupesScheduledForDeletion) {
                $this->groupesScheduledForDeletion = clone $this->collGroupes;
                $this->groupesScheduledForDeletion->clear();
            }
            $this->groupesScheduledForDeletion[]= $groupe;
        }
    }
