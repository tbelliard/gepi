...
abstract class BaseCahierTexteTravailAFairePeer
{
    ...
    const OM_CLASS = 'CahierTexteTravailAFaire';
     ...
     * e.g. CahierTexteTravailAFairePeer::$fieldNames[CahierTexteTravailAFairePeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (CahierTexteTravailAFairePeer::ID_CT, CahierTexteTravailAFairePeer::DATE_CT, CahierTexteTravailAFairePeer::CONTENU, CahierTexteTravailAFairePeer::VISE, CahierTexteTravailAFairePeer::ID_GROUPE, CahierTexteTravailAFairePeer::ID_LOGIN, CahierTexteTravailAFairePeer::ID_SEQUENCE, CahierTexteTravailAFairePeer::DATE_VISIBILITE_ELEVE, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. CahierTexteTravailAFairePeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (CahierTexteTravailAFairePeer::ID_CT => 0, CahierTexteTravailAFairePeer::DATE_CT => 1, CahierTexteTravailAFairePeer::CONTENU => 2, CahierTexteTravailAFairePeer::VISE => 3, CahierTexteTravailAFairePeer::ID_GROUPE => 4, CahierTexteTravailAFairePeer::ID_LOGIN => 5, CahierTexteTravailAFairePeer::ID_SEQUENCE => 6, CahierTexteTravailAFairePeer::DATE_VISIBILITE_ELEVE => 7, ),
    ...
    {
        $toNames = CahierTexteTravailAFairePeer::getFieldNames($toType);
        $key = isset(CahierTexteTravailAFairePeer::$fieldKeys[$fromType][$name]) ? CahierTexteTravailAFairePeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(CahierTexteTravailAFairePeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, CahierTexteTravailAFairePeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return CahierTexteTravailAFairePeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(CahierTexteTravailAFairePeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(CahierTexteTravailAFairePeer::DATABASE_NAME);
     ...
     *
     * @param      CahierTexteTravailAFaire $obj A CahierTexteTravailAFaire object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            CahierTexteTravailAFairePeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(CahierTexteTravailAFairePeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(CahierTexteTravailAFairePeer::$instances[$key])) {
                return CahierTexteTravailAFairePeer::$instances[$key];
            }
        }
    ...
    {
        CahierTexteTravailAFairePeer::$instances = array();
    }

    /**
     * Method to invalidate the instance pool of all tables related to ct_devoirs_entry
     ...
     * @throws PropelException Any exceptions caught during processing will be
     *		 rethrown wrapped into a PropelException.
     * @return array (CahierTexteTravailAFaire object, last column rank)
     */
    ...
    {
        return Propel::getDatabaseMap(CahierTexteTravailAFairePeer::DATABASE_NAME)->getTable(CahierTexteTravailAFairePeer::TABLE_NAME);
    }
    ...
    {
      $dbMap = Propel::getDatabaseMap(BaseCahierTexteTravailAFairePeer::DATABASE_NAME);
      if (!$dbMap->hasTable(BaseCahierTexteTravailAFairePeer::TABLE_NAME)) {
        $dbMap->addTableObject(new CahierTexteTravailAFaireTableMap());
      }
    }
    ...
    {
        return CahierTexteTravailAFairePeer::OM_CLASS;
    }

    /**
     * Performs an INSERT on the database, given a CahierTexteTravailAFaire or Criteria object.
     *
    ...
    /**
     * Performs an UPDATE on the database, given a CahierTexteTravailAFaire or Criteria object.
     *
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(CahierTexteTravailAFairePeer::DATABASE_NAME);

        if ($values instanceof Criteria) {
            $criteria = clone $values; // rename for clarity

            $comparison = $criteria->getComparison(CahierTexteTravailAFairePeer::ID_CT);
            $value = $criteria->remove(CahierTexteTravailAFairePeer::ID_CT);
            if ($value) {
                $selectCriteria->add(CahierTexteTravailAFairePeer::ID_CT, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(CahierTexteTravailAFairePeer::TABLE_NAME);
            }
    ...
    /**
     * Deletes all rows from the ct_devoirs_entry table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            CahierTexteTravailAFairePeer::clearRelatedInstancePool();
            $con->commit();
    ...
    /**
     * Performs a DELETE on the database, given a CahierTexteTravailAFaire or Criteria object OR a primary key value.
     *
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        } elseif ($values instanceof CahierTexteTravailAFaire) { // it's a model object
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            $criteria->add(CahierTexteTravailAFaireFichierJointPeer::ID_CT_DEVOIR, $obj->getIdCt());
            $affectedRows += CahierTexteTravailAFaireFichierJointPeer::doDelete($criteria, $con);
        }
...
//
BaseCahierTexteTravailAFairePeer::buildTableMap();
