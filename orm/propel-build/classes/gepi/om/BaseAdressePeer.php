...
abstract class BaseAdressePeer
{
     ...
     * e.g. AdressePeer::$fieldNames[AdressePeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (AdressePeer::ADR_ID, AdressePeer::ADR1, AdressePeer::ADR2, AdressePeer::ADR3, AdressePeer::ADR4, AdressePeer::CP, AdressePeer::PAYS, AdressePeer::COMMUNE, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. AdressePeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (AdressePeer::ADR_ID => 0, AdressePeer::ADR1 => 1, AdressePeer::ADR2 => 2, AdressePeer::ADR3 => 3, AdressePeer::ADR4 => 4, AdressePeer::CP => 5, AdressePeer::PAYS => 6, AdressePeer::COMMUNE => 7, ),
    ...
    {
        $toNames = AdressePeer::getFieldNames($toType);
        $key = isset(AdressePeer::$fieldKeys[$fromType][$name]) ? AdressePeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(AdressePeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, AdressePeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return AdressePeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(AdressePeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(AdressePeer::DATABASE_NAME);
     ...
     *
     * @param      Adresse $obj A Adresse object.
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(AdressePeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(AdressePeer::$instances[$key])) {
                return AdressePeer::$instances[$key];
            }
        }
    ...
    {
        return Propel::getDatabaseMap(AdressePeer::DATABASE_NAME)->getTable(AdressePeer::TABLE_NAME);
    }
