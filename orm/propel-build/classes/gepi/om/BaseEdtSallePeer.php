...
/**
 * Base static class for performing query and update operations on the 'salle_cours' table.
 *
...
abstract class BaseEdtSallePeer
{
    ...
    /** the column name for the NUMERO_SALLE field */
    const NUMERO_SALLE = 'salle_cours.NUMERO_SALLE';
     ...
     * e.g. EdtSallePeer::$fieldNames[EdtSallePeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (EdtSallePeer::ID_SALLE, EdtSallePeer::NUMERO_SALLE, EdtSallePeer::NOM_SALLE, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. EdtSallePeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (EdtSallePeer::ID_SALLE => 0, EdtSallePeer::NUMERO_SALLE => 1, EdtSallePeer::NOM_SALLE => 2, ),
    ...
    {
        $toNames = EdtSallePeer::getFieldNames($toType);
        $key = isset(EdtSallePeer::$fieldKeys[$fromType][$name]) ? EdtSallePeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(EdtSallePeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, EdtSallePeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return EdtSallePeer::$fieldNames[$type];
    }
     ...
     * @param      string $column The column name for current table. (i.e. EdtSallePeer::COLUMN_NAME).
     * @return string
     */
    public static function alias($alias, $column)
    {
        return str_replace(EdtSallePeer::TABLE_NAME.'.', $alias.'.', $column);
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setPrimaryTableName(EdtSallePeer::TABLE_NAME);
        ...
        $criteria->setDbName(EdtSallePeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectOne(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $critcopy->setLimit(1);
        $objects = EdtSallePeer::doSelect($critcopy, $con);
        if ($objects) {
            return $objects[0];
        }
    ...
    {
        return EdtSallePeer::populateObjects(EdtSallePeer::doSelectStmt($criteria, $con));
    }
    /**
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(EdtSallePeer::DATABASE_NAME);
     ...
     *
     * @param      EdtSalle $obj A EdtSalle object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if ($key === null) {
                $key = (string) $obj->getIdSalle();
            } // if key === null
            EdtSallePeer::$instances[$key] = $obj;
        }
    }
     ...
     *
     * @param      mixed $value A EdtSalle object or a primary key value.
     *
     * @return void
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof EdtSalle) {
                $key = (string) $value->getIdSalle();
            } elseif (is_scalar($value)) {
                // assume we've been passed a primary key
                $key = (string) $value;
            } else {
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or EdtSalle object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
                throw $e;
            }

            unset(EdtSallePeer::$instances[$key]);
        }
     ...
     * @return   EdtSalle Found object or null if 1) no instance exists for specified key or 2) instance pooling has been disabled.
     * @see        getPrimaryKeyHash()
     */
    public static function getInstanceFromPool($key)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(EdtSallePeer::$instances[$key])) {
                return EdtSallePeer::$instances[$key];
            }
        }
    ...
    {
        return Propel::getDatabaseMap(EdtSallePeer::DATABASE_NAME)->getTable(EdtSallePeer::TABLE_NAME);
    }
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria = $values->buildCriteria(); // build Criteria from EdtSalle object
        }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(EdtSallePeer::DATABASE_NAME);
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $affectedRows += BasePeer::doDeleteAll(EdtSallePeer::TABLE_NAME, $con, EdtSallePeer::DATABASE_NAME);
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        try {
            ...
            $c = clone $criteria;
            EdtSallePeer::doOnDeleteSetNull($c, $con);
    ...
    protected static function doOnDeleteSetNull(Criteria $criteria, PropelPDO $con)
    {
        ...
        $objects = EdtSallePeer::doSelect($criteria, $con);
        foreach ($objects as $obj) {

            // set fkey col in related EdtEmplacementCours rows to null
            $selectCriteria = new Criteria(EdtSallePeer::DATABASE_NAME);
            $updateValues = new Criteria(EdtSallePeer::DATABASE_NAME);
            $selectCriteria->add(EdtEmplacementCoursPeer::ID_SALLE, $obj->getIdSalle());
            $updateValues->add(EdtEmplacementCoursPeer::ID_SALLE, null);
    ...
    /**
     * Validates all modified columns of given EdtSalle object.
     * If parameter $columns is either a single column name or an array of column names
     * than only those columns are validated.
     *
     * NOTICE: This does not apply to primary or foreign keys for now.
     *
     * @param      EdtSalle $obj The object to validate.
    ...
    public static function doValidate($obj, $cols = null)
    {
        ...
        if ($cols) {
            $dbMap = Propel::getDatabaseMap(EdtSallePeer::DATABASE_NAME);
            $tableMap = $dbMap->getTable(EdtSallePeer::TABLE_NAME);
        ...
        return BasePeer::doValidate(EdtSallePeer::DATABASE_NAME, EdtSallePeer::TABLE_NAME, $columns);
    }
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        if (null !== ($obj = EdtSallePeer::getInstanceFromPool((string) $pk))) {
            return $obj;
        }
        ...
        $criteria = new Criteria(EdtSallePeer::DATABASE_NAME);
        $criteria->add(EdtSallePeer::ID_SALLE, $pk);

        $v = EdtSallePeer::doSelect($criteria, $con);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(EdtSallePeer::DATABASE_NAME);
            $criteria->add(EdtSallePeer::ID_SALLE, $pks, Criteria::IN);
            $objs = EdtSallePeer::doSelect($criteria, $con);
        }
