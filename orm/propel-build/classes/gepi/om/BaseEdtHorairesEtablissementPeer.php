...
abstract class BaseEdtHorairesEtablissementPeer
{
     ...
     * e.g. EdtHorairesEtablissementPeer::$fieldNames[EdtHorairesEtablissementPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (EdtHorairesEtablissementPeer::ID_HORAIRE_ETABLISSEMENT, EdtHorairesEtablissementPeer::DATE_HORAIRE_ETABLISSEMENT, EdtHorairesEtablissementPeer::JOUR_HORAIRE_ETABLISSEMENT, EdtHorairesEtablissementPeer::OUVERTURE_HORAIRE_ETABLISSEMENT, EdtHorairesEtablissementPeer::FERMETURE_HORAIRE_ETABLISSEMENT, EdtHorairesEtablissementPeer::PAUSE_HORAIRE_ETABLISSEMENT, EdtHorairesEtablissementPeer::OUVERT_HORAIRE_ETABLISSEMENT, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. EdtHorairesEtablissementPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (EdtHorairesEtablissementPeer::ID_HORAIRE_ETABLISSEMENT => 0, EdtHorairesEtablissementPeer::DATE_HORAIRE_ETABLISSEMENT => 1, EdtHorairesEtablissementPeer::JOUR_HORAIRE_ETABLISSEMENT => 2, EdtHorairesEtablissementPeer::OUVERTURE_HORAIRE_ETABLISSEMENT => 3, EdtHorairesEtablissementPeer::FERMETURE_HORAIRE_ETABLISSEMENT => 4, EdtHorairesEtablissementPeer::PAUSE_HORAIRE_ETABLISSEMENT => 5, EdtHorairesEtablissementPeer::OUVERT_HORAIRE_ETABLISSEMENT => 6, ),
    ...
    {
        $toNames = EdtHorairesEtablissementPeer::getFieldNames($toType);
        $key = isset(EdtHorairesEtablissementPeer::$fieldKeys[$fromType][$name]) ? EdtHorairesEtablissementPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(EdtHorairesEtablissementPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, EdtHorairesEtablissementPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return EdtHorairesEtablissementPeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(EdtHorairesEtablissementPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(EdtHorairesEtablissementPeer::DATABASE_NAME);
     ...
     *
     * @param      EdtHorairesEtablissement $obj A EdtHorairesEtablissement object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            EdtHorairesEtablissementPeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(EdtHorairesEtablissementPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(EdtHorairesEtablissementPeer::$instances[$key])) {
                return EdtHorairesEtablissementPeer::$instances[$key];
            }
        }
    ...
    {
        EdtHorairesEtablissementPeer::$instances = array();
    }
    ...
    public static function populateObjects(PDOStatement $stmt)
    {
        ...
        $cls = EdtHorairesEtablissementPeer::getOMClass();
    ...
    {
        return Propel::getDatabaseMap(EdtHorairesEtablissementPeer::DATABASE_NAME)->getTable(EdtHorairesEtablissementPeer::TABLE_NAME);
    }
    ...
    {
        return EdtHorairesEtablissementPeer::OM_CLASS;
    }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(EdtHorairesEtablissementPeer::DATABASE_NAME);
