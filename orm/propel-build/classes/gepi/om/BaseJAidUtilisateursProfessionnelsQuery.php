...
abstract class BaseJAidUtilisateursProfessionnelsQuery extends ModelCriteria
{
     ...
     * @param     JAidUtilisateursProfessionnelsQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     * @param array $key Primary key to use for the query
                         A Primary key composition: [$id_aid, $id_utilisateur]
     * @param     PropelPDO $con an optional connection object
     *
     * @return   JAidUtilisateursProfessionnels|JAidUtilisateursProfessionnels[]|mixed the result, formatted by the current formatter
     */
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|JAidUtilisateursProfessionnels[]|mixed the list of results, formatted by the current formatter
     */
