...
abstract class BaseAbsenceEleveNotificationQuery extends ModelCriteria
{
     ...
     * @param     AbsenceEleveNotificationQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     *
     * @return   AbsenceEleveNotification|AbsenceEleveNotification[]|mixed the result, formatted by the current formatter
     */
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|AbsenceEleveNotification[]|mixed the list of results, formatted by the current formatter
     */
     ...
     *
     * @param   AbsenceEleveTraitement|PropelObjectCollection $absenceEleveTraitement The related object(s) to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   AbsenceEleveNotificationQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
     ...
     *
     * @param   Adresse|PropelObjectCollection $adresse The related object(s) to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   AbsenceEleveNotificationQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
     ...
     *
     * @param   JNotificationResponsableEleve|PropelObjectCollection $jNotificationResponsableEleve  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   AbsenceEleveNotificationQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByJNotificationResponsableEleve($jNotificationResponsableEleve, $comparison = null)
    {
        ...
        } elseif ($jNotificationResponsableEleve instanceof PropelObjectCollection) {
            return $this
