...
abstract class BaseCahierTexteTravailAFaireQuery extends ModelCriteria
{
     ...
     * @param     CahierTexteTravailAFaireQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     *
     * @return   CahierTexteTravailAFaire|CahierTexteTravailAFaire[]|mixed the result, formatted by the current formatter
     */
     ...
     */
     public function findOneByIdCt($key, $con = null)
     {
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|CahierTexteTravailAFaire[]|mixed the list of results, formatted by the current formatter
     */
     ...
     *
     * @param   CahierTexteSequence|PropelObjectCollection $cahierTexteSequence The related object(s) to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   CahierTexteTravailAFaireQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByCahierTexteSequence($cahierTexteSequence, $comparison = null)
    {
        ...
        } elseif ($cahierTexteSequence instanceof PropelObjectCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }
     ...
     *
     * @param   CahierTexteTravailAFaireFichierJoint|PropelObjectCollection $cahierTexteTravailAFaireFichierJoint  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   CahierTexteTravailAFaireQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByCahierTexteTravailAFaireFichierJoint($cahierTexteTravailAFaireFichierJoint, $comparison = null)
    {
        ...
        } elseif ($cahierTexteTravailAFaireFichierJoint instanceof PropelObjectCollection) {
            return $this
