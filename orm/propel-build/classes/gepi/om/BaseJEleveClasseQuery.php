...
abstract class BaseJEleveClasseQuery extends ModelCriteria
{
     ...
     * @param     JEleveClasseQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     * @param array $key Primary key to use for the query
                         A Primary key composition: [$login, $id_classe, $periode]
     * @param     PropelPDO $con an optional connection object
     *
     * @return   JEleveClasse|JEleveClasse[]|mixed the result, formatted by the current formatter
     */
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|JEleveClasse[]|mixed the list of results, formatted by the current formatter
     */
