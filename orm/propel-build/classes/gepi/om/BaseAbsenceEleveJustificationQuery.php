...
abstract class BaseAbsenceEleveJustificationQuery extends ModelCriteria
{
     ...
     * @param     AbsenceEleveJustificationQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     *
     * @return   AbsenceEleveJustification|AbsenceEleveJustification[]|mixed the result, formatted by the current formatter
     */
    public function findPk($key, $con = null)
    {
        ...
        if ((null !== ($obj = AbsenceEleveJustificationPeer::getInstanceFromPool((string) $key))) && !$this->formatter) {
     ...
     *
     * @return   AbsenceEleveJustification A model object, or null if the key is not found
    ...
    {
        $sql = 'SELECT ID, NOM, COMMENTAIRE, SORTABLE_RANK, CREATED_AT, UPDATED_AT FROM a_justifications WHERE ID = :p0';
        try {
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|AbsenceEleveJustification[]|mixed the list of results, formatted by the current formatter
     */
