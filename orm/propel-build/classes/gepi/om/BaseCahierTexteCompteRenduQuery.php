...
abstract class BaseCahierTexteCompteRenduQuery extends ModelCriteria
{
     ...
     * @param     CahierTexteCompteRenduQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     *
     * @return   CahierTexteCompteRendu|CahierTexteCompteRendu[]|mixed the result, formatted by the current formatter
     */
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|CahierTexteCompteRendu[]|mixed the list of results, formatted by the current formatter
     */
     ...
     *
     * @param   CahierTexteCompteRenduFichierJoint|PropelObjectCollection $cahierTexteCompteRenduFichierJoint  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   CahierTexteCompteRenduQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByCahierTexteCompteRenduFichierJoint($cahierTexteCompteRenduFichierJoint, $comparison = null)
    {
        ...
        } elseif ($cahierTexteCompteRenduFichierJoint instanceof PropelObjectCollection) {
            return $this
