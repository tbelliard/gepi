...
abstract class BaseUtilisateurProfessionnelPeer
{
     ...
     * e.g. UtilisateurProfessionnelPeer::$fieldNames[UtilisateurProfessionnelPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (UtilisateurProfessionnelPeer::LOGIN, UtilisateurProfessionnelPeer::NOM, UtilisateurProfessionnelPeer::PRENOM, UtilisateurProfessionnelPeer::CIVILITE, UtilisateurProfessionnelPeer::PASSWORD, UtilisateurProfessionnelPeer::SALT, UtilisateurProfessionnelPeer::EMAIL, UtilisateurProfessionnelPeer::SHOW_EMAIL, UtilisateurProfessionnelPeer::STATUT, UtilisateurProfessionnelPeer::ETAT, UtilisateurProfessionnelPeer::CHANGE_MDP, UtilisateurProfessionnelPeer::DATE_VERROUILLAGE, UtilisateurProfessionnelPeer::PASSWORD_TICKET, UtilisateurProfessionnelPeer::TICKET_EXPIRATION, UtilisateurProfessionnelPeer::NIVEAU_ALERTE, UtilisateurProfessionnelPeer::OBSERVATION_SECURITE, UtilisateurProfessionnelPeer::TEMP_DIR, UtilisateurProfessionnelPeer::NUMIND, UtilisateurProfessionnelPeer::AUTH_MODE, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. UtilisateurProfessionnelPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (UtilisateurProfessionnelPeer::LOGIN => 0, UtilisateurProfessionnelPeer::NOM => 1, UtilisateurProfessionnelPeer::PRENOM => 2, UtilisateurProfessionnelPeer::CIVILITE => 3, UtilisateurProfessionnelPeer::PASSWORD => 4, UtilisateurProfessionnelPeer::SALT => 5, UtilisateurProfessionnelPeer::EMAIL => 6, UtilisateurProfessionnelPeer::SHOW_EMAIL => 7, UtilisateurProfessionnelPeer::STATUT => 8, UtilisateurProfessionnelPeer::ETAT => 9, UtilisateurProfessionnelPeer::CHANGE_MDP => 10, UtilisateurProfessionnelPeer::DATE_VERROUILLAGE => 11, UtilisateurProfessionnelPeer::PASSWORD_TICKET => 12, UtilisateurProfessionnelPeer::TICKET_EXPIRATION => 13, UtilisateurProfessionnelPeer::NIVEAU_ALERTE => 14, UtilisateurProfessionnelPeer::OBSERVATION_SECURITE => 15, UtilisateurProfessionnelPeer::TEMP_DIR => 16, UtilisateurProfessionnelPeer::NUMIND => 17, UtilisateurProfessionnelPeer::AUTH_MODE => 18, ),
    ...
    {
        $toNames = UtilisateurProfessionnelPeer::getFieldNames($toType);
        $key = isset(UtilisateurProfessionnelPeer::$fieldKeys[$fromType][$name]) ? UtilisateurProfessionnelPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(UtilisateurProfessionnelPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, UtilisateurProfessionnelPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return UtilisateurProfessionnelPeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(UtilisateurProfessionnelPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(UtilisateurProfessionnelPeer::DATABASE_NAME);
     ...
     *
     * @param      UtilisateurProfessionnel $obj A UtilisateurProfessionnel object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            UtilisateurProfessionnelPeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(UtilisateurProfessionnelPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(UtilisateurProfessionnelPeer::$instances[$key])) {
                return UtilisateurProfessionnelPeer::$instances[$key];
            }
        }
    ...
    {
        UtilisateurProfessionnelPeer::$instances = array();
    }
    ...
    {
        return Propel::getDatabaseMap(UtilisateurProfessionnelPeer::DATABASE_NAME)->getTable(UtilisateurProfessionnelPeer::TABLE_NAME);
    }
    ...
    {
        return UtilisateurProfessionnelPeer::OM_CLASS;
    }
