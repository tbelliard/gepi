...
abstract class BaseClasseQuery extends ModelCriteria
{
     ...
     * @param     ClasseQuery|Criteria $criteria Optional Criteria to build the query from
     *
     * @return ClasseQuery
     */
     ...
     *
     * @return   Classe|Classe[]|mixed the result, formatted by the current formatter
     */
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|Classe[]|mixed the list of results, formatted by the current formatter
     */
     ...
     *
     * @param   PeriodeNote|PropelObjectCollection $periodeNote  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   ClasseQuery The current query, for fluid interface
    ...
    public function filterByPeriodeNote($periodeNote, $comparison = null)
    {
        ...
        } elseif ($periodeNote instanceof PropelObjectCollection) {
            return $this
                ->usePeriodeNoteQuery()
     ...
     *
     * @param   JGroupesClasses|PropelObjectCollection $jGroupesClasses  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   ClasseQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByJGroupesClasses($jGroupesClasses, $comparison = null)
    {
        ...
        } elseif ($jGroupesClasses instanceof PropelObjectCollection) {
            return $this
     ...
     *
     * @param   JEleveClasse|PropelObjectCollection $jEleveClasse  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   ClasseQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByJEleveClasse($jEleveClasse, $comparison = null)
    {
        ...
        } elseif ($jEleveClasse instanceof PropelObjectCollection) {
            return $this
     ...
     *
     * @param   JCategoriesMatieresClasses|PropelObjectCollection $jCategoriesMatieresClasses  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   ClasseQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByJCategoriesMatieresClasses($jCategoriesMatieresClasses, $comparison = null)
    {
        ...
        } elseif ($jCategoriesMatieresClasses instanceof PropelObjectCollection) {
            return $this
