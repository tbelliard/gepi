...
abstract class BaseEleveQuery extends ModelCriteria
{
     ...
     * @param     EleveQuery|Criteria $criteria Optional Criteria to build the query from
     *
     * @return EleveQuery
     */
     ...
     *
     * @return   Eleve|Eleve[]|mixed the result, formatted by the current formatter
     */
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|Eleve[]|mixed the list of results, formatted by the current formatter
     */
     ...
     *
     * @param   Mef|PropelObjectCollection $mef The related object(s) to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   EleveQuery The current query, for fluid interface
    ...
    public function filterByMef($mef, $comparison = null)
    {
        ...
        } elseif ($mef instanceof PropelObjectCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }
     ...
     *
     * @param   JEleveGroupe|PropelObjectCollection $jEleveGroupe  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   EleveQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByJEleveGroupe($jEleveGroupe, $comparison = null)
    {
        ...
        } elseif ($jEleveGroupe instanceof PropelObjectCollection) {
            return $this
     ...
     *
     * @param   EleveRegimeDoublant|PropelObjectCollection $eleveRegimeDoublant  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   EleveQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByEleveRegimeDoublant($eleveRegimeDoublant, $comparison = null)
    {
        ...
        } elseif ($eleveRegimeDoublant instanceof PropelObjectCollection) {
            return $this
     ...
     *
     * @param   AbsenceAgregationDecompte|PropelObjectCollection $absenceAgregationDecompte  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   EleveQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByAbsenceAgregationDecompte($absenceAgregationDecompte, $comparison = null)
    {
        ...
        } elseif ($absenceAgregationDecompte instanceof PropelObjectCollection) {
            return $this
     ...
     *
     * @param   CreditEcts|PropelObjectCollection $creditEcts  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   EleveQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByCreditEcts($creditEcts, $comparison = null)
    {
        ...
        } elseif ($creditEcts instanceof PropelObjectCollection) {
            return $this
                ->useCreditEctsQuery()
     ...
     *
     * @param   CreditEctsGlobal|PropelObjectCollection $creditEctsGlobal  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   EleveQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByCreditEctsGlobal($creditEctsGlobal, $comparison = null)
    {
        ...
        } elseif ($creditEctsGlobal instanceof PropelObjectCollection) {
            return $this
     ...
     *
     * @param   ArchiveEcts|PropelObjectCollection $archiveEcts  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   EleveQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByArchiveEcts($archiveEcts, $comparison = null)
    {
        ...
        } elseif ($archiveEcts instanceof PropelObjectCollection) {
            return $this
                ->useArchiveEctsQuery()
