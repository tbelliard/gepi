...
abstract class BasePreferenceUtilisateurProfessionnelQuery extends ModelCriteria
{
     ...
     * @param     PreferenceUtilisateurProfessionnelQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     * @param array $key Primary key to use for the query
                         A Primary key composition: [$name, $login]
     * @param     PropelPDO $con an optional connection object
     *
     * @return   PreferenceUtilisateurProfessionnel|PreferenceUtilisateurProfessionnel[]|mixed the result, formatted by the current formatter
     */
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|PreferenceUtilisateurProfessionnel[]|mixed the list of results, formatted by the current formatter
     */
