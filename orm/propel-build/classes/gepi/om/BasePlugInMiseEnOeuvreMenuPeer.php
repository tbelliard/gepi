...
abstract class BasePlugInMiseEnOeuvreMenuPeer
{
    ...
    const PLUGIN_ID = 'plugins_menus.PLUGIN_ID';

    /** the column name for the USER_STATUT field */
    const USER_STATUT = 'plugins_menus.USER_STATUT';

    /** the column name for the TITRE_ITEM field */
    const TITRE_ITEM = 'plugins_menus.TITRE_ITEM';

    /** the column name for the LIEN_ITEM field */
    const LIEN_ITEM = 'plugins_menus.LIEN_ITEM';
     ...
     * queries.
     * @var        array PlugInMiseEnOeuvreMenu[]
     */
     ...
     * e.g. PlugInMiseEnOeuvreMenuPeer::$fieldNames[PlugInMiseEnOeuvreMenuPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (PlugInMiseEnOeuvreMenuPeer::ID, PlugInMiseEnOeuvreMenuPeer::PLUGIN_ID, PlugInMiseEnOeuvreMenuPeer::USER_STATUT, PlugInMiseEnOeuvreMenuPeer::TITRE_ITEM, PlugInMiseEnOeuvreMenuPeer::LIEN_ITEM, PlugInMiseEnOeuvreMenuPeer::DESCRIPTION_ITEM, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. PlugInMiseEnOeuvreMenuPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (PlugInMiseEnOeuvreMenuPeer::ID => 0, PlugInMiseEnOeuvreMenuPeer::PLUGIN_ID => 1, PlugInMiseEnOeuvreMenuPeer::USER_STATUT => 2, PlugInMiseEnOeuvreMenuPeer::TITRE_ITEM => 3, PlugInMiseEnOeuvreMenuPeer::LIEN_ITEM => 4, PlugInMiseEnOeuvreMenuPeer::DESCRIPTION_ITEM => 5, ),
    ...
    {
        $toNames = PlugInMiseEnOeuvreMenuPeer::getFieldNames($toType);
        $key = isset(PlugInMiseEnOeuvreMenuPeer::$fieldKeys[$fromType][$name]) ? PlugInMiseEnOeuvreMenuPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(PlugInMiseEnOeuvreMenuPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, PlugInMiseEnOeuvreMenuPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return PlugInMiseEnOeuvreMenuPeer::$fieldNames[$type];
    }
     ...
     * @param      string $column The column name for current table. (i.e. PlugInMiseEnOeuvreMenuPeer::COLUMN_NAME).
     * @return string
     */
    public static function alias($alias, $column)
    {
        return str_replace(PlugInMiseEnOeuvreMenuPeer::TABLE_NAME.'.', $alias.'.', $column);
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setPrimaryTableName(PlugInMiseEnOeuvreMenuPeer::TABLE_NAME);
        ...
        $criteria->setDbName(PlugInMiseEnOeuvreMenuPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectOne(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $critcopy->setLimit(1);
        $objects = PlugInMiseEnOeuvreMenuPeer::doSelect($critcopy, $con);
        if ($objects) {
            return $objects[0];
        }
    ...
    {
        return PlugInMiseEnOeuvreMenuPeer::populateObjects(PlugInMiseEnOeuvreMenuPeer::doSelectStmt($criteria, $con));
    }
    /**
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(PlugInMiseEnOeuvreMenuPeer::DATABASE_NAME);
     ...
     *
     * @param      PlugInMiseEnOeuvreMenu $obj A PlugInMiseEnOeuvreMenu object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            PlugInMiseEnOeuvreMenuPeer::$instances[$key] = $obj;
        }
    }
     ...
     *
     * @param      mixed $value A PlugInMiseEnOeuvreMenu object or a primary key value.
     *
     * @return void
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof PlugInMiseEnOeuvreMenu) {
                $key = (string) $value->getId();
            } elseif (is_scalar($value)) {
                // assume we've been passed a primary key
                $key = (string) $value;
            } else {
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or PlugInMiseEnOeuvreMenu object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
                throw $e;
            }

            unset(PlugInMiseEnOeuvreMenuPeer::$instances[$key]);
        }
     ...
     * @return   PlugInMiseEnOeuvreMenu Found object or null if 1) no instance exists for specified key or 2) instance pooling has been disabled.
     * @see        getPrimaryKeyHash()
     */
    public static function getInstanceFromPool($key)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(PlugInMiseEnOeuvreMenuPeer::$instances[$key])) {
                return PlugInMiseEnOeuvreMenuPeer::$instances[$key];
            }
        }
    ...
    {
        PlugInMiseEnOeuvreMenuPeer::$instances = array();
    }
    ...
    public static function doSelectJoinPlugIn(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (PlugInMiseEnOeuvreMenu) to $obj2 (PlugIn)
                $obj2->addPlugInMiseEnOeuvreMenu($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (PlugInMiseEnOeuvreMenu) to the collection in $obj2 (PlugIn)
                $obj2->addPlugInMiseEnOeuvreMenu($obj1);
    ...
    {
        return Propel::getDatabaseMap(PlugInMiseEnOeuvreMenuPeer::DATABASE_NAME)->getTable(PlugInMiseEnOeuvreMenuPeer::TABLE_NAME);
    }
    ...
    {
        return PlugInMiseEnOeuvreMenuPeer::OM_CLASS;
    }
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria = $values->buildCriteria(); // build Criteria from PlugInMiseEnOeuvreMenu object
        }

        if ($criteria->containsKey(PlugInMiseEnOeuvreMenuPeer::ID) && $criteria->keyContainsValue(PlugInMiseEnOeuvreMenuPeer::ID) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(PlugInMiseEnOeuvreMenuPeer::DATABASE_NAME);
    ...
    /**
     * Validates all modified columns of given PlugInMiseEnOeuvreMenu object.
     * If parameter $columns is either a single column name or an array of column names
     * than only those columns are validated.
     *
     * NOTICE: This does not apply to primary or foreign keys for now.
     *
     * @param      PlugInMiseEnOeuvreMenu $obj The object to validate.
    ...
    public static function doValidate($obj, $cols = null)
    {
        ...
        if ($cols) {
            $dbMap = Propel::getDatabaseMap(PlugInMiseEnOeuvreMenuPeer::DATABASE_NAME);
            $tableMap = $dbMap->getTable(PlugInMiseEnOeuvreMenuPeer::TABLE_NAME);
        ...
        return BasePeer::doValidate(PlugInMiseEnOeuvreMenuPeer::DATABASE_NAME, PlugInMiseEnOeuvreMenuPeer::TABLE_NAME, $columns);
    }
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        if (null !== ($obj = PlugInMiseEnOeuvreMenuPeer::getInstanceFromPool((string) $pk))) {
            return $obj;
        }
        ...
        $criteria = new Criteria(PlugInMiseEnOeuvreMenuPeer::DATABASE_NAME);
        $criteria->add(PlugInMiseEnOeuvreMenuPeer::ID, $pk);

        $v = PlugInMiseEnOeuvreMenuPeer::doSelect($criteria, $con);
