...
abstract class BaseJTraitementSaisieEleveQuery extends ModelCriteria
{
     ...
     * @param     JTraitementSaisieEleveQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     * @param array $key Primary key to use for the query
                         A Primary key composition: [$a_saisie_id, $a_traitement_id]
     * @param     PropelPDO $con an optional connection object
     *
     * @return   JTraitementSaisieEleve|JTraitementSaisieEleve[]|mixed the result, formatted by the current formatter
     */
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|JTraitementSaisieEleve[]|mixed the list of results, formatted by the current formatter
     */
     ...
     *
     * @param   AbsenceEleveSaisie|PropelObjectCollection $absenceEleveSaisie The related object(s) to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   JTraitementSaisieEleveQuery The current query, for fluid interface
