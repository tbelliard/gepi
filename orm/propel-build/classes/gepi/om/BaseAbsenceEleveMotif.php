...
/**
 * Base class that represents a row from the 'a_motifs' table.
 *
 * Liste des motifs possibles pour une absence
 *
 * @package    propel.generator.gepi.om
 */
abstract class BaseAbsenceEleveMotif extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'AbsenceEleveMotifPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        AbsenceEleveMotifPeer
     */
    ...
    public function setNom($v)
    {
        ...
        if ($this->nom !== $v) {
            $this->nom = $v;
            $this->modifiedColumns[] = AbsenceEleveMotifPeer::NOM;
        }
    ...
    public function setCommentaire($v)
    {
        ...
        if ($this->commentaire !== $v) {
            $this->commentaire = $v;
            $this->modifiedColumns[] = AbsenceEleveMotifPeer::COMMENTAIRE;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = AbsenceEleveMotifPeer::CREATED_AT;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 6; // 6 = AbsenceEleveMotifPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = AbsenceEleveMotifPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(AbsenceEleveMotifPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                AbsenceEleveMotifPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = AbsenceEleveMotifPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = AbsenceEleveMotifPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AbsenceEleveMotifPeer::CREATED_AT)) $criteria->add(AbsenceEleveMotifPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(AbsenceEleveMotifPeer::UPDATED_AT)) $criteria->add(AbsenceEleveMotifPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(AbsenceEleveMotifPeer::DATABASE_NAME);
        $criteria->add(AbsenceEleveMotifPeer::ID, $this->id);
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return AbsenceEleveMotif Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return AbsenceEleveMotifPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new AbsenceEleveMotifPeer();
        }
     ...
     * If this AbsenceEleveMotif is new, it will return
        ...
        if (null === $this->collAbsenceEleveTraitements || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collAbsenceEleveTraitements) {
                ...
                $collAbsenceEleveTraitements = AbsenceEleveTraitementQuery::create(null, $criteria)
                    ->filterByAbsenceEleveMotif($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function setAbsenceEleveTraitements(PropelCollection $absenceEleveTraitements, PropelPDO $con = null)
    {
        ...
        foreach ($this->absenceEleveTraitementsScheduledForDeletion as $absenceEleveTraitementRemoved) {
            $absenceEleveTraitementRemoved->setAbsenceEleveMotif(null);
        }
    ...
    public function removeAbsenceEleveTraitement($absenceEleveTraitement)
    {
        if ($this->getAbsenceEleveTraitements()->contains($absenceEleveTraitement)) {
            ...
            $absenceEleveTraitement->setAbsenceEleveMotif(null);
        }
    }
     ...
     * Otherwise if this AbsenceEleveMotif is new, it will return
     * an empty collection; or if this AbsenceEleveMotif has previously
     * been saved, it will retrieve related AbsenceEleveTraitements from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in AbsenceEleveMotif.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
