...
abstract class BaseAbsenceEleveSaisie extends BaseObject implements Persistent
{
    ...
    /**
     * @var        PropelObjectCollection|JTraitementSaisieEleve[] Collection to store aggregation of JTraitementSaisieEleve objects.
     */
    protected $collJTraitementSaisieEleves;
    protected $collJTraitementSaisieElevesPartial;

    /**
     * @var        PropelObjectCollection|AbsenceEleveSaisieVersion[] Collection to store aggregation of AbsenceEleveSaisieVersion objects.
     */
    protected $collAbsenceEleveSaisieVersions;
    protected $collAbsenceEleveSaisieVersionsPartial;

    /**
     * @var        PropelObjectCollection|AbsenceEleveTraitement[] Collection to store aggregation of AbsenceEleveTraitement objects.
     */
     ...
     * @var		PropelObjectCollection
     */
    protected $absenceEleveSaisieVersionsScheduledForDeletion = null;
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->absenceEleveTraitementsScheduledForDeletion !== null) {
                if (!$this->absenceEleveTraitementsScheduledForDeletion->isEmpty()) {
                    ...
                    foreach ($this->absenceEleveTraitementsScheduledForDeletion->getPrimaryKeys(false) as $remotePk) {
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(AbsenceEleveSaisiePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(AbsenceEleveSaisiePeer::UTILISATEUR_ID)) {
            $modifiedColumns[':p' . $index++]  = 'UTILISATEUR_ID';
        }
        if ($this->isColumnModified(AbsenceEleveSaisiePeer::ELEVE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'ELEVE_ID';
        }
        if ($this->isColumnModified(AbsenceEleveSaisiePeer::COMMENTAIRE)) {
            $modifiedColumns[':p' . $index++]  = 'COMMENTAIRE';
        }
        if ($this->isColumnModified(AbsenceEleveSaisiePeer::DEBUT_ABS)) {
            $modifiedColumns[':p' . $index++]  = 'DEBUT_ABS';
        }
        if ($this->isColumnModified(AbsenceEleveSaisiePeer::FIN_ABS)) {
            $modifiedColumns[':p' . $index++]  = 'FIN_ABS';
        }
        if ($this->isColumnModified(AbsenceEleveSaisiePeer::ID_EDT_CRENEAU)) {
            $modifiedColumns[':p' . $index++]  = 'ID_EDT_CRENEAU';
        }
        if ($this->isColumnModified(AbsenceEleveSaisiePeer::ID_EDT_EMPLACEMENT_COURS)) {
            $modifiedColumns[':p' . $index++]  = 'ID_EDT_EMPLACEMENT_COURS';
        }
        if ($this->isColumnModified(AbsenceEleveSaisiePeer::ID_GROUPE)) {
            $modifiedColumns[':p' . $index++]  = 'ID_GROUPE';
        }
        if ($this->isColumnModified(AbsenceEleveSaisiePeer::ID_CLASSE)) {
            $modifiedColumns[':p' . $index++]  = 'ID_CLASSE';
        }
        if ($this->isColumnModified(AbsenceEleveSaisiePeer::ID_AID)) {
            $modifiedColumns[':p' . $index++]  = 'ID_AID';
        }
        if ($this->isColumnModified(AbsenceEleveSaisiePeer::ID_S_INCIDENTS)) {
            $modifiedColumns[':p' . $index++]  = 'ID_S_INCIDENTS';
        }
        if ($this->isColumnModified(AbsenceEleveSaisiePeer::ID_LIEU)) {
            $modifiedColumns[':p' . $index++]  = 'ID_LIEU';
        }
        if ($this->isColumnModified(AbsenceEleveSaisiePeer::DELETED_BY)) {
        ...
        if ($this->isColumnModified(AbsenceEleveSaisiePeer::DELETED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'DELETED_AT';
        }
        if ($this->isColumnModified(AbsenceEleveSaisiePeer::VERSION)) {
            $modifiedColumns[':p' . $index++]  = 'VERSION';
        }
        if ($this->isColumnModified(AbsenceEleveSaisiePeer::VERSION_CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'VERSION_CREATED_AT';
        }
        if ($this->isColumnModified(AbsenceEleveSaisiePeer::VERSION_CREATED_BY)) {
            $modifiedColumns[':p' . $index++]  = 'VERSION_CREATED_BY';
        }

        $sql = sprintf(
            'INSERT INTO a_saisies (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'COMMENTAIRE':
                        ...
                        break;
                    case 'DEBUT_ABS':
                        $stmt->bindValue($identifier, $this->debut_abs, PDO::PARAM_STR);
                        break;
                    case 'FIN_ABS':
                        $stmt->bindValue($identifier, $this->fin_abs, PDO::PARAM_STR);
                        break;
                    case 'ID_EDT_CRENEAU':
                        $stmt->bindValue($identifier, $this->id_edt_creneau, PDO::PARAM_INT);
                        break;
                    case 'ID_EDT_EMPLACEMENT_COURS':
                        $stmt->bindValue($identifier, $this->id_edt_emplacement_cours, PDO::PARAM_INT);
                        break;
                    case 'ID_GROUPE':
                    ...
                    case 'ID_CLASSE':
                        ...
                        break;
                    case 'ID_AID':
                        $stmt->bindValue($identifier, $this->id_aid, PDO::PARAM_INT);
                        break;
                    case 'ID_S_INCIDENTS':
                        $stmt->bindValue($identifier, $this->id_s_incidents, PDO::PARAM_INT);
                        break;
                    case 'ID_LIEU':
                        $stmt->bindValue($identifier, $this->id_lieu, PDO::PARAM_INT);
                        break;
                    case 'DELETED_BY':
    ...
    public function clearJTraitementSaisieEleves()
    {
        ...
        $this->collJTraitementSaisieElevesPartial = null;
    }

    /**
     * reset is the collJTraitementSaisieEleves collection loaded partially
     *
     * @return void
     */
    public function resetPartialJTraitementSaisieEleves($v = true)
    {
        $this->collJTraitementSaisieElevesPartial = $v;
    }
     ...
     * @param PropelPDO $con optional connection object
     * @return PropelObjectCollection|JTraitementSaisieEleve[] List of JTraitementSaisieEleve objects
     * @throws PropelException
     */
    public function getJTraitementSaisieEleves($criteria = null, PropelPDO $con = null)
    {
        $partial = $this->collJTraitementSaisieElevesPartial && !$this->isNew();
        if (null === $this->collJTraitementSaisieEleves || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collJTraitementSaisieEleves) {
                ...
                $collJTraitementSaisieEleves = JTraitementSaisieEleveQuery::create(null, $criteria)
                    ...
                    ->find($con);
                if (null !== $criteria) {
                    if (false !== $this->collJTraitementSaisieElevesPartial && count($collJTraitementSaisieEleves)) {
                      $this->initJTraitementSaisieEleves(false);

                      foreach($collJTraitementSaisieEleves as $obj) {
                        if (false == $this->collJTraitementSaisieEleves->contains($obj)) {
                          $this->collJTraitementSaisieEleves->append($obj);
                        }
                      }

                      $this->collJTraitementSaisieElevesPartial = true;
                    }

                    return $collJTraitementSaisieEleves;
                }

                if($partial && $this->collJTraitementSaisieEleves) {
                    foreach($this->collJTraitementSaisieEleves as $obj) {
                        if($obj->isNew()) {
                            $collJTraitementSaisieEleves[] = $obj;
                        }
                    }
                }

                $this->collJTraitementSaisieEleves = $collJTraitementSaisieEleves;
                $this->collJTraitementSaisieElevesPartial = false;
            }
        }
    ...
    public function setJTraitementSaisieEleves(PropelCollection $jTraitementSaisieEleves, PropelPDO $con = null)
    {
        ...
        foreach ($this->jTraitementSaisieElevesScheduledForDeletion as $jTraitementSaisieEleveRemoved) {
            $jTraitementSaisieEleveRemoved->setAbsenceEleveSaisie(null);
        }
    ...
    public function countJTraitementSaisieEleves(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        ...
        if (null === $this->collJTraitementSaisieEleves || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collJTraitementSaisieEleves) {
                ...
                if($partial && !$criteria) {
                    return count($this->getJTraitementSaisieEleves());
                }
    ...
    public function addJTraitementSaisieEleve(JTraitementSaisieEleve $l)
    {
        ...
        if (!in_array($l, $this->collJTraitementSaisieEleves->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
    ...
    protected function doAddJTraitementSaisieEleve($jTraitementSaisieEleve)
    {
        ...
        $jTraitementSaisieEleve->setAbsenceEleveSaisie($this);
    }

    /**
     * @param	JTraitementSaisieEleve $jTraitementSaisieEleve The jTraitementSaisieEleve object to remove.
     */
    public function removeJTraitementSaisieEleve($jTraitementSaisieEleve)
    {
        if ($this->getJTraitementSaisieEleves()->contains($jTraitementSaisieEleve)) {
            $this->collJTraitementSaisieEleves->remove($this->collJTraitementSaisieEleves->search($jTraitementSaisieEleve));
            if (null === $this->jTraitementSaisieElevesScheduledForDeletion) {
                $this->jTraitementSaisieElevesScheduledForDeletion = clone $this->collJTraitementSaisieEleves;
                $this->jTraitementSaisieElevesScheduledForDeletion->clear();
            }
            $this->jTraitementSaisieElevesScheduledForDeletion[]= $jTraitementSaisieEleve;
            $jTraitementSaisieEleve->setAbsenceEleveSaisie(null);
        }
    }
    ...
    public function clearAbsenceEleveSaisieVersions()
    {
        ...
        $this->collAbsenceEleveSaisieVersionsPartial = null;
    }

    /**
     * reset is the collAbsenceEleveSaisieVersions collection loaded partially
     *
     * @return void
     */
    public function resetPartialAbsenceEleveSaisieVersions($v = true)
    {
        $this->collAbsenceEleveSaisieVersionsPartial = $v;
    }
     ...
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     * @return PropelObjectCollection|AbsenceEleveSaisieVersion[] List of AbsenceEleveSaisieVersion objects
     * @throws PropelException
     */
    public function getAbsenceEleveSaisieVersions($criteria = null, PropelPDO $con = null)
    {
        $partial = $this->collAbsenceEleveSaisieVersionsPartial && !$this->isNew();
        if (null === $this->collAbsenceEleveSaisieVersions || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collAbsenceEleveSaisieVersions) {
                ...
                $collAbsenceEleveSaisieVersions = AbsenceEleveSaisieVersionQuery::create(null, $criteria)
                    ...
                    ->find($con);
                if (null !== $criteria) {
                    if (false !== $this->collAbsenceEleveSaisieVersionsPartial && count($collAbsenceEleveSaisieVersions)) {
                      $this->initAbsenceEleveSaisieVersions(false);

                      foreach($collAbsenceEleveSaisieVersions as $obj) {
                        if (false == $this->collAbsenceEleveSaisieVersions->contains($obj)) {
                          $this->collAbsenceEleveSaisieVersions->append($obj);
                        }
                      }

                      $this->collAbsenceEleveSaisieVersionsPartial = true;
                    }

                    return $collAbsenceEleveSaisieVersions;
                }

                if($partial && $this->collAbsenceEleveSaisieVersions) {
                    foreach($this->collAbsenceEleveSaisieVersions as $obj) {
                        if($obj->isNew()) {
                            $collAbsenceEleveSaisieVersions[] = $obj;
                        }
                    }
                }

                $this->collAbsenceEleveSaisieVersions = $collAbsenceEleveSaisieVersions;
                $this->collAbsenceEleveSaisieVersionsPartial = false;
            }
        }
    ...
    /**
     * Sets a collection of AbsenceEleveSaisieVersion objects related by a one-to-many relationship
     * to the current object.
     * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
     * and new objects from the given Propel collection.
     *
     * @param PropelCollection $absenceEleveSaisieVersions A Propel collection.
     * @param PropelPDO $con Optional connection object
     */
    public function setAbsenceEleveSaisieVersions(PropelCollection $absenceEleveSaisieVersions, PropelPDO $con = null)
    {
        $this->absenceEleveSaisieVersionsScheduledForDeletion = $this->getAbsenceEleveSaisieVersions(new Criteria(), $con)->diff($absenceEleveSaisieVersions);

        foreach ($this->absenceEleveSaisieVersionsScheduledForDeletion as $absenceEleveSaisieVersionRemoved) {
            $absenceEleveSaisieVersionRemoved->setAbsenceEleveSaisie(null);
        }

        $this->collAbsenceEleveSaisieVersions = null;
        foreach ($absenceEleveSaisieVersions as $absenceEleveSaisieVersion) {
            $this->addAbsenceEleveSaisieVersion($absenceEleveSaisieVersion);
        }

        $this->collAbsenceEleveSaisieVersions = $absenceEleveSaisieVersions;
        $this->collAbsenceEleveSaisieVersionsPartial = false;
    }
    ...
    public function countAbsenceEleveSaisieVersions(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        ...
        if (null === $this->collAbsenceEleveSaisieVersions || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collAbsenceEleveSaisieVersions) {
                ...
                if($partial && !$criteria) {
                    return count($this->getAbsenceEleveSaisieVersions());
                }
    ...
    public function addAbsenceEleveSaisieVersion(AbsenceEleveSaisieVersion $l)
    {
        ...
        if (!in_array($l, $this->collAbsenceEleveSaisieVersions->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
            $this->doAddAbsenceEleveSaisieVersion($l);
        }
    ...
    /**
     * @param	AbsenceEleveSaisieVersion $absenceEleveSaisieVersion The absenceEleveSaisieVersion object to add.
     */
    protected function doAddAbsenceEleveSaisieVersion($absenceEleveSaisieVersion)
    {
        $this->collAbsenceEleveSaisieVersions[]= $absenceEleveSaisieVersion;
        $absenceEleveSaisieVersion->setAbsenceEleveSaisie($this);
    }

    /**
     * @param	AbsenceEleveSaisieVersion $absenceEleveSaisieVersion The absenceEleveSaisieVersion object to remove.
     */
    public function removeAbsenceEleveSaisieVersion($absenceEleveSaisieVersion)
    {
        if ($this->getAbsenceEleveSaisieVersions()->contains($absenceEleveSaisieVersion)) {
            $this->collAbsenceEleveSaisieVersions->remove($this->collAbsenceEleveSaisieVersions->search($absenceEleveSaisieVersion));
            if (null === $this->absenceEleveSaisieVersionsScheduledForDeletion) {
                $this->absenceEleveSaisieVersionsScheduledForDeletion = clone $this->collAbsenceEleveSaisieVersions;
                $this->absenceEleveSaisieVersionsScheduledForDeletion->clear();
            }
            $this->absenceEleveSaisieVersionsScheduledForDeletion[]= $absenceEleveSaisieVersion;
            $absenceEleveSaisieVersion->setAbsenceEleveSaisie(null);
        }
    }
    ...
    public function clearAbsenceEleveTraitements()
    {
        ...
        $this->collAbsenceEleveTraitementsPartial = null;
    }
     ...
     * @param PropelPDO $con Optional connection object
     *
     * @return PropelObjectCollection|AbsenceEleveTraitement[] List of AbsenceEleveTraitement objects
     */
    ...
    /**
     * Sets a collection of AbsenceEleveTraitement objects related by a many-to-many relationship
     * to the current object by way of the j_traitements_saisies cross-reference table.
     * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
     * and new objects from the given Propel collection.
     *
    ...
    {
        $this->clearAbsenceEleveTraitements();
        $currentAbsenceEleveTraitements = $this->getAbsenceEleveTraitements();

        $this->absenceEleveTraitementsScheduledForDeletion = $currentAbsenceEleveTraitements->diff($absenceEleveTraitements);

        foreach ($absenceEleveTraitements as $absenceEleveTraitement) {
            if (!$currentAbsenceEleveTraitements->contains($absenceEleveTraitement)) {
                $this->doAddAbsenceEleveTraitement($absenceEleveTraitement);
            }
        }
    ...
    /**
     * Remove a AbsenceEleveTraitement object to this object
     * through the j_traitements_saisies cross reference table.
     *
     * @param AbsenceEleveTraitement $absenceEleveTraitement The JTraitementSaisieEleve object to relate
     * @return void
     */
    public function removeAbsenceEleveTraitement(AbsenceEleveTraitement $absenceEleveTraitement)
    {
        if ($this->getAbsenceEleveTraitements()->contains($absenceEleveTraitement)) {
            $this->collAbsenceEleveTraitements->remove($this->collAbsenceEleveTraitements->search($absenceEleveTraitement));
            if (null === $this->absenceEleveTraitementsScheduledForDeletion) {
                $this->absenceEleveTraitementsScheduledForDeletion = clone $this->collAbsenceEleveTraitements;
                $this->absenceEleveTraitementsScheduledForDeletion->clear();
            }
            $this->absenceEleveTraitementsScheduledForDeletion[]= $absenceEleveTraitement;
        }
    }
    ...
    public function isVersioningNecessary($con = null)
    {
        ...
        if (AbsenceEleveSaisiePeer::isVersioningEnabled() && ($this->isNew() || $this->isModified() || $this->isDeleted())) {
            return true;
        }
     ...
     * @param AbsenceEleveSaisieVersionQuery|Criteria $criteria Additional criteria to filter.
     * @param PropelPDO $con An optional connection to use.
     *
     * @return PropelCollection|AbsenceEleveSaisieVersion[] List of AbsenceEleveSaisieVersion objects
     */
    public function getLastVersions($number = 10, $criteria = null, PropelPDO $con = null)
    {
        $criteria = AbsenceEleveSaisieVersionQuery::create(null, $criteria);
        $criteria->addDescendingOrderByColumn(AbsenceEleveSaisieVersionPeer::VERSION);
