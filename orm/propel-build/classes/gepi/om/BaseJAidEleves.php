...
abstract class BaseJAidEleves extends BaseObject  implements Persistent
{
	 ...
	 * Login de l'eleve qui est membre de cette AID
	 * @return     string
	 */
	 ...
	 * @return     JAidEleves The current object (for fluent API support)
	 */
	public function setIdAid($v)
	{
		...
		if ($this->id_aid !== $v) {
			$this->id_aid = $v;
			$this->modifiedColumns[] = JAidElevesPeer::ID_AID;
		}
	...
	public function setLogin($v)
	{
		...
		if ($this->login !== $v) {
			$this->login = $v;
			$this->modifiedColumns[] = JAidElevesPeer::LOGIN;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = JAidElevesPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating JAidEleves object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = JAidElevesPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = JAidElevesQuery::create()
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(JAidElevesPeer::ID_AID)) {
			$modifiedColumns[':p' . $index++]  = 'ID_AID';
		}
		if ($this->isColumnModified(JAidElevesPeer::LOGIN)) {
			$modifiedColumns[':p' . $index++]  = 'LOGIN';
		}

		$sql = sprintf(
			'INSERT INTO j_aid_eleves (%s) VALUES (%s)',
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = JAidElevesPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = JAidElevesPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['JAidEleves'][serialize($this->getPrimaryKey())])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['JAidEleves'][serialize($this->getPrimaryKey())] = true;
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(JAidElevesPeer::ID_AID)) $criteria->add(JAidElevesPeer::ID_AID, $this->id_aid);
		if ($this->isColumnModified(JAidElevesPeer::LOGIN)) $criteria->add(JAidElevesPeer::LOGIN, $this->login);
	...
	{
		$criteria = new Criteria(JAidElevesPeer::DATABASE_NAME);
		$criteria->add(JAidElevesPeer::ID_AID, $this->id_aid);
	...
	{
		return (null === $this->getIdAid()) && (null === $this->getLogin());
	}
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of JAidEleves (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     JAidEleves Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     JAidElevesPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new JAidElevesPeer();
		}
		return self::$peer;
	}
	...
	{
		return (string) $this->exportTo(JAidElevesPeer::DEFAULT_STRING_FORMAT);
	}
