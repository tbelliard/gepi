...
abstract class BasePlugInAutorisation extends BaseObject  implements Persistent
{
	 ...
	 * Est-ce que ce statut a le droit de voir ce fichier y/n
	 * @return     string
	 */
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = PlugInAutorisationPeer::ID;
		}
	...
	public function setPluginId($v)
	{
		...
		if ($this->plugin_id !== $v) {
			$this->plugin_id = $v;
			$this->modifiedColumns[] = PlugInAutorisationPeer::PLUGIN_ID;
		}
	...
	public function setFichier($v)
	{
		...
		if ($this->fichier !== $v) {
			$this->fichier = $v;
			$this->modifiedColumns[] = PlugInAutorisationPeer::FICHIER;
		}
	...
	public function setUserStatut($v)
	{
		...
		if ($this->user_statut !== $v) {
			$this->user_statut = $v;
			$this->modifiedColumns[] = PlugInAutorisationPeer::USER_STATUT;
		}
	...
	public function setAuth($v)
	{
		...
		if ($this->auth !== $v) {
			$this->auth = $v;
			$this->modifiedColumns[] = PlugInAutorisationPeer::AUTH;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->fichier = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->user_statut = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->auth = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->resetModified();
			...
			return $startcol + 5; // 5 = PlugInAutorisationPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating PlugInAutorisation object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = PlugInAutorisationPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = PlugInAutorisationQuery::create()
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(PlugInAutorisationPeer::ID)) {
			$modifiedColumns[':p' . $index++]  = 'ID';
		}
		if ($this->isColumnModified(PlugInAutorisationPeer::PLUGIN_ID)) {
			$modifiedColumns[':p' . $index++]  = 'PLUGIN_ID';
		}
		if ($this->isColumnModified(PlugInAutorisationPeer::FICHIER)) {
			$modifiedColumns[':p' . $index++]  = 'FICHIER';
		}
		if ($this->isColumnModified(PlugInAutorisationPeer::USER_STATUT)) {
			$modifiedColumns[':p' . $index++]  = 'USER_STATUT';
		}
		if ($this->isColumnModified(PlugInAutorisationPeer::AUTH)) {
			$modifiedColumns[':p' . $index++]  = 'AUTH';
		}

		$sql = sprintf(
			'INSERT INTO plugins_autorisations (%s) VALUES (%s)',
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = PlugInAutorisationPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = PlugInAutorisationPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['PlugInAutorisation'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['PlugInAutorisation'][$this->getPrimaryKey()] = true;
		$keys = PlugInAutorisationPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getPluginId(),
			$keys[2] => $this->getFichier(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setFichier($arr[$keys[2]]);
		if (array_key_exists($keys[3], $arr)) $this->setUserStatut($arr[$keys[3]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PlugInAutorisationPeer::ID)) $criteria->add(PlugInAutorisationPeer::ID, $this->id);
		if ($this->isColumnModified(PlugInAutorisationPeer::PLUGIN_ID)) $criteria->add(PlugInAutorisationPeer::PLUGIN_ID, $this->plugin_id);
		if ($this->isColumnModified(PlugInAutorisationPeer::FICHIER)) $criteria->add(PlugInAutorisationPeer::FICHIER, $this->fichier);
		if ($this->isColumnModified(PlugInAutorisationPeer::USER_STATUT)) $criteria->add(PlugInAutorisationPeer::USER_STATUT, $this->user_statut);
		if ($this->isColumnModified(PlugInAutorisationPeer::AUTH)) $criteria->add(PlugInAutorisationPeer::AUTH, $this->auth);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of PlugInAutorisation (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
	{
		...
		$copyObj->setUserStatut($this->getUserStatut());
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     PlugInAutorisation Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     PlugInAutorisationPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new PlugInAutorisationPeer();
		}
		return self::$peer;
	}
	...
	public function getPlugIn(PropelPDO $con = null)
	{
		if ($this->aPlugIn === null && ($this->plugin_id !== null)) {
			...
			/* The following can be used additionally to
				...
				$this->aPlugIn->addPlugInAutorisations($this);
			 */
		}
		return $this->aPlugIn;
	}
	...
	{
		return (string) $this->exportTo(PlugInAutorisationPeer::DEFAULT_STRING_FORMAT);
	}
