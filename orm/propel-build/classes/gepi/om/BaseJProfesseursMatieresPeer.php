...
abstract class BaseJProfesseursMatieresPeer
{
     ...
     * e.g. JProfesseursMatieresPeer::$fieldNames[JProfesseursMatieresPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (JProfesseursMatieresPeer::ID_MATIERE, JProfesseursMatieresPeer::ID_PROFESSEUR, JProfesseursMatieresPeer::ORDRE_MATIERES, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. JProfesseursMatieresPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (JProfesseursMatieresPeer::ID_MATIERE => 0, JProfesseursMatieresPeer::ID_PROFESSEUR => 1, JProfesseursMatieresPeer::ORDRE_MATIERES => 2, ),
    ...
    {
        $toNames = JProfesseursMatieresPeer::getFieldNames($toType);
        $key = isset(JProfesseursMatieresPeer::$fieldKeys[$fromType][$name]) ? JProfesseursMatieresPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(JProfesseursMatieresPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, JProfesseursMatieresPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return JProfesseursMatieresPeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(JProfesseursMatieresPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(JProfesseursMatieresPeer::DATABASE_NAME);
     ...
     *
     * @param      JProfesseursMatieres $obj A JProfesseursMatieres object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            JProfesseursMatieresPeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(JProfesseursMatieresPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(JProfesseursMatieresPeer::$instances[$key])) {
                return JProfesseursMatieresPeer::$instances[$key];
            }
        }
    ...
    {
        JProfesseursMatieresPeer::$instances = array();
    }
    ...
    public static function populateObjects(PDOStatement $stmt)
    {
        ...
        $cls = JProfesseursMatieresPeer::getOMClass();
    ...
    {
        return Propel::getDatabaseMap(JProfesseursMatieresPeer::DATABASE_NAME)->getTable(JProfesseursMatieresPeer::TABLE_NAME);
    }
    ...
    {
        return JProfesseursMatieresPeer::OM_CLASS;
    }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(JProfesseursMatieresPeer::DATABASE_NAME);
