...
abstract class BaseEdtCreneauPeer
{
    ...
    /** the column name for the NOM_DEFINIE_PERIODE field */
    const NOM_DEFINIE_PERIODE = 'edt_creneaux.NOM_DEFINIE_PERIODE';

    /** the column name for the HEUREDEBUT_DEFINIE_PERIODE field */
    const HEUREDEBUT_DEFINIE_PERIODE = 'edt_creneaux.HEUREDEBUT_DEFINIE_PERIODE';

    /** the column name for the HEUREFIN_DEFINIE_PERIODE field */
    const HEUREFIN_DEFINIE_PERIODE = 'edt_creneaux.HEUREFIN_DEFINIE_PERIODE';
     ...
     * e.g. EdtCreneauPeer::$fieldNames[EdtCreneauPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (EdtCreneauPeer::ID_DEFINIE_PERIODE, EdtCreneauPeer::NOM_DEFINIE_PERIODE, EdtCreneauPeer::HEUREDEBUT_DEFINIE_PERIODE, EdtCreneauPeer::HEUREFIN_DEFINIE_PERIODE, EdtCreneauPeer::SUIVI_DEFINIE_PERIODE, EdtCreneauPeer::TYPE_CRENEAUX, EdtCreneauPeer::JOUR_CRENEAU, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. EdtCreneauPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (EdtCreneauPeer::ID_DEFINIE_PERIODE => 0, EdtCreneauPeer::NOM_DEFINIE_PERIODE => 1, EdtCreneauPeer::HEUREDEBUT_DEFINIE_PERIODE => 2, EdtCreneauPeer::HEUREFIN_DEFINIE_PERIODE => 3, EdtCreneauPeer::SUIVI_DEFINIE_PERIODE => 4, EdtCreneauPeer::TYPE_CRENEAUX => 5, EdtCreneauPeer::JOUR_CRENEAU => 6, ),
    ...
    {
        $toNames = EdtCreneauPeer::getFieldNames($toType);
        $key = isset(EdtCreneauPeer::$fieldKeys[$fromType][$name]) ? EdtCreneauPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(EdtCreneauPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, EdtCreneauPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return EdtCreneauPeer::$fieldNames[$type];
    }
     ...
     * @param      string $column The column name for current table. (i.e. EdtCreneauPeer::COLUMN_NAME).
     * @return string
     */
    public static function alias($alias, $column)
    {
        return str_replace(EdtCreneauPeer::TABLE_NAME.'.', $alias.'.', $column);
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setPrimaryTableName(EdtCreneauPeer::TABLE_NAME);
        ...
        $criteria->setDbName(EdtCreneauPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectOne(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $critcopy->setLimit(1);
        $objects = EdtCreneauPeer::doSelect($critcopy, $con);
        if ($objects) {
            return $objects[0];
        }
    ...
    {
        return EdtCreneauPeer::populateObjects(EdtCreneauPeer::doSelectStmt($criteria, $con));
    }
    /**
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(EdtCreneauPeer::DATABASE_NAME);
     ...
     *
     * @param      EdtCreneau $obj A EdtCreneau object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if ($key === null) {
                $key = (string) $obj->getIdDefiniePeriode();
            } // if key === null
            EdtCreneauPeer::$instances[$key] = $obj;
        }
    }
     ...
     *
     * @param      mixed $value A EdtCreneau object or a primary key value.
     *
     * @return void
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof EdtCreneau) {
                $key = (string) $value->getIdDefiniePeriode();
            } elseif (is_scalar($value)) {
                // assume we've been passed a primary key
                $key = (string) $value;
            } else {
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or EdtCreneau object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
                throw $e;
            }

            unset(EdtCreneauPeer::$instances[$key]);
        }
     ...
     * @return   EdtCreneau Found object or null if 1) no instance exists for specified key or 2) instance pooling has been disabled.
     * @see        getPrimaryKeyHash()
     */
    public static function getInstanceFromPool($key)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(EdtCreneauPeer::$instances[$key])) {
                return EdtCreneauPeer::$instances[$key];
            }
        }
    ...
    {
        EdtCreneauPeer::$instances = array();
    }
    ...
    {
        return Propel::getDatabaseMap(EdtCreneauPeer::DATABASE_NAME)->getTable(EdtCreneauPeer::TABLE_NAME);
    }
    ...
    {
        return EdtCreneauPeer::OM_CLASS;
    }

    /**
     * Performs an INSERT on the database, given a EdtCreneau or Criteria object.
     *
     * @param      mixed $values Criteria or EdtCreneau object containing data that is used to create the INSERT statement.
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria = $values->buildCriteria(); // build Criteria from EdtCreneau object
        }

        if ($criteria->containsKey(EdtCreneauPeer::ID_DEFINIE_PERIODE) && $criteria->keyContainsValue(EdtCreneauPeer::ID_DEFINIE_PERIODE) ) {
    ...
    /**
     * Performs an UPDATE on the database, given a EdtCreneau or Criteria object.
     *
     * @param      mixed $values Criteria or EdtCreneau object containing data that is used to create the UPDATE statement.
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(EdtCreneauPeer::DATABASE_NAME);
    ...
    /**
     * Deletes all rows from the edt_creneaux table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
    ...
    /**
     * Performs a DELETE on the database, given a EdtCreneau or Criteria object OR a primary key value.
     *
     * @param      mixed $values Criteria or EdtCreneau object or primary key or array of primary keys
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        try {
            ...
            $c = clone $criteria;
            $affectedRows += EdtCreneauPeer::doOnDeleteCascade($c, $con);

            // cloning the Criteria in case it's modified by doSelect() or doSelectStmt()
            $c = clone $criteria;
            EdtCreneauPeer::doOnDeleteSetNull($c, $con);
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        $objects = EdtCreneauPeer::doSelect($criteria, $con);
    ...
    protected static function doOnDeleteSetNull(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            $selectCriteria = new Criteria(EdtCreneauPeer::DATABASE_NAME);
            $updateValues = new Criteria(EdtCreneauPeer::DATABASE_NAME);
            $selectCriteria->add(AbsenceEleveSaisiePeer::ID_EDT_CRENEAU, $obj->getIdDefiniePeriode());
            $updateValues->add(AbsenceEleveSaisiePeer::ID_EDT_CRENEAU, null);
    ...
    /**
     * Validates all modified columns of given EdtCreneau object.
     * If parameter $columns is either a single column name or an array of column names
     * than only those columns are validated.
     *
     * NOTICE: This does not apply to primary or foreign keys for now.
     *
     * @param      EdtCreneau $obj The object to validate.
    ...
    public static function doValidate($obj, $cols = null)
    {
        ...
        if ($cols) {
            $dbMap = Propel::getDatabaseMap(EdtCreneauPeer::DATABASE_NAME);
            $tableMap = $dbMap->getTable(EdtCreneauPeer::TABLE_NAME);
        ...
        return BasePeer::doValidate(EdtCreneauPeer::DATABASE_NAME, EdtCreneauPeer::TABLE_NAME, $columns);
    }
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        if (null !== ($obj = EdtCreneauPeer::getInstanceFromPool((string) $pk))) {
            return $obj;
        }
        ...
        $criteria = new Criteria(EdtCreneauPeer::DATABASE_NAME);
        $criteria->add(EdtCreneauPeer::ID_DEFINIE_PERIODE, $pk);

        $v = EdtCreneauPeer::doSelect($criteria, $con);
