 ...
 * @package    gepi.om
 */
abstract class BaseEdtHoraires extends BaseObject  implements Persistent {
	 ...
	 * Note: this column has a database default value of: '-99999:-99999:-99999'
	 * @var        string
	 */
	...
	/**
	 * Initializes internal state of BaseEdtHoraires object.
	 * @see        applyDefaults()
	 */
	...
	{
		$this->fermeture_horaire_etablissement = '-99999:-99999:-99999';
	}
	 ...
	 * @return     EdtHoraires The current object (for fluent API support)
	 */
	public function setIdHoraireEtablissement($v)
	{
		...
		if ($this->id_horaire_etablissement !== $v) {
			...
			$this->modifiedColumns[] = EdtHorairesPeer::ID_HORAIRE_ETABLISSEMENT;
		}
	...
	public function setDateHoraireEtablissement($v)
	{
		...
		if ( $this->date_horaire_etablissement !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = EdtHorairesPeer::DATE_HORAIRE_ETABLISSEMENT;
			}
	...
	public function setJourHoraireEtablissement($v)
	{
		...
		if ($this->jour_horaire_etablissement !== $v) {
			...
			$this->modifiedColumns[] = EdtHorairesPeer::JOUR_HORAIRE_ETABLISSEMENT;
		}
	...
	public function setOuvertureHoraireEtablissement($v)
	{
		...
		if ( $this->ouverture_horaire_etablissement !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = EdtHorairesPeer::OUVERTURE_HORAIRE_ETABLISSEMENT;
			}
		} // if either are not null
	...
	public function setFermetureHoraireEtablissement($v)
	{
		...
		if ( $this->fermeture_horaire_etablissement !== null || $dt !== null ) {
			...
			if ( ($currNorm !== $newNorm) // normalized values don't match 
					|| ($dt->format('H:i:s') === '-99999:-99999:-99999') // or the entered value matches the default
					)
			{
				$this->fermeture_horaire_etablissement = ($dt ? $dt->format('H:i:s') : null);
				$this->modifiedColumns[] = EdtHorairesPeer::FERMETURE_HORAIRE_ETABLISSEMENT;
			}
		} // if either are not null
	...
	public function setPauseHoraireEtablissement($v)
	{
		...
		if ( $this->pause_horaire_etablissement !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = EdtHorairesPeer::PAUSE_HORAIRE_ETABLISSEMENT;
			}
		} // if either are not null
	...
	public function setOuvertHoraireEtablissement($v)
	{
		...
		if ($this->ouvert_horaire_etablissement !== $v) {
			...
			$this->modifiedColumns[] = EdtHorairesPeer::OUVERT_HORAIRE_ETABLISSEMENT;
		}
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(EdtHorairesPeer::FERMETURE_HORAIRE_ETABLISSEMENT))) {
				return false;
			}

			if ($this->fermeture_horaire_etablissement !== '-99999:-99999:-99999') {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 7; // 7 = EdtHorairesPeer::NUM_COLUMNS - EdtHorairesPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating EdtHoraires object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = EdtHorairesPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			$con->commit();
			EdtHorairesPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = EdtHorairesPeer::doInsert($this, $con);
					...
					$affectedRows += EdtHorairesPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = EdtHorairesPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = EdtHorairesPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = EdtHorairesPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(EdtHorairesPeer::ID_HORAIRE_ETABLISSEMENT)) $criteria->add(EdtHorairesPeer::ID_HORAIRE_ETABLISSEMENT, $this->id_horaire_etablissement);
		if ($this->isColumnModified(EdtHorairesPeer::DATE_HORAIRE_ETABLISSEMENT)) $criteria->add(EdtHorairesPeer::DATE_HORAIRE_ETABLISSEMENT, $this->date_horaire_etablissement);
		if ($this->isColumnModified(EdtHorairesPeer::JOUR_HORAIRE_ETABLISSEMENT)) $criteria->add(EdtHorairesPeer::JOUR_HORAIRE_ETABLISSEMENT, $this->jour_horaire_etablissement);
		if ($this->isColumnModified(EdtHorairesPeer::OUVERTURE_HORAIRE_ETABLISSEMENT)) $criteria->add(EdtHorairesPeer::OUVERTURE_HORAIRE_ETABLISSEMENT, $this->ouverture_horaire_etablissement);
		if ($this->isColumnModified(EdtHorairesPeer::FERMETURE_HORAIRE_ETABLISSEMENT)) $criteria->add(EdtHorairesPeer::FERMETURE_HORAIRE_ETABLISSEMENT, $this->fermeture_horaire_etablissement);
		if ($this->isColumnModified(EdtHorairesPeer::PAUSE_HORAIRE_ETABLISSEMENT)) $criteria->add(EdtHorairesPeer::PAUSE_HORAIRE_ETABLISSEMENT, $this->pause_horaire_etablissement);
		if ($this->isColumnModified(EdtHorairesPeer::OUVERT_HORAIRE_ETABLISSEMENT)) $criteria->add(EdtHorairesPeer::OUVERT_HORAIRE_ETABLISSEMENT, $this->ouvert_horaire_etablissement);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(EdtHorairesPeer::ID_HORAIRE_ETABLISSEMENT, $this->id_horaire_etablissement);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of EdtHoraires (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     EdtHoraires Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     EdtHorairesPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new EdtHorairesPeer();
		}
		return self::$peer;
	}
