...
abstract class BaseAidConfigurationQuery extends ModelCriteria
{
     ...
     * @param     AidConfigurationQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     *
     * @return   AidConfiguration|AidConfiguration[]|mixed the result, formatted by the current formatter
     */
     ...
     */
     public function findOneByIndiceAid($key, $con = null)
     {
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|AidConfiguration[]|mixed the list of results, formatted by the current formatter
     */
     ...
     *
     * @param   AidDetails|PropelObjectCollection $aidDetails  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   AidConfigurationQuery The current query, for fluid interface
