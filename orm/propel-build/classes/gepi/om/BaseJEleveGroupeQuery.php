...
abstract class BaseJEleveGroupeQuery extends ModelCriteria
{
     ...
     * @param     JEleveGroupeQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     * @param array $key Primary key to use for the query
                         A Primary key composition: [$login, $id_groupe, $periode]
     * @param     PropelPDO $con an optional connection object
     *
     * @return   JEleveGroupe|JEleveGroupe[]|mixed the result, formatted by the current formatter
     */
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|JEleveGroupe[]|mixed the list of results, formatted by the current formatter
     */
