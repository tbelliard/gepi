...
abstract class BaseCahierTexteSequencePeer
{
     ...
     * e.g. CahierTexteSequencePeer::$fieldNames[CahierTexteSequencePeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Titre', 'Description', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'titre', 'description', ),
        BasePeer::TYPE_COLNAME => array (CahierTexteSequencePeer::ID, CahierTexteSequencePeer::TITRE, CahierTexteSequencePeer::DESCRIPTION, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. CahierTexteSequencePeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Titre' => 1, 'Description' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'titre' => 1, 'description' => 2, ),
        BasePeer::TYPE_COLNAME => array (CahierTexteSequencePeer::ID => 0, CahierTexteSequencePeer::TITRE => 1, CahierTexteSequencePeer::DESCRIPTION => 2, ),
    ...
    {
        $toNames = CahierTexteSequencePeer::getFieldNames($toType);
        $key = isset(CahierTexteSequencePeer::$fieldKeys[$fromType][$name]) ? CahierTexteSequencePeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(CahierTexteSequencePeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, CahierTexteSequencePeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return CahierTexteSequencePeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(CahierTexteSequencePeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(CahierTexteSequencePeer::DATABASE_NAME);
     ...
     *
     * @param      CahierTexteSequence $obj A CahierTexteSequence object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            CahierTexteSequencePeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(CahierTexteSequencePeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(CahierTexteSequencePeer::$instances[$key])) {
                return CahierTexteSequencePeer::$instances[$key];
            }
        }
    ...
    {
        CahierTexteSequencePeer::$instances = array();
    }
    ...
    {
        return Propel::getDatabaseMap(CahierTexteSequencePeer::DATABASE_NAME)->getTable(CahierTexteSequencePeer::TABLE_NAME);
    }
    ...
    {
        return CahierTexteSequencePeer::OM_CLASS;
    }
