...
abstract class BaseCahierTexteNoticePriveeQuery extends ModelCriteria
{
     ...
     * @param     CahierTexteNoticePriveeQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     *
     * @return   CahierTexteNoticePrivee|CahierTexteNoticePrivee[]|mixed the result, formatted by the current formatter
     */
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|CahierTexteNoticePrivee[]|mixed the list of results, formatted by the current formatter
     */
