...
abstract class BaseEleveRegimeDoublantQuery extends ModelCriteria
{
     ...
     * @param     EleveRegimeDoublantQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     *
     * @return   EleveRegimeDoublant|EleveRegimeDoublant[]|mixed the result, formatted by the current formatter
     */
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|EleveRegimeDoublant[]|mixed the list of results, formatted by the current formatter
     */
