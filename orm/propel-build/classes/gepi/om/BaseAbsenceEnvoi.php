 ...
 * @package    gepi.om
 */
abstract class BaseAbsenceEnvoi extends BaseObject  implements Persistent {
	...
	/**
	 * @var        AbsenceTypeEnvoi
	 */
	protected $aAbsenceTypeEnvoi;
	...
	/**
	 * Initializes internal state of BaseAbsenceEnvoi object.
	 * @see        applyDefaults()
	 */
	 ...
	 * Login de l'utilisateur professionnel qui a lance l'envoi
	 * @return     string
	 */
	...
	/**
	 * Get the [id_type_envoi] column value.
	 * id du type de l'envoi
	 * @return     int
	 */
	public function getIdTypeEnvoi()
	{
		return $this->id_type_envoi;
	}

	/**
	 * Get the [statut_envoi] column value.
	 * Statut de cet envoi (envoye, en cours,...)
	 * @return     string
	 */
	 ...
	 * Date en timestamp UNIX de l'envoi
	 * @return     int
	 */
	 ...
	 * Date de la saisie de l'envoi en timestamp UNIX
	 * @return     int
	 */
	 ...
	 * Date de la modification de l'envoi en timestamp UNIX
	 * @return     int
	 */
	 ...
	 * @return     AbsenceEnvoi The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = AbsenceEnvoiPeer::ID;
		}
	...
	public function setUtilisateurId($v)
	{
		...
		if ($this->utilisateur_id !== $v) {
			...
			$this->modifiedColumns[] = AbsenceEnvoiPeer::UTILISATEUR_ID;
		}
	...
	/**
	 * Set the value of [id_type_envoi] column.
	 * id du type de l'envoi
	 * @param      int $v new value
	 * @return     AbsenceEnvoi The current object (for fluent API support)
	 */
	public function setIdTypeEnvoi($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}
		...
		if ($this->id_type_envoi !== $v) {
			...
			$this->modifiedColumns[] = AbsenceEnvoiPeer::ID_TYPE_ENVOI;
		}

		if ($this->aAbsenceTypeEnvoi !== null && $this->aAbsenceTypeEnvoi->getId() !== $v) {
			$this->aAbsenceTypeEnvoi = null;
		}
	...
	public function setStatutEnvoi($v)
	{
		...
		if ($this->statut_envoi !== $v || $v === '0') {
			$this->statut_envoi = $v;
			$this->modifiedColumns[] = AbsenceEnvoiPeer::STATUT_ENVOI;
		}
	...
	public function setDateEnvoi($v)
	{
		...
		if ($this->date_envoi !== $v || $v === 0) {
			$this->date_envoi = $v;
			$this->modifiedColumns[] = AbsenceEnvoiPeer::DATE_ENVOI;
		}
	...
	public function setCreatedOn($v)
	{
		...
		if ($this->created_on !== $v || $v === 0) {
			$this->created_on = $v;
			$this->modifiedColumns[] = AbsenceEnvoiPeer::CREATED_ON;
		}
	...
	public function setUpdatedOn($v)
	{
		...
		if ($this->updated_on !== $v || $v === 0) {
			$this->updated_on = $v;
			$this->modifiedColumns[] = AbsenceEnvoiPeer::UPDATED_ON;
		}
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(AbsenceEnvoiPeer::STATUT_ENVOI,AbsenceEnvoiPeer::DATE_ENVOI,AbsenceEnvoiPeer::CREATED_ON,AbsenceEnvoiPeer::UPDATED_ON))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->id_type_envoi = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			$this->statut_envoi = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->date_envoi = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
			$this->created_on = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
			$this->updated_on = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
			$this->resetModified();
			...
			return $startcol + 7; // 7 = AbsenceEnvoiPeer::NUM_COLUMNS - AbsenceEnvoiPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating AbsenceEnvoi object", $e);
		}
	}
	...
	public function ensureConsistency()
	{
		...
		if ($this->aAbsenceTypeEnvoi !== null && $this->id_type_envoi !== $this->aAbsenceTypeEnvoi->getId()) {
			$this->aAbsenceTypeEnvoi = null;
		}
	} // ensureConsistency
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = AbsenceEnvoiPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			AbsenceEnvoiPeer::doDelete($this, $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			$con->commit();
			AbsenceEnvoiPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->aAbsenceTypeEnvoi !== null) {
				if ($this->aAbsenceTypeEnvoi->isModified() || $this->aAbsenceTypeEnvoi->isNew()) {
					$affectedRows += $this->aAbsenceTypeEnvoi->save($con);
				}
				$this->setAbsenceTypeEnvoi($this->aAbsenceTypeEnvoi);
			}
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = AbsenceEnvoiPeer::doInsert($this, $con);
					...
					$affectedRows += AbsenceEnvoiPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if ($this->aAbsenceTypeEnvoi !== null) {
				if (!$this->aAbsenceTypeEnvoi->validate($columns)) {
					$failureMap = array_merge($failureMap, $this->aAbsenceTypeEnvoi->getValidationFailures());
				}
			}


			if (($retval = AbsenceEnvoiPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = AbsenceEnvoiPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = AbsenceEnvoiPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getUtilisateurId(),
			$keys[2] => $this->getIdTypeEnvoi(),
			$keys[3] => $this->getStatutEnvoi(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setIdTypeEnvoi($arr[$keys[2]]);
		if (array_key_exists($keys[3], $arr)) $this->setStatutEnvoi($arr[$keys[3]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AbsenceEnvoiPeer::ID)) $criteria->add(AbsenceEnvoiPeer::ID, $this->id);
		if ($this->isColumnModified(AbsenceEnvoiPeer::UTILISATEUR_ID)) $criteria->add(AbsenceEnvoiPeer::UTILISATEUR_ID, $this->utilisateur_id);
		if ($this->isColumnModified(AbsenceEnvoiPeer::ID_TYPE_ENVOI)) $criteria->add(AbsenceEnvoiPeer::ID_TYPE_ENVOI, $this->id_type_envoi);
		if ($this->isColumnModified(AbsenceEnvoiPeer::STATUT_ENVOI)) $criteria->add(AbsenceEnvoiPeer::STATUT_ENVOI, $this->statut_envoi);
		if ($this->isColumnModified(AbsenceEnvoiPeer::DATE_ENVOI)) $criteria->add(AbsenceEnvoiPeer::DATE_ENVOI, $this->date_envoi);
		if ($this->isColumnModified(AbsenceEnvoiPeer::CREATED_ON)) $criteria->add(AbsenceEnvoiPeer::CREATED_ON, $this->created_on);
		if ($this->isColumnModified(AbsenceEnvoiPeer::UPDATED_ON)) $criteria->add(AbsenceEnvoiPeer::UPDATED_ON, $this->updated_on);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(AbsenceEnvoiPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of AbsenceEnvoi (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     AbsenceEnvoi Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     AbsenceEnvoiPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new AbsenceEnvoiPeer();
		}
		return self::$peer;
	}
	...
	public function getUtilisateurProfessionnel(PropelPDO $con = null)
	{
		if ($this->aUtilisateurProfessionnel === null && (($this->utilisateur_id !== "" && $this->utilisateur_id !== null))) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aUtilisateurProfessionnel->addAbsenceEnvois($this);
			 */
		}
	...
	/**
	 * Declares an association between this object and a AbsenceTypeEnvoi object.
	 *
	 * @param      AbsenceTypeEnvoi $v
	 * @return     AbsenceEnvoi The current object (for fluent API support)
	 * @throws     PropelException
	 */
	public function setAbsenceTypeEnvoi(AbsenceTypeEnvoi $v = null)
	{
		if ($v === null) {
		...
		$this->aAbsenceTypeEnvoi = $v;

		// Add binding for other direction of this n:n relationship.
		// If this object has already been added to the AbsenceTypeEnvoi object, it will not be re-added.
		if ($v !== null) {
			$v->addAbsenceEnvoi($this);
		}
	...
	/**
	 * Get the associated AbsenceTypeEnvoi object
	 *
	 * @param      PropelPDO Optional Connection object.
	 * @return     AbsenceTypeEnvoi The associated AbsenceTypeEnvoi object.
	 * @throws     PropelException
	 */
	public function getAbsenceTypeEnvoi(PropelPDO $con = null)
	{
		if ($this->aAbsenceTypeEnvoi === null && ($this->id_type_envoi !== null)) {
			$this->aAbsenceTypeEnvoi = AbsenceTypeEnvoiPeer::retrieveByPK($this->id_type_envoi, $con);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aAbsenceTypeEnvoi->addAbsenceEnvois($this);
			 */
		}
		return $this->aAbsenceTypeEnvoi;
	}
	 ...
	 * Otherwise if this AbsenceEnvoi has previously been saved, it will retrieve
	 * related JTraitementEnvois from storage. If this AbsenceEnvoi is new, it will return
		...
		if ($this->collJTraitementEnvois === null) {
			if ($this->isNew()) {
			   $this->collJTraitementEnvois = array();
				...
				$criteria->add(JTraitementEnvoiPeer::A_ENVOI_ID, $this->id);
	 ...
	 * Otherwise if this AbsenceEnvoi is new, it will return
	 * an empty collection; or if this AbsenceEnvoi has previously
	 * been saved, it will retrieve related JTraitementEnvois from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in AbsenceEnvoi.
	 */
	public function getJTraitementEnvoisJoinAbsenceTraitement($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(AbsenceEnvoiPeer::DATABASE_NAME);
		}
		...
		if ($this->collJTraitementEnvois === null) {
			if ($this->isNew()) {
				...
				$this->collJTraitementEnvois = JTraitementEnvoiPeer::doSelectJoinAbsenceTraitement($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
