...
abstract class BaseUtilisateurPeer {
	...
	const CLASS_DEFAULT = 'gepi.Utilisateur';
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(UtilisateurPeer::CIVILITE);

		$criteria->addSelectColumn(UtilisateurPeer::PASSWORD);

		$criteria->addSelectColumn(UtilisateurPeer::EMAIL);

		$criteria->addSelectColumn(UtilisateurPeer::SHOW_EMAIL);

		$criteria->addSelectColumn(UtilisateurPeer::STATUT);

		$criteria->addSelectColumn(UtilisateurPeer::ETAT);

		$criteria->addSelectColumn(UtilisateurPeer::CHANGE_MDP);

		$criteria->addSelectColumn(UtilisateurPeer::DATE_VERROUILLAGE);

		$criteria->addSelectColumn(UtilisateurPeer::PASSWORD_TICKET);

		$criteria->addSelectColumn(UtilisateurPeer::TICKET_EXPIRATION);

		$criteria->addSelectColumn(UtilisateurPeer::NIVEAU_ALERTE);

		$criteria->addSelectColumn(UtilisateurPeer::OBSERVATION_SECURITE);

		$criteria->addSelectColumn(UtilisateurPeer::TEMP_DIR);

		$criteria->addSelectColumn(UtilisateurPeer::NUMIND);

		$criteria->addSelectColumn(UtilisateurPeer::AUTH_MODE);
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(UtilisateurPeer::LOGIN);
			$selectCriteria->add(UtilisateurPeer::LOGIN, $criteria->remove(UtilisateurPeer::LOGIN), $comparison);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(UtilisateurPeer::LOGIN, (array) $values, Criteria::IN);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(UtilisateurPeer::LOGIN, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(UtilisateurPeer::DATABASE_NAME);
			$criteria->add(UtilisateurPeer::LOGIN, $pks, Criteria::IN);
