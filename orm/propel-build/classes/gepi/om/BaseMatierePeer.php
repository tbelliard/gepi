...
abstract class BaseMatierePeer
{
     ...
     * e.g. MatierePeer::$fieldNames[MatierePeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (MatierePeer::MATIERE, MatierePeer::NOM_COMPLET, MatierePeer::PRIORITY, MatierePeer::MATIERE_AID, MatierePeer::MATIERE_ATELIER, MatierePeer::CATEGORIE_ID, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. MatierePeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (MatierePeer::MATIERE => 0, MatierePeer::NOM_COMPLET => 1, MatierePeer::PRIORITY => 2, MatierePeer::MATIERE_AID => 3, MatierePeer::MATIERE_ATELIER => 4, MatierePeer::CATEGORIE_ID => 5, ),
    ...
    {
        $toNames = MatierePeer::getFieldNames($toType);
        $key = isset(MatierePeer::$fieldKeys[$fromType][$name]) ? MatierePeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(MatierePeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, MatierePeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return MatierePeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(MatierePeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(MatierePeer::DATABASE_NAME);
     ...
     *
     * @param      Matiere $obj A Matiere object.
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(MatierePeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(MatierePeer::$instances[$key])) {
                return MatierePeer::$instances[$key];
            }
        }
    ...
    {
        return Propel::getDatabaseMap(MatierePeer::DATABASE_NAME)->getTable(MatierePeer::TABLE_NAME);
    }
    ...
    {
        return MatierePeer::OM_CLASS;
    }

    /**
     * Performs an INSERT on the database, given a Matiere or Criteria object.
     *
    ...
    /**
     * Performs an UPDATE on the database, given a Matiere or Criteria object.
     *
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(MatierePeer::DATABASE_NAME);
    ...
    /**
     * Deletes all rows from the matieres table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $affectedRows += BasePeer::doDeleteAll(MatierePeer::TABLE_NAME, $con, MatierePeer::DATABASE_NAME);
    ...
    /**
     * Performs a DELETE on the database, given a Matiere or Criteria object OR a primary key value.
     *
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        try {
            ...
            $c = clone $criteria;
            $affectedRows += MatierePeer::doOnDeleteCascade($c, $con);
