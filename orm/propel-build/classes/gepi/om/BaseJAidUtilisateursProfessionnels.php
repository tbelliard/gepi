...
abstract class BaseJAidUtilisateursProfessionnels extends BaseObject  implements Persistent
{
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = JAidUtilisateursProfessionnelsPeer::NUM_HYDRATE_COLUMNS.
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = JAidUtilisateursProfessionnelsQuery::create()
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(JAidUtilisateursProfessionnelsPeer::ID_AID)) {
			$modifiedColumns[':p' . $index++]  = 'ID_AID';
		}
		if ($this->isColumnModified(JAidUtilisateursProfessionnelsPeer::ID_UTILISATEUR)) {
			$modifiedColumns[':p' . $index++]  = 'ID_UTILISATEUR';
		}

		$sql = sprintf(
			'INSERT INTO j_aid_utilisateurs (%s) VALUES (%s)',
	...
	{
		if (isset($alreadyDumpedObjects['JAidUtilisateursProfessionnels'][serialize($this->getPrimaryKey())])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['JAidUtilisateursProfessionnels'][serialize($this->getPrimaryKey())] = true;
	...
	{
		return (string) $this->exportTo(JAidUtilisateursProfessionnelsPeer::DEFAULT_STRING_FORMAT);
	}
