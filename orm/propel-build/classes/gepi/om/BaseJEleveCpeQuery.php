...
abstract class BaseJEleveCpeQuery extends ModelCriteria
{
     ...
     * @param     JEleveCpeQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     * @param array $key Primary key to use for the query
                         A Primary key composition: [$e_login, $cpe_login]
     * @param     PropelPDO $con an optional connection object
     *
     * @return   JEleveCpe|JEleveCpe[]|mixed the result, formatted by the current formatter
     */
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|JEleveCpe[]|mixed the list of results, formatted by the current formatter
     */
