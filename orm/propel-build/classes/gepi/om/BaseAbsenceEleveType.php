...
abstract class BaseAbsenceEleveType extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the mode_interface field.
     * Note: this column has a database default value of: 'NON_PRECISE'
     * @var        string
     */
    protected $mode_interface;
    ...
    /**
     * @var        PropelObjectCollection|AbsenceEleveTypeStatutAutorise[] Collection to store aggregation of AbsenceEleveTypeStatutAutorise objects.
     */
    protected $collAbsenceEleveTypeStatutAutorises;
    protected $collAbsenceEleveTypeStatutAutorisesPartial;
    ...
    protected $collAbsenceEleveTraitementsPartial;
     ...
     */
    protected $absenceEleveTypeStatutAutorisesScheduledForDeletion = null;
    ...
    public function applyDefaultValues()
    {
        ...
        $this->mode_interface = 'NON_PRECISE';
    }
    ...
    /**
     * Get the [mode_interface] column value.
     * Enumeration des possibilités de l'interface de saisie de l'absence pour ce type : DEBUT_ABS, FIN_ABS, DEBUT_ET_FIN_ABS, NON_PRECISE, COMMENTAIRE_EXIGE, DISCIPLINE, CHECKBOX, CHECKBOX_HIDDEN
     * @return string
     */
    public function getModeInterface()
    {
        return $this->mode_interface;
    }
    ...
    /**
     * Set the value of [mode_interface] column.
     * Enumeration des possibilités de l'interface de saisie de l'absence pour ce type : DEBUT_ABS, FIN_ABS, DEBUT_ET_FIN_ABS, NON_PRECISE, COMMENTAIRE_EXIGE, DISCIPLINE, CHECKBOX, CHECKBOX_HIDDEN
     * @param string $v new value
     * @return AbsenceEleveType The current object (for fluent API support)
     */
    public function setModeInterface($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->mode_interface !== $v) {
            $this->mode_interface = $v;
            $this->modifiedColumns[] = AbsenceEleveTypePeer::MODE_INTERFACE;
        }
    ...
    public function hasOnlyDefaultValues()
    {
            ...
            if ($this->mode_interface !== 'NON_PRECISE') {
                return false;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->mode_interface = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = AbsenceEleveTypeQuery::create()
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->absenceEleveTraitementsScheduledForDeletion !== null) {
                if (!$this->absenceEleveTraitementsScheduledForDeletion->isEmpty()) {
                    foreach ($this->absenceEleveTraitementsScheduledForDeletion as $absenceEleveTraitement) {
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(AbsenceEleveTypePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(AbsenceEleveTypePeer::NOM)) {
            $modifiedColumns[':p' . $index++]  = 'NOM';
        }
        if ($this->isColumnModified(AbsenceEleveTypePeer::JUSTIFICATION_EXIGIBLE)) {
            $modifiedColumns[':p' . $index++]  = 'JUSTIFICATION_EXIGIBLE';
        }
        if ($this->isColumnModified(AbsenceEleveTypePeer::SOUS_RESPONSABILITE_ETABLISSEMENT)) {
            $modifiedColumns[':p' . $index++]  = 'SOUS_RESPONSABILITE_ETABLISSEMENT';
        }
        if ($this->isColumnModified(AbsenceEleveTypePeer::MANQUEMENT_OBLIGATION_PRESENCE)) {
            $modifiedColumns[':p' . $index++]  = 'MANQUEMENT_OBLIGATION_PRESENCE';
        }
        if ($this->isColumnModified(AbsenceEleveTypePeer::RETARD_BULLETIN)) {
            $modifiedColumns[':p' . $index++]  = 'RETARD_BULLETIN';
        }
        if ($this->isColumnModified(AbsenceEleveTypePeer::MODE_INTERFACE)) {
            $modifiedColumns[':p' . $index++]  = 'MODE_INTERFACE';
        }
        if ($this->isColumnModified(AbsenceEleveTypePeer::COMMENTAIRE)) {
            $modifiedColumns[':p' . $index++]  = 'COMMENTAIRE';
        }
        if ($this->isColumnModified(AbsenceEleveTypePeer::ID_LIEU)) {
            $modifiedColumns[':p' . $index++]  = 'ID_LIEU';
        }
        if ($this->isColumnModified(AbsenceEleveTypePeer::SORTABLE_RANK)) {
        ...
        $sql = sprintf(
            'INSERT INTO a_types (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'NOM':
                        ...
                        break;
                    case 'JUSTIFICATION_EXIGIBLE':
                        $stmt->bindValue($identifier, (int) $this->justification_exigible, PDO::PARAM_INT);
                        break;
                    case 'SOUS_RESPONSABILITE_ETABLISSEMENT':
                        $stmt->bindValue($identifier, $this->sous_responsabilite_etablissement, PDO::PARAM_STR);
                        break;
                    case 'MANQUEMENT_OBLIGATION_PRESENCE':
                        $stmt->bindValue($identifier, $this->manquement_obligation_presence, PDO::PARAM_STR);
                        break;
                    case 'RETARD_BULLETIN':
                        $stmt->bindValue($identifier, $this->retard_bulletin, PDO::PARAM_STR);
                        break;
                    case 'MODE_INTERFACE':
                        $stmt->bindValue($identifier, $this->mode_interface, PDO::PARAM_STR);
                        break;
                    case 'COMMENTAIRE':
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[6], $arr)) $this->setModeInterface($arr[$keys[6]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AbsenceEleveTypePeer::MODE_INTERFACE)) $criteria->add(AbsenceEleveTypePeer::MODE_INTERFACE, $this->mode_interface);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setModeInterface($this->getModeInterface());
    ...
    public function clearAbsenceEleveTypeStatutAutorises()
    {
        ...
        $this->collAbsenceEleveTypeStatutAutorisesPartial = null;
    }

    /**
     * reset is the collAbsenceEleveTypeStatutAutorises collection loaded partially
     *
     * @return void
     */
    public function resetPartialAbsenceEleveTypeStatutAutorises($v = true)
    {
        $this->collAbsenceEleveTypeStatutAutorisesPartial = $v;
    }
     ...
     * @param PropelPDO $con optional connection object
     * @return PropelObjectCollection|AbsenceEleveTypeStatutAutorise[] List of AbsenceEleveTypeStatutAutorise objects
     * @throws PropelException
     */
    public function getAbsenceEleveTypeStatutAutorises($criteria = null, PropelPDO $con = null)
    {
        $partial = $this->collAbsenceEleveTypeStatutAutorisesPartial && !$this->isNew();
        if (null === $this->collAbsenceEleveTypeStatutAutorises || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collAbsenceEleveTypeStatutAutorises) {
                ...
                $collAbsenceEleveTypeStatutAutorises = AbsenceEleveTypeStatutAutoriseQuery::create(null, $criteria)
                    ...
                    ->find($con);
                if (null !== $criteria) {
                    if (false !== $this->collAbsenceEleveTypeStatutAutorisesPartial && count($collAbsenceEleveTypeStatutAutorises)) {
                      $this->initAbsenceEleveTypeStatutAutorises(false);

                      foreach($collAbsenceEleveTypeStatutAutorises as $obj) {
                        if (false == $this->collAbsenceEleveTypeStatutAutorises->contains($obj)) {
                          $this->collAbsenceEleveTypeStatutAutorises->append($obj);
                        }
                      }

                      $this->collAbsenceEleveTypeStatutAutorisesPartial = true;
                    }

                    return $collAbsenceEleveTypeStatutAutorises;
                }

                if($partial && $this->collAbsenceEleveTypeStatutAutorises) {
                    foreach($this->collAbsenceEleveTypeStatutAutorises as $obj) {
                        if($obj->isNew()) {
                            $collAbsenceEleveTypeStatutAutorises[] = $obj;
                        }
                    }
                }

                $this->collAbsenceEleveTypeStatutAutorises = $collAbsenceEleveTypeStatutAutorises;
                $this->collAbsenceEleveTypeStatutAutorisesPartial = false;
            }
        }
    ...
    /**
     * Sets a collection of AbsenceEleveTypeStatutAutorise objects related by a one-to-many relationship
     * to the current object.
     * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
     * and new objects from the given Propel collection.
     *
     * @param PropelCollection $absenceEleveTypeStatutAutorises A Propel collection.
     * @param PropelPDO $con Optional connection object
     */
    public function setAbsenceEleveTypeStatutAutorises(PropelCollection $absenceEleveTypeStatutAutorises, PropelPDO $con = null)
    {
        $this->absenceEleveTypeStatutAutorisesScheduledForDeletion = $this->getAbsenceEleveTypeStatutAutorises(new Criteria(), $con)->diff($absenceEleveTypeStatutAutorises);

        foreach ($this->absenceEleveTypeStatutAutorisesScheduledForDeletion as $absenceEleveTypeStatutAutoriseRemoved) {
            $absenceEleveTypeStatutAutoriseRemoved->setAbsenceEleveType(null);
        }

        $this->collAbsenceEleveTypeStatutAutorises = null;
        foreach ($absenceEleveTypeStatutAutorises as $absenceEleveTypeStatutAutorise) {
            $this->addAbsenceEleveTypeStatutAutorise($absenceEleveTypeStatutAutorise);
        }

        $this->collAbsenceEleveTypeStatutAutorises = $absenceEleveTypeStatutAutorises;
        $this->collAbsenceEleveTypeStatutAutorisesPartial = false;
    }
    ...
    public function countAbsenceEleveTypeStatutAutorises(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        ...
        if (null === $this->collAbsenceEleveTypeStatutAutorises || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collAbsenceEleveTypeStatutAutorises) {
                ...
                if($partial && !$criteria) {
                    return count($this->getAbsenceEleveTypeStatutAutorises());
                }
    ...
    public function addAbsenceEleveTypeStatutAutorise(AbsenceEleveTypeStatutAutorise $l)
    {
        ...
        if (!in_array($l, $this->collAbsenceEleveTypeStatutAutorises->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
            $this->doAddAbsenceEleveTypeStatutAutorise($l);
        }
    ...
    /**
     * @param	AbsenceEleveTypeStatutAutorise $absenceEleveTypeStatutAutorise The absenceEleveTypeStatutAutorise object to add.
     */
    protected function doAddAbsenceEleveTypeStatutAutorise($absenceEleveTypeStatutAutorise)
    {
        $this->collAbsenceEleveTypeStatutAutorises[]= $absenceEleveTypeStatutAutorise;
        $absenceEleveTypeStatutAutorise->setAbsenceEleveType($this);
    }

    /**
     * @param	AbsenceEleveTypeStatutAutorise $absenceEleveTypeStatutAutorise The absenceEleveTypeStatutAutorise object to remove.
     */
    public function removeAbsenceEleveTypeStatutAutorise($absenceEleveTypeStatutAutorise)
    {
        if ($this->getAbsenceEleveTypeStatutAutorises()->contains($absenceEleveTypeStatutAutorise)) {
            $this->collAbsenceEleveTypeStatutAutorises->remove($this->collAbsenceEleveTypeStatutAutorises->search($absenceEleveTypeStatutAutorise));
            if (null === $this->absenceEleveTypeStatutAutorisesScheduledForDeletion) {
                $this->absenceEleveTypeStatutAutorisesScheduledForDeletion = clone $this->collAbsenceEleveTypeStatutAutorises;
                $this->absenceEleveTypeStatutAutorisesScheduledForDeletion->clear();
            }
            $this->absenceEleveTypeStatutAutorisesScheduledForDeletion[]= $absenceEleveTypeStatutAutorise;
            $absenceEleveTypeStatutAutorise->setAbsenceEleveType(null);
        }
    }
    ...
    /**
     * reset is the collAbsenceEleveTraitements collection loaded partially
     *
     * @return void
     */
    public function resetPartialAbsenceEleveTraitements($v = true)
    {
        $this->collAbsenceEleveTraitementsPartial = $v;
    }
    ...
    {
        $partial = $this->collAbsenceEleveTraitementsPartial && !$this->isNew();
        if (null === $this->collAbsenceEleveTraitements || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collAbsenceEleveTraitements) {
                ...
                $collAbsenceEleveTraitements = AbsenceEleveTraitementQuery::create(null, $criteria)
                    ...
                    ->find($con);
                if (null !== $criteria) {
                    if (false !== $this->collAbsenceEleveTraitementsPartial && count($collAbsenceEleveTraitements)) {
                      $this->initAbsenceEleveTraitements(false);

                      foreach($collAbsenceEleveTraitements as $obj) {
                        if (false == $this->collAbsenceEleveTraitements->contains($obj)) {
                          $this->collAbsenceEleveTraitements->append($obj);
                        }
                      }

                      $this->collAbsenceEleveTraitementsPartial = true;
                    }

                    return $collAbsenceEleveTraitements;
                }

                if($partial && $this->collAbsenceEleveTraitements) {
                    foreach($this->collAbsenceEleveTraitements as $obj) {
                        if($obj->isNew()) {
                            $collAbsenceEleveTraitements[] = $obj;
                        }
                    }
                }

                $this->collAbsenceEleveTraitements = $collAbsenceEleveTraitements;
                $this->collAbsenceEleveTraitementsPartial = false;
            }
        }
    ...
    public function setAbsenceEleveTraitements(PropelCollection $absenceEleveTraitements, PropelPDO $con = null)
    {
        ...
        foreach ($this->absenceEleveTraitementsScheduledForDeletion as $absenceEleveTraitementRemoved) {
            $absenceEleveTraitementRemoved->setAbsenceEleveType(null);
        }
    ...
    public function countAbsenceEleveTraitements(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        ...
        if (null === $this->collAbsenceEleveTraitements || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collAbsenceEleveTraitements) {
                ...
                if($partial && !$criteria) {
                    return count($this->getAbsenceEleveTraitements());
                }
    ...
    public function addAbsenceEleveTraitement(AbsenceEleveTraitement $l)
    {
        ...
        if (!in_array($l, $this->collAbsenceEleveTraitements->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
    ...
    protected function doAddAbsenceEleveTraitement($absenceEleveTraitement)
    {
        ...
        $absenceEleveTraitement->setAbsenceEleveType($this);
    }

    /**
     * @param	AbsenceEleveTraitement $absenceEleveTraitement The absenceEleveTraitement object to remove.
     */
    public function removeAbsenceEleveTraitement($absenceEleveTraitement)
    {
        if ($this->getAbsenceEleveTraitements()->contains($absenceEleveTraitement)) {
            ...
            $absenceEleveTraitement->setAbsenceEleveType(null);
        }
    }
