...
abstract class BaseEdtCreneauQuery extends ModelCriteria
{
     ...
     * @param     EdtCreneauQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     *
     * @return   EdtCreneau|EdtCreneau[]|mixed the result, formatted by the current formatter
     */
     ...
     */
     public function findOneByIdDefiniePeriode($key, $con = null)
     {
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|EdtCreneau[]|mixed the list of results, formatted by the current formatter
     */
