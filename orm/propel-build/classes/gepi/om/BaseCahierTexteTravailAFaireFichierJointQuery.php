...
abstract class BaseCahierTexteTravailAFaireFichierJointQuery extends ModelCriteria
{
     ...
     * @param     CahierTexteTravailAFaireFichierJointQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     *
     * @return   CahierTexteTravailAFaireFichierJoint|CahierTexteTravailAFaireFichierJoint[]|mixed the result, formatted by the current formatter
     */
    public function findPk($key, $con = null)
    {
        ...
        if ((null !== ($obj = CahierTexteTravailAFaireFichierJointPeer::getInstanceFromPool((string) $key))) && !$this->formatter) {
     ...
     *
     * @return   CahierTexteTravailAFaireFichierJoint A model object, or null if the key is not found
    ...
    {
        $sql = 'SELECT ID, ID_CT_DEVOIR, TITRE, TAILLE, EMPLACEMENT, VISIBLE_ELEVE_PARENT FROM ct_devoirs_documents WHERE ID = :p0';
        try {
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|CahierTexteTravailAFaireFichierJoint[]|mixed the list of results, formatted by the current formatter
     */
     ...
     *
     * @param   CahierTexteTravailAFaire|PropelObjectCollection $cahierTexteTravailAFaire The related object(s) to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   CahierTexteTravailAFaireFichierJointQuery The current query, for fluid interface
