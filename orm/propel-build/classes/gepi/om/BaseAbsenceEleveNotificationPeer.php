...
abstract class BaseAbsenceEleveNotificationPeer
{
     ...
     * e.g. AbsenceEleveNotificationPeer::$fieldNames[AbsenceEleveNotificationPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (AbsenceEleveNotificationPeer::ID, AbsenceEleveNotificationPeer::UTILISATEUR_ID, AbsenceEleveNotificationPeer::A_TRAITEMENT_ID, AbsenceEleveNotificationPeer::TYPE_NOTIFICATION, AbsenceEleveNotificationPeer::EMAIL, AbsenceEleveNotificationPeer::TELEPHONE, AbsenceEleveNotificationPeer::ADR_ID, AbsenceEleveNotificationPeer::COMMENTAIRE, AbsenceEleveNotificationPeer::STATUT_ENVOI, AbsenceEleveNotificationPeer::DATE_ENVOI, AbsenceEleveNotificationPeer::ERREUR_MESSAGE_ENVOI, AbsenceEleveNotificationPeer::CREATED_AT, AbsenceEleveNotificationPeer::UPDATED_AT, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. AbsenceEleveNotificationPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (AbsenceEleveNotificationPeer::ID => 0, AbsenceEleveNotificationPeer::UTILISATEUR_ID => 1, AbsenceEleveNotificationPeer::A_TRAITEMENT_ID => 2, AbsenceEleveNotificationPeer::TYPE_NOTIFICATION => 3, AbsenceEleveNotificationPeer::EMAIL => 4, AbsenceEleveNotificationPeer::TELEPHONE => 5, AbsenceEleveNotificationPeer::ADR_ID => 6, AbsenceEleveNotificationPeer::COMMENTAIRE => 7, AbsenceEleveNotificationPeer::STATUT_ENVOI => 8, AbsenceEleveNotificationPeer::DATE_ENVOI => 9, AbsenceEleveNotificationPeer::ERREUR_MESSAGE_ENVOI => 10, AbsenceEleveNotificationPeer::CREATED_AT => 11, AbsenceEleveNotificationPeer::UPDATED_AT => 12, ),
    ...
    protected static $enumValueSets = array(
        AbsenceEleveNotificationPeer::TYPE_NOTIFICATION => array(
        ...
        AbsenceEleveNotificationPeer::STATUT_ENVOI => array(
    ...
    {
        $toNames = AbsenceEleveNotificationPeer::getFieldNames($toType);
        $key = isset(AbsenceEleveNotificationPeer::$fieldKeys[$fromType][$name]) ? AbsenceEleveNotificationPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(AbsenceEleveNotificationPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, AbsenceEleveNotificationPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return AbsenceEleveNotificationPeer::$fieldNames[$type];
    }
    ...
    {
        $valueSets = AbsenceEleveNotificationPeer::getValueSets();
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(AbsenceEleveNotificationPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(AbsenceEleveNotificationPeer::DATABASE_NAME);
     ...
     *
     * @param      AbsenceEleveNotification $obj A AbsenceEleveNotification object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            AbsenceEleveNotificationPeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(AbsenceEleveNotificationPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(AbsenceEleveNotificationPeer::$instances[$key])) {
                return AbsenceEleveNotificationPeer::$instances[$key];
            }
        }
    ...
    {
        AbsenceEleveNotificationPeer::$instances = array();
    }
    ...
    public static function populateObjects(PDOStatement $stmt)
    {
        ...
        $cls = AbsenceEleveNotificationPeer::getOMClass();
    ...
    {
        return Propel::getDatabaseMap(AbsenceEleveNotificationPeer::DATABASE_NAME)->getTable(AbsenceEleveNotificationPeer::TABLE_NAME);
    }
    ...
    {
        return AbsenceEleveNotificationPeer::OM_CLASS;
    }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(AbsenceEleveNotificationPeer::DATABASE_NAME);
