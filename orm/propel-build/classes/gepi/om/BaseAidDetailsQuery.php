...
abstract class BaseAidDetailsQuery extends ModelCriteria
{
     ...
     * @param     AidDetailsQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     *
     * @return   AidDetails|AidDetails[]|mixed the result, formatted by the current formatter
     */
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|AidDetails[]|mixed the list of results, formatted by the current formatter
     */
     ...
     *
     * @param   AidConfiguration|PropelObjectCollection $aidConfiguration The related object(s) to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   AidDetailsQuery The current query, for fluid interface
    ...
    public function filterByAidConfiguration($aidConfiguration, $comparison = null)
    {
        ...
        } elseif ($aidConfiguration instanceof PropelObjectCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }
     ...
     *
     * @param   JAidEleves|PropelObjectCollection $jAidEleves  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   AidDetailsQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByJAidEleves($jAidEleves, $comparison = null)
    {
        ...
        } elseif ($jAidEleves instanceof PropelObjectCollection) {
            return $this
                ->useJAidElevesQuery()
