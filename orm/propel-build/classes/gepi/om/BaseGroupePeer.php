	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// invalidate objects in CtCompteRenduPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
			CtCompteRenduPeer::clearInstancePool();

			// invalidate objects in CtTravailAFairePeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
			CtTravailAFairePeer::clearInstancePool();
