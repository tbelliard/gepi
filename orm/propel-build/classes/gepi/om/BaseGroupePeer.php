...
abstract class BaseGroupePeer
{
     ...
     * e.g. GroupePeer::$fieldNames[GroupePeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (GroupePeer::ID, GroupePeer::NAME, GroupePeer::DESCRIPTION, GroupePeer::RECALCUL_RANG, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. GroupePeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (GroupePeer::ID => 0, GroupePeer::NAME => 1, GroupePeer::DESCRIPTION => 2, GroupePeer::RECALCUL_RANG => 3, ),
    ...
    {
        $toNames = GroupePeer::getFieldNames($toType);
        $key = isset(GroupePeer::$fieldKeys[$fromType][$name]) ? GroupePeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(GroupePeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, GroupePeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return GroupePeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(GroupePeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(GroupePeer::DATABASE_NAME);
     ...
     *
     * @param      Groupe $obj A Groupe object.
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(GroupePeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(GroupePeer::$instances[$key])) {
                return GroupePeer::$instances[$key];
            }
        }
    ...
    public static function populateObject($row, $startcol = 0)
    {
        ...
        if (null !== ($obj = GroupePeer::getInstanceFromPool($key))) {
            ...
            $col = $startcol + GroupePeer::NUM_HYDRATE_COLUMNS;
        } else {
    ...
    {
        return Propel::getDatabaseMap(GroupePeer::DATABASE_NAME)->getTable(GroupePeer::TABLE_NAME);
    }
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $affectedRows += BasePeer::doDeleteAll(GroupePeer::TABLE_NAME, $con, GroupePeer::DATABASE_NAME);
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        try {
            ...
            $c = clone $criteria;
            $affectedRows += GroupePeer::doOnDeleteCascade($c, $con);

            // cloning the Criteria in case it's modified by doSelect() or doSelectStmt()
            $c = clone $criteria;
            GroupePeer::doOnDeleteSetNull($c, $con);
