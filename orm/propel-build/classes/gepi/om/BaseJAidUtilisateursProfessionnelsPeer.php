...
/**
 * Base static class for performing query and update operations on the 'j_aid_utilisateurs' table.
 *
 * Table de liaison entre les AID et les utilisateurs professionnels
 *
 * @package propel.generator.gepi.om
 */
abstract class BaseJAidUtilisateursProfessionnelsPeer
{
    ...
    const TABLE_NAME = 'j_aid_utilisateurs';

    /** the related Propel class for this table */
    const OM_CLASS = 'JAidUtilisateursProfessionnels';
     ...
     * queries.
     * @var        array JAidUtilisateursProfessionnels[]
     */
     ...
     * e.g. JAidUtilisateursProfessionnelsPeer::$fieldNames[JAidUtilisateursProfessionnelsPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('IdAid', 'IdUtilisateur', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idAid', 'idUtilisateur', ),
        BasePeer::TYPE_COLNAME => array (JAidUtilisateursProfessionnelsPeer::ID_AID, JAidUtilisateursProfessionnelsPeer::ID_UTILISATEUR, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. JAidUtilisateursProfessionnelsPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('IdAid' => 0, 'IdUtilisateur' => 1, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idAid' => 0, 'idUtilisateur' => 1, ),
        BasePeer::TYPE_COLNAME => array (JAidUtilisateursProfessionnelsPeer::ID_AID => 0, JAidUtilisateursProfessionnelsPeer::ID_UTILISATEUR => 1, ),
    ...
    {
        $toNames = JAidUtilisateursProfessionnelsPeer::getFieldNames($toType);
        $key = isset(JAidUtilisateursProfessionnelsPeer::$fieldKeys[$fromType][$name]) ? JAidUtilisateursProfessionnelsPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(JAidUtilisateursProfessionnelsPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, JAidUtilisateursProfessionnelsPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return JAidUtilisateursProfessionnelsPeer::$fieldNames[$type];
    }
     ...
     * @param      string $column The column name for current table. (i.e. JAidUtilisateursProfessionnelsPeer::COLUMN_NAME).
     * @return string
     */
    public static function alias($alias, $column)
    {
        return str_replace(JAidUtilisateursProfessionnelsPeer::TABLE_NAME.'.', $alias.'.', $column);
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(JAidUtilisateursProfessionnelsPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectOne(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $critcopy->setLimit(1);
        $objects = JAidUtilisateursProfessionnelsPeer::doSelect($critcopy, $con);
        if ($objects) {
            return $objects[0];
        }
    ...
    {
        return JAidUtilisateursProfessionnelsPeer::populateObjects(JAidUtilisateursProfessionnelsPeer::doSelectStmt($criteria, $con));
    }
    /**
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(JAidUtilisateursProfessionnelsPeer::DATABASE_NAME);
     ...
     *
     * @param      JAidUtilisateursProfessionnels $obj A JAidUtilisateursProfessionnels object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            JAidUtilisateursProfessionnelsPeer::$instances[$key] = $obj;
        }
    }
     ...
     *
     * @param      mixed $value A JAidUtilisateursProfessionnels object or a primary key value.
     *
     * @return void
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof JAidUtilisateursProfessionnels) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or JAidUtilisateursProfessionnels object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
                throw $e;
            }

            unset(JAidUtilisateursProfessionnelsPeer::$instances[$key]);
        }
     ...
     * @return   JAidUtilisateursProfessionnels Found object or null if 1) no instance exists for specified key or 2) instance pooling has been disabled.
     * @see        getPrimaryKeyHash()
     */
    public static function getInstanceFromPool($key)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(JAidUtilisateursProfessionnelsPeer::$instances[$key])) {
                return JAidUtilisateursProfessionnelsPeer::$instances[$key];
            }
        }
    ...
    {
        JAidUtilisateursProfessionnelsPeer::$instances = array();
    }

    /**
     * Method to invalidate the instance pool of all tables related to j_aid_utilisateurs
    ...
    public static function populateObjects(PDOStatement $stmt)
    {
        ...
        $cls = JAidUtilisateursProfessionnelsPeer::getOMClass();
        // populate the object(s)
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key = JAidUtilisateursProfessionnelsPeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj = JAidUtilisateursProfessionnelsPeer::getInstanceFromPool($key))) {
                ...
                $obj->hydrate($row);
                $results[] = $obj;
                JAidUtilisateursProfessionnelsPeer::addInstanceToPool($obj, $key);
            } // if key exists
        }
        $stmt->closeCursor();
     ...
     * @throws PropelException Any exceptions caught during processing will be
     *		 rethrown wrapped into a PropelException.
     * @return array (JAidUtilisateursProfessionnels object, last column rank)
     */
    public static function populateObject($row, $startcol = 0)
    {
        $key = JAidUtilisateursProfessionnelsPeer::getPrimaryKeyHashFromRow($row, $startcol);
        if (null !== ($obj = JAidUtilisateursProfessionnelsPeer::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
    ...
    public static function doSelectJoinAidDetails(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (JAidUtilisateursProfessionnels) to $obj2 (AidDetails)
    ...
    /**
     * Selects a collection of JAidUtilisateursProfessionnels objects pre-filled with their UtilisateurProfessionnel objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of JAidUtilisateursProfessionnels objects.
    ...
    public static function doSelectJoinUtilisateurProfessionnel(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (JAidUtilisateursProfessionnels) to $obj2 (UtilisateurProfessionnel)
                $obj2->addJAidUtilisateursProfessionnels($obj1);
    ...
    /**
     * Selects a collection of JAidUtilisateursProfessionnels objects pre-filled with all related objects.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    /**
     * Selects a collection of JAidUtilisateursProfessionnels objects pre-filled with all related objects except AidDetails.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAllExceptAidDetails(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = JAidUtilisateursProfessionnelsPeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (JAidUtilisateursProfessionnels) to the collection in $obj2 (UtilisateurProfessionnel)
                $obj2->addJAidUtilisateursProfessionnels($obj1);
    ...
    /**
     * Selects a collection of JAidUtilisateursProfessionnels objects pre-filled with all related objects except UtilisateurProfessionnel.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    {
        return Propel::getDatabaseMap(JAidUtilisateursProfessionnelsPeer::DATABASE_NAME)->getTable(JAidUtilisateursProfessionnelsPeer::TABLE_NAME);
    }
    ...
    {
      $dbMap = Propel::getDatabaseMap(BaseJAidUtilisateursProfessionnelsPeer::DATABASE_NAME);
      if (!$dbMap->hasTable(BaseJAidUtilisateursProfessionnelsPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new JAidUtilisateursProfessionnelsTableMap());
      }
    }
    ...
    {
        return JAidUtilisateursProfessionnelsPeer::OM_CLASS;
    }
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria = $values->buildCriteria(); // build Criteria from JAidUtilisateursProfessionnels object
        }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(JAidUtilisateursProfessionnelsPeer::DATABASE_NAME);

        if ($values instanceof Criteria) {
            $criteria = clone $values; // rename for clarity

            $comparison = $criteria->getComparison(JAidUtilisateursProfessionnelsPeer::ID_AID);
            $value = $criteria->remove(JAidUtilisateursProfessionnelsPeer::ID_AID);
            if ($value) {
                $selectCriteria->add(JAidUtilisateursProfessionnelsPeer::ID_AID, $value, $comparison);
            } else {
        ...
        } else { // $values is JAidUtilisateursProfessionnels object
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += BasePeer::doDeleteAll(JAidUtilisateursProfessionnelsPeer::TABLE_NAME, $con, JAidUtilisateursProfessionnelsPeer::DATABASE_NAME);
            // Because this db requires some delete cascade/set null emulation, we have to
            // clear the cached instance *after* the emulation has happened (since
            // instances get re-added by the select statement contained therein).
            JAidUtilisateursProfessionnelsPeer::clearInstancePool();
            JAidUtilisateursProfessionnelsPeer::clearRelatedInstancePool();
            $con->commit();
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        } elseif ($values instanceof JAidUtilisateursProfessionnels) { // it's a model object
            // invalidate the cache for this single object
            JAidUtilisateursProfessionnelsPeer::removeInstanceFromPool($values);
    ...
    /**
     * Validates all modified columns of given JAidUtilisateursProfessionnels object.
     * If parameter $columns is either a single column name or an array of column names
     * than only those columns are validated.
     *
     * NOTICE: This does not apply to primary or foreign keys for now.
     *
     * @param      JAidUtilisateursProfessionnels $obj The object to validate.
    ...
    public static function doValidate($obj, $cols = null)
    {
        ...
        if ($cols) {
            $dbMap = Propel::getDatabaseMap(JAidUtilisateursProfessionnelsPeer::DATABASE_NAME);
            $tableMap = $dbMap->getTable(JAidUtilisateursProfessionnelsPeer::TABLE_NAME);
        ...
        return BasePeer::doValidate(JAidUtilisateursProfessionnelsPeer::DATABASE_NAME, JAidUtilisateursProfessionnelsPeer::TABLE_NAME, $columns);
    }
    ...
    public static function retrieveByPK($id_aid, $id_utilisateur, PropelPDO $con = null) {
        $_instancePoolKey = serialize(array((string) $id_aid, (string) $id_utilisateur));
         if (null !== ($obj = JAidUtilisateursProfessionnelsPeer::getInstanceFromPool($_instancePoolKey))) {
             return $obj;
        }
...
} // BaseJAidUtilisateursProfessionnelsPeer

// This is the static code needed to register the TableMap for this table with the main Propel class.
//
BaseJAidUtilisateursProfessionnelsPeer::buildTableMap();
