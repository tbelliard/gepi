...
/**
 * Base class that represents a row from the 'preferences' table.
 *
...
abstract class BasePreferenceUtilisateurProfessionnel extends BaseObject  implements Persistent
{
	 ...
	 * @var        PreferenceUtilisateurProfessionnelPeer
	 */
	...
	public function setValue($v)
	{
		...
		if ($this->value !== $v) {
			$this->value = $v;
			$this->modifiedColumns[] = PreferenceUtilisateurProfessionnelPeer::VALUE;
		}
	...
	public function setLogin($v)
	{
		...
		if ($this->login !== $v) {
			$this->login = $v;
			$this->modifiedColumns[] = PreferenceUtilisateurProfessionnelPeer::LOGIN;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = PreferenceUtilisateurProfessionnelPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating PreferenceUtilisateurProfessionnel object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = PreferenceUtilisateurProfessionnelPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = PreferenceUtilisateurProfessionnelPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = PreferenceUtilisateurProfessionnelPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['PreferenceUtilisateurProfessionnel'][serialize($this->getPrimaryKey())])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['PreferenceUtilisateurProfessionnel'][serialize($this->getPrimaryKey())] = true;
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PreferenceUtilisateurProfessionnelPeer::NAME)) $criteria->add(PreferenceUtilisateurProfessionnelPeer::NAME, $this->name);
		if ($this->isColumnModified(PreferenceUtilisateurProfessionnelPeer::VALUE)) $criteria->add(PreferenceUtilisateurProfessionnelPeer::VALUE, $this->value);
		if ($this->isColumnModified(PreferenceUtilisateurProfessionnelPeer::LOGIN)) $criteria->add(PreferenceUtilisateurProfessionnelPeer::LOGIN, $this->login);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of PreferenceUtilisateurProfessionnel (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     PreferenceUtilisateurProfessionnel Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     PreferenceUtilisateurProfessionnelPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new PreferenceUtilisateurProfessionnelPeer();
		}
		return self::$peer;
	}
	...
	public function setUtilisateurProfessionnel(UtilisateurProfessionnel $v = null)
	{
		...
		if ($v !== null) {
			$v->addPreferenceUtilisateurProfessionnel($this);
		}
