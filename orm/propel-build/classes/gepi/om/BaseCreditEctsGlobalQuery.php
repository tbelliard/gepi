...
abstract class BaseCreditEctsGlobalQuery extends ModelCriteria
{
     ...
     * @param     CreditEctsGlobalQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     * @param array $key Primary key to use for the query
                         A Primary key composition: [$id, $id_eleve]
     * @param     PropelPDO $con an optional connection object
     *
     * @return   CreditEctsGlobal|CreditEctsGlobal[]|mixed the result, formatted by the current formatter
     */
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|CreditEctsGlobal[]|mixed the list of results, formatted by the current formatter
     */
