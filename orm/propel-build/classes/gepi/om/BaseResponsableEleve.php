...
abstract class BaseResponsableEleve extends BaseObject implements Persistent
{
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->absenceEleveNotificationsScheduledForDeletion !== null) {
                if (!$this->absenceEleveNotificationsScheduledForDeletion->isEmpty()) {
                    ...
                    foreach ($this->absenceEleveNotificationsScheduledForDeletion->getPrimaryKeys(false) as $remotePk) {
    ...
    public function setResponsableInformations(PropelCollection $responsableInformations, PropelPDO $con = null)
    {
        ...
        foreach ($this->responsableInformationsScheduledForDeletion as $responsableInformationRemoved) {
            $responsableInformationRemoved->setResponsableEleve(null);
        }
    ...
    public function removeResponsableInformation($responsableInformation)
    {
        if ($this->getResponsableInformations()->contains($responsableInformation)) {
            ...
            $responsableInformation->setResponsableEleve(null);
        }
    }
    ...
    public function setJNotificationResponsableEleves(PropelCollection $jNotificationResponsableEleves, PropelPDO $con = null)
    {
        ...
        foreach ($this->jNotificationResponsableElevesScheduledForDeletion as $jNotificationResponsableEleveRemoved) {
            $jNotificationResponsableEleveRemoved->setResponsableEleve(null);
        }
    ...
    public function removeJNotificationResponsableEleve($jNotificationResponsableEleve)
    {
        if ($this->getJNotificationResponsableEleves()->contains($jNotificationResponsableEleve)) {
            ...
            $jNotificationResponsableEleve->setResponsableEleve(null);
        }
    }
    ...
    {
        $this->clearAbsenceEleveNotifications();
        $currentAbsenceEleveNotifications = $this->getAbsenceEleveNotifications();

        $this->absenceEleveNotificationsScheduledForDeletion = $currentAbsenceEleveNotifications->diff($absenceEleveNotifications);

        foreach ($absenceEleveNotifications as $absenceEleveNotification) {
            if (!$currentAbsenceEleveNotifications->contains($absenceEleveNotification)) {
    ...
    /**
     * Remove a AbsenceEleveNotification object to this object
     * through the j_notifications_resp_pers cross reference table.
     *
     * @param AbsenceEleveNotification $absenceEleveNotification The JNotificationResponsableEleve object to relate
     * @return void
     */
    public function removeAbsenceEleveNotification(AbsenceEleveNotification $absenceEleveNotification)
    {
