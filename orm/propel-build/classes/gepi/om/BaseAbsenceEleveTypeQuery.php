...
abstract class BaseAbsenceEleveTypeQuery extends ModelCriteria
{
     ...
     * @param     AbsenceEleveTypeQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     *
     * @return   AbsenceEleveType|AbsenceEleveType[]|mixed the result, formatted by the current formatter
     */
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|AbsenceEleveType[]|mixed the list of results, formatted by the current formatter
     */
     ...
     *
     * @param   AbsenceEleveTypeStatutAutorise|PropelObjectCollection $absenceEleveTypeStatutAutorise  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   AbsenceEleveTypeQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByAbsenceEleveTypeStatutAutorise($absenceEleveTypeStatutAutorise, $comparison = null)
    {
        ...
        } elseif ($absenceEleveTypeStatutAutorise instanceof PropelObjectCollection) {
            return $this
