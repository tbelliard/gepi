...
abstract class BaseJEleveProfesseurPrincipalQuery extends ModelCriteria
{
     ...
     * @param     JEleveProfesseurPrincipalQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     * @param array $key Primary key to use for the query
                         A Primary key composition: [$login, $professeur]
     * @param     PropelPDO $con an optional connection object
     *
     * @return   JEleveProfesseurPrincipal|JEleveProfesseurPrincipal[]|mixed the result, formatted by the current formatter
     */
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|JEleveProfesseurPrincipal[]|mixed the list of results, formatted by the current formatter
     */
