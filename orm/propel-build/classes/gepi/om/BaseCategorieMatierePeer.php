...
abstract class BaseCategorieMatierePeer
{
    ...
    /** the column name for the NOM_COURT field */
    const NOM_COURT = 'matieres_categories.NOM_COURT';

    /** the column name for the NOM_COMPLET field */
    const NOM_COMPLET = 'matieres_categories.NOM_COMPLET';
     ...
     * e.g. CategorieMatierePeer::$fieldNames[CategorieMatierePeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (CategorieMatierePeer::ID, CategorieMatierePeer::NOM_COURT, CategorieMatierePeer::NOM_COMPLET, CategorieMatierePeer::PRIORITY, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. CategorieMatierePeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (CategorieMatierePeer::ID => 0, CategorieMatierePeer::NOM_COURT => 1, CategorieMatierePeer::NOM_COMPLET => 2, CategorieMatierePeer::PRIORITY => 3, ),
    ...
    {
        $toNames = CategorieMatierePeer::getFieldNames($toType);
        $key = isset(CategorieMatierePeer::$fieldKeys[$fromType][$name]) ? CategorieMatierePeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(CategorieMatierePeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, CategorieMatierePeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return CategorieMatierePeer::$fieldNames[$type];
    }
     ...
     * @param      string $column The column name for current table. (i.e. CategorieMatierePeer::COLUMN_NAME).
     * @return string
     */
    public static function alias($alias, $column)
    {
        return str_replace(CategorieMatierePeer::TABLE_NAME.'.', $alias.'.', $column);
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setPrimaryTableName(CategorieMatierePeer::TABLE_NAME);
        ...
        $criteria->setDbName(CategorieMatierePeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectOne(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $critcopy->setLimit(1);
        $objects = CategorieMatierePeer::doSelect($critcopy, $con);
        if ($objects) {
            return $objects[0];
        }
    ...
    {
        return CategorieMatierePeer::populateObjects(CategorieMatierePeer::doSelectStmt($criteria, $con));
    }
    /**
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(CategorieMatierePeer::DATABASE_NAME);
     ...
     *
     * @param      CategorieMatiere $obj A CategorieMatiere object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            CategorieMatierePeer::$instances[$key] = $obj;
        }
    }
     ...
     *
     * @param      mixed $value A CategorieMatiere object or a primary key value.
     *
     * @return void
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof CategorieMatiere) {
                $key = (string) $value->getId();
            } elseif (is_scalar($value)) {
                // assume we've been passed a primary key
                $key = (string) $value;
            } else {
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or CategorieMatiere object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
                throw $e;
            }

            unset(CategorieMatierePeer::$instances[$key]);
        }
     ...
     * @return   CategorieMatiere Found object or null if 1) no instance exists for specified key or 2) instance pooling has been disabled.
     * @see        getPrimaryKeyHash()
     */
    public static function getInstanceFromPool($key)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(CategorieMatierePeer::$instances[$key])) {
                return CategorieMatierePeer::$instances[$key];
            }
        }
    ...
    {
        CategorieMatierePeer::$instances = array();
    }
    ...
    {
        return Propel::getDatabaseMap(CategorieMatierePeer::DATABASE_NAME)->getTable(CategorieMatierePeer::TABLE_NAME);
    }
    ...
    {
        return CategorieMatierePeer::OM_CLASS;
    }
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria = $values->buildCriteria(); // build Criteria from CategorieMatiere object
        }

        if ($criteria->containsKey(CategorieMatierePeer::ID) && $criteria->keyContainsValue(CategorieMatierePeer::ID) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(CategorieMatierePeer::DATABASE_NAME);
    ...
    /**
     * Validates all modified columns of given CategorieMatiere object.
     * If parameter $columns is either a single column name or an array of column names
     * than only those columns are validated.
     *
     * NOTICE: This does not apply to primary or foreign keys for now.
     *
     * @param      CategorieMatiere $obj The object to validate.
    ...
    public static function doValidate($obj, $cols = null)
    {
        ...
        if ($cols) {
            $dbMap = Propel::getDatabaseMap(CategorieMatierePeer::DATABASE_NAME);
            $tableMap = $dbMap->getTable(CategorieMatierePeer::TABLE_NAME);
        ...
        return BasePeer::doValidate(CategorieMatierePeer::DATABASE_NAME, CategorieMatierePeer::TABLE_NAME, $columns);
    }
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        if (null !== ($obj = CategorieMatierePeer::getInstanceFromPool((string) $pk))) {
            return $obj;
        }
        ...
        $criteria = new Criteria(CategorieMatierePeer::DATABASE_NAME);
        $criteria->add(CategorieMatierePeer::ID, $pk);

        $v = CategorieMatierePeer::doSelect($criteria, $con);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(CategorieMatierePeer::DATABASE_NAME);
            $criteria->add(CategorieMatierePeer::ID, $pks, Criteria::IN);
            $objs = CategorieMatierePeer::doSelect($criteria, $con);
        }
