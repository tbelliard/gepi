...
abstract class BaseResponsableInformationPeer
{
     ...
     * e.g. ResponsableInformationPeer::$fieldNames[ResponsableInformationPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (ResponsableInformationPeer::ELE_ID, ResponsableInformationPeer::PERS_ID, ResponsableInformationPeer::RESP_LEGAL, ResponsableInformationPeer::PERS_CONTACT, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. ResponsableInformationPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (ResponsableInformationPeer::ELE_ID => 0, ResponsableInformationPeer::PERS_ID => 1, ResponsableInformationPeer::RESP_LEGAL => 2, ResponsableInformationPeer::PERS_CONTACT => 3, ),
    ...
    {
        $toNames = ResponsableInformationPeer::getFieldNames($toType);
        $key = isset(ResponsableInformationPeer::$fieldKeys[$fromType][$name]) ? ResponsableInformationPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(ResponsableInformationPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, ResponsableInformationPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return ResponsableInformationPeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(ResponsableInformationPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(ResponsableInformationPeer::DATABASE_NAME);
     ...
     *
     * @param      ResponsableInformation $obj A ResponsableInformation object.
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(ResponsableInformationPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(ResponsableInformationPeer::$instances[$key])) {
                return ResponsableInformationPeer::$instances[$key];
            }
        }
    ...
    {
        ResponsableInformationPeer::$instances = array();
    }
    ...
    {
        return Propel::getDatabaseMap(ResponsableInformationPeer::DATABASE_NAME)->getTable(ResponsableInformationPeer::TABLE_NAME);
    }
    ...
    {
        return ResponsableInformationPeer::OM_CLASS;
    }

    /**
     * Performs an INSERT on the database, given a ResponsableInformation or Criteria object.
     *
    ...
    /**
     * Performs an UPDATE on the database, given a ResponsableInformation or Criteria object.
     *
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(ResponsableInformationPeer::DATABASE_NAME);
    ...
    /**
     * Deletes all rows from the responsables2 table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
    ...
    /**
     * Performs a DELETE on the database, given a ResponsableInformation or Criteria object OR a primary key value.
     *
