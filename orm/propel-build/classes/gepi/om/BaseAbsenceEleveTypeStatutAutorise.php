 ...
 */
abstract class BaseAbsenceEleveTypeStatutAutorise extends BaseObject  implements Persistent
{
	 ...
	 * @var        AbsenceEleveTypeStatutAutorisePeer
	 */
	...
	/**
	 * The value for the id_a_type field.
	 * @var        int
	 */
	protected $id_a_type;
	...
	/**
	 * Get the [id_a_type] column value.
	 * Cle etrangere de la table a_type
	 * @return     int
	 */
	public function getIdAType()
	{
		return $this->id_a_type;
	}
	 ...
	 * @return     AbsenceEleveTypeStatutAutorise The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = AbsenceEleveTypeStatutAutorisePeer::ID;
		}
	...
	/**
	 * Set the value of [id_a_type] column.
	 * Cle etrangere de la table a_type
	 * @param      int $v new value
	 * @return     AbsenceEleveTypeStatutAutorise The current object (for fluent API support)
	 */
	public function setIdAType($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}
		...
		if ($this->id_a_type !== $v) {
			$this->id_a_type = $v;
			$this->modifiedColumns[] = AbsenceEleveTypeStatutAutorisePeer::ID_A_TYPE;
		}
	...
	public function setStatut($v)
	{
		...
		if ($this->statut !== $v) {
			$this->statut = $v;
			$this->modifiedColumns[] = AbsenceEleveTypeStatutAutorisePeer::STATUT;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->id_a_type = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
	...
	public function ensureConsistency()
	{
		...
		if ($this->aAbsenceEleveType !== null && $this->id_a_type !== $this->aAbsenceEleveType->getId()) {
			$this->aAbsenceEleveType = null;
		}
	} // ensureConsistency
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = AbsenceEleveTypeStatutAutorisePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = AbsenceEleveTypeStatutAutoriseQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				AbsenceEleveTypeStatutAutorisePeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(AbsenceEleveTypeStatutAutorisePeer::ID)) {
			$modifiedColumns[':p' . $index++]  = 'ID';
		}
		if ($this->isColumnModified(AbsenceEleveTypeStatutAutorisePeer::ID_A_TYPE)) {
			$modifiedColumns[':p' . $index++]  = 'ID_A_TYPE';
		}
		if ($this->isColumnModified(AbsenceEleveTypeStatutAutorisePeer::STATUT)) {
			$modifiedColumns[':p' . $index++]  = 'STATUT';
		}

		$sql = sprintf(
			'INSERT INTO a_types_statut (%s) VALUES (%s)',
			...
			foreach ($modifiedColumns as $identifier => $columnName) {
				switch ($columnName) {
					case 'ID':
						...
						break;
					case 'ID_A_TYPE':
						$stmt->bindValue($identifier, $this->id_a_type, PDO::PARAM_INT);
						break;
					case 'STATUT':
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = AbsenceEleveTypeStatutAutorisePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = AbsenceEleveTypeStatutAutorisePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setIdAType($arr[$keys[1]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AbsenceEleveTypeStatutAutorisePeer::ID)) $criteria->add(AbsenceEleveTypeStatutAutorisePeer::ID, $this->id);
		if ($this->isColumnModified(AbsenceEleveTypeStatutAutorisePeer::ID_A_TYPE)) $criteria->add(AbsenceEleveTypeStatutAutorisePeer::ID_A_TYPE, $this->id_a_type);
		if ($this->isColumnModified(AbsenceEleveTypeStatutAutorisePeer::STATUT)) $criteria->add(AbsenceEleveTypeStatutAutorisePeer::STATUT, $this->statut);
	...
	{
		$criteria = new Criteria(AbsenceEleveTypeStatutAutorisePeer::DATABASE_NAME);
		$criteria->add(AbsenceEleveTypeStatutAutorisePeer::ID, $this->id);
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     AbsenceEleveTypeStatutAutorise Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     AbsenceEleveTypeStatutAutorisePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new AbsenceEleveTypeStatutAutorisePeer();
		}
		return self::$peer;
	}
	...
	{
		if ($v === null) {
			$this->setIdAType(NULL);
		} else {
			$this->setIdAType($v->getId());
		}
		...
		if ($v !== null) {
			$v->addAbsenceEleveTypeStatutAutorise($this);
		}
...
} // BaseAbsenceEleveTypeStatutAutorise
