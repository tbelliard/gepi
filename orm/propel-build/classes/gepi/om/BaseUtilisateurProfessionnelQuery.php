...
abstract class BaseUtilisateurProfessionnelQuery extends ModelCriteria
{
     ...
     * @param     UtilisateurProfessionnelQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     *
     * @return   UtilisateurProfessionnel|UtilisateurProfessionnel[]|mixed the result, formatted by the current formatter
     */
     ...
     */
     public function findOneByLogin($key, $con = null)
     {
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|UtilisateurProfessionnel[]|mixed the list of results, formatted by the current formatter
     */
     ...
     *
     * @param   JGroupesProfesseurs|PropelObjectCollection $jGroupesProfesseurs  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   UtilisateurProfessionnelQuery The current query, for fluid interface
    ...
    public function filterByJGroupesProfesseurs($jGroupesProfesseurs, $comparison = null)
    {
        ...
        } elseif ($jGroupesProfesseurs instanceof PropelObjectCollection) {
            return $this
     ...
     *
     * @param   JScolClasses|PropelObjectCollection $jScolClasses  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   UtilisateurProfessionnelQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByJScolClasses($jScolClasses, $comparison = null)
    {
        ...
        } elseif ($jScolClasses instanceof PropelObjectCollection) {
            return $this
     ...
     *
     * @param   CahierTexteCompteRendu|PropelObjectCollection $cahierTexteCompteRendu  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   UtilisateurProfessionnelQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByCahierTexteCompteRendu($cahierTexteCompteRendu, $comparison = null)
    {
        ...
        } elseif ($cahierTexteCompteRendu instanceof PropelObjectCollection) {
            return $this
     ...
     *
     * @param   CahierTexteTravailAFaire|PropelObjectCollection $cahierTexteTravailAFaire  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   UtilisateurProfessionnelQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByCahierTexteTravailAFaire($cahierTexteTravailAFaire, $comparison = null)
    {
        ...
        } elseif ($cahierTexteTravailAFaire instanceof PropelObjectCollection) {
            return $this
     ...
     *
     * @param   CahierTexteNoticePrivee|PropelObjectCollection $cahierTexteNoticePrivee  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   UtilisateurProfessionnelQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByCahierTexteNoticePrivee($cahierTexteNoticePrivee, $comparison = null)
    {
        ...
        } elseif ($cahierTexteNoticePrivee instanceof PropelObjectCollection) {
            return $this
     ...
     *
     * @param   JEleveCpe|PropelObjectCollection $jEleveCpe  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   UtilisateurProfessionnelQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByJEleveCpe($jEleveCpe, $comparison = null)
    {
        ...
        } elseif ($jEleveCpe instanceof PropelObjectCollection) {
            return $this
                ->useJEleveCpeQuery()
     ...
     *
     * @param   JEleveProfesseurPrincipal|PropelObjectCollection $jEleveProfesseurPrincipal  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   UtilisateurProfessionnelQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByJEleveProfesseurPrincipal($jEleveProfesseurPrincipal, $comparison = null)
    {
        ...
        } elseif ($jEleveProfesseurPrincipal instanceof PropelObjectCollection) {
            return $this
     ...
     *
     * @param   JAidUtilisateursProfessionnels|PropelObjectCollection $jAidUtilisateursProfessionnels  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   UtilisateurProfessionnelQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByJAidUtilisateursProfessionnels($jAidUtilisateursProfessionnels, $comparison = null)
    {
        ...
        } elseif ($jAidUtilisateursProfessionnels instanceof PropelObjectCollection) {
            return $this
     ...
     *
     * @param   AbsenceEleveSaisie|PropelObjectCollection $absenceEleveSaisie  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   UtilisateurProfessionnelQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByAbsenceEleveSaisie($absenceEleveSaisie, $comparison = null)
    {
        ...
        } elseif ($absenceEleveSaisie instanceof PropelObjectCollection) {
            return $this
     ...
     *
     * @param   AbsenceEleveTraitement|PropelObjectCollection $absenceEleveTraitement  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   UtilisateurProfessionnelQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByAbsenceEleveTraitement($absenceEleveTraitement, $comparison = null)
    {
        ...
        } elseif ($absenceEleveTraitement instanceof PropelObjectCollection) {
            return $this
     ...
     *
     * @param   AbsenceEleveNotification|PropelObjectCollection $absenceEleveNotification  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   UtilisateurProfessionnelQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByAbsenceEleveNotification($absenceEleveNotification, $comparison = null)
    {
        ...
        } elseif ($absenceEleveNotification instanceof PropelObjectCollection) {
            return $this
     ...
     *
     * @param   JProfesseursMatieres|PropelObjectCollection $jProfesseursMatieres  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   UtilisateurProfessionnelQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByJProfesseursMatieres($jProfesseursMatieres, $comparison = null)
    {
        ...
        } elseif ($jProfesseursMatieres instanceof PropelObjectCollection) {
            return $this
     ...
     *
     * @param   PreferenceUtilisateurProfessionnel|PropelObjectCollection $preferenceUtilisateurProfessionnel  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   UtilisateurProfessionnelQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByPreferenceUtilisateurProfessionnel($preferenceUtilisateurProfessionnel, $comparison = null)
    {
        ...
        } elseif ($preferenceUtilisateurProfessionnel instanceof PropelObjectCollection) {
            return $this
     ...
     *
     * @param   EdtEmplacementCours|PropelObjectCollection $edtEmplacementCours  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   UtilisateurProfessionnelQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByEdtEmplacementCours($edtEmplacementCours, $comparison = null)
    {
        ...
        } elseif ($edtEmplacementCours instanceof PropelObjectCollection) {
            return $this
