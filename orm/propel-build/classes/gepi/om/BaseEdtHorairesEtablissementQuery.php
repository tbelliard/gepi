...
abstract class BaseEdtHorairesEtablissementQuery extends ModelCriteria
{
     ...
     * @param     EdtHorairesEtablissementQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     *
     * @return   EdtHorairesEtablissement|EdtHorairesEtablissement[]|mixed the result, formatted by the current formatter
     */
     ...
     */
     public function findOneByIdHoraireEtablissement($key, $con = null)
     {
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|EdtHorairesEtablissement[]|mixed the list of results, formatted by the current formatter
     */
