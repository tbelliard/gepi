...
abstract class BaseJEleveProfesseurPrincipalPeer
{
     ...
     * e.g. JEleveProfesseurPrincipalPeer::$fieldNames[JEleveProfesseurPrincipalPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Login', 'Professeur', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('login', 'professeur', ),
        BasePeer::TYPE_COLNAME => array (JEleveProfesseurPrincipalPeer::LOGIN, JEleveProfesseurPrincipalPeer::PROFESSEUR, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. JEleveProfesseurPrincipalPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Login' => 0, 'Professeur' => 1, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('login' => 0, 'professeur' => 1, ),
        BasePeer::TYPE_COLNAME => array (JEleveProfesseurPrincipalPeer::LOGIN => 0, JEleveProfesseurPrincipalPeer::PROFESSEUR => 1, ),
    ...
    {
        $toNames = JEleveProfesseurPrincipalPeer::getFieldNames($toType);
        $key = isset(JEleveProfesseurPrincipalPeer::$fieldKeys[$fromType][$name]) ? JEleveProfesseurPrincipalPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(JEleveProfesseurPrincipalPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, JEleveProfesseurPrincipalPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return JEleveProfesseurPrincipalPeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(JEleveProfesseurPrincipalPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(JEleveProfesseurPrincipalPeer::DATABASE_NAME);
     ...
     *
     * @param      JEleveProfesseurPrincipal $obj A JEleveProfesseurPrincipal object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            JEleveProfesseurPrincipalPeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(JEleveProfesseurPrincipalPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(JEleveProfesseurPrincipalPeer::$instances[$key])) {
                return JEleveProfesseurPrincipalPeer::$instances[$key];
            }
        }
    ...
    {
        JEleveProfesseurPrincipalPeer::$instances = array();
    }
    ...
    public static function populateObjects(PDOStatement $stmt)
    {
        ...
        $cls = JEleveProfesseurPrincipalPeer::getOMClass();
    ...
    {
        return Propel::getDatabaseMap(JEleveProfesseurPrincipalPeer::DATABASE_NAME)->getTable(JEleveProfesseurPrincipalPeer::TABLE_NAME);
    }
    ...
    {
        return JEleveProfesseurPrincipalPeer::OM_CLASS;
    }

    /**
     * Performs an INSERT on the database, given a JEleveProfesseurPrincipal or Criteria object.
     *
    ...
    /**
     * Performs an UPDATE on the database, given a JEleveProfesseurPrincipal or Criteria object.
     *
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(JEleveProfesseurPrincipalPeer::DATABASE_NAME);
    ...
    /**
     * Deletes all rows from the j_eleves_professeurs table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
    ...
    /**
     * Performs a DELETE on the database, given a JEleveProfesseurPrincipal or Criteria object OR a primary key value.
     *
