...
abstract class BaseElevePeer
{
     ...
     * e.g. ElevePeer::$fieldNames[ElevePeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (ElevePeer::NO_GEP, ElevePeer::LOGIN, ElevePeer::NOM, ElevePeer::PRENOM, ElevePeer::SEXE, ElevePeer::NAISSANCE, ElevePeer::LIEU_NAISSANCE, ElevePeer::ELENOET, ElevePeer::ERENO, ElevePeer::ELE_ID, ElevePeer::EMAIL, ElevePeer::ID_ELEVE, ElevePeer::DATE_SORTIE, ElevePeer::MEF_CODE, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. ElevePeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (ElevePeer::NO_GEP => 0, ElevePeer::LOGIN => 1, ElevePeer::NOM => 2, ElevePeer::PRENOM => 3, ElevePeer::SEXE => 4, ElevePeer::NAISSANCE => 5, ElevePeer::LIEU_NAISSANCE => 6, ElevePeer::ELENOET => 7, ElevePeer::ERENO => 8, ElevePeer::ELE_ID => 9, ElevePeer::EMAIL => 10, ElevePeer::ID_ELEVE => 11, ElevePeer::DATE_SORTIE => 12, ElevePeer::MEF_CODE => 13, ),
    ...
    {
        $toNames = ElevePeer::getFieldNames($toType);
        $key = isset(ElevePeer::$fieldKeys[$fromType][$name]) ? ElevePeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(ElevePeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, ElevePeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return ElevePeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(ElevePeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(ElevePeer::DATABASE_NAME);
     ...
     *
     * @param      Eleve $obj A Eleve object.
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(ElevePeer::$instances[$key])) {
                return ElevePeer::$instances[$key];
            }
        }
    ...
    {
        return Propel::getDatabaseMap(ElevePeer::DATABASE_NAME)->getTable(ElevePeer::TABLE_NAME);
    }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(ElevePeer::DATABASE_NAME);
