...
abstract class BasePreferenceUtilisateurProfessionnelPeer
{
     ...
     * queries.
     * @var        array PreferenceUtilisateurProfessionnel[]
     */
     ...
     * e.g. PreferenceUtilisateurProfessionnelPeer::$fieldNames[PreferenceUtilisateurProfessionnelPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Name', 'Value', 'Login', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('name', 'value', 'login', ),
        BasePeer::TYPE_COLNAME => array (PreferenceUtilisateurProfessionnelPeer::NAME, PreferenceUtilisateurProfessionnelPeer::VALUE, PreferenceUtilisateurProfessionnelPeer::LOGIN, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. PreferenceUtilisateurProfessionnelPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Name' => 0, 'Value' => 1, 'Login' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('name' => 0, 'value' => 1, 'login' => 2, ),
        BasePeer::TYPE_COLNAME => array (PreferenceUtilisateurProfessionnelPeer::NAME => 0, PreferenceUtilisateurProfessionnelPeer::VALUE => 1, PreferenceUtilisateurProfessionnelPeer::LOGIN => 2, ),
    ...
    {
        $toNames = PreferenceUtilisateurProfessionnelPeer::getFieldNames($toType);
        $key = isset(PreferenceUtilisateurProfessionnelPeer::$fieldKeys[$fromType][$name]) ? PreferenceUtilisateurProfessionnelPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(PreferenceUtilisateurProfessionnelPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, PreferenceUtilisateurProfessionnelPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return PreferenceUtilisateurProfessionnelPeer::$fieldNames[$type];
    }
     ...
     * @param      string $column The column name for current table. (i.e. PreferenceUtilisateurProfessionnelPeer::COLUMN_NAME).
     * @return string
     */
    public static function alias($alias, $column)
    {
        return str_replace(PreferenceUtilisateurProfessionnelPeer::TABLE_NAME.'.', $alias.'.', $column);
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setPrimaryTableName(PreferenceUtilisateurProfessionnelPeer::TABLE_NAME);
        ...
        $criteria->setDbName(PreferenceUtilisateurProfessionnelPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectOne(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $critcopy->setLimit(1);
        $objects = PreferenceUtilisateurProfessionnelPeer::doSelect($critcopy, $con);
        if ($objects) {
            return $objects[0];
        }
    ...
    {
        return PreferenceUtilisateurProfessionnelPeer::populateObjects(PreferenceUtilisateurProfessionnelPeer::doSelectStmt($criteria, $con));
    }
    /**
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(PreferenceUtilisateurProfessionnelPeer::DATABASE_NAME);
     ...
     *
     * @param      PreferenceUtilisateurProfessionnel $obj A PreferenceUtilisateurProfessionnel object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if ($key === null) {
                $key = serialize(array((string) $obj->getName(), (string) $obj->getLogin()));
            } // if key === null
            PreferenceUtilisateurProfessionnelPeer::$instances[$key] = $obj;
        }
    }
     ...
     *
     * @param      mixed $value A PreferenceUtilisateurProfessionnel object or a primary key value.
     *
     * @return void
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof PreferenceUtilisateurProfessionnel) {
                $key = serialize(array((string) $value->getName(), (string) $value->getLogin()));
            } elseif (is_array($value) && count($value) === 2) {
                // assume we've been passed a primary key
                $key = serialize(array((string) $value[0], (string) $value[1]));
            } else {
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or PreferenceUtilisateurProfessionnel object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
                throw $e;
            }

            unset(PreferenceUtilisateurProfessionnelPeer::$instances[$key]);
        }
     ...
     * @return   PreferenceUtilisateurProfessionnel Found object or null if 1) no instance exists for specified key or 2) instance pooling has been disabled.
     * @see        getPrimaryKeyHash()
     */
    public static function getInstanceFromPool($key)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(PreferenceUtilisateurProfessionnelPeer::$instances[$key])) {
                return PreferenceUtilisateurProfessionnelPeer::$instances[$key];
            }
        }
    ...
    {
        PreferenceUtilisateurProfessionnelPeer::$instances = array();
    }
    ...
    public static function doSelectJoinUtilisateurProfessionnel(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (PreferenceUtilisateurProfessionnel) to $obj2 (UtilisateurProfessionnel)
                $obj2->addPreferenceUtilisateurProfessionnel($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (PreferenceUtilisateurProfessionnel) to the collection in $obj2 (UtilisateurProfessionnel)
                $obj2->addPreferenceUtilisateurProfessionnel($obj1);
    ...
    {
        return Propel::getDatabaseMap(PreferenceUtilisateurProfessionnelPeer::DATABASE_NAME)->getTable(PreferenceUtilisateurProfessionnelPeer::TABLE_NAME);
    }
    ...
    {
        return PreferenceUtilisateurProfessionnelPeer::OM_CLASS;
    }

    /**
     * Performs an INSERT on the database, given a PreferenceUtilisateurProfessionnel or Criteria object.
     *
     * @param      mixed $values Criteria or PreferenceUtilisateurProfessionnel object containing data that is used to create the INSERT statement.
    ...
    /**
     * Performs an UPDATE on the database, given a PreferenceUtilisateurProfessionnel or Criteria object.
     *
     * @param      mixed $values Criteria or PreferenceUtilisateurProfessionnel object containing data that is used to create the UPDATE statement.
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(PreferenceUtilisateurProfessionnelPeer::DATABASE_NAME);
    ...
    /**
     * Performs a DELETE on the database, given a PreferenceUtilisateurProfessionnel or Criteria object OR a primary key value.
     *
     * @param      mixed $values Criteria or PreferenceUtilisateurProfessionnel object or primary key or array of primary keys
    ...
    public static function retrieveByPK($name, $login, PropelPDO $con = null) {
        ...
        $criteria->add(PreferenceUtilisateurProfessionnelPeer::LOGIN, $login);
        $v = PreferenceUtilisateurProfessionnelPeer::doSelect($criteria, $con);
