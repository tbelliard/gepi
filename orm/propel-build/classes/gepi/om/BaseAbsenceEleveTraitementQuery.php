...
abstract class BaseAbsenceEleveTraitementQuery extends ModelCriteria
{
     ...
     * @param     AbsenceEleveTraitementQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     *
     * @return   AbsenceEleveTraitement|AbsenceEleveTraitement[]|mixed the result, formatted by the current formatter
     */
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|AbsenceEleveTraitement[]|mixed the list of results, formatted by the current formatter
     */
     ...
     *
     * @param   AbsenceEleveType|PropelObjectCollection $absenceEleveType The related object(s) to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   AbsenceEleveTraitementQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
     ...
     *
     * @param   AbsenceEleveMotif|PropelObjectCollection $absenceEleveMotif The related object(s) to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   AbsenceEleveTraitementQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByAbsenceEleveMotif($absenceEleveMotif, $comparison = null)
    {
        ...
        } elseif ($absenceEleveMotif instanceof PropelObjectCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }
     ...
     *
     * @param   AbsenceEleveJustification|PropelObjectCollection $absenceEleveJustification The related object(s) to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   AbsenceEleveTraitementQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByAbsenceEleveJustification($absenceEleveJustification, $comparison = null)
    {
        ...
        } elseif ($absenceEleveJustification instanceof PropelObjectCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }
