...
abstract class BaseCahierTexteCompteRendu extends BaseObject implements Persistent
{
    ...
    /**
     * @var        PropelObjectCollection|CahierTexteCompteRenduFichierJoint[] Collection to store aggregation of CahierTexteCompteRenduFichierJoint objects.
     */
    protected $collCahierTexteCompteRenduFichierJoints;
    protected $collCahierTexteCompteRenduFichierJointsPartial;
    ...
    public function clearCahierTexteCompteRenduFichierJoints()
    {
        ...
        $this->collCahierTexteCompteRenduFichierJointsPartial = null;
    }

    /**
     * reset is the collCahierTexteCompteRenduFichierJoints collection loaded partially
     *
     * @return void
     */
    public function resetPartialCahierTexteCompteRenduFichierJoints($v = true)
    {
        $this->collCahierTexteCompteRenduFichierJointsPartial = $v;
    }
     ...
     * @param PropelPDO $con optional connection object
     * @return PropelObjectCollection|CahierTexteCompteRenduFichierJoint[] List of CahierTexteCompteRenduFichierJoint objects
     * @throws PropelException
     */
    public function getCahierTexteCompteRenduFichierJoints($criteria = null, PropelPDO $con = null)
    {
        $partial = $this->collCahierTexteCompteRenduFichierJointsPartial && !$this->isNew();
        if (null === $this->collCahierTexteCompteRenduFichierJoints || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collCahierTexteCompteRenduFichierJoints) {
                ...
                $collCahierTexteCompteRenduFichierJoints = CahierTexteCompteRenduFichierJointQuery::create(null, $criteria)
                    ...
                    ->find($con);
                if (null !== $criteria) {
                    if (false !== $this->collCahierTexteCompteRenduFichierJointsPartial && count($collCahierTexteCompteRenduFichierJoints)) {
                      $this->initCahierTexteCompteRenduFichierJoints(false);

                      foreach($collCahierTexteCompteRenduFichierJoints as $obj) {
                        if (false == $this->collCahierTexteCompteRenduFichierJoints->contains($obj)) {
                          $this->collCahierTexteCompteRenduFichierJoints->append($obj);
                        }
                      }

                      $this->collCahierTexteCompteRenduFichierJointsPartial = true;
                    }

                    return $collCahierTexteCompteRenduFichierJoints;
                }

                if($partial && $this->collCahierTexteCompteRenduFichierJoints) {
                    foreach($this->collCahierTexteCompteRenduFichierJoints as $obj) {
                        if($obj->isNew()) {
                            $collCahierTexteCompteRenduFichierJoints[] = $obj;
                        }
                    }
                }

                $this->collCahierTexteCompteRenduFichierJoints = $collCahierTexteCompteRenduFichierJoints;
                $this->collCahierTexteCompteRenduFichierJointsPartial = false;
            }
        }
    ...
    public function setCahierTexteCompteRenduFichierJoints(PropelCollection $cahierTexteCompteRenduFichierJoints, PropelPDO $con = null)
    {
        ...
        foreach ($this->cahierTexteCompteRenduFichierJointsScheduledForDeletion as $cahierTexteCompteRenduFichierJointRemoved) {
            $cahierTexteCompteRenduFichierJointRemoved->setCahierTexteCompteRendu(null);
        }
    ...
    public function countCahierTexteCompteRenduFichierJoints(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        ...
        if (null === $this->collCahierTexteCompteRenduFichierJoints || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collCahierTexteCompteRenduFichierJoints) {
                ...
                if($partial && !$criteria) {
                    return count($this->getCahierTexteCompteRenduFichierJoints());
                }
    ...
    public function addCahierTexteCompteRenduFichierJoint(CahierTexteCompteRenduFichierJoint $l)
    {
        ...
        if (!in_array($l, $this->collCahierTexteCompteRenduFichierJoints->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
    ...
    /**
     * @param	CahierTexteCompteRenduFichierJoint $cahierTexteCompteRenduFichierJoint The cahierTexteCompteRenduFichierJoint object to remove.
     */
    public function removeCahierTexteCompteRenduFichierJoint($cahierTexteCompteRenduFichierJoint)
    {
        if ($this->getCahierTexteCompteRenduFichierJoints()->contains($cahierTexteCompteRenduFichierJoint)) {
            $this->collCahierTexteCompteRenduFichierJoints->remove($this->collCahierTexteCompteRenduFichierJoints->search($cahierTexteCompteRenduFichierJoint));
            if (null === $this->cahierTexteCompteRenduFichierJointsScheduledForDeletion) {
                $this->cahierTexteCompteRenduFichierJointsScheduledForDeletion = clone $this->collCahierTexteCompteRenduFichierJoints;
                $this->cahierTexteCompteRenduFichierJointsScheduledForDeletion->clear();
            }
            $this->cahierTexteCompteRenduFichierJointsScheduledForDeletion[]= $cahierTexteCompteRenduFichierJoint;
            $cahierTexteCompteRenduFichierJoint->setCahierTexteCompteRendu(null);
        }
    }
