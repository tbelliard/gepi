...
abstract class BaseResponsableEleveQuery extends ModelCriteria
{
     ...
     * @param     ResponsableEleveQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     *
     * @return   ResponsableEleve|ResponsableEleve[]|mixed the result, formatted by the current formatter
     */
     ...
     */
     public function findOneByResponsableEleveId($key, $con = null)
     {
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|ResponsableEleve[]|mixed the list of results, formatted by the current formatter
     */
     ...
     *
     * @param   ResponsableInformation|PropelObjectCollection $responsableInformation  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   ResponsableEleveQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByResponsableInformation($responsableInformation, $comparison = null)
    {
        ...
        } elseif ($responsableInformation instanceof PropelObjectCollection) {
            return $this
