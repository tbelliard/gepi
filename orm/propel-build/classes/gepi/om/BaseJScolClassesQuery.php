...
abstract class BaseJScolClassesQuery extends ModelCriteria
{
     ...
     * @param     JScolClassesQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     * @param array $key Primary key to use for the query
                         A Primary key composition: [$login, $id_classe]
     * @param     PropelPDO $con an optional connection object
     *
     * @return   JScolClasses|JScolClasses[]|mixed the result, formatted by the current formatter
     */
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|JScolClasses[]|mixed the list of results, formatted by the current formatter
     */
