...
abstract class BaseEdtCalendrierPeriodeQuery extends ModelCriteria
{
     ...
     * @param     EdtCalendrierPeriodeQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     *
     * @return   EdtCalendrierPeriode|EdtCalendrierPeriode[]|mixed the result, formatted by the current formatter
     */
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|EdtCalendrierPeriode[]|mixed the list of results, formatted by the current formatter
     */
