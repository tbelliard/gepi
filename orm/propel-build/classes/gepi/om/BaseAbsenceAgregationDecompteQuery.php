...
abstract class BaseAbsenceAgregationDecompteQuery extends ModelCriteria
{
     ...
     * @param     AbsenceAgregationDecompteQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     * @param array $key Primary key to use for the query
                         A Primary key composition: [$eleve_id, $date_demi_jounee]
     * @param     PropelPDO $con an optional connection object
     *
     * @return   AbsenceAgregationDecompte|AbsenceAgregationDecompte[]|mixed the result, formatted by the current formatter
     */
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|AbsenceAgregationDecompte[]|mixed the list of results, formatted by the current formatter
     */
