...
abstract class BaseEdtEmplacementCoursPeer
{
     ...
     * e.g. EdtEmplacementCoursPeer::$fieldNames[EdtEmplacementCoursPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (EdtEmplacementCoursPeer::ID_COURS, EdtEmplacementCoursPeer::ID_GROUPE, EdtEmplacementCoursPeer::ID_AID, EdtEmplacementCoursPeer::ID_SALLE, EdtEmplacementCoursPeer::JOUR_SEMAINE, EdtEmplacementCoursPeer::ID_DEFINIE_PERIODE, EdtEmplacementCoursPeer::DUREE, EdtEmplacementCoursPeer::HEUREDEB_DEC, EdtEmplacementCoursPeer::ID_SEMAINE, EdtEmplacementCoursPeer::ID_CALENDRIER, EdtEmplacementCoursPeer::MODIF_EDT, EdtEmplacementCoursPeer::LOGIN_PROF, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. EdtEmplacementCoursPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (EdtEmplacementCoursPeer::ID_COURS => 0, EdtEmplacementCoursPeer::ID_GROUPE => 1, EdtEmplacementCoursPeer::ID_AID => 2, EdtEmplacementCoursPeer::ID_SALLE => 3, EdtEmplacementCoursPeer::JOUR_SEMAINE => 4, EdtEmplacementCoursPeer::ID_DEFINIE_PERIODE => 5, EdtEmplacementCoursPeer::DUREE => 6, EdtEmplacementCoursPeer::HEUREDEB_DEC => 7, EdtEmplacementCoursPeer::ID_SEMAINE => 8, EdtEmplacementCoursPeer::ID_CALENDRIER => 9, EdtEmplacementCoursPeer::MODIF_EDT => 10, EdtEmplacementCoursPeer::LOGIN_PROF => 11, ),
    ...
    {
        $toNames = EdtEmplacementCoursPeer::getFieldNames($toType);
        $key = isset(EdtEmplacementCoursPeer::$fieldKeys[$fromType][$name]) ? EdtEmplacementCoursPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(EdtEmplacementCoursPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, EdtEmplacementCoursPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return EdtEmplacementCoursPeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(EdtEmplacementCoursPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(EdtEmplacementCoursPeer::DATABASE_NAME);
     ...
     *
     * @param      EdtEmplacementCours $obj A EdtEmplacementCours object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            EdtEmplacementCoursPeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(EdtEmplacementCoursPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(EdtEmplacementCoursPeer::$instances[$key])) {
                return EdtEmplacementCoursPeer::$instances[$key];
            }
        }
    ...
    {
        EdtEmplacementCoursPeer::$instances = array();
    }
    ...
    {
        return Propel::getDatabaseMap(EdtEmplacementCoursPeer::DATABASE_NAME)->getTable(EdtEmplacementCoursPeer::TABLE_NAME);
    }
    ...
    {
        return EdtEmplacementCoursPeer::OM_CLASS;
    }

    /**
     * Performs an INSERT on the database, given a EdtEmplacementCours or Criteria object.
     *
    ...
    /**
     * Performs an UPDATE on the database, given a EdtEmplacementCours or Criteria object.
     *
    ...
    /**
     * Deletes all rows from the edt_cours table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
    ...
    /**
     * Performs a DELETE on the database, given a EdtEmplacementCours or Criteria object OR a primary key value.
     *
