...
abstract class BaseAbsenceEleveJustification extends BaseObject  implements Persistent {
	...
	/**
	 * Initializes internal state of BaseAbsenceEleveJustification object.
	 * @see        applyDefaults()
	 */
	 ...
	 * Ordre d'affichage de la justification dans la liste déroulante
	 * @return     int
	 */
	...
	public function setOrdre($v)
	{
		...
		if ($this->ordre !== $v) {
			$this->ordre = $v;
			$this->modifiedColumns[] = AbsenceEleveJustificationPeer::ORDRE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = AbsenceEleveJustificationPeer::NUM_COLUMNS - AbsenceEleveJustificationPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			AbsenceEleveJustificationPeer::doDelete($this, $con);
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = AbsenceEleveJustificationPeer::doInsert($this, $con);
					...
					$affectedRows += AbsenceEleveJustificationPeer::doUpdate($this, $con);
				}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AbsenceEleveJustificationPeer::ORDRE)) $criteria->add(AbsenceEleveJustificationPeer::ORDRE, $this->ordre);
	 ...
	 * Otherwise if this AbsenceEleveJustification has previously been saved, it will retrieve
	 * related AbsenceEleveTraitements from storage. If this AbsenceEleveJustification is new, it will return
		...
		if ($this->collAbsenceEleveTraitements === null) {
			if ($this->isNew()) {
			   $this->collAbsenceEleveTraitements = array();
				...
				$criteria->add(AbsenceEleveTraitementPeer::A_JUSTIFICATION_ID, $this->id);
	...
	public function addAbsenceEleveTraitement(AbsenceEleveTraitement $l)
	{
		...
		if (!in_array($l, $this->collAbsenceEleveTraitements, true)) { // only add it if the **same** object is not already associated
			...
			$l->setAbsenceEleveJustification($this);
		}
	}
