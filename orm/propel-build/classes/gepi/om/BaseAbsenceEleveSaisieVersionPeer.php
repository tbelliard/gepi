...
abstract class BaseAbsenceEleveSaisieVersionPeer {
	...
	const MODIFIE_PAR_UTILISATEUR_ID = 'a_saisies_version.MODIFIE_PAR_UTILISATEUR_ID';
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(AbsenceEleveSaisieVersionPeer::MODIFIE_PAR_UTILISATEUR_ID);
	...
	/**
	 * Method perform an INSERT on the database, given a AbsenceEleveSaisieVersion or Criteria object.
	 *
	...
	/**
	 * Method perform an UPDATE on the database, given a AbsenceEleveSaisieVersion or Criteria object.
	 *
	...
	/**
	 * Method to DELETE all rows from the a_saisies_version table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a AbsenceEleveSaisieVersion or Criteria object OR a primary key value.
	 *
