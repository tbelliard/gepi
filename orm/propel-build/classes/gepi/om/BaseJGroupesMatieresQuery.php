...
abstract class BaseJGroupesMatieresQuery extends ModelCriteria
{
     ...
     * @param     JGroupesMatieresQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     * @param array $key Primary key to use for the query
                         A Primary key composition: [$id_groupe, $id_matiere]
     * @param     PropelPDO $con an optional connection object
     *
     * @return   JGroupesMatieres|JGroupesMatieres[]|mixed the result, formatted by the current formatter
     */
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|JGroupesMatieres[]|mixed the list of results, formatted by the current formatter
     */
     ...
     *
     * @param   Matiere|PropelObjectCollection $matiere The related object(s) to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   JGroupesMatieresQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByMatiere($matiere, $comparison = null)
    {
        ...
        } elseif ($matiere instanceof PropelObjectCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }
