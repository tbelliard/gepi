...
abstract class BaseJGroupesMatieresQuery extends ModelCriteria
{
	...
	public function filterByIdGroupe($idGroupe = null, $comparison = Criteria::EQUAL)
	{
		if (is_array($idGroupe)) {
			return $this->addUsingAlias(JGroupesMatieresPeer::ID_GROUPE, $idGroupe, Criteria::IN);
		} else {
	 ...
	 * @return    JGroupesMatieresQuery The current query, for fluid interface
	 */
	public function filterByIdMatiere($idMatiere = null, $comparison = Criteria::EQUAL)
	{
		if (is_array($idMatiere)) {
			return $this->addUsingAlias(JGroupesMatieresPeer::ID_MATIERE, $idMatiere, Criteria::IN);
		} elseif(preg_match('/[\%\*]/', $idMatiere)) {
			return $this->addUsingAlias(JGroupesMatieresPeer::ID_MATIERE, str_replace('*', '%', $idMatiere), Criteria::LIKE);
		} else {
