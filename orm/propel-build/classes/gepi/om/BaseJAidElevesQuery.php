...
abstract class BaseJAidElevesQuery extends ModelCriteria
{
     ...
     * @param     JAidElevesQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     * @param array $key Primary key to use for the query
                         A Primary key composition: [$id_aid, $login]
     * @param     PropelPDO $con an optional connection object
     *
     * @return   JAidEleves|JAidEleves[]|mixed the result, formatted by the current formatter
     */
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|JAidEleves[]|mixed the list of results, formatted by the current formatter
     */
