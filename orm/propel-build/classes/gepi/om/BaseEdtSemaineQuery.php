...
abstract class BaseEdtSemaineQuery extends ModelCriteria
{
     ...
     * @param     EdtSemaineQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     *
     * @return   EdtSemaine|EdtSemaine[]|mixed the result, formatted by the current formatter
     */
     ...
     */
     public function findOneByIdEdtSemaine($key, $con = null)
     {
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|EdtSemaine[]|mixed the list of results, formatted by the current formatter
     */
