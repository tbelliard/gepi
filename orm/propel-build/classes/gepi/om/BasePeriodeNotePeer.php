...
abstract class BasePeriodeNotePeer
{
     ...
     * e.g. PeriodeNotePeer::$fieldNames[PeriodeNotePeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (PeriodeNotePeer::NOM_PERIODE, PeriodeNotePeer::NUM_PERIODE, PeriodeNotePeer::VEROUILLER, PeriodeNotePeer::ID_CLASSE, PeriodeNotePeer::DATE_VERROUILLAGE, PeriodeNotePeer::DATE_FIN, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. PeriodeNotePeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (PeriodeNotePeer::NOM_PERIODE => 0, PeriodeNotePeer::NUM_PERIODE => 1, PeriodeNotePeer::VEROUILLER => 2, PeriodeNotePeer::ID_CLASSE => 3, PeriodeNotePeer::DATE_VERROUILLAGE => 4, PeriodeNotePeer::DATE_FIN => 5, ),
    ...
    {
        $toNames = PeriodeNotePeer::getFieldNames($toType);
        $key = isset(PeriodeNotePeer::$fieldKeys[$fromType][$name]) ? PeriodeNotePeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(PeriodeNotePeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, PeriodeNotePeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return PeriodeNotePeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(PeriodeNotePeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(PeriodeNotePeer::DATABASE_NAME);
     ...
     *
     * @param      PeriodeNote $obj A PeriodeNote object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            PeriodeNotePeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(PeriodeNotePeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(PeriodeNotePeer::$instances[$key])) {
                return PeriodeNotePeer::$instances[$key];
            }
        }
    ...
    {
        PeriodeNotePeer::$instances = array();
    }
    ...
    public static function populateObjects(PDOStatement $stmt)
    {
        ...
        $cls = PeriodeNotePeer::getOMClass();
    ...
    {
        return Propel::getDatabaseMap(PeriodeNotePeer::DATABASE_NAME)->getTable(PeriodeNotePeer::TABLE_NAME);
    }
    ...
    {
        return PeriodeNotePeer::OM_CLASS;
    }

    /**
     * Performs an INSERT on the database, given a PeriodeNote or Criteria object.
     *
    ...
    /**
     * Performs an UPDATE on the database, given a PeriodeNote or Criteria object.
     *
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(PeriodeNotePeer::DATABASE_NAME);
    ...
    /**
     * Deletes all rows from the periodes table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
    ...
    /**
     * Performs a DELETE on the database, given a PeriodeNote or Criteria object OR a primary key value.
     *
