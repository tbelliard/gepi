...
abstract class BaseAbsenceEleveSaisieQuery extends ModelCriteria
{
     ...
     * @param     AbsenceEleveSaisieQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     *
     * @return   AbsenceEleveSaisie|AbsenceEleveSaisie[]|mixed the result, formatted by the current formatter
     */
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|AbsenceEleveSaisie[]|mixed the list of results, formatted by the current formatter
     */
     ...
     *
     * @param   UtilisateurProfessionnel|PropelObjectCollection $utilisateurProfessionnel The related object(s) to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   AbsenceEleveSaisieQuery The current query, for fluid interface
    ...
    public function filterByUtilisateurProfessionnel($utilisateurProfessionnel, $comparison = null)
    {
        ...
        } elseif ($utilisateurProfessionnel instanceof PropelObjectCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }
     ...
     *
     * @param   Eleve|PropelObjectCollection $eleve The related object(s) to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   AbsenceEleveSaisieQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByEleve($eleve, $comparison = null)
    {
        ...
        } elseif ($eleve instanceof PropelObjectCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }
     ...
     *
     * @param   EdtCreneau|PropelObjectCollection $edtCreneau The related object(s) to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   AbsenceEleveSaisieQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByEdtCreneau($edtCreneau, $comparison = null)
    {
        ...
        } elseif ($edtCreneau instanceof PropelObjectCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }
     ...
     *
     * @param   EdtEmplacementCours|PropelObjectCollection $edtEmplacementCours The related object(s) to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   AbsenceEleveSaisieQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
     ...
     *
     * @param   Groupe|PropelObjectCollection $groupe The related object(s) to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   AbsenceEleveSaisieQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByGroupe($groupe, $comparison = null)
    {
        ...
        } elseif ($groupe instanceof PropelObjectCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }
     ...
     *
     * @param   Classe|PropelObjectCollection $classe The related object(s) to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   AbsenceEleveSaisieQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByClasse($classe, $comparison = null)
    {
        ...
        } elseif ($classe instanceof PropelObjectCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }
     ...
     *
     * @param   AidDetails|PropelObjectCollection $aidDetails The related object(s) to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   AbsenceEleveSaisieQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByAidDetails($aidDetails, $comparison = null)
    {
        ...
        } elseif ($aidDetails instanceof PropelObjectCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }
     ...
     *
     * @param   AbsenceEleveLieu|PropelObjectCollection $absenceEleveLieu The related object(s) to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   AbsenceEleveSaisieQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByAbsenceEleveLieu($absenceEleveLieu, $comparison = null)
    {
        ...
        } elseif ($absenceEleveLieu instanceof PropelObjectCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }
     ...
     *
     * @param   JTraitementSaisieEleve|PropelObjectCollection $jTraitementSaisieEleve  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   AbsenceEleveSaisieQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByJTraitementSaisieEleve($jTraitementSaisieEleve, $comparison = null)
    {
        ...
        } elseif ($jTraitementSaisieEleve instanceof PropelObjectCollection) {
            return $this
     ...
     *
     * @param   AbsenceEleveSaisieVersion|PropelObjectCollection $absenceEleveSaisieVersion  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   AbsenceEleveSaisieQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByAbsenceEleveSaisieVersion($absenceEleveSaisieVersion, $comparison = null)
    {
        ...
        } elseif ($absenceEleveSaisieVersion instanceof PropelObjectCollection) {
            return $this
