...
abstract class BaseJGroupesProfesseursQuery extends ModelCriteria
{
     ...
     * @param     JGroupesProfesseursQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     * @param array $key Primary key to use for the query
                         A Primary key composition: [$id_groupe, $login]
     * @param     PropelPDO $con an optional connection object
     *
     * @return   JGroupesProfesseurs|JGroupesProfesseurs[]|mixed the result, formatted by the current formatter
     */
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|JGroupesProfesseurs[]|mixed the list of results, formatted by the current formatter
     */
