...
abstract class BaseMatiereQuery extends ModelCriteria
{
     ...
     * @param     MatiereQuery|Criteria $criteria Optional Criteria to build the query from
     *
     * @return MatiereQuery
     */
     ...
     *
     * @return   Matiere|Matiere[]|mixed the result, formatted by the current formatter
     */
     ...
     */
     public function findOneByMatiere($key, $con = null)
     {
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|Matiere[]|mixed the list of results, formatted by the current formatter
     */
