...
/**
 * Base class that represents a row from the 'ects_global_credits' table.
 *
 * Objet qui précise la mention globale obtenue pour un eleve
 *
 * @package    propel.generator.gepi.om
 */
abstract class BaseCreditEctsGlobal extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'CreditEctsGlobalPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        CreditEctsGlobalPeer
	 */
	 ...
	 * @return     CreditEctsGlobal The current object (for fluent API support)
	 */
	...
	public function setMention($v)
	{
		...
		if ($this->mention !== $v) {
			$this->mention = $v;
			$this->modifiedColumns[] = CreditEctsGlobalPeer::MENTION;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->mention = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->resetModified();
			...
			return $startcol + 3; // 3 = CreditEctsGlobalPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating CreditEctsGlobal object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = CreditEctsGlobalPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				CreditEctsGlobalPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = CreditEctsGlobalPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = CreditEctsGlobalPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['CreditEctsGlobal'][serialize($this->getPrimaryKey())])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['CreditEctsGlobal'][serialize($this->getPrimaryKey())] = true;
		$keys = CreditEctsGlobalPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getIdEleve(),
			$keys[2] => $this->getMention(),
		);
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setMention($arr[$keys[2]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CreditEctsGlobalPeer::ID)) $criteria->add(CreditEctsGlobalPeer::ID, $this->id);
		if ($this->isColumnModified(CreditEctsGlobalPeer::ID_ELEVE)) $criteria->add(CreditEctsGlobalPeer::ID_ELEVE, $this->id_eleve);
		if ($this->isColumnModified(CreditEctsGlobalPeer::MENTION)) $criteria->add(CreditEctsGlobalPeer::MENTION, $this->mention);
	...
	{
		$criteria = new Criteria(CreditEctsGlobalPeer::DATABASE_NAME);
		$criteria->add(CreditEctsGlobalPeer::ID, $this->id);
	...
	{
		return (null === $this->getId()) && (null === $this->getIdEleve());
	}
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of CreditEctsGlobal (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     CreditEctsGlobal Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     CreditEctsGlobalPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new CreditEctsGlobalPeer();
		}
		return self::$peer;
	}
	...
	public function getEleve(PropelPDO $con = null)
	{
		if ($this->aEleve === null && ($this->id_eleve !== null)) {
			...
			/* The following can be used additionally to
				...
				$this->aEleve->addCreditEctsGlobals($this);
			 */
		}
		return $this->aEleve;
	}
