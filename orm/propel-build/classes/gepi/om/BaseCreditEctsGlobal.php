...
abstract class BaseCreditEctsGlobal extends BaseObject  implements Persistent {
	...
	/**
	 * Initializes internal state of BaseCreditEctsGlobal object.
	 * @see        applyDefaults()
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = CreditEctsGlobalPeer::NUM_COLUMNS - CreditEctsGlobalPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = CreditEctsGlobalPeer::doInsert($this, $con);
