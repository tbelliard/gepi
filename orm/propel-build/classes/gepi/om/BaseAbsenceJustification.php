 ...
 * @package    gepi.om
 */
abstract class BaseAbsenceJustification extends BaseObject  implements Persistent {
	...
	/**
	 * Initializes internal state of BaseAbsenceJustification object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     AbsenceJustification The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = AbsenceJustificationPeer::ID;
		}
	...
	public function setNom($v)
	{
		...
		if ($this->nom !== $v) {
			$this->nom = $v;
			$this->modifiedColumns[] = AbsenceJustificationPeer::NOM;
		}
	...
	public function setOrdre($v)
	{
		...
		if ($this->ordre !== $v) {
			$this->ordre = $v;
			$this->modifiedColumns[] = AbsenceJustificationPeer::ORDRE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = AbsenceJustificationPeer::NUM_COLUMNS - AbsenceJustificationPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating AbsenceJustification object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = AbsenceJustificationPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			AbsenceJustificationPeer::doDelete($this, $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			$con->commit();
			AbsenceJustificationPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = AbsenceJustificationPeer::doInsert($this, $con);
					...
					$affectedRows += AbsenceJustificationPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = AbsenceJustificationPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = AbsenceJustificationPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = AbsenceJustificationPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getNom(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AbsenceJustificationPeer::ID)) $criteria->add(AbsenceJustificationPeer::ID, $this->id);
		if ($this->isColumnModified(AbsenceJustificationPeer::NOM)) $criteria->add(AbsenceJustificationPeer::NOM, $this->nom);
		if ($this->isColumnModified(AbsenceJustificationPeer::ORDRE)) $criteria->add(AbsenceJustificationPeer::ORDRE, $this->ordre);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(AbsenceJustificationPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of AbsenceJustification (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     AbsenceJustification Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     AbsenceJustificationPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new AbsenceJustificationPeer();
		}
		return self::$peer;
	}
	 ...
	 * Otherwise if this AbsenceJustification has previously been saved, it will retrieve
	 * related AbsenceTraitements from storage. If this AbsenceJustification is new, it will return
		...
		if ($this->collAbsenceTraitements === null) {
			if ($this->isNew()) {
			   $this->collAbsenceTraitements = array();
				...
				$criteria->add(AbsenceTraitementPeer::A_JUSTIFICATION_ID, $this->id);
	...
	public function addAbsenceTraitement(AbsenceTraitement $l)
	{
		...
		if (!in_array($l, $this->collAbsenceTraitements, true)) { // only add it if the **same** object is not already associated
			...
			$l->setAbsenceJustification($this);
		}
	}
	 ...
	 * Otherwise if this AbsenceJustification is new, it will return
	 * an empty collection; or if this AbsenceJustification has previously
	 * been saved, it will retrieve related AbsenceTraitements from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in AbsenceJustification.
	 */
