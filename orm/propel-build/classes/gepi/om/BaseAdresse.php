...
abstract class BaseAdresse extends BaseObject implements Persistent
{
    ...
    /**
     * @var        PropelObjectCollection|ResponsableEleve[] Collection to store aggregation of ResponsableEleve objects.
     */
    protected $collResponsableEleves;
    protected $collResponsableElevesPartial;
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->responsableElevesScheduledForDeletion !== null) {
                if (!$this->responsableElevesScheduledForDeletion->isEmpty()) {
                    foreach ($this->responsableElevesScheduledForDeletion as $responsableEleve) {
            ...
            if ($this->absenceEleveNotificationsScheduledForDeletion !== null) {
                if (!$this->absenceEleveNotificationsScheduledForDeletion->isEmpty()) {
                    foreach ($this->absenceEleveNotificationsScheduledForDeletion as $absenceEleveNotification) {
                        // need to save related object because we set the relation to null
    ...
    public function clearResponsableEleves()
    {
        ...
        $this->collResponsableElevesPartial = null;
    }

    /**
     * reset is the collResponsableEleves collection loaded partially
     *
     * @return void
     */
    public function resetPartialResponsableEleves($v = true)
    {
        $this->collResponsableElevesPartial = $v;
    }
     ...
     * @return PropelObjectCollection|ResponsableEleve[] List of ResponsableEleve objects
     * @throws PropelException
     */
    public function getResponsableEleves($criteria = null, PropelPDO $con = null)
    {
        $partial = $this->collResponsableElevesPartial && !$this->isNew();
        if (null === $this->collResponsableEleves || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collResponsableEleves) {
                ...
                $collResponsableEleves = ResponsableEleveQuery::create(null, $criteria)
                    ...
                    ->find($con);
                if (null !== $criteria) {
                    if (false !== $this->collResponsableElevesPartial && count($collResponsableEleves)) {
                      $this->initResponsableEleves(false);

                      foreach($collResponsableEleves as $obj) {
                        if (false == $this->collResponsableEleves->contains($obj)) {
                          $this->collResponsableEleves->append($obj);
                        }
                      }

                      $this->collResponsableElevesPartial = true;
                    }

                    return $collResponsableEleves;
                }

                if($partial && $this->collResponsableEleves) {
                    foreach($this->collResponsableEleves as $obj) {
                        if($obj->isNew()) {
                            $collResponsableEleves[] = $obj;
                        }
                    }
                }

                $this->collResponsableEleves = $collResponsableEleves;
                $this->collResponsableElevesPartial = false;
            }
        }
    ...
    public function setResponsableEleves(PropelCollection $responsableEleves, PropelPDO $con = null)
    {
        ...
        foreach ($this->responsableElevesScheduledForDeletion as $responsableEleveRemoved) {
            $responsableEleveRemoved->setAdresse(null);
        }
    ...
    public function countResponsableEleves(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        ...
        if (null === $this->collResponsableEleves || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collResponsableEleves) {
                ...
                if($partial && !$criteria) {
                    return count($this->getResponsableEleves());
                }
    ...
    public function addResponsableEleve(ResponsableEleve $l)
    {
        ...
        if (!in_array($l, $this->collResponsableEleves->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
    ...
    /**
     * @param	ResponsableEleve $responsableEleve The responsableEleve object to remove.
     */
    public function removeResponsableEleve($responsableEleve)
    {
        if ($this->getResponsableEleves()->contains($responsableEleve)) {
            $this->collResponsableEleves->remove($this->collResponsableEleves->search($responsableEleve));
            if (null === $this->responsableElevesScheduledForDeletion) {
                $this->responsableElevesScheduledForDeletion = clone $this->collResponsableEleves;
                $this->responsableElevesScheduledForDeletion->clear();
            }
            $this->responsableElevesScheduledForDeletion[]= $responsableEleve;
            $responsableEleve->setAdresse(null);
        }
    }
    ...
    public function setAbsenceEleveNotifications(PropelCollection $absenceEleveNotifications, PropelPDO $con = null)
    {
        ...
        foreach ($this->absenceEleveNotificationsScheduledForDeletion as $absenceEleveNotificationRemoved) {
            $absenceEleveNotificationRemoved->setAdresse(null);
        }
    ...
    public function removeAbsenceEleveNotification($absenceEleveNotification)
    {
        if ($this->getAbsenceEleveNotifications()->contains($absenceEleveNotification)) {
            ...
            $absenceEleveNotification->setAdresse(null);
        }
    }
