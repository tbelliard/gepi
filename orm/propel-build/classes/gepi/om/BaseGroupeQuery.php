...
abstract class BaseGroupeQuery extends ModelCriteria
{
     ...
     * @param     GroupeQuery|Criteria $criteria Optional Criteria to build the query from
     *
     * @return GroupeQuery
     */
     ...
     *
     * @return   Groupe|Groupe[]|mixed the result, formatted by the current formatter
     */
    public function findPk($key, $con = null)
    {
        ...
        if ((null !== ($obj = GroupePeer::getInstanceFromPool((string) $key))) && !$this->formatter) {
     ...
     *
     * @return   Groupe A model object, or null if the key is not found
    ...
    {
        $sql = 'SELECT ID, NAME, DESCRIPTION, RECALCUL_RANG FROM groupes WHERE ID = :p0';
        try {
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|Groupe[]|mixed the list of results, formatted by the current formatter
     */
     ...
     *
     * @param   JGroupesMatieres|PropelObjectCollection $jGroupesMatieres  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   GroupeQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByJGroupesMatieres($jGroupesMatieres, $comparison = null)
    {
        ...
        } elseif ($jGroupesMatieres instanceof PropelObjectCollection) {
            return $this
