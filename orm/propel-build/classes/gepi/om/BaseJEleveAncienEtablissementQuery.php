...
abstract class BaseJEleveAncienEtablissementQuery extends ModelCriteria
{
     ...
     * @param     JEleveAncienEtablissementQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     * @param array $key Primary key to use for the query
                         A Primary key composition: [$id_eleve, $id_etablissement]
     * @param     PropelPDO $con an optional connection object
     *
     * @return   JEleveAncienEtablissement|JEleveAncienEtablissement[]|mixed the result, formatted by the current formatter
     */
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|JEleveAncienEtablissement[]|mixed the list of results, formatted by the current formatter
     */
     ...
     *
     * @param   AncienEtablissement|PropelObjectCollection $ancienEtablissement The related object(s) to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   JEleveAncienEtablissementQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByAncienEtablissement($ancienEtablissement, $comparison = null)
    {
        ...
        } elseif ($ancienEtablissement instanceof PropelObjectCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }
