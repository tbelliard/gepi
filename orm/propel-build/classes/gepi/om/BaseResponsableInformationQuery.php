...
abstract class BaseResponsableInformationQuery extends ModelCriteria
{
     ...
     * @param     ResponsableInformationQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|ResponsableInformation[]|mixed the list of results, formatted by the current formatter
     */
     ...
     *
     * @param   ResponsableEleve|PropelObjectCollection $responsableEleve The related object(s) to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   ResponsableInformationQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByResponsableEleve($responsableEleve, $comparison = null)
    {
        ...
        } elseif ($responsableEleve instanceof PropelObjectCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }
