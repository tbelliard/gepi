...
abstract class BaseCategorieMatiereQuery extends ModelCriteria
{
     ...
     * @param     CategorieMatiereQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     *
     * @return   CategorieMatiere|CategorieMatiere[]|mixed the result, formatted by the current formatter
     */
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|CategorieMatiere[]|mixed the list of results, formatted by the current formatter
     */
     ...
     *
     * @param   Matiere|PropelObjectCollection $matiere  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   CategorieMatiereQuery The current query, for fluid interface
