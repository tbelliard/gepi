...
abstract class BaseJGroupesProfesseursPeer
{
     ...
     * e.g. JGroupesProfesseursPeer::$fieldNames[JGroupesProfesseursPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('IdGroupe', 'Login', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idGroupe', 'login', ),
        BasePeer::TYPE_COLNAME => array (JGroupesProfesseursPeer::ID_GROUPE, JGroupesProfesseursPeer::LOGIN, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. JGroupesProfesseursPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('IdGroupe' => 0, 'Login' => 1, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idGroupe' => 0, 'login' => 1, ),
        BasePeer::TYPE_COLNAME => array (JGroupesProfesseursPeer::ID_GROUPE => 0, JGroupesProfesseursPeer::LOGIN => 1, ),
    ...
    {
        $toNames = JGroupesProfesseursPeer::getFieldNames($toType);
        $key = isset(JGroupesProfesseursPeer::$fieldKeys[$fromType][$name]) ? JGroupesProfesseursPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(JGroupesProfesseursPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, JGroupesProfesseursPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return JGroupesProfesseursPeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(JGroupesProfesseursPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(JGroupesProfesseursPeer::DATABASE_NAME);
     ...
     *
     * @param      JGroupesProfesseurs $obj A JGroupesProfesseurs object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            JGroupesProfesseursPeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(JGroupesProfesseursPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(JGroupesProfesseursPeer::$instances[$key])) {
                return JGroupesProfesseursPeer::$instances[$key];
            }
        }
    ...
    {
        JGroupesProfesseursPeer::$instances = array();
    }
    ...
    {
        return Propel::getDatabaseMap(JGroupesProfesseursPeer::DATABASE_NAME)->getTable(JGroupesProfesseursPeer::TABLE_NAME);
    }
    ...
    {
        return JGroupesProfesseursPeer::OM_CLASS;
    }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(JGroupesProfesseursPeer::DATABASE_NAME);
