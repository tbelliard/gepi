 ...
 * @package    gepi.om
 */
abstract class BaseAbsenceMotif extends BaseObject  implements Persistent {
	...
	/**
	 * Initializes internal state of BaseAbsenceMotif object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     AbsenceMotif The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = AbsenceMotifPeer::ID;
		}
	...
	public function setNom($v)
	{
		...
		if ($this->nom !== $v) {
			$this->nom = $v;
			$this->modifiedColumns[] = AbsenceMotifPeer::NOM;
		}
	...
	public function setOrdre($v)
	{
		...
		if ($this->ordre !== $v) {
			$this->ordre = $v;
			$this->modifiedColumns[] = AbsenceMotifPeer::ORDRE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = AbsenceMotifPeer::NUM_COLUMNS - AbsenceMotifPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating AbsenceMotif object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = AbsenceMotifPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			AbsenceMotifPeer::doDelete($this, $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			$con->commit();
			AbsenceMotifPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = AbsenceMotifPeer::doInsert($this, $con);
					...
					$affectedRows += AbsenceMotifPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = AbsenceMotifPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = AbsenceMotifPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = AbsenceMotifPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getNom(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AbsenceMotifPeer::ID)) $criteria->add(AbsenceMotifPeer::ID, $this->id);
		if ($this->isColumnModified(AbsenceMotifPeer::NOM)) $criteria->add(AbsenceMotifPeer::NOM, $this->nom);
		if ($this->isColumnModified(AbsenceMotifPeer::ORDRE)) $criteria->add(AbsenceMotifPeer::ORDRE, $this->ordre);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(AbsenceMotifPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of AbsenceMotif (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     AbsenceMotif Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     AbsenceMotifPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new AbsenceMotifPeer();
		}
		return self::$peer;
	}
	 ...
	 * Otherwise if this AbsenceMotif has previously been saved, it will retrieve
	 * related AbsenceTraitements from storage. If this AbsenceMotif is new, it will return
		...
		if ($this->collAbsenceTraitements === null) {
			if ($this->isNew()) {
			   $this->collAbsenceTraitements = array();
				...
				$criteria->add(AbsenceTraitementPeer::A_MOTIF_ID, $this->id);
	 ...
	 * Otherwise if this AbsenceMotif is new, it will return
	 * an empty collection; or if this AbsenceMotif has previously
	 * been saved, it will retrieve related AbsenceTraitements from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in AbsenceMotif.
	 */
	public function getAbsenceTraitementsJoinUtilisateurProfessionnel($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(AbsenceMotifPeer::DATABASE_NAME);
		}
		...
		if ($this->collAbsenceTraitements === null) {
			if ($this->isNew()) {
				...
				$this->collAbsenceTraitements = AbsenceTraitementPeer::doSelectJoinUtilisateurProfessionnel($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
