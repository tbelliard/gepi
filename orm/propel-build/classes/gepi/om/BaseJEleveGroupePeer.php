...
abstract class BaseJEleveGroupePeer
{
     ...
     * e.g. JEleveGroupePeer::$fieldNames[JEleveGroupePeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Login', 'IdGroupe', 'Periode', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('login', 'idGroupe', 'periode', ),
        BasePeer::TYPE_COLNAME => array (JEleveGroupePeer::LOGIN, JEleveGroupePeer::ID_GROUPE, JEleveGroupePeer::PERIODE, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. JEleveGroupePeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (JEleveGroupePeer::LOGIN => 0, JEleveGroupePeer::ID_GROUPE => 1, JEleveGroupePeer::PERIODE => 2, ),
    ...
    {
        $toNames = JEleveGroupePeer::getFieldNames($toType);
        $key = isset(JEleveGroupePeer::$fieldKeys[$fromType][$name]) ? JEleveGroupePeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(JEleveGroupePeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, JEleveGroupePeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return JEleveGroupePeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(JEleveGroupePeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(JEleveGroupePeer::DATABASE_NAME);
     ...
     *
     * @param      JEleveGroupe $obj A JEleveGroupe object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            JEleveGroupePeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(JEleveGroupePeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(JEleveGroupePeer::$instances[$key])) {
                return JEleveGroupePeer::$instances[$key];
            }
        }
    ...
    {
        JEleveGroupePeer::$instances = array();
    }
    ...
    {
        return Propel::getDatabaseMap(JEleveGroupePeer::DATABASE_NAME)->getTable(JEleveGroupePeer::TABLE_NAME);
    }
    ...
    {
        return JEleveGroupePeer::OM_CLASS;
    }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(JEleveGroupePeer::DATABASE_NAME);
