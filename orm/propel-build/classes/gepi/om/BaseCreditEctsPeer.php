...
abstract class BaseCreditEctsPeer
{
     ...
     * e.g. CreditEctsPeer::$fieldNames[CreditEctsPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (CreditEctsPeer::ID, CreditEctsPeer::ID_ELEVE, CreditEctsPeer::NUM_PERIODE, CreditEctsPeer::ID_GROUPE, CreditEctsPeer::VALEUR, CreditEctsPeer::MENTION, CreditEctsPeer::MENTION_PROF, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. CreditEctsPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (CreditEctsPeer::ID => 0, CreditEctsPeer::ID_ELEVE => 1, CreditEctsPeer::NUM_PERIODE => 2, CreditEctsPeer::ID_GROUPE => 3, CreditEctsPeer::VALEUR => 4, CreditEctsPeer::MENTION => 5, CreditEctsPeer::MENTION_PROF => 6, ),
    ...
    {
        $toNames = CreditEctsPeer::getFieldNames($toType);
        $key = isset(CreditEctsPeer::$fieldKeys[$fromType][$name]) ? CreditEctsPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(CreditEctsPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, CreditEctsPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return CreditEctsPeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(CreditEctsPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(CreditEctsPeer::DATABASE_NAME);
     ...
     *
     * @param      CreditEcts $obj A CreditEcts object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            CreditEctsPeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(CreditEctsPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(CreditEctsPeer::$instances[$key])) {
                return CreditEctsPeer::$instances[$key];
            }
        }
    ...
    {
        CreditEctsPeer::$instances = array();
    }
    ...
    {
        return Propel::getDatabaseMap(CreditEctsPeer::DATABASE_NAME)->getTable(CreditEctsPeer::TABLE_NAME);
    }
    ...
    {
        return CreditEctsPeer::OM_CLASS;
    }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(CreditEctsPeer::DATABASE_NAME);
