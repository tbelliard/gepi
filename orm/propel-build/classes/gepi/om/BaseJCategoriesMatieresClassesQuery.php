...
abstract class BaseJCategoriesMatieresClassesQuery extends ModelCriteria
{
     ...
     * @param     JCategoriesMatieresClassesQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     * @param array $key Primary key to use for the query
                         A Primary key composition: [$categorie_id, $classe_id]
     * @param     PropelPDO $con an optional connection object
     *
     * @return   JCategoriesMatieresClasses|JCategoriesMatieresClasses[]|mixed the result, formatted by the current formatter
     */
    public function findPk($key, $con = null)
    {
        ...
        if ((null !== ($obj = JCategoriesMatieresClassesPeer::getInstanceFromPool(serialize(array((string) $key[0], (string) $key[1]))))) && !$this->formatter) {
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|JCategoriesMatieresClasses[]|mixed the list of results, formatted by the current formatter
     */
     ...
     *
     * @param   CategorieMatiere|PropelObjectCollection $categorieMatiere The related object(s) to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   JCategoriesMatieresClassesQuery The current query, for fluid interface
    ...
    public function filterByCategorieMatiere($categorieMatiere, $comparison = null)
    {
        ...
        } elseif ($categorieMatiere instanceof PropelObjectCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }
