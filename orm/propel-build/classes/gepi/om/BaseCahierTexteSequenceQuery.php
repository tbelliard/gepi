...
abstract class BaseCahierTexteSequenceQuery extends ModelCriteria
{
     ...
     * @param     CahierTexteSequenceQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     *
     * @return   CahierTexteSequence|CahierTexteSequence[]|mixed the result, formatted by the current formatter
     */
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|CahierTexteSequence[]|mixed the list of results, formatted by the current formatter
     */
