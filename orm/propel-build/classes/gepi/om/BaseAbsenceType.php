...
abstract class BaseAbsenceType extends BaseObject  implements Persistent {
	...
	public function setNom($v)
	{
		...
		if ($this->nom !== $v) {
			$this->nom = $v;
			$this->modifiedColumns[] = AbsenceTypePeer::NOM;
		}
	...
	public function setOrdre($v)
	{
		...
		if ($this->ordre !== $v) {
			$this->ordre = $v;
			$this->modifiedColumns[] = AbsenceTypePeer::ORDRE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = AbsenceTypePeer::NUM_COLUMNS - AbsenceTypePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AbsenceTypePeer::NOM)) $criteria->add(AbsenceTypePeer::NOM, $this->nom);
		if ($this->isColumnModified(AbsenceTypePeer::ORDRE)) $criteria->add(AbsenceTypePeer::ORDRE, $this->ordre);
	 ...
	 * related AbsenceTraitements from storage. If this AbsenceType is new, it will return
		...
		if ($this->collAbsenceTraitements === null) {
			if ($this->isNew()) {
			   $this->collAbsenceTraitements = array();
				...
				$criteria->add(AbsenceTraitementPeer::A_TYPE_ID, $this->id);
