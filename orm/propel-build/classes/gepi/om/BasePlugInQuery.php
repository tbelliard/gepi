...
abstract class BasePlugInQuery extends ModelCriteria
{
     ...
     *
     * @param   PlugInAutorisation|PropelObjectCollection $plugInAutorisation  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   PlugInQuery The current query, for fluid interface
    ...
    public function filterByPlugInAutorisation($plugInAutorisation, $comparison = null)
    {
        ...
        } elseif ($plugInAutorisation instanceof PropelObjectCollection) {
            return $this
     ...
     *
     * @param   PlugInMiseEnOeuvreMenu|PropelObjectCollection $plugInMiseEnOeuvreMenu  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   PlugInQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByPlugInMiseEnOeuvreMenu($plugInMiseEnOeuvreMenu, $comparison = null)
    {
        ...
        } elseif ($plugInMiseEnOeuvreMenu instanceof PropelObjectCollection) {
            return $this
