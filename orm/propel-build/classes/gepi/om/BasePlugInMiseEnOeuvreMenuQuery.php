...
abstract class BasePlugInMiseEnOeuvreMenuQuery extends ModelCriteria
{
     ...
     * @param     PlugInMiseEnOeuvreMenuQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     *
     * @return   PlugInMiseEnOeuvreMenu|PlugInMiseEnOeuvreMenu[]|mixed the result, formatted by the current formatter
     */
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|PlugInMiseEnOeuvreMenu[]|mixed the list of results, formatted by the current formatter
     */
