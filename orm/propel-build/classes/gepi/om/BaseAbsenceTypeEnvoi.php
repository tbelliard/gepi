 ...
 * @package    gepi.om
 */
abstract class BaseAbsenceTypeEnvoi extends BaseObject  implements Persistent {
	...
	/**
	 * Initializes internal state of BaseAbsenceTypeEnvoi object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     AbsenceTypeEnvoi The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = AbsenceTypeEnvoiPeer::ID;
		}
	...
	public function setNom($v)
	{
		...
		if ($this->nom !== $v) {
			$this->nom = $v;
			$this->modifiedColumns[] = AbsenceTypeEnvoiPeer::NOM;
		}
	...
	public function setOrdreAffichage($v)
	{
		...
		if ($this->ordre_affichage !== $v) {
			...
			$this->modifiedColumns[] = AbsenceTypeEnvoiPeer::ORDRE_AFFICHAGE;
		}
	...
	public function setContenu($v)
	{
		...
		if ($this->contenu !== $v) {
			$this->contenu = $v;
			$this->modifiedColumns[] = AbsenceTypeEnvoiPeer::CONTENU;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = AbsenceTypeEnvoiPeer::NUM_COLUMNS - AbsenceTypeEnvoiPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating AbsenceTypeEnvoi object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = AbsenceTypeEnvoiPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			AbsenceTypeEnvoiPeer::doDelete($this, $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			$con->commit();
			AbsenceTypeEnvoiPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = AbsenceTypeEnvoiPeer::doInsert($this, $con);
					...
					$affectedRows += AbsenceTypeEnvoiPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = AbsenceTypeEnvoiPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = AbsenceTypeEnvoiPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = AbsenceTypeEnvoiPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getNom(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AbsenceTypeEnvoiPeer::ID)) $criteria->add(AbsenceTypeEnvoiPeer::ID, $this->id);
		if ($this->isColumnModified(AbsenceTypeEnvoiPeer::NOM)) $criteria->add(AbsenceTypeEnvoiPeer::NOM, $this->nom);
		if ($this->isColumnModified(AbsenceTypeEnvoiPeer::ORDRE_AFFICHAGE)) $criteria->add(AbsenceTypeEnvoiPeer::ORDRE_AFFICHAGE, $this->ordre_affichage);
		if ($this->isColumnModified(AbsenceTypeEnvoiPeer::CONTENU)) $criteria->add(AbsenceTypeEnvoiPeer::CONTENU, $this->contenu);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(AbsenceTypeEnvoiPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of AbsenceTypeEnvoi (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     AbsenceTypeEnvoi Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     AbsenceTypeEnvoiPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new AbsenceTypeEnvoiPeer();
		}
		return self::$peer;
	}
	 ...
	 * Otherwise if this AbsenceTypeEnvoi has previously been saved, it will retrieve
	 * related AbsenceEnvois from storage. If this AbsenceTypeEnvoi is new, it will return
		...
		if ($this->collAbsenceEnvois === null) {
			if ($this->isNew()) {
			   $this->collAbsenceEnvois = array();
				...
				$criteria->add(AbsenceEnvoiPeer::ID_TYPE_ENVOI, $this->id);
	 ...
	 * Otherwise if this AbsenceTypeEnvoi is new, it will return
	 * an empty collection; or if this AbsenceTypeEnvoi has previously
	 * been saved, it will retrieve related AbsenceEnvois from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in AbsenceTypeEnvoi.
	 */
	public function getAbsenceEnvoisJoinUtilisateurProfessionnel($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(AbsenceTypeEnvoiPeer::DATABASE_NAME);
		}
		...
		if ($this->collAbsenceEnvois === null) {
			if ($this->isNew()) {
				...
				$this->collAbsenceEnvois = AbsenceEnvoiPeer::doSelectJoinUtilisateurProfessionnel($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
