 ...
 * @package    gepi.om
 */
abstract class BaseAbsenceEleveTypeEnvoi extends BaseObject  implements Persistent {
	...
	/**
	 * Initializes internal state of BaseAbsenceEleveTypeEnvoi object.
	 * @see        applyDefaults()
	 */
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = AbsenceEleveTypeEnvoiPeer::ID;
		}
	...
	public function setNom($v)
	{
		...
		if ($this->nom !== $v) {
			$this->nom = $v;
			$this->modifiedColumns[] = AbsenceEleveTypeEnvoiPeer::NOM;
		}
	...
	public function setContenu($v)
	{
		...
		if ($this->contenu !== $v) {
			$this->contenu = $v;
			$this->modifiedColumns[] = AbsenceEleveTypeEnvoiPeer::CONTENU;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = AbsenceEleveTypeEnvoiPeer::NUM_COLUMNS - AbsenceEleveTypeEnvoiPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating AbsenceEleveTypeEnvoi object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = AbsenceEleveTypeEnvoiPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			$con->commit();
			AbsenceEleveTypeEnvoiPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = AbsenceEleveTypeEnvoiPeer::doInsert($this, $con);
					...
					$affectedRows += AbsenceEleveTypeEnvoiPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = AbsenceEleveTypeEnvoiPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = AbsenceEleveTypeEnvoiPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = AbsenceEleveTypeEnvoiPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getNom(),
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(AbsenceEleveTypeEnvoiPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of AbsenceEleveTypeEnvoi (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     AbsenceEleveTypeEnvoi Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     AbsenceEleveTypeEnvoiPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new AbsenceEleveTypeEnvoiPeer();
		}
		return self::$peer;
	}
	 ...
	 * Otherwise if this AbsenceEleveTypeEnvoi has previously been saved, it will retrieve
	 * related AbsenceEleveEnvois from storage. If this AbsenceEleveTypeEnvoi is new, it will return
		...
		if ($this->collAbsenceEleveEnvois === null) {
			if ($this->isNew()) {
			   $this->collAbsenceEleveEnvois = array();
				...
				$criteria->add(AbsenceEleveEnvoiPeer::ID_TYPE_ENVOI, $this->id);
	...
	public function addAbsenceEleveEnvoi(AbsenceEleveEnvoi $l)
	{
		...
		if (!in_array($l, $this->collAbsenceEleveEnvois, true)) { // only add it if the **same** object is not already associated
			...
			$l->setAbsenceEleveTypeEnvoi($this);
		}
	}
	 ...
	 * Otherwise if this AbsenceEleveTypeEnvoi is new, it will return
	 * an empty collection; or if this AbsenceEleveTypeEnvoi has previously
	...
	public function getAbsenceEleveEnvoisJoinUtilisateurProfessionnel($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		if ($this->collAbsenceEleveEnvois === null) {
			if ($this->isNew()) {
				...
				$this->collAbsenceEleveEnvois = AbsenceEleveEnvoiPeer::doSelectJoinUtilisateurProfessionnel($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
