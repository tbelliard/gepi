...
/**
 * Base static class for performing query and update operations on the 'plugins_autorisations' table.
 *
...
abstract class BasePlugInAutorisationPeer
{
    ...
    const ID = 'plugins_autorisations.ID';

    /** the column name for the PLUGIN_ID field */
    const PLUGIN_ID = 'plugins_autorisations.PLUGIN_ID';

    /** the column name for the FICHIER field */
    const FICHIER = 'plugins_autorisations.FICHIER';

    /** the column name for the USER_STATUT field */
    const USER_STATUT = 'plugins_autorisations.USER_STATUT';

    /** the column name for the AUTH field */
    const AUTH = 'plugins_autorisations.AUTH';

    /** The default string format for model objects of the related table **/
    const DEFAULT_STRING_FORMAT = 'YAML';

    /**
     * An identiy map to hold any loaded instances of PlugInAutorisation objects.
     * This must be public so that other peer classes can access this when hydrating from JOIN
     * queries.
     * @var        array PlugInAutorisation[]
     */
     ...
     * e.g. PlugInAutorisationPeer::$fieldNames[PlugInAutorisationPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (PlugInAutorisationPeer::ID, PlugInAutorisationPeer::PLUGIN_ID, PlugInAutorisationPeer::FICHIER, PlugInAutorisationPeer::USER_STATUT, PlugInAutorisationPeer::AUTH, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. PlugInAutorisationPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (PlugInAutorisationPeer::ID => 0, PlugInAutorisationPeer::PLUGIN_ID => 1, PlugInAutorisationPeer::FICHIER => 2, PlugInAutorisationPeer::USER_STATUT => 3, PlugInAutorisationPeer::AUTH => 4, ),
    ...
    {
        $toNames = PlugInAutorisationPeer::getFieldNames($toType);
        $key = isset(PlugInAutorisationPeer::$fieldKeys[$fromType][$name]) ? PlugInAutorisationPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(PlugInAutorisationPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, PlugInAutorisationPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return PlugInAutorisationPeer::$fieldNames[$type];
    }
     ...
     * @param      string $column The column name for current table. (i.e. PlugInAutorisationPeer::COLUMN_NAME).
     * @return string
     */
    public static function alias($alias, $column)
    {
        return str_replace(PlugInAutorisationPeer::TABLE_NAME.'.', $alias.'.', $column);
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setPrimaryTableName(PlugInAutorisationPeer::TABLE_NAME);
        ...
        $criteria->setDbName(PlugInAutorisationPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectOne(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $critcopy->setLimit(1);
        $objects = PlugInAutorisationPeer::doSelect($critcopy, $con);
        if ($objects) {
            return $objects[0];
        }
    ...
    {
        return PlugInAutorisationPeer::populateObjects(PlugInAutorisationPeer::doSelectStmt($criteria, $con));
    }
    /**
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(PlugInAutorisationPeer::DATABASE_NAME);
     ...
     *
     * @param      PlugInAutorisation $obj A PlugInAutorisation object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            PlugInAutorisationPeer::$instances[$key] = $obj;
        }
    }
     ...
     *
     * @param      mixed $value A PlugInAutorisation object or a primary key value.
     *
     * @return void
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof PlugInAutorisation) {
                $key = (string) $value->getId();
            } elseif (is_scalar($value)) {
                // assume we've been passed a primary key
                $key = (string) $value;
            } else {
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or PlugInAutorisation object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
                throw $e;
            }

            unset(PlugInAutorisationPeer::$instances[$key]);
        }
     ...
     * @return   PlugInAutorisation Found object or null if 1) no instance exists for specified key or 2) instance pooling has been disabled.
     * @see        getPrimaryKeyHash()
     */
    public static function getInstanceFromPool($key)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(PlugInAutorisationPeer::$instances[$key])) {
                return PlugInAutorisationPeer::$instances[$key];
            }
        }
    ...
    {
        PlugInAutorisationPeer::$instances = array();
    }
    ...
    public static function populateObject($row, $startcol = 0)
    {
        ...
        if (null !== ($obj = PlugInAutorisationPeer::getInstanceFromPool($key))) {
            ...
            $col = $startcol + PlugInAutorisationPeer::NUM_HYDRATE_COLUMNS;
        } else {
    ...
    public static function doSelectJoinPlugIn(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        PlugInAutorisationPeer::addSelectColumns($criteria);
        $startcol = PlugInAutorisationPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (PlugInAutorisation) to $obj2 (PlugIn)
    ...
    {
        return Propel::getDatabaseMap(PlugInAutorisationPeer::DATABASE_NAME)->getTable(PlugInAutorisationPeer::TABLE_NAME);
    }
    ...
    {
        return PlugInAutorisationPeer::OM_CLASS;
    }
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria = $values->buildCriteria(); // build Criteria from PlugInAutorisation object
        }

        if ($criteria->containsKey(PlugInAutorisationPeer::ID) && $criteria->keyContainsValue(PlugInAutorisationPeer::ID) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(PlugInAutorisationPeer::DATABASE_NAME);
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += BasePeer::doDeleteAll(PlugInAutorisationPeer::TABLE_NAME, $con, PlugInAutorisationPeer::DATABASE_NAME);
    ...
    /**
     * Validates all modified columns of given PlugInAutorisation object.
     * If parameter $columns is either a single column name or an array of column names
     * than only those columns are validated.
     *
     * NOTICE: This does not apply to primary or foreign keys for now.
     *
     * @param      PlugInAutorisation $obj The object to validate.
    ...
    public static function doValidate($obj, $cols = null)
    {
        ...
        if ($cols) {
            $dbMap = Propel::getDatabaseMap(PlugInAutorisationPeer::DATABASE_NAME);
            $tableMap = $dbMap->getTable(PlugInAutorisationPeer::TABLE_NAME);
        ...
        return BasePeer::doValidate(PlugInAutorisationPeer::DATABASE_NAME, PlugInAutorisationPeer::TABLE_NAME, $columns);
    }
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        if (null !== ($obj = PlugInAutorisationPeer::getInstanceFromPool((string) $pk))) {
            return $obj;
        }
        ...
        $criteria = new Criteria(PlugInAutorisationPeer::DATABASE_NAME);
        $criteria->add(PlugInAutorisationPeer::ID, $pk);

        $v = PlugInAutorisationPeer::doSelect($criteria, $con);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(PlugInAutorisationPeer::DATABASE_NAME);
            $criteria->add(PlugInAutorisationPeer::ID, $pks, Criteria::IN);
            $objs = PlugInAutorisationPeer::doSelect($criteria, $con);
        }
