...
abstract class BaseMefQuery extends ModelCriteria
{
     ...
     * @param     MefQuery|Criteria $criteria Optional Criteria to build the query from
     *
     * @return MefQuery
     */
     ...
     *
     * @return   Mef|Mef[]|mixed the result, formatted by the current formatter
     */
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|Mef[]|mixed the list of results, formatted by the current formatter
     */
     ...
     *
     * @param   Eleve|PropelObjectCollection $eleve  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   MefQuery The current query, for fluid interface
