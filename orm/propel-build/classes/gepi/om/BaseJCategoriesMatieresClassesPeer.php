...
abstract class BaseJCategoriesMatieresClassesPeer
{
     ...
     * e.g. JCategoriesMatieresClassesPeer::$fieldNames[JCategoriesMatieresClassesPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (JCategoriesMatieresClassesPeer::CATEGORIE_ID, JCategoriesMatieresClassesPeer::CLASSE_ID, JCategoriesMatieresClassesPeer::AFFICHE_MOYENNE, JCategoriesMatieresClassesPeer::PRIORITY, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. JCategoriesMatieresClassesPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (JCategoriesMatieresClassesPeer::CATEGORIE_ID => 0, JCategoriesMatieresClassesPeer::CLASSE_ID => 1, JCategoriesMatieresClassesPeer::AFFICHE_MOYENNE => 2, JCategoriesMatieresClassesPeer::PRIORITY => 3, ),
    ...
    {
        $toNames = JCategoriesMatieresClassesPeer::getFieldNames($toType);
        $key = isset(JCategoriesMatieresClassesPeer::$fieldKeys[$fromType][$name]) ? JCategoriesMatieresClassesPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(JCategoriesMatieresClassesPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, JCategoriesMatieresClassesPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return JCategoriesMatieresClassesPeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(JCategoriesMatieresClassesPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(JCategoriesMatieresClassesPeer::DATABASE_NAME);
     ...
     *
     * @param      JCategoriesMatieresClasses $obj A JCategoriesMatieresClasses object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            JCategoriesMatieresClassesPeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(JCategoriesMatieresClassesPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(JCategoriesMatieresClassesPeer::$instances[$key])) {
                return JCategoriesMatieresClassesPeer::$instances[$key];
            }
        }
    ...
    {
        JCategoriesMatieresClassesPeer::$instances = array();
    }
    ...
    public static function populateObject($row, $startcol = 0)
    {
        ...
        if (null !== ($obj = JCategoriesMatieresClassesPeer::getInstanceFromPool($key))) {
            ...
            $col = $startcol + JCategoriesMatieresClassesPeer::NUM_HYDRATE_COLUMNS;
        } else {
    ...
    public static function doSelectJoinCategorieMatiere(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        JCategoriesMatieresClassesPeer::addSelectColumns($criteria);
        $startcol = JCategoriesMatieresClassesPeer::NUM_HYDRATE_COLUMNS;
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        JCategoriesMatieresClassesPeer::addSelectColumns($criteria);
        $startcol2 = JCategoriesMatieresClassesPeer::NUM_HYDRATE_COLUMNS;
    ...
    {
        return Propel::getDatabaseMap(JCategoriesMatieresClassesPeer::DATABASE_NAME)->getTable(JCategoriesMatieresClassesPeer::TABLE_NAME);
    }
    ...
    {
        return JCategoriesMatieresClassesPeer::OM_CLASS;
    }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(JCategoriesMatieresClassesPeer::DATABASE_NAME);
