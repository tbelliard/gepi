...
*/
	echo "<h3>Mes listes d'élèves</h3>\n";

	if($_SESSION['statut']=='professeur'){
		echo "<p>Séléctionnez l'enseignement et la période pour lesquels vous souhaitez télécharger un fichier CSV des élèves:</p>\n";
	...
	elseif($_SESSION['statut']=='cpe'){
		echo "<p>Séléctionnez la classe et la période pour lesquels vous souhaitez télécharger un fichier CSV des élèves:</p>\n";
