...
*/
	...
	foreach( $ical2->events() as $event ) {
		...
		if(($tmp_ts_debut>$begin_bookings)&&($tmp_ts_debut<$end_bookings)) {
			...
			if(isset($event['DESCRIPTION'])) {
				if(isset($event['DTEND'])) {
					echo "<p><input type='checkbox' name='date_vacances[]' id='date_vacances_$cpt' value=\"".preg_replace('/"/', '', $event['DESCRIPTION'])."|".strftime("%d/%m/%Y", $ts_debut)."|".strftime("%d/%m/%Y", $ts_fin)."\" onchange=\"checkbox_change(this.id); changement();\" /><label for='date_vacances_$cpt' id='texte_date_vacances_$cpt'> ".$event['DESCRIPTION']."&nbsp;: Du ".french_strftime("%A %d/%m/%Y", $ts_debut)." <span style='font-size:xx-small; font-style:italic;'>(inclus)</span> au ".french_strftime("%A %d/%m/%Y", $ts_fin)." <span style='font-size:xx-small; font-style:italic;'>(exclus)</span></label></p>";
				}
			}
	...
	echo "
		...
		<p><input type='checkbox' name='date_vacances[]' id='date_vacances_$cpt' value=\"11 novembre|11/11/".$annee_0."|12/11/".$annee_0."\" onchange=\"checkbox_change(this.id); changement();\" /><label for='date_vacances_$cpt' id='texte_date_vacances_$cpt'> 11 novembre (<em>Armistice</em>)&nbsp;: Du ".french_strftime("%A %d/%m/%Y", $ts_11_novembre)." <span style='font-size:xx-small; font-style:italic;'>(inclus)</span> au ".french_strftime("%A %d/%m/%Y", $ts_11_novembre+24*3600)." <span style='font-size:xx-small; font-style:italic;'>(exclus)</span></label></p>";
	$cpt++;

	$ts_1er_mai=mktime(0,0,0,5,1,$annee_1);
	echo "
		<p><input type='checkbox' name='date_vacances[]' id='date_vacances_$cpt' value=\"1er mai|01/05/".$annee_1."|02/05/".$annee_1."\" onchange=\"checkbox_change(this.id); changement();\" /><label for='date_vacances_$cpt' id='texte_date_vacances_$cpt'> 1er mai (<em>Fête du travail</em>)&nbsp;: Du ".french_strftime("%A %d/%m/%Y", $ts_1er_mai)." <span style='font-size:xx-small; font-style:italic;'>(inclus)</span> au ".french_strftime("%A %d/%m/%Y", $ts_1er_mai+24*3600)." <span style='font-size:xx-small; font-style:italic;'>(exclus)</span></label></p>";
	$cpt++;
	...
	echo "
	   ...
	   . "<label for='date_vacances_$cpt' id='texte_date_vacances_$cpt'> 8 mai (<em>Fête de la victoire de 1945</em>)&nbsp;: Du ".french_strftime("%A %d/%m/%Y", $ts_8_mai)." <span style='font-size:xx-small; font-style:italic;'>(inclus)</span> au ".french_strftime("%A %d/%m/%Y", $ts_8_mai+24*3600)." <span style='font-size:xx-small; font-style:italic;'>(exclus)</span></label></p>";
	$cpt++;
...
<p>
	...
	<label for='date_vacances_<?php echo $cpt; ?>' id='texte_date_vacances_<?php echo $cpt; ?>'>
		Lundi de Pâques : <?php echo french_strftime('%d %B %Y', LundiPaques($annee_1)); ?>
	</label>
</p>
<?php $cpt++; ?>
<p>
	<input type='checkbox' 
		   ...
		   onchange="checkbox_change(this.id); changement();" />
	<label for='date_vacances_<?php echo $cpt; ?>' id='texte_date_vacances_<?php echo $cpt; ?>'>
		Ascension : <?php echo french_strftime('%d %B %Y', Ascension($annee_1)); ?>
	</label>
</p>
<?php $cpt++; ?>
<p>
	<input type='checkbox' 
		   ...
		   onchange="checkbox_change(this.id); changement();" />
	<label for='date_vacances_<?php echo $cpt; ?>' id='texte_date_vacances_<?php echo $cpt; ?>'>
		Vendredi de l'Ascension : <?php echo french_strftime('%d %B %Y', VendrediAscension($annee_1)); ?>
	</label>
</p>
<?php $cpt++; ?>
<p>
	<input type='checkbox' 
		   ...
		   onchange="checkbox_change(this.id); changement();" />
	<label for='date_vacances_<?php echo $cpt; ?>' id='texte_date_vacances_<?php echo $cpt; ?>'>
		Lundi de Pentecôte : <?php echo french_strftime('%d %B %Y', Pentecote($annee_1)); ?>
	</label>
</p>
<?php $cpt++; ?>
