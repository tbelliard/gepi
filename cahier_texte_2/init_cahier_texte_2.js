...
function insere_lien_instrumenpoche_dans_ckeditor2(titre, url, url_iep) {
	texte="<a href='"+url_iep+"?"+url+"' target='_blank'>"+titre+"</a>";	
	CKEDITOR.instances['contenu'].insertHtml(texte);
}

function insere_lien_document_dans_ckeditor(titre, url) {
	texte="<a href='"+url+"' target='_blank'>"+titre+"</a>";	
	CKEDITOR.instances['contenu'].insertHtml(texte);
}
