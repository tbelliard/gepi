...
// Dernière modification: 18/11/2006
...
<body-->
						...
						*/
						...
						if($etape==1){
							...
							if($fp){
								...
								echo "<p>Aller à la section <a href='#csv'>CSV</a>.</p>\n";
								echo "</blockquote>\n";
	...
	*/
								...
								echo "<p>ERREUR! Le fichier Elèves n'a pas pu être ouvert.<br /><a href='".$_SERVER['PHP_SELF']."'>Retour</a>.</p>\n";
							}
							...
							if($fp){
								...
								echo "<p>ERREUR! Le fichier Nomenclature.xml n'a pas pu être ouvert.<br /><a href='".$_SERVER['PHP_SELF']."'>Retour</a>.</p>\n";
							}
							...
							*/
							...
							if($fp){
								...
								echo "<p>ERREUR! Le fichier Responsables n'a pas pu être ouvert.<br /><a href='".$_SERVER['PHP_SELF']."'>Retour</a>.</p>\n";
							}
