...
if ($test1 ==0) {
    ...
    if ($test2 ==0) {
        ...
        $test3 = mysql_result(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT count(*) FROM temp_gep_import2 WHERE LOGIN !=''"),0);
        if ($test3 ==0) {
...
while ($classe_row = mysqli_fetch_object($appel_donnees_classes)) {
    ...
    $call_data = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT $tempo FROM temp_gep_import2 WHERE DIVCOD = '$classe'");
    $tab_options = array();
    ...
    while($i = mysqli_fetch_object($appel_donnees_eleves)) {
        ...
        $call_data = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT ELEOPT1,ELEOPT2,ELEOPT3,ELEOPT4,ELEOPT5,ELEOPT6,ELEOPT7,ELEOPT8,ELEOPT9,ELEOPT10,ELEOPT11,ELEOPT12 FROM temp_gep_import2 WHERE LOGIN = '$current_eleve_login'");
