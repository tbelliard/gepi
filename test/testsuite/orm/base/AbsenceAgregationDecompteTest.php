...
class AbsenceAgregationDecompteTest extends GepiEmptyTestBase
{
	...
	public function testPeerCheckSynchroAbsenceAgregationTable()
	{
	    ...
	    AbsenceAgregationDecompteQuery::create()->deleteAll();
	    foreach (EleveQuery::create()->find() as $eleve) {
            $eleve->updateAbsenceAgregationTable(new DateTime('2012-10-05 00:00:00'),new DateTime('2012-10-09 23:59:59'));
	    }
	    $this->assertTrue(AbsenceAgregationDecomptePeer::checkSynchroAbsenceAgregationTable(new DateTime('2012-10-05 00:00:00'),new DateTime('2012-10-09 23:59:59'), 0));
	    $this->assertFalse(AbsenceAgregationDecomptePeer::checkSynchroAbsenceAgregationTable(new DateTime('2012-10-05 00:00:00'),new DateTime('2012-10-10 23:59:59'), 0));
	    $this->assertFalse(AbsenceAgregationDecomptePeer::checkSynchroAbsenceAgregationTable(new DateTime('2012-10-05 00:00:00'),new DateTime('2012-10-10 23:59:59'), 1));
	    $this->assertTrue(AbsenceAgregationDecomptePeer::checkSynchroAbsenceAgregationTable(new DateTime('2012-10-05 00:00:00'),new DateTime('2012-10-10 23:59:59'), 10));
	    ...
	    $this->assertFalse(AbsenceAgregationDecomptePeer::checkSynchroAbsenceAgregationTable(new DateTime('2012-10-05 00:00:00'),new DateTime('2012-10-09 23:59:59'), 0));
	    $this->assertFalse(AbsenceAgregationDecomptePeer::checkSynchroAbsenceAgregationTable(new DateTime('2012-10-05 00:00:00'),new DateTime('2012-10-09 23:59:59'), 0));
	    $this->assertFalse(AbsenceAgregationDecomptePeer::checkSynchroAbsenceAgregationTable(new DateTime('2012-10-05 00:00:00'),new DateTime('2012-10-09 23:59:59'), 1));
	    $this->assertTrue(AbsenceAgregationDecomptePeer::checkSynchroAbsenceAgregationTable(new DateTime('2012-10-05 00:00:00'),new DateTime('2012-10-09 23:59:59'), 10));
	    ...
	    $this->assertTrue(AbsenceAgregationDecomptePeer::checkSynchroAbsenceAgregationTable(new DateTime('2012-10-06 00:00:00'),new DateTime('2012-10-09 23:59:59'), 0));
	    $this->assertFalse(AbsenceAgregationDecomptePeer::checkSynchroAbsenceAgregationTable(new DateTime('2012-10-05 00:00:00'),new DateTime('2012-10-09 23:59:59'), 0));
	    $this->assertFalse(AbsenceAgregationDecomptePeer::checkSynchroAbsenceAgregationTable(new DateTime('2012-10-05 00:00:00'),new DateTime('2012-10-09 23:59:59'), 1));
	    $this->assertFalse(AbsenceAgregationDecomptePeer::checkSynchroAbsenceAgregationTable(new DateTime('2012-10-05 00:00:00'),new DateTime('2012-10-09 23:59:59'), 10));
	    ...
	    AbsenceAgregationDecompteQuery::create()->deleteAll();
	    foreach (EleveQuery::create()->find() as $eleve) {
            $eleve->updateAbsenceAgregationTable(new DateTime('2012-10-05 00:00:00'),new DateTime('2012-10-20 23:59:59'));
	    }
	    sleep(1);
	    $saisie_id = $florence_eleve->getAbsenceEleveSaisiesDuJour('2012-10-06')->getFirst()->getId();
        mysql_query("update a_saisies set updated_at = now() where id = ".$saisie_id);
	    $this->assertFalse(AbsenceAgregationDecomptePeer::checkSynchroAbsenceAgregationTable(new DateTime('2012-10-05 00:00:00'),new DateTime('2012-10-14 23:59:59'),0));
	    $this->assertFalse(AbsenceAgregationDecomptePeer::checkSynchroAbsenceAgregationTable(new DateTime('2012-10-05 00:00:00'),new DateTime('2012-10-14 23:59:59'),10));
	    ...
	    $this->assertTrue(AbsenceAgregationDecomptePeer::checkSynchroAbsenceAgregationTable(new DateTime('2012-10-05 00:00:00'),new DateTime('2012-10-14 23:59:59'),0));
	    ...
	    $traitement_id = AbsenceEleveTraitementQuery::create()->filterByAbsenceEleveSaisie($florence_eleve->getAbsenceEleveSaisiesDuJour('2012-10-06')->getFirst())->findOne()->getId();
        ...
        mysql_query("update a_saisies set updated_at = now() where id = ".$saisie_id);
	    $this->assertTrue(AbsenceAgregationDecomptePeer::checkSynchroAbsenceAgregationTable(new DateTime('2012-10-05 00:00:00'),new DateTime('2012-10-14 23:59:59'),0));
	    $this->assertTrue(AbsenceAgregationDecomptePeer::checkSynchroAbsenceAgregationTable(new DateTime('2012-10-05 00:00:00'),new DateTime('2012-10-14 23:59:59'),10));
	    $this->assertTrue(AbsenceAgregationDecomptePeer::checkSynchroAbsenceAgregationTable(null, null, 0));
        mysql_query("update a_saisies set updated_at = now()-10 where id = ".$saisie_id);
	    $this->assertTrue(AbsenceAgregationDecomptePeer::checkSynchroAbsenceAgregationTable(new DateTime('2012-10-05 00:00:00'),new DateTime('2012-10-14 23:59:59'),0));
	    $this->assertTrue(AbsenceAgregationDecomptePeer::checkSynchroAbsenceAgregationTable(null, null, 0));
	    ...
	    $this->assertTrue(AbsenceAgregationDecomptePeer::checkSynchroAbsenceAgregationTable(new DateTime('2012-10-05 00:00:00'),new DateTime('2012-10-20 23:59:59'),0));
	    $this->assertTrue(AbsenceAgregationDecomptePeer::checkSynchroAbsenceAgregationTable(new DateTime('2012-10-05 00:00:00'),new DateTime('2012-10-20 23:59:59'),10));
	    $this->assertTrue(AbsenceAgregationDecomptePeer::checkSynchroAbsenceAgregationTable(null, null, 0));
	...
	public function testPeerUpdateAgregationTable()
	{
	    ...
	    AbsenceAgregationDecompteQuery::create()->deleteAll();
        AbsenceAgregationDecomptePeer::updateAgregationTable(AbsenceEleveSaisieQuery::create()->filterByPlageTemps(new DateTime('2012-10-05'), new DateTime('2012-10-14'))->find());
        $eleve_col = EleveQuery::create()->useAbsenceEleveSaisieQuery()->filterByPlageTemps(new DateTime('2012-10-05'), new DateTime('2012-10-14'))->endUse()->find();
        foreach($eleve_col as $eleve) {
            $this->assertTrue($eleve->checkSynchroAbsenceAgregationTable(new DateTime('2012-10-06 00:00:00'),new DateTime('2012-10-09')));
        }
	}
	...
	public function testQueryFilterByDateIntervalle()
	{
	    AbsenceAgregationDecompteQuery::create()->deleteAll();
	    foreach (EleveQuery::create()->find() as $eleve) {
            $eleve->updateAbsenceAgregationTable(new DateTime('2012-10-05 00:00:00'),new DateTime('2012-10-24 23:59:59'));
	    }
	    $florence_eleve = EleveQuery::create()->findOneByLogin('Florence Michu');
	    $this->assertEquals(4,AbsenceAgregationDecompteQuery::create()->filterByEleve($florence_eleve)->filterByDateIntervalle(new DateTime('2012-10-05'),new DateTime('2012-10-07'))->count());
	    $this->assertEquals(5,AbsenceAgregationDecompteQuery::create()->filterByEleve($florence_eleve)->filterByDateIntervalle(new DateTime('2012-10-05'),new DateTime('2012-10-07 12:00:00'))->count());
	...
	public function testQueryCountRetards()
	{
	    ...
	    $this->assertEquals(6,AbsenceAgregationDecompteQuery::create()->filterByDateIntervalle(new DateTime('2012-10-05 00:00:00'),new DateTime('2013-06-03 23:59:59'))->countRetards());
	    $florence_eleve = EleveQuery::create()->findOneByLogin('Florence Michu');
	    $this->assertEquals(6,AbsenceAgregationDecompteQuery::create()->filterByDateIntervalle(new DateTime('2012-10-05 00:00:00'),new DateTime('2013-06-03 23:59:59'))->filterByEleve($florence_eleve)->countRetards());
	}
