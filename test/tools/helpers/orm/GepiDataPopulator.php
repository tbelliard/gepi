...
class GepiDataPopulator
{
    ...
    public static function populate($con = null)
    {
        ...
        $michel_eleve->setDateSortie('2012-12-24');
        $michel_eleve->save();
        ...
        $periode_6A_1->setDateFin('2012-12-01 00:00:00');
        $periode_6A_1->save();
        ...
        $periode_6A_2->setDateFin('2013-03-01 23:59:59');
        $periode_6A_2->save();
        ...
        $periode_6B_2->setDateFin('2013-03-01 23:59:59');
        $periode_6B_2->save();
        ...
        $periode_6B_3->setDateFin('2013-07-01 23:59:59');
        $periode_6B_3->save();
        ...
        $saisie_1->setDebutAbs('2012-10-05 08:00:00');//le 2010-10-01 est un vendredi
        $saisie_1->setFinAbs('2012-10-05 09:00:00');
        $saisie_1->save();

        $saisie_2 = new AbsenceEleveSaisie();
        $saisie_2->setEleve($florence_eleve);
        $saisie_2->setUtilisateurProfessionnel($lebesgue_prof);
        $saisie_2->setDebutAbs('2012-10-06 08:00:00');//samedi : ne comptera pas comme demi journée d'absence
        $saisie_2->setFinAbs('2012-10-06 09:00:00');
        $saisie_2->save();
        ...
        $saisie_3->setDebutAbs('2012-10-07 08:00:00');//dimanche : ne comptera pas comme demi journée d'absence
        $saisie_3->setFinAbs('2012-10-07 08:29:00');
        $saisie_3->save();
        $traitement = new AbsenceEleveTraitement();
        ...
        $saisie_4->setDebutAbs('2012-10-08 08:00:00');
        $saisie_4->setFinAbs('2012-10-08 08:29:00');//retard : ne comptera pas comme demi journée d'absence
        $saisie_4->save();
        $traitement = new AbsenceEleveTraitement();
        ...
        $saisie_5->setDebutAbs('2012-10-09 08:00:00');
        $saisie_5->setFinAbs('2012-10-09 08:29:00');//retard : ne comptera pas comme demi journée d'absence
        $saisie_5->save();
        $saisie_51 = new AbsenceEleveSaisie();
        $saisie_51->setEleve($florence_eleve);
        $saisie_51->setUtilisateurProfessionnel($lebesgue_prof);
        $saisie_51->setDebutAbs('2012-10-09 09:00:00');
        $saisie_51->setFinAbs('2012-10-09 09:29:00');//retard : ne comptera pas comme demi journée d'absence
        $saisie_51->save();
        $traitement = new AbsenceEleveTraitement();
        ...
        $saisie_6->setDebutAbs('2012-10-10 08:00:00');
        $saisie_6->setFinAbs('2012-10-10 09:00:00');
        $saisie_6->save();
        $traitement = new AbsenceEleveTraitement();
        ...
        $saisie_7->setDebutAbs('2012-10-11 08:00:00');
        $saisie_7->setFinAbs('2012-10-11 09:00:00');
        $saisie_7->save();
        $traitement = new AbsenceEleveTraitement();
        ...
        $saisie_8->setDebutAbs('2012-10-12 08:00:00');
        $saisie_8->setFinAbs('2012-10-12 09:00:00');
        $saisie_8->save();
        $saisie_81 = new AbsenceEleveSaisie();
        $saisie_81->setEleve($florence_eleve);
        $saisie_81->setUtilisateurProfessionnel($lebesgue_prof);
        $saisie_81->setDebutAbs('2012-10-12 08:00:00');
        $saisie_81->setFinAbs('2012-10-12 08:10:00');//ce retard ne sera pas décompté car il est inclus dans une absence plus globale
        $saisie_81->save();
        $traitement = new AbsenceEleveTraitement();
        ...
        $saisie_9->setDebutAbs('2012-10-13 08:00:00');
        $saisie_9->setFinAbs('2012-10-13 09:00:00');//samedi : ne comptera pas comme demi journée d'absence
        $saisie_9->save();
        $saisie_91 = new AbsenceEleveSaisie();
        $saisie_91->setEleve($florence_eleve);
        $saisie_91->setUtilisateurProfessionnel($lebesgue_prof);
        $saisie_91->setDebutAbs('2012-10-13 08:00:00');
        $saisie_91->setFinAbs('2012-10-13 08:10:00');
        $saisie_91->save();
        $traitement = new AbsenceEleveTraitement();
        ...
        $saisie_10->setDebutAbs('2012-10-14 08:00:00');
        $saisie_10->setFinAbs('2012-10-14 09:00:00');
        ...
        $saisie_101->setDebutAbs('2012-10-14 08:00:00');
        $saisie_101->setFinAbs('2012-10-14 08:10:00');
        $saisie_101->save();
        $traitement = new AbsenceEleveTraitement();
        ...
        $saisie_11->setDebutAbs('2012-10-15 08:00:00');
        $saisie_11->setFinAbs('2012-10-15 09:00:00');
        ...
        $saisie_111->setDebutAbs('2012-10-15 08:00:00');
        $saisie_111->setFinAbs('2012-10-15 08:10:00');
        $saisie_111->save();
        $traitement = new AbsenceEleveTraitement();
        ...
        $saisie_12->setDebutAbs('2012-10-16 08:00:00');
        $saisie_12->setFinAbs('2012-10-16 09:00:00');
        ...
        $saisie_121->setDebutAbs('2012-10-16 08:00:00');
        $saisie_121->setFinAbs('2012-10-16 08:10:00');
        $saisie_121->save();
        $traitement = new AbsenceEleveTraitement();
        ...
        $saisie_13->setDebutAbs('2012-10-17 08:00:00');
        $saisie_13->setFinAbs('2012-10-17 09:00:00');
        ...
        $saisie_131->setDebutAbs('2012-10-17 08:00:00');
        $saisie_131->setFinAbs('2012-10-17 08:10:00');
        $saisie_131->save();
        $traitement = new AbsenceEleveTraitement();
        ...
        $saisie_14->setDebutAbs('2012-10-18 08:00:00');
        $saisie_14->setFinAbs('2012-10-18 09:00:00');
        ...
        $saisie_15->setDebutAbs('2012-10-19 08:00:00');
        $saisie_15->setFinAbs('2012-10-19 09:00:00');
        ...
        $saisie_151->setDebutAbs('2012-10-19 08:00:00');//ce retard ne sera pas décompté car il est inclus dans une absence plus globale
        $saisie_151->setFinAbs('2012-10-19 08:10:00');
        ...
        $saisie_16->setDebutAbs('2012-10-20 08:00:00');
        $saisie_16->setFinAbs('2012-10-20 09:00:00');
        ...
        $saisie_17->setDebutAbs('2012-10-21 08:00:00');
        $saisie_17->setFinAbs('2012-10-21 09:00:00');
        $saisie_17->save();
        $saisie_171 = new AbsenceEleveSaisie();
        $saisie_171->setEleve($florence_eleve);
        $saisie_171->setUtilisateurProfessionnel($lebesgue_prof);
        $saisie_171->setDebutAbs('2012-10-21 14:00:00');
        $saisie_171->setFinAbs('2012-10-21 15:00:00');
        $saisie_171->save();
        $traitement = new AbsenceEleveTraitement();
        ...
        $saisie_18->setDebutAbs('2012-10-22 08:00:00');
        $saisie_18->setFinAbs('2012-10-22 09:00:00');
        $saisie_18->save();
        $traitement = new AbsenceEleveTraitement();
        ...
        $saisie_181->setDebutAbs('2012-10-22 08:00:00');
        $saisie_181->setFinAbs('2012-10-22 09:00:00');
        $saisie_181->save();
        ...
        $saisie_19->setDebutAbs('2012-10-23 08:00:00');
        $saisie_19->setFinAbs('2012-10-23 16:30:00');
        $saisie_19->save();
        ...
        $saisie_20->setDebutAbs('2012-11-01 08:00:00');
        $saisie_20->setFinAbs('2012-11-06 17:00:00');
        $saisie_20->save();
        $traitement = new AbsenceEleveTraitement();
        ...
        $saisie_21->setDebutAbs('2013-05-27 08:00:00');
        $saisie_21->setFinAbs('2013-05-27 16:30:00');
        $saisie_21->save();
        
        $saisie_22 = new AbsenceEleveSaisie();
        $saisie_22->setEleve($florence_eleve);
        $saisie_22->setUtilisateurProfessionnel($lebesgue_prof);
        $saisie_22->setDebutAbs('2013-05-28 08:01:00');
        $saisie_22->setFinAbs('2013-05-28 09:00:00');
        $saisie_22->save();
        $saisie_221 = new AbsenceEleveSaisie();
        $saisie_221->setEleve($florence_eleve);
        $saisie_221->setUtilisateurProfessionnel($lebesgue_prof);
        $saisie_221->setDebutAbs('2013-05-28 08:00:00');
        $saisie_221->setFinAbs('2013-05-28 09:10:00');
        $saisie_221->save();
        $traitement = new AbsenceEleveTraitement();
        ...
        $saisie_23->setDebutAbs('2013-05-29 08:01:00');
        $saisie_23->setFinAbs('2013-05-29 08:10:00');
        $saisie_23->save();
        $saisie_231 = new AbsenceEleveSaisie();
        $saisie_231->setEleve($florence_eleve);
        $saisie_231->setUtilisateurProfessionnel($lebesgue_prof);
        $saisie_231->setDebutAbs('2013-05-29 08:00:00');
        $saisie_231->setFinAbs('2013-05-29 09:10:00');
        $saisie_231->save();
        $traitement = new AbsenceEleveTraitement();
        ...
        $saisie_1->setEleve($florence_eleve);
        $saisie_1->setUtilisateurProfessionnel($lebesgue_prof);
        $saisie_1->setDebutAbs('2013-05-30 08:00:00');
        $saisie_1->setFinAbs('2013-05-30 09:00:00');
        $saisie_1->save();
        $saisie_1 = new AbsenceEleveSaisie();
        $saisie_1->setEleve($florence_eleve);
        $saisie_1->setUtilisateurProfessionnel($lebesgue_prof);
        $saisie_1->setDebutAbs('2013-05-30 07:00:00');
        $saisie_1->setFinAbs('2013-05-30 10:00:00');
        $saisie_1->save();
        $traitement = new AbsenceEleveTraitement();
        ...
        $saisie_1->setEleve($florence_eleve);
        $saisie_1->setUtilisateurProfessionnel($lebesgue_prof);
        $saisie_1->setDebutAbs('2013-05-31 08:00:00');
        $saisie_1->setFinAbs('2013-05-31 09:00:00');
        $saisie_1->save();
        $saisie_1 = new AbsenceEleveSaisie();
        $saisie_1->setEleve($florence_eleve);
        $saisie_1->setUtilisateurProfessionnel($lebesgue_prof);
        ...
        $saisie_1->setEleve($florence_eleve);
        $saisie_1->setUtilisateurProfessionnel($lebesgue_prof);
        $saisie_1->setDebutAbs('2013-06-03 08:00:00');
        $saisie_1->setFinAbs('2013-06-03 09:00:00');
        $saisie_1->save();
        $saisie_1 = new AbsenceEleveSaisie();
        $saisie_1->setEleve($florence_eleve);
        $saisie_1->setUtilisateurProfessionnel($lebesgue_prof);
        $saisie_1->setDebutAbs('2013-06-03 08:00:00');
        $saisie_1->setFinAbs('2013-06-03 09:30:00');
        $saisie_1->save();
        $traitement = new AbsenceEleveTraitement();
        $traitement->addAbsenceEleveSaisie($saisie_1);
        $traitement->setAbsenceEleveType(AbsenceEleveTypeQuery::create()->filterByNom('Infirmerie')->findOne());
        ...
        $saisie_1->setUtilisateurProfessionnel($lebesgue_prof);
        $saisie_1->setDebutAbs('2013-06-03 08:00:00');
        $saisie_1->setFinAbs('2013-06-03 10:00:00');
        $saisie_1->save();

        $saisie_1 = new AbsenceEleveSaisie();
        $saisie_1->setEleve($florence_eleve);
        $saisie_1->setUtilisateurProfessionnel($lebesgue_prof);
        $saisie_1->setDebutAbs('2013-06-04 08:00:00');
        $saisie_1->setFinAbs('2013-06-04 09:00:00');
        $saisie_1->save();
        $traitement = new AbsenceEleveTraitement();
        $traitement->addAbsenceEleveSaisie($saisie_1);
        $traitement->setAbsenceEleveType(AbsenceEleveTypeQuery::create()->filterByNom('Infirmerie')->findOne());
        ...
        $saisie_1->setEleve($florence_eleve);
        $saisie_1->setUtilisateurProfessionnel($lebesgue_prof);
        $saisie_1->setDebutAbs('2013-06-04 09:00:00');
        $saisie_1->setFinAbs('2013-06-04 09:40:00');
        $saisie_1->save();
        $saisie_1 = new AbsenceEleveSaisie();
        $saisie_1->setEleve($florence_eleve);
        $saisie_1->setUtilisateurProfessionnel($lebesgue_prof);
        $saisie_1->setDebutAbs('2013-06-04 08:00:00');
        $saisie_1->setFinAbs('2013-06-04 10:00:00');
        $saisie_1->save();
        $traitement = new AbsenceEleveTraitement();
        $traitement->addAbsenceEleveSaisie($saisie_1);
        $traitement->setAbsenceEleveJustification(AbsenceEleveJustificationQuery::create()->filterByNom('Courrier familial')->findOne());
        ...
        $saisie_1->setEleve($florence_eleve);
        $saisie_1->setUtilisateurProfessionnel($lebesgue_prof);
        $saisie_1->setDebutAbs('2013-06-05 08:00:00');
        $saisie_1->setFinAbs('2013-06-05 09:00:00');
        $saisie_1->save();
        $saisie_1 = new AbsenceEleveSaisie();
        $saisie_1->setEleve($florence_eleve);
        $saisie_1->setUtilisateurProfessionnel($lebesgue_prof);
        ...
        $saisie_1->setEleve($florence_eleve);
        $saisie_1->setUtilisateurProfessionnel($lebesgue_prof);
        $saisie_1->setDebutAbs('2013-06-06 08:00:00');
        $saisie_1->setFinAbs('2013-06-06 08:10:00');
        $saisie_1->save();
        $saisie_1 = new AbsenceEleveSaisie();
        $saisie_1->setEleve($florence_eleve);
        $saisie_1->setUtilisateurProfessionnel($lebesgue_prof);
        $saisie_1->setDebutAbs('2013-06-06 08:00:00');
        $saisie_1->setFinAbs('2013-06-06 08:15:00');
        $saisie_1->save();
        $traitement = new AbsenceEleveTraitement();
        $traitement->addAbsenceEleveSaisie($saisie_1);
        $traitement->setUtilisateurProfessionnel($dolto_cpe);
        ...
        $saisie_1->setEleve($florence_eleve);
        $saisie_1->setUtilisateurProfessionnel($lebesgue_prof);
        $saisie_1->setDebutAbs('2013-06-07 08:00:00');
        $saisie_1->setFinAbs('2013-06-07 08:10:00');
        $saisie_1->save();
        $saisie_1 = new AbsenceEleveSaisie();
        $saisie_1->setEleve($florence_eleve);
        $saisie_1->setUtilisateurProfessionnel($lebesgue_prof);
        ...
        $saisie_1->setEleve($florence_eleve);
        $saisie_1->setUtilisateurProfessionnel($lebesgue_prof);
        $saisie_1->setDebutAbs('2013-06-08 08:00:00');
        $saisie_1->setFinAbs('2013-06-08 09:00:00');
        $saisie_1->save();
        $saisie_1 = new AbsenceEleveSaisie();
        $saisie_1->setEleve($florence_eleve);
        $saisie_1->setUtilisateurProfessionnel($lebesgue_prof);
        ...
        $saisie_1->setUtilisateurProfessionnel($lebesgue_prof);
        $saisie_1->setDebutAbs('2013-06-08 08:00:00');
        $saisie_1->setFinAbs('2013-06-08 09:10:00');
        $saisie_1->save();
        $traitement = new AbsenceEleveTraitement();
        $traitement->addAbsenceEleveSaisie($saisie_1);
        $traitement->setAbsenceEleveType(AbsenceEleveTypeQuery::create()->filterByNom('Erreur de saisie')->findOne());
        ...
        $saisie_1->setEleve($florence_eleve);
        $saisie_1->setUtilisateurProfessionnel($lebesgue_prof);
        $saisie_1->setDebutAbs('2013-06-09 08:00:00');
        $saisie_1->setFinAbs('2013-06-09 09:00:00');
        $saisie_1->save();
        $saisie_1 = new AbsenceEleveSaisie();
        $saisie_1->setEleve($florence_eleve);
        $saisie_1->setUtilisateurProfessionnel($lebesgue_prof);
        $saisie_1->setDebutAbs('2013-06-09 07:00:00');
        $saisie_1->setFinAbs('2013-06-09 09:10:00');
        $saisie_1->save();
        $saisie_1 = new AbsenceEleveSaisie();
        $saisie_1->setEleve($florence_eleve);
        $saisie_1->setUtilisateurProfessionnel($lebesgue_prof);
        $saisie_1->setDebutAbs('2013-06-09 08:00:00');
        $saisie_1->setFinAbs('2013-06-09 09:11:00');
        $saisie_1->save();
        $traitement = new AbsenceEleveTraitement();
        $traitement->addAbsenceEleveSaisie($saisie_1);
        $traitement->setAbsenceEleveType(AbsenceEleveTypeQuery::create()->filterByNom('Infirmerie')->findOne());
        ...
        $saisie_1->setEleve($florence_eleve);
        $saisie_1->setUtilisateurProfessionnel($lebesgue_prof);
        $saisie_1->setDebutAbs('2013-06-10 08:00:00');
        $saisie_1->setFinAbs('2013-06-10 08:10:00');
        $saisie_1->save();
        $saisie_1 = new AbsenceEleveSaisie();
        $saisie_1->setEleve($florence_eleve);
        $saisie_1->setUtilisateurProfessionnel($lebesgue_prof);
        ...
        $saisie_1->setUtilisateurProfessionnel($lebesgue_prof);
        $saisie_1->setDebutAbs('2013-06-10 08:00:00');
        $saisie_1->setFinAbs('2013-06-10 09:10:00');
        $saisie_1->save();
        $traitement = new AbsenceEleveTraitement();
        $traitement->addAbsenceEleveSaisie($saisie_1);
        $traitement->setUtilisateurProfessionnel($dolto_cpe);
