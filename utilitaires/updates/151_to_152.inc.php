		...
		if ($test == 0) {
			$query2 = mysql_query("CREATE TABLE ects_credits
                                    (
                                        ...
                                        valeur DECIMAL(3,1) NOT NULL COMMENT 'Nombre de crÃƒÂ©dits obtenus par l\'eleve',
		...
		if ($test == 0) {
			$query2 = mysql_query("CREATE TABLE archivage_ects
                                    (
                                        ...
                                        valeur DECIMAL  NOT NULL COMMENT 'Nombre de crÃƒÂ©dits obtenus par l\'eleve',
                                        mention VARCHAR(255)  NOT NULL COMMENT 'Mention obtenue',
...
description_item VARCHAR( 255 ) NOT NULL
		...
		//==========================================================
		$result .= "<br />&nbsp;->ContrÃ´le des valeurs autorisées pour le champ 'acces' de la table 'matieres_appreciations_acces'&nbsp;: ";
	...
	# Il semble que sur certaines bases le champ ait pu Ãªtre manquant:
