...
if ($mode=='module_discipline') {
	...
	*/
	...
	if(mysqli_num_rows($res_incident)>0) {
		...
		//echo "$sql_lieu<br />\n";
		$res_mesures_prises=mysqli_query($GLOBALS["___mysqli_ston"], $sql_mesures_prises);
		...
		//echo "$sql_lieu<br />\n";
		$res_mesures_demandees=mysqli_query($GLOBALS["___mysqli_ston"], $sql_mesures_demandees);
		...
		$res_autres_mesures_prises=mysqli_query($GLOBALS["___mysqli_ston"], $sql_autres_mesures_prises);
			...
			while ($lig_autre_sanction=mysqli_fetch_object($res_autres_mesures_prises)) {
				switch($lig_autre_sanction->nature)
				{
					case "travail" :
						...
						$R=mysqli_query($GLOBALS["___mysqli_ston"], $r_sql);
		...
		//echo "$sql_lieu<br />\n";
		$res_lieu=mysqli_query($GLOBALS["___mysqli_ston"], $sql_lieu);
