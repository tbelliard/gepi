...
/*
*
* $Id: bulletin_pdf_avec_modele_classe.php 8271 2011-09-19 14:33:27Z crob $
*
...
if(!empty($model_bulletin)) {
	...
	$affiche_moyenne_mini_general[$classe_id] = '1'; // permet l'affichage de la moyenne général mini
