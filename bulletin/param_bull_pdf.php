			...
			while($donner_model = mysql_fetch_array($requete_model))
			 {
				...
				$affiche_ine = $donner_model['affiche_ine']; // affiche le numéro INE de l'élève
			}
		?>
