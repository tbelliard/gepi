	...
	for($i=0;$i<$cpt_grp;$i++) {
		if((isset($id_groupe_dest[$i]))&&($id_groupe_dest[$i]!='')) {
			...
			if($id_groupe_dest[$i]==$id_groupe_src[$i]) {
				...
				$res_ccn_src=mysqli_query($GLOBALS["___mysqli_ston"], $sql);
				if(mysqli_num_rows($res_ccn_src)>0) {
					while($lig_ccn_src=mysqli_fetch_object($res_ccn_src)) {
						...
						$res_ccn_dest=mysqli_query($GLOBALS["___mysqli_ston"], $sql);
						if(mysqli_num_rows($res_ccn_dest)>0) {
							...
							$sql="INSERT INTO cn_conteneurs SET id_racine='', nom_court='".((isset($GLOBALS["___mysqli_ston"]) && is_object($GLOBALS["___mysqli_ston"])) ? mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $current_group_dest["description"]) : ((trigger_error("[MySQLConverterToo] Fix the mysql_escape_string() call! This code does not work.", E_USER_ERROR)) ? "" : ""))."', nom_complet='". ((isset($GLOBALS["___mysqli_ston"]) && is_object($GLOBALS["___mysqli_ston"])) ? mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $current_group_dest["matiere"]["nom_complet"]) : ((trigger_error("[MySQLConverterToo] Fix the mysql_escape_string() call! This code does not work.", E_USER_ERROR)) ? "" : ""))."', description = '', mode = '2', coef = '1.0', arrondir = 's1', ponderation = '0.0', display_parents = '0', display_bulletin = '1', parent = '0'";
							$creation_cnc=mysqli_query($GLOBALS["___mysqli_ston"], $sql);
							if($creation_cnc) {
								$id_cahier_notes_dest=((is_null($___mysqli_res = mysqli_insert_id($GLOBALS["___mysqli_ston"]))) ? false : $___mysqli_res);

								$sql="UPDATE cn_conteneurs SET id_racine='$id_cahier_notes_dest', parent = '0' WHERE id='$id_cahier_notes_dest';";
								$update_cn = mysqli_query($GLOBALS["___mysqli_ston"], $sql);
								if(!$update_cn) {
									...
									$creation_ccn=mysqli_query($GLOBALS["___mysqli_ston"], $sql);
									if(!$creation_ccn) {
										echo "<span style='color:red'>Erreur en créant le cahier de notes destination en période $lig_ccn_src->periode.</span><br />\n";
										unset($id_cahier_notes_dest);
									}
						...
						if(isset($id_cahier_notes_dest)) {
							...
							$res_dev_src=mysqli_query($GLOBALS["___mysqli_ston"], $sql);
							if(mysqli_num_rows($res_dev_src)>0) {
								while($lig_dev_src=mysqli_fetch_object($res_dev_src)) {
									...
									$sql="INSERT INTO cn_devoirs SET id_racine='$id_cahier_notes_dest', 
										...
										nom_court='".((isset($GLOBALS["___mysqli_ston"]) && is_object($GLOBALS["___mysqli_ston"])) ? mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $lig_dev_src->nom_court) : ((trigger_error("[MySQLConverterToo] Fix the mysql_escape_string() call! This code does not work.", E_USER_ERROR)) ? "" : ""))."', 
										nom_complet='".((isset($GLOBALS["___mysqli_ston"]) && is_object($GLOBALS["___mysqli_ston"])) ? mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $lig_dev_src->nom_complet) : ((trigger_error("[MySQLConverterToo] Fix the mysql_escape_string() call! This code does not work.", E_USER_ERROR)) ? "" : ""))."', 
										description='".((isset($GLOBALS["___mysqli_ston"]) && is_object($GLOBALS["___mysqli_ston"])) ? mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $lig_dev_src->description) : ((trigger_error("[MySQLConverterToo] Fix the mysql_escape_string() call! This code does not work.", E_USER_ERROR)) ? "" : ""))."', 
									...
									if($creation_dev) {
										...
										$id_devoir_dest=((is_null($___mysqli_res = mysqli_insert_id($GLOBALS["___mysqli_ston"]))) ? false : $___mysqli_res);
										...
										if(isset($notes_aleatoires)) {
											...
											foreach($current_group_dest['eleves'][$lig_ccn_src->periode]['list'] as $login_ele) {
												...
												$insert_note=mysqli_query($GLOBALS["___mysqli_ston"], $sql);
												if($insert_note) {
													$nb_notes++;
												}
											}
				...
				if($copier_cdt=="y") {
					...
					$res_cte=mysqli_query($GLOBALS["___mysqli_ston"], $sql);
					while($lig_cte=mysqli_fetch_object($res_cte)) {
						$sql="INSERT INTO ct_entry SET id_groupe='".$id_groupe_dest[$i]."', heure_entry='".$lig_cte->heure_entry."', date_ct='".$lig_cte->date_ct."', id_login='".$lig_cte->id_login."', contenu='".((isset($GLOBALS["___mysqli_ston"]) && is_object($GLOBALS["___mysqli_ston"])) ? mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $lig_cte->contenu) : ((trigger_error("[MySQLConverterToo] Fix the mysql_escape_string() call! This code does not work.", E_USER_ERROR)) ? "" : ""))."', vise='".$lig_cte->vise."', id_sequence='".$lig_cte->id_sequence."', visa='".$lig_cte->visa."';";
						//echo "$sql<br />";
						$insert=mysqli_query($GLOBALS["___mysqli_ston"], $sql);
						if($insert) {
							$id_ct_cte=((is_null($___mysqli_res = mysqli_insert_id($GLOBALS["___mysqli_ston"]))) ? false : $___mysqli_res);
							$sql="SELECT * FROM ct_documents WHERE id_ct='$id_ct_cte';";
							//echo "$sql<br />";
							$res_ctd=mysqli_query($GLOBALS["___mysqli_ston"], $sql);
					...
					$res_cte=mysqli_query($GLOBALS["___mysqli_ston"], $sql);
					while($lig_cte=mysqli_fetch_object($res_cte)) {
						$sql="INSERT INTO ct_devoirs_entry SET id_groupe='".$id_groupe_dest[$i]."',date_ct='".$lig_cte->date_ct."', id_login='".$lig_cte->id_login."', contenu='".((isset($GLOBALS["___mysqli_ston"]) && is_object($GLOBALS["___mysqli_ston"])) ? mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $lig_cte->contenu) : ((trigger_error("[MySQLConverterToo] Fix the mysql_escape_string() call! This code does not work.", E_USER_ERROR)) ? "" : ""))."', vise='".$lig_cte->vise."', id_sequence='".$lig_cte->id_sequence."', date_visibilite_eleve='".$lig_cte->date_visibilite_eleve."';";
						//echo "$sql<br />";
						$insert=mysqli_query($GLOBALS["___mysqli_ston"], $sql);
						if($insert) {
							$id_ct_cte=((is_null($___mysqli_res = mysqli_insert_id($GLOBALS["___mysqli_ston"]))) ? false : $___mysqli_res);
		...
		elseif(isset($new_groupe_dest[$i])) {
			...
			if (!$create) {
				...
				$result_list_periodes=mysqli_query($GLOBALS["___mysqli_ston"], $sql);
				while($ligne_periode=mysqli_fetch_object($result_list_periodes)){
					...
					$result_list_eleves=mysqli_query($GLOBALS["___mysqli_ston"], $sql);
