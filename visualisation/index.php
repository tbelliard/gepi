...
<tr>
    <td width=200><a href="affiche_eleve.php?type_graphe=courbe">Elève par rapport à un élève ou une moyenne</a></td>
    <td><b>Graphique en courbe</b>: Permet de comparer les résultats d'un élève, par rapport aux moyennes min/max/classe et par rapport à un autre élève, matière par matière, période par période.<br />Alternativement, ce choix permet d'obtenir les courbes des 3 trimestres.</td>
</tr>
<tr>
    <td width=200><a href="affiche_eleve.php?type_graphe=etoile">Elève par rapport à un élève ou une moyenne</a></td>
    <td><b>Graphique en étoile/polygone</b>: Permet de comparer les résultats d'un élève, par rapport aux moyennes min/max/classe et par rapport à un autre élève, matière par matière, période par période.<br />Alternativement, ce choix permet d'obtenir les polygones des 3 trimestres.</td>
</tr>
</table>
<p><br /></p>
</center>
