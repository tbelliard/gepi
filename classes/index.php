...
if ($nombre_lignes != 0) {
    ...
    while ($i < $nombre_lignes){
        ...
        echo "><td><b>$classe</b> ";
        echo "</td><td>|<a href='periodes.php?id_classe=$id_classe'> Gérer les périodes</a></td>";
        ...
        if ($nb_per != 0) {
            echo "<a href='classes_const.php?id_classe=$id_classe'>Gérer les élèves</a></td><td>|";
        } else {
            echo "&nbsp;</td><td>|";
        }
        if ($nb_per != 0) {
            echo "<a href='../groupes/edit_class.php?id_classe=$id_classe'>Gérer les enseignements</a></td><td>|";
        } else {
            echo "&nbsp;</td><td>|";
        }
...
*/
        echo "<a href='../groupes/edit_class_grp_lot.php?id_classe=$id_classe'>Gérer les enseignements simples</a></td><td>|
	<a href='modify_nom_class.php?id_classe=$id_classe'>Modifier les paramètres</a></td><td>|
        <a href='../lib/confirm_query.php?liste_cible=$id_classe&amp;action=del_classe'>Supprimer la classe</a> |
        </td><td>";
	//=======================================
