...
/*
*
* Copyright 2001, 2012, 2021 Thomas Belliard, Laurent Delineau, Edouard Hue, Eric Lebrun, Romain Neil
*
...
<form enctype="multipart/form-data" action="classes_ajout.php" name="form1" method=post>
	...
	<p class="bold">
		<a href="classes_const.php?id_classe=<?php echo $id_classe; ?>"><img src='../images/icons/back.png' alt='Retour'
																			 class='back_link'/> Retour à la page de
			gestion des élèves</a>

		<?php
		if ($id_class_prec != 0) {
			echo " | <a href='" . $_SERVER['PHP_SELF'] . "?id_classe=$id_class_prec'>Classe précédente</a>";
		}
	...
	function confirm_changement_classe(thechange, themessage) {
		...
		if ($id_class_suiv != 0) {
			echo " | <a href='" . $_SERVER['PHP_SELF'] . "?id_classe=$id_class_suiv'>Classe suivante</a>";
		}
		?>
	</p>
</form>
