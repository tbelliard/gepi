...
<form action="contacter_admin.php" method="post" name="doc">
	...
	<p>Sujet&nbsp;<span style='color:red' alt='Ce champ doit être renseigné'
						title='Ce champ doit être renseigné'>(*)</span>&nbsp;:
		<!--input type='text' name='objet_msg' value="Demande d'aide dans GEPI" size='35' maxlength='80' /--><input
				type='text' name='objet_msg' id='objet_msg' value="" size='35' maxlength='80'/><br/>
	...
	function verif_et_valide_envoi() {
		if(document.getElementById('objet_msg').value === '') {
			...
			if(document.getElementById('email_reponse')) {
				let email = document.getElementById('email_reponse').value;
				let confirmation;
