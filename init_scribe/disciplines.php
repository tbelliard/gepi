...
if (isset($_POST['is_posted'])) {
    ...
    $sr = ldap_search($ds,$ldap_base,"(description=Matiere*)");
        ...
        */
        ...
        for ($i=0;$i<$info["count"];$i++) {
            ...
            if (!in_array($matiere, $matieres)) {
                $reg_matiere = mysql_query("INSERT INTO matieres SET matiere='".$matiere."',nom_complet='".htmlentities($_POST['reg_nom_complet'][$matiere])."', priority='11'");
            } else {
