...
if (isset($_GET['id'])) {
  ...
  <p class=bold>|<a href="modify_type_doc.php">Retour</a>|</p>
  ...
  <p class='bold'>|<a href="index.php">Retour</a>|<a href="modify_type_doc.php?id=ajout">Ajouter un type de fichier</a>|</p>
