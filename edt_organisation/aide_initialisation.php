...
<p><strong>5. Salles : </strong>Vous devez définir les salles dans lesquelles se déroulent les cours. Dans le menu, cliquez sur [Création] [Créer/éditer les salles] </p>
<p><strong>6. Périodes : </strong>Vous allez définir la ou les périodes qui vont découper l'année scolaire. Evitez le chevauchement des périodes qui n'est pas une fonctionnalité prévue dans le module d'emploi du temps. A partir du menu, cliquez sur [Création] [Créer/éditer les périodes].</p>
<p><strong>7. Importation du fichier : </strong>Cliquez sur [Création] [Initialisation automatique] et suivez les étapes qui correspondent au  type d'import réalisé.</strong></p>
<?php
$ua = getenv("HTTP_USER_AGENT");
if (!strstr($ua, "MSIE 6.0")) {
echo "</div>";
