...
function RecupereEnseignementsID($creneau_courant, $jour_semaine, $id_classe, &$tab_enseignement_final, $period)
{
    ...
    $req_id_groupe = mysql_query("SELECT id_groupe from j_groupes_classes where
                                id_classe = '".$id_classe."' ");
    ...
    $req_aid_classe = mysql_query("SELECT DISTINCT id_aid FROM j_aid_eleves WHERE login IN
    ...
    while (isset($tab_id_creneaux[$j]) AND !$erreur) {
        ...
        // ========================================== 1 seul cours
            ...
            if ($tab_cours['id_semaine'][0] != '0') {
                //$tab_cours['duree'][1] = 0;
                //$tab_cours['heuredeb_dec'][1] = 0;
                //$tab_cours['id_semaine'][1] = 0;
