...
function add_token_field($avec_id=false,$avec_gepi_alea=true) {
	...
	// appels pour insÈrer le champ 'csrf_alea' dans des forumulaires inclus dans le code
...
function envoi_mail($sujet, $message, $destinataire, $ajout_headers='') {
	...
	// Si on ajoute un retour ‡ la ligne de plus, l'ajout_headers est mis dans le corps du message
