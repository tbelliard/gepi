...
function remplace_accents($chaine,$mode){
	...
	if($mode='all'){
		...
		$retour=strtr(ereg_replace("∆","AE",ereg_replace("Ê","ae",ereg_replace("º","OE",ereg_replace("Ω","oe","$chaine")))),"__¬ƒ¿¡√ƒ≈« À»…ŒœÃÕ—‘÷“”’¶€‹Ÿ⁄›æ¥·‡‚‰„ÂÁÈËÍÎÓÔÏÌÒÙˆÚÛı®˚¸˘˙˝ˇ∏","AAAAAAACEEEEIIIINOOOOOSUUUUYYZaaaaaaceeeeiiiinoooooosuuuuyyz");
	}
	else{
