...
function remplace_accents($chaine,$mode){
	...
	elseif($mode == 'all_nospace'){
		// On remplace espaces et apostrophes par des '_' et les caractËres accentuÈs par leurs Èquivalents non accentuÈs.
		$retour1 = strtr(ereg_replace("∆","AE",ereg_replace("Ê","ae",ereg_replace("º","OE",ereg_replace("Ω","oe","$chaine")))),"'¬ƒ¿¡√ƒ≈« À»…ŒœÃÕ—‘÷“”’¶€‹Ÿ⁄›æ¥·‡‚‰„ÂÁÈËÍÎÓÔÏÌÒÙˆÚÛı®˚¸˘˙˝ˇ∏","_AAAAAAACEEEEIIIINOOOOOSUUUUYYZaaaaaaceeeeiiiinoooooosuuuuyyz");
