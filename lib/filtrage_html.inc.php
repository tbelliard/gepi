<?php
	...
	// Recuperation et si necessaire initialisation de la valeur de 'filtrage_html'
	...
	// Test de validite de la valeur recuperee
	...
	// Test de compatibilite de la valeur avec la configuration
