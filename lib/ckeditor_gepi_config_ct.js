...
CKEDITOR.editorConfig = function( config ) {
	...
	// Pour forcer le protocole https
	// config.embed_provider = 'https://ckeditor.iframe.ly/api/oembed?url={url}&callback={callback}';
	// Dupral et Noembed : https://www.drupal.org/node/2742571
	config.embed_provider = 'https://noembed.com/embed?maxwidth=200&url={url}&callback={callback}';

	// Focus sur la notice CDT au chargement
