...
<div id="alert_entete" style="z-index:2000;
								display:none;
								position:absolute;"><img src="<?php echo $image_path ?>images/alerte_entete.png"
														 alt="alerte"/></div>
<div id="alert_popup" style="z-index:2000;
	...
	<div id="alert_button" style="margin:5px auto;width:90px;">
		<div id="alert_bouton_ok" style="float:left;"><img src="<?php echo $image_path ?>images/bouton_continue.png"
														   alt="ok"/></div>
	</div>
</div>
