...
if (!$_SESSION["login"]) {
	...
	if ($_SESSION['statut'] == "administrateur") {
		...
		$menus = null;
		$menus  = '<li class="li_inline"><a href="#">&nbsp;Administration</a>';
		$menus .= '<ul class="niveau2">';
		$menus .= '  <li><a href="'.$gepiPath.'/gestion/index.php">Gestion Générale</a>';
		$menus .= '    <ul class="niveau3">';
		$menus .= '      <li><a href="#">Sécurité</a>';
		...
		$menus .= '        </ul>';
		$menus .= '      </li>';
		$menus .= '      <li><a href="#">Paramétrages</a>';
		$menus .= '        <ul class="niveau4">';
		...
		$menus .= '        </ul>';
		$menus .= '      </li>';		
		$menus .= '      <li><a href="#">Bases de données</a>';
		$menus .= '        <ul class="niveau4">';
		...
		$menus .= '    </ul>';
		$menus .= '  </li>';		
		$menus .= '  <li><a href="'.$gepiPath.'/accueil_modules.php">Gestion des modules</a>';
		$menus .= '    <ul class="niveau3">';
		...
		$menus .= '    </ul>';		
		$menus .= '  </li>';
		$menus .= '  <li><a href="'.$gepiPath.'/accueil_admin.php">Gestion des bases</a>';
		$menus .= '    <ul class="niveau3">';
		...
		$menus .= '</ul>';
		$menus .= '</li>';
		$menus .= '<li class="li_inline"><a href="'.$gepiPath.'/edt_organisation/index_edt.php">&nbsp;Emplois du temps</a>';
		$menus .= '</li>';
