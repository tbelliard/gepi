...
function delete_group($_id_groupe) {
    ...
    $del11 = mysqli_query($GLOBALS["mysqli"], "DELETE from edt_corresp2 WHERE id_groupe = '" . $_id_groupe . "'");
    if (!$del11) $errors .= "Erreur lors de la suppression des références au groupe dans edt_corresp2.<br/>";
    ...
    $del14 = mysqli_query($GLOBALS["mysqli"], "DELETE from edt_cours WHERE id_groupe = '" . $_id_groupe . "'");
    if (!$del14) $errors .= "Erreur lors de la suppression du groupe dans les emplois du temps.<br/>";
