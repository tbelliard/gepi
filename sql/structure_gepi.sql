...
CREATE TABLE eleves
(
	no_gep VARCHAR(50) NOT NULL DEFAULT '' COMMENT 'Ancien numero GEP, Numero national de l\'eleve',
	login VARCHAR(50) NOT NULL DEFAULT '' COMMENT 'Login de l\'eleve, est conserve pour le login utilisateur',
	nom VARCHAR(100) NOT NULL DEFAULT '' COMMENT 'Nom eleve',
	prenom VARCHAR(100) NOT NULL DEFAULT '' COMMENT 'Prenom eleve',
	sexe VARCHAR(1) NOT NULL DEFAULT '' COMMENT 'M ou F',
	...
	elenoet VARCHAR(50) NOT NULL DEFAULT '' COMMENT 'Numero interne de l\'eleve dans l\'etablissement',
	ereno VARCHAR(50) NOT NULL DEFAULT '' COMMENT 'Plus utilise',
...
CREATE TABLE `utilisateurs` ( `login` varchar(50) NOT NULL default '', `nom` varchar(50) NOT NULL default '', `prenom` varchar(50) NOT NULL default '', `civilite` varchar(5) NOT NULL default '', `password` varchar(128) NOT NULL default '', `salt` varchar(128) NOT NULL DEFAULT '', `email` varchar(50) NOT NULL default '', `show_email` varchar(3) NOT NULL default 'no', `statut` varchar(20) NOT NULL default '', `etat` varchar(20) NOT NULL default '', `change_mdp` char(1) NOT NULL default 'n', `date_verrouillage` datetime NOT NULL default '2006-01-01 00:00:00', `password_ticket` varchar(255) NOT NULL default '', `ticket_expiration` datetime NOT NULL DEFAULT '1000-01-01 00:00:00', `niveau_alerte` SMALLINT NOT NULL DEFAULT '0', `observation_securite` TINYINT NOT NULL DEFAULT '0', `temp_dir` VARCHAR( 255 )  NOT NULL DEFAULT '', `numind` varchar(255)  NOT NULL DEFAULT '', `type` varchar(10)  NOT NULL DEFAULT '', `auth_mode` enum('gepi', 'ldap', 'sso') NOT NULL default 'gepi', PRIMARY KEY  (`login`), INDEX statut ( `statut` ), INDEX etat ( `etat` )) ENGINE=MyISAM CHARACTER SET utf8 COLLATE utf8_general_ci;
...
DROP TABLE IF EXISTS a_agregation_demi_journees;
CREATE TABLE IF NOT EXISTS a_agregation_demi_journees (
id INTEGER(11) NOT NULL AUTO_INCREMENT,
