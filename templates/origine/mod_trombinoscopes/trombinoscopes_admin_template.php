...
<span class="bold">Attention : </span>si l'encodage est activé alors pour transférer directement par FTP les fichiers photo des élèves (<em>nommés sous la forme elenoet.jpg ou login.jpg</em>) dans le dossier photos/eleves il faut au préalable désactiver l'encodage, procéder au transfert, puis activer l'encodage.</p>
