...
?>
		...
		<input type='radio'
			   ...
			   id='activer_y'
			   value='y'
			   <?php if (getSettingValue('active_mod_examen_blanc')=='y') echo ' checked="checked"'; ?>/>
		<label for='activer_y'>
		  Activer le module Examens blancs
		</label>
		<br />
		<input type='radio'
			   name='activer'
			   id='activer_n'
			   value='n'
			   <?php if (getSettingValue('active_mod_examen_blanc')=='n') echo ' checked="checked"'; ?>/>
		<label for='activer_n'>
		  Désactiver le module Examens blancs
		</label>
	  </fieldset>
	  <p class="center">
