...
?>
		...
		<input type='radio'
			   ...
			   id='activer_y'
			   value='y'
			   <?php if (getSettingValue('active_messagerie')=='y') echo ' checked="checked"'; ?>/>
		<label for='activer_y'>
		  Activer le module Messagerie
		</label>
		<br />
		<input type='radio'
			   name='activer'
			   id='activer_n'
			   value='n'
			   <?php if (getSettingValue('active_messagerie')=='n') echo ' checked="checked"'; ?>/>
		<label for='activer_n'>
		  Désactiver le module Messagerie
		</label>
		</p>
