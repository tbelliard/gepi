...
?>
	...
	<h2>Rappel du B.O.</h2>
	<p>Le "cahier de textes de classe [...] constitue un document officiel, à valeur 
juridique.<br />
[...]<br />
Le cahier de textes mentionnera, d'une part, le contenu de la séance et, d'autre part, le travail à effectuer, accompagnés l'un et l'autre de tout document, ressource ou conseil à l'initiative du professeur, sous forme de textes, de fichiers joints ou de liens. [...] Les travaux donnés aux élèves porteront, outre la date du jour où ils sont donnés, l'indication du jour où ils doivent être présentés ou remis par l'élève.<br />
Les textes des devoirs et des contrôles figureront au cahier de textes, sous forme de textes ou de fichiers joints. Il en sera de même du texte des exercices ou des activités lorsque ceux-ci ne figureront pas sur les manuels scolaires.<br />
En ce qui concerne les travaux effectués dans le cadre de groupes, ou de sous-groupes d'élèves de différents niveaux de compétences, et en vue de favoriser un accompagnement plus personnalisé, le contenu de ces activités spécifiques sera également mentionné dans le cahier de textes."<br />
