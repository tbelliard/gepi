			...
			if(!$fp) {
				...
				while (!feof($fp)) {
					...
					if(trim($ligne)!="") {
						...
						//=====================================
// DEBUG: if($tabligne[0]=='GRUY') {echo "<p>".$tabligne[0]." ".$tabligne[1]." -&gt; ";}
//$tabligne[1]=casse_mot($tabligne[1],'majf2');
//$tabligne[1]=ensure_utf8($tabligne[1]);
//if($tabligne[0]=='GRUY') {echo " -&gt; ".$tabligne[1]." -&gt; ";}
...
// DEBUG: if($tabligne[0]=='GRUY') {echo $tabligne[1]."</p>";}
