...
$query = mysql_query("CREATE TABLE IF NOT EXISTS notanet_saisie (login VARCHAR( 50 ) NOT NULL, id_mat INT(4), matiere VARCHAR(50), note VARCHAR(4), PRIMARY KEY ( login )) ENGINE=MyISAM CHARACTER SET utf8 COLLATE utf8_general_ci;");
//===========================================================
...
elseif($_SESSION['statut']=="scolarite") {
	...
	if(mysql_num_rows($res_matiere_notanet)>0) {
		if(!getSettingAOui("notanet_saisie_note_ouverte")) {
			echo "<li>La saisie de notes est actuellement fermée.<br />
			<a href='saisie_notes.php'>Consulter les 'notes' dans les enseignements dont la note n'est pas la moyenne des 3 trimestres (<i>APSA en EPS</i>)</li>\n";
		}
