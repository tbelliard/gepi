            ...
            if (isset($NON_PROTECT["correction_app_eleve"])) {
                ...
                (mb_strlen(preg_replace('/[0-9]/','',$correction_periode))!=0)) {
                    ...
                    if(mysqli_num_rows($test)==0) {
                        $msg.="L'élève $correction_nom_prenom_eleve n'est pas associé au groupe nÂ°$id_groupe pour la période $correction_periode.<br />";
                    }
                    else {
                        // 20131204
...
echo "<script type='text/javascript'>
    ...
    function signaler_une_faute(eleve_login, id_eleve, id_groupe, liste_profs_du_groupe, num_periode) {
        ...
        message='Bonjour,\\n\\nL\'appréciation de l\'élève '+info_eleve+' sur l\'enseignement nÂ°'+id_groupe+' ('+info_groupe+') en période nÂ°'+num_periode+' présente un problème ou une faute:\\n';
        message=message+'================================\\n';
