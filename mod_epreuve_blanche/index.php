...
if(($_SESSION['statut']=='administrateur')||($_SESSION['statut']=='scolarite')) {
	...
	if((isset($_POST['creer_epreuve']))||(isset($_POST['modif_epreuve']))) {
		...
		if(strlen(ereg_replace("[A-Za-z _.-]","",remplace_accents($intitule,'all')))!=0) {$intitule=ereg_replace("[^A-Za-zÂÄÀÁÃÄÅÇÊËÈÉÎÏÌÍÑÔÖÒÓÕ¦ÛÜÙÚÝ¾´áàâäãåçéèêëîïìíñôöðòóõ¨ûüùúýÿ¸_.-]"," ",$intitule);}
