...
if($extraire=="y") {
	...
	while($lig_mef=mysqli_fetch_object($res_mef)) {
		...
		// Justifiée ou non:
		// PROBLEME: Un élève qui a un retard et qui dans la même dem-journée sèche des cours, si aucun motifs_absences n'est saisi, il ne sera pas totalisé ici.
		...
		*/
		...
		$tab_stat['mef'][$cpt_mef]['pourcentage_non_valable_sup_egal_4']=0;

		$tab_stat['mef'][$cpt_mef]['liste_non_valable_sup_egal_4']="";
		$tab_stat['mef'][$cpt_mef]['ele_non_valable_sup_egal_4']=array();
		if(mysqli_num_rows($res)>0) {
			...
			while($lig_ele=mysqli_fetch_object($res)) {
				...
				*/
				...
				if($cpt_non_valable>=4) {
					...
					$tab_stat['mef'][$cpt_mef]['liste_non_valable_sup_egal_4'].=$lig_ele->nom." ".$lig_ele->prenom;
					$tab_stat['mef'][$cpt_mef]['ele_non_valable_sup_egal_4'][$cpt_ele]['login']=$lig_ele->login;
					$tab_stat['mef'][$cpt_mef]['ele_non_valable_sup_egal_4'][$cpt_ele]['nom_prenom']=$lig_ele->nom." ".$lig_ele->prenom;
			...
			$tab_stat['mef'][$cpt_mef]['non_valable_sup_egal_4']=count($tab_stat['mef'][$cpt_mef]['ele_non_valable_sup_egal_4']);
			$tab_stat['mef'][$cpt_mef]['pourcentage_non_valable_sup_egal_4']=round($tab_stat['mef'][$cpt_mef]['non_valable_sup_egal_4']/$tab_stat['mef'][$cpt_mef]['effectif'],2);

			$tabdiv_infobulle_0[]=creer_div_infobulle('infobulle_mef_'.$cpt_mef.'_non_valable_sup_egal_4',$titre_infobulle,"",$texte_infobulle,"",35,0,'y','y','n','n');
		...
		*/
		...
		$tab_stat['mef'][$cpt_mef]['pourcentage_non_valable_4_a_10']=0;

		$tab_stat['mef'][$cpt_mef]['liste_non_valable_4_a_10']="";
		$tab_stat['mef'][$cpt_mef]['ele_non_valable_4_a_10']=array();
		if(mysqli_num_rows($res)>0) {
			...
			while($lig_ele=mysqli_fetch_object($res)) {
				...
				*/
				...
				if(($cpt_non_valable>=4)&&($cpt_non_valable<=10)) {
					...
					$tab_stat['mef'][$cpt_mef]['liste_non_valable_4_a_10'].=$lig_ele->nom." ".$lig_ele->prenom;
					$tab_stat['mef'][$cpt_mef]['ele_non_valable_4_a_10'][$cpt_ele]['login']=$lig_ele->login;
					$tab_stat['mef'][$cpt_mef]['ele_non_valable_4_a_10'][$cpt_ele]['nom_prenom']=$lig_ele->nom." ".$lig_ele->prenom;
			...
			$tab_stat['mef'][$cpt_mef]['non_valable_4_a_10']=count($tab_stat['mef'][$cpt_mef]['ele_non_valable_4_a_10']);
			$tab_stat['mef'][$cpt_mef]['pourcentage_non_valable_4_a_10']=round($tab_stat['mef'][$cpt_mef]['non_valable_4_a_10']/$tab_stat['mef'][$cpt_mef]['effectif'],2);

			$tabdiv_infobulle_0[]=creer_div_infobulle('infobulle_mef_'.$cpt_mef.'_non_valable_4_a_10',$titre_infobulle,"",$texte_infobulle,"",35,0,'y','y','n','n');
		...
		*/
		...
		$tab_stat['mef'][$cpt_mef]['pourcentage_non_valable_sup_egal_11']=0;

		$tab_stat['mef'][$cpt_mef]['liste_non_valable_sup_egal_11']="";
		$tab_stat['mef'][$cpt_mef]['ele_non_valable_sup_egal_11']=array();
		if(mysqli_num_rows($res)>0) {
			...
			while($lig_ele=mysqli_fetch_object($res)) {
				...
				*/
				...
				if($cpt_non_valable>=11) {
					...
					$tab_stat['mef'][$cpt_mef]['liste_non_valable_sup_egal_11'].=$lig_ele->nom." ".$lig_ele->prenom;
					$tab_stat['mef'][$cpt_mef]['ele_non_valable_sup_egal_11'][$cpt_ele]['login']=$lig_ele->login;
					$tab_stat['mef'][$cpt_mef]['ele_non_valable_sup_egal_11'][$cpt_ele]['nom_prenom']=$lig_ele->nom." ".$lig_ele->prenom;
			...
			$tab_stat['mef'][$cpt_mef]['non_valable_sup_egal_11']=count($tab_stat['mef'][$cpt_mef]['ele_non_valable_sup_egal_11']);
			$tab_stat['mef'][$cpt_mef]['pourcentage_non_valable_sup_egal_11']=round($tab_stat['mef'][$cpt_mef]['non_valable_sup_egal_11']/$tab_stat['mef'][$cpt_mef]['effectif'],2);

			$tabdiv_infobulle_0[]=creer_div_infobulle('infobulle_mef_'.$cpt_mef.'_non_valable_sup_egal_11',$titre_infobulle,"",$texte_infobulle,"",35,0,'y','y','n','n');
...
echo "<table class='boireaus boireaus_alt sortable resizable' border='1'>
	<thead>
		<tr>
			...
			<th colspan='3'>Motif non valable</th>
		</tr>
		<tr>
			...
			<th class='number'>
				non_valable_sup_egal_4
			</th>
			<th class='number'>
				non_valable_4_a_10
			</th>
			<th class='number'>
				non_valable_sup_egal_11
			</th>
		</tr>
	<thead>
	<tbody>";
for($loop=0;$loop<count($tab_stat['mef']);$loop++) {
	...
	// Motif non valable
	if($tab_stat['mef'][$loop]['non_valable_sup_egal_4']>0) {
		echo "
			<td title=\"".$tab_stat['mef'][$loop]['liste_non_valable_sup_egal_4']."\" onclick=\"afficher_div('infobulle_mef_".$loop."_non_valable_sup_egal_4', 'y', 10, 10); return false;\">
				<a href='#' onclick=\"afficher_div('infobulle_mef_".$loop."_non_valable_sup_egal_4', 'y', 10, 10); return false;\">".$tab_stat['mef'][$loop]['non_valable_sup_egal_4']."</a>
			</td>";
	}
	else {
		echo "
	...
	if($tab_stat['mef'][$loop]['non_valable_4_a_10']>0) {
		echo "
			<td title=\"".$tab_stat['mef'][$loop]['liste_non_valable_4_a_10']."\" onclick=\"afficher_div('infobulle_mef_".$loop."_non_valable_4_a_10', 'y', 10, 10); return false;\">
				<a href='#' onclick=\"afficher_div('infobulle_mef_".$loop."_non_valable_4_a_10', 'y', 10, 10); return false;\">".$tab_stat['mef'][$loop]['non_valable_4_a_10']."</a>
			</td>";
	}
	else {
		echo "
	...
	if($tab_stat['mef'][$loop]['non_valable_sup_egal_11']>0) {
		echo "
			<td title=\"".$tab_stat['mef'][$loop]['liste_non_valable_sup_egal_11']."\" onclick=\"afficher_div('infobulle_mef_".$loop."_non_valable_sup_egal_11', 'y', 10, 10); return false;\">
				<a href='#' onclick=\"afficher_div('infobulle_mef_".$loop."_non_valable_sup_egal_11', 'y', 10, 10); return false;\">".$tab_stat['mef'][$loop]['non_valable_sup_egal_11']."</a>
			</td>";
	}
	else {
		echo "
