...
if ($reinit_filtre == 'y') {
    ...
    $liste_parametres_checkbox = array('filter_date_modification', 'filter_discipline', 'filter_marqueur_appel', 'filter_saisies_supprimees','filter_saisies_globalement_non_justifiees', 'filter_saisies_globalement_non_notifiees', 'filter_saisies_globalement_manquement', 'filter_no_marqueur_appel');
