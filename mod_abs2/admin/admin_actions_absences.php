...
<div style="text-align:center">
    <h2>Définition des Actions d'absence</h2>
...
<?php
    ...
    foreach ($Action_collection as $Action) { ?>
	  ...
	  <td><?php echo $Action->getCommentaire(); ?></td>
          ...
          <td><a href="admin_actions_absences.php?action=supprimer&amp;id=<?php echo $Action->getId(); ?>" onClick="return confirm('Etes-vous sûr de vouloir supprimer cette action ?')"><img src="../../images/icons/delete.png" width="22" height="22" title="Supprimer" border="0" alt="" /></a></td>
