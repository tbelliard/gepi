			...
			<th>Enregistement</th>
				...
				if(mysql_num_rows($res)>0) {
					while($lig=mysql_fetch_object($res)) {
						...
						//echo "$sql<br />";
						$res_nj=mysql_query($sql);
						$nb_nj=mysql_num_rows($res_nj);
						...
						//echo "$sql<br />";
						$res_ret=mysql_query($sql);
						$nb_ret=mysql_num_rows($res_ret);
